# Function: `fn_GetDauKy_Of_Quy_NhanVienTheoSanPham`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-07 12:18:13.510000
- **Ngày sửa cuối**: 2015-03-07 12:18:13.510000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Quy_NhanVienTheoSanPham] 
(
...
BEGIN
	...
	IF @isSoluong = 0
		...
		(
			...
			FROM rptThucChay_NhanVien_TheoSanPham_Quy dstchdc
			WHERE 1 = 1
