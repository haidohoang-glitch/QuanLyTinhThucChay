# Stored Procedure: `ThucChay_Insert_TinhLai_ThucChayDaTinh_ByHopDongChiTiet_Native_Ads`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2022-07-07 11:17:45.253000
- **Ngày sửa cuối**: 2023-05-08 10:02:49.260000
...
CREATE  PROCEDURE [dbo].[ThucChay_Insert_TinhLai_ThucChayDaTinh_ByHopDongChiTiet_Native_Ads] 
	...
	(		
		SELECT  NEWID() AS ThucChayDaTinhID,
			...
			(
				...
				AND DmSanPhamREF = tc.DmSanPhamREF AND DmBannerREF = tc.DmBannerID ORDER BY ThucChayHopDongChiTietID) AS NhanHang,
				...
				ISNULL((SELECT TOP (1) sp.TenSanPham FROM dmsanpham sp WHERE sp.dmsanphamid = tc.DmSanPhamREF),'') as TenSanPham,  
				hd.DmNhomWebsiteREF, 
				hd.TenNhomWebsite, 
				hd.DmChuyenMucREF, 
				hd.TenChuyenMuc, 
