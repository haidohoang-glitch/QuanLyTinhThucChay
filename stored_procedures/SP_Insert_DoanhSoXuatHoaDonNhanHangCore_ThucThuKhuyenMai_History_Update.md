# Stored Procedure: `Insert_DoanhSoXuatHoaDonNhanHangCore_ThucThuKhuyenMai_History_Update`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-06-12 10:47:03.950000
- **Ngày sửa cuối**: 2015-06-12 10:47:03.950000
...
-- =============================================
--EXEC [dbo].[Insert_DoanhSoXuatHoaDonNhanHangCore_ThucThuKhuyenMai_History] '2013-01-01'
CREATE PROCEDURE [dbo].[Insert_DoanhSoXuatHoaDonNhanHangCore_ThucThuKhuyenMai_History_Update]
...
BEGIN
	...
	DECLARE @NgayDanhSo DATETIME, @NgayKyHopDong DATETIME, @NgayXuatHoaDon DATETIME, @SoHoaDon NVARCHAR(50), @ThongTinHoaDonID INT;
	...
	FROM HopDong hd
		...
		(SELECT  tthd.HopDongREF,CONVERT(DATE,tthd.NgayXuatHoaDon) AS NgayXuatHoaDon, tthd.ThongTinHoaDonID, tthd.SoHoaDon, tthd.GiaTri
		   FROM ThongTinHoaDon tthd WHERE  
		     tthd.DeletedStatus = 0 AND tthd.ThongTinHoaDonID = @ThongTinHoaDonID_in) A
	...
	, @SoHoaDon,@NgayXuatHoaDon,@ThongTinHoaDonID,@DmMaHopDongREF
