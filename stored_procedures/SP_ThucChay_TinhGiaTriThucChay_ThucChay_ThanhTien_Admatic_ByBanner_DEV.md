# Stored Procedure: `ThucChay_TinhGiaTriThucChay_ThucChay_ThanhTien_Admatic_ByBanner_DEV`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2021-06-29 11:01:39.720000
- **Ngày sửa cuối**: 2021-06-30 15:01:03.747000
...
CREATE PROCEDURE [dbo].[ThucChay_TinhGiaTriThucChay_ThucChay_ThanhTien_Admatic_ByBanner_dev]
...
BEGIN
	...
	BEGIN
		...
		SET @FromDate = ISNULL((SELECT top 1 max(TC.NgayThucHienMax) FROM [dbo].[INFOBANNER_BRANDING_THANHTIEN_ADMATIC] TC WHERE TC.SOHOPDONG = @SoHopDong
