# Stored Procedure: `ThucChayDaTinh_CheckVaUpdateGiaTriThayDoi_ThanhTien_GGFB_ByHopDongChiTietREF_bk20211126`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2021-11-26 14:23:52.720000
- **Ngày sửa cuối**: 2021-11-26 14:23:52.720000
...
--	  AND NgayThucHien = @NgayThucHien
	...
	EXEC [ThucChayDaTinh_CheckVaUpdateGiaTriThayDoi_ThanhTien_GGFB] '2020-10-19'
*/
create PROCEDURE [dbo].[ThucChayDaTinh_CheckVaUpdateGiaTriThayDoi_ThanhTien_GGFB_ByHopDongChiTietREF_bk20211126]
...
BEGIN
	...
	(
		...
		AND (hdct.DmSanPhamREF in (306,423,5160,5188) OR DmViTriREF in (100093,100478) )
	...
	AND TCL.LastModifiedAt < tc.LastModifiedAt
