# Function: `fn_GetDauKy_Of_Thang_DoiBanTheoNhanVienKhachHang`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-07 12:18:11.323000
- **Ngày sửa cuối**: 2015-03-07 12:18:11.323000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Thang_DoiBanTheoNhanVienKhachHang] 
(
...
BEGIN
	...
	IF @isSoluong = 0
		...
		(
			...
			FROM rptThucChay_DoiBan_TheoNhanVien_KhachHang_Thang dstchdc
			WHERE 1 = 1
