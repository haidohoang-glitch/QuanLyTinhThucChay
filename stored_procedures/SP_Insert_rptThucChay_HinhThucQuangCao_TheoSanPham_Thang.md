# Stored Procedure: `Insert_rptThucChay_HinhThucQuangCao_TheoSanPham_Thang`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-03-27 17:43:47.883000
- **Ngày sửa cuối**: 2015-03-27 17:43:47.883000
...
-- =============================================
--EXEC [dbo].[Insert_rptThucChay_HinhThucQuangCao_TheoSanPham_Thang] '2013-01-01'
CREATE PROCEDURE [dbo].[Insert_rptThucChay_HinhThucQuangCao_TheoSanPham_Thang]
...
BEGIN
	...
	rtchdn.DmSanPhamREF
	-------------------------------------UPDATE DL--------------------------------
	UPDATE rptThucChay_HinhThucQuangCao_TheoSanPham_Thang
	...
	FROM rptThucChay_HinhThucQuangCao_TheoSanPham_Thang rtchtqct
	...
	AND td.Nam = rtchtqct.Nam
	-------------------------------------INSERT DL--------------------------------------
	INSERT INTO rptThucChay_HinhThucQuangCao_TheoSanPham_Thang
				SELECT 
				@NgayThucHien,
				td.Thang,
				td.Nam,
				...
				td.TenSanPham,
				td.DmSanPhamREF,
				[dbo].[fn_GetDauKy_Of_Ngay_HinhThucQuangCaoTheoSanPham]
				(
				  td.DmNhanVienREF,
				  td.PhongBanREF,
				  td.BoPhanREF,
