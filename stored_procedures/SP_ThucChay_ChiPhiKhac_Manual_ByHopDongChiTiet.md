# Stored Procedure: `ThucChay_ChiPhiKhac_Manual_ByHopDongChiTiet`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2025-08-29 11:24:38.053000
- **Ngày sửa cuối**: 2026-02-04 09:44:17.400000
...
/*
EXEC dbo.ThucChay_ChiPhiKhac_Manual_ByHopDongChiTiet
    @NgayGhiNhan = '2026-02-03',  -- date
    @HopDongChiTietID = 766787  -- int
*/


CREATE PROCEDURE [dbo].[ThucChay_ChiPhiKhac_Manual_ByHopDongChiTiet]
    @NgayGhiNhan DATE,
	...
	@NgayDanhSoGioiHan_Admatic_MKT DATETIME = '2025-10-10'
		...
		BEGIN
			...
			SELECT  NEWID(),
					...
					hd.IsBanCung , 
					hd.DmPhongBanREF ,
					SUBSTRING(ISNULL(hd.TenPhongBan, ''),1,49) AS TenPhongBan ,
					hd.DmBoPhanREF ,
					SUBSTRING(ISNULL(hd.TenBoPhan, ''),1,49) AS TenBoPhan ,
					hd.DmNhomLamViecREF ,
					SUBSTRING(ISNULL(hd.TenNhom, ''),1,49) AS TenNhom ,
