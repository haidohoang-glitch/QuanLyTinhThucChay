# Stored Procedure: `Insert_rptThucChay_DoiBan_TheoNhanVien_Ngay`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-03-07 12:18:30.747000
- **Ngày sửa cuối**: 2015-03-07 12:18:30.747000
...
CREATE PROCEDURE [dbo].[Insert_rptThucChay_DoiBan_TheoNhanVien_Ngay] 
...
BEGIN
	...
	WHILE @NgayThucHien <= @ToDate
		BEGIN
			 INSERT INTO rptThucChay_DoiBan_TheoNhanVien_Ngay
			 SELECT 
				...
				dstchdc.NhomREF,
				'' DienGiai,
			    [dbo].[fn_GetDauKy_Of_Ngay_DoiBanTheoNhanVien] 
				(
				  dstchdc.DmNhanVienREF,
				  dstchdc.PhongBanREF,
	              dstchdc.BoPhanREF,
