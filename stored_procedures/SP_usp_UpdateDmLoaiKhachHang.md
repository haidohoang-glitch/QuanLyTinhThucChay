# Stored Procedure: `usp_UpdateDmLoaiKhachHang`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2013-08-20 16:13:06.447000
- **Ngày sửa cuối**: 2014-11-19 12:16:44.133000
...
--=============================================
-- Author:   Nhat Mai Quy
-- Stored Procedure Name: [dbo].[usp_UpdateDmLoaiKhachHang]
-- Create Date: Monday, August 19, 2013
-- Description: 
--=============================================

CREATE PROCEDURE [dbo].[usp_UpdateDmLoaiKhachHang]
...
UPDATE [dbo].[DmLoaiKhachHang] SET
