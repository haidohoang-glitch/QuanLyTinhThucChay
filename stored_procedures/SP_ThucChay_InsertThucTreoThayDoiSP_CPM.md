# Stored Procedure: `ThucChay_InsertThucTreoThayDoiSP_CPM`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2014-05-29 16:16:25.047000
- **Ngày sửa cuối**: 2015-06-05 01:14:46.657000
...
CREATE  PROCEDURE [dbo].[ThucChay_InsertThucTreoThayDoiSP_CPM]
	@HopDongChiTiet INT,
	@DmSanPhamREF INT,
...
BEGIN
	...
	FROM 
	(
		SELECT * FROM HopDongChiTiet WHERE DmSanPhamREF in (231,238,339,240,370,531,598,613)
