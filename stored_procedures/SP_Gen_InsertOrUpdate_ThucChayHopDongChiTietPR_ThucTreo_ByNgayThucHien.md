# Stored Procedure: `Gen_InsertOrUpdate_ThucChayHopDongChiTietPR_ThucTreo_ByNgayThucHien`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2019-06-03 10:02:15.140000
- **Ngày sửa cuối**: 2019-06-03 10:02:29.310000

## Parameters

| Parameter | Type | Output |
|-----------|------|--------|
| `@SoNgayThucHien` | `int(4)` | No |
...
CREATE PROCEDURE [dbo].[Gen_InsertOrUpdate_ThucChayHopDongChiTietPR_ThucTreo_ByNgayThucHien] 	
	@SoNgayThucHien INT
As 	
...
SET @NgayThucHien = DATEADD(DAY,-@SoNgayThucHien,@NgayThucHien)
...
SELECT id,
       ...
       DonViTinh_Id, 
	   0 Status_syn
 FROM [192.168.23.217].ThucTreo.dbo.ThucTreo_PR
