# Function: `fn_GetDauKy_Of_Quy_BaoCaoTongHopTheoWebsite`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-27 17:43:33.250000
- **Ngày sửa cuối**: 2015-03-27 17:43:33.250000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Quy_BaoCaoTongHopTheoWebsite] 
(
...
BEGIN
	...
	IF @isSoluong = 0
		...
		(
			...
			FROM rptThucChay_BaoCaoTongHopTheoWebsite_Quy dstchdc
			WHERE 1 = 1
