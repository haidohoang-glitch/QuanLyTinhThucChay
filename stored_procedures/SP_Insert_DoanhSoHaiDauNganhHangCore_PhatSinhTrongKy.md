# Stored Procedure: `Insert_DoanhSoHaiDauNganhHangCore_PhatSinhTrongKy`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-04-22 16:42:54.500000
- **Ngày sửa cuối**: 2015-04-22 16:42:54.500000
...
-- =============================================
CREATE PROCEDURE [dbo].[Insert_DoanhSoHaiDauNganhHangCore_PhatSinhTrongKy]
	...
	BEGIN
			...
			BEGIN   
				  SET @CountNhan +=1;
					...
					IF @IsHopDongNoiBo =1
					BEGIN
							--- Insert du lieu vao table DoanhSoHaiDauNganhHangCore
							...
							SELECT @NgayThucHien AS NgayThucHien,
								   ...
								   --SoLuongThucThu
									...
									--SoLuongKM
									, (
										CASE WHEN @ChietKhau = 100 THEN [dbo].[fn_GetSoLuongDauKy_DoanhSoHaiDauNganhHangCore]
												(   2,
												    @NgayThucHien ,
													@HopDongID ,
													@DmNhanVienREF ,
									...
									, (
										CASE WHEN @ChietKhau = 100 THEN @ChiSoSLNhanM - [dbo].[fn_GetSoLuongDauKy_DoanhSoHaiDauNganhHangCore]
												(   2,
												    @NgayThucHien ,
													@HopDongID ,
													@DmNhanVienREF ,
									...
									, (
										CASE WHEN @ChietKhau = 100 THEN 0
											ELSE [dbo].[fn_GetSoLuongDauKy_DoanhSoHaiDauNganhHangCore]
												(   3,
												    @NgayThucHien ,
													@HopDongID ,
													@DmNhanVienREF ,
									...
									, (
										CASE WHEN @ChietKhau = 100 THEN 0
											ELSE @ChiSoSLNhanM - [dbo].[fn_GetSoLuongDauKy_DoanhSoHaiDauNganhHangCore]
												(   3,
												    @NgayThucHien ,
													@HopDongID ,
													@DmNhanVienREF ,
									...
									--ThanhTienKM
									, (
										CASE WHEN @ChietKhau = 100 THEN [dbo].[fn_GetDoanhSoDauKy_DoanhSoHaiDauNganhHangCore]
												(   2,
												    @NgayThucHien ,
													@HopDongID ,
													@DmNhanVienREF ,
									...
									, (
										CASE WHEN @ChietKhau = 100 THEN  @ChiSoSLNhanM * @DonGia -
													[dbo].[fn_GetDoanhSoDauKy_DoanhSoHaiDauNganhHangCore]
												(   2,
												    @NgayThucHien ,
													@HopDongID ,
													@DmNhanVienREF ,
									...
									, (
										CASE WHEN @ChietKhau = 100 THEN 0
											ELSE [dbo].[fn_GetDoanhSoDauKy_DoanhSoHaiDauNganhHangCore]
												(   3,
												    @NgayThucHien ,
													@HopDongID ,
													@DmNhanVienREF ,
			  ...
			  BEGIN
							...
							SELECT @NgayThucHien AS NgayThucHien,
								   ...
								   --SoLuongThucThu
									...
									, (
										CASE WHEN @ChietKhau = 100 THEN  @SoLuong - [dbo].[fn_GetSoLuongDauKy_DoanhSoHaiDauNganhHangCore]
												(   2,
												    @NgayThucHien ,
													@HopDongID ,
													@DmNhanVienREF ,
									...
									, (
										CASE WHEN @ChietKhau = 100 THEN 0
											ELSE @SoLuong - [dbo].[fn_GetSoLuongDauKy_DoanhSoHaiDauNganhHangCore]
												(   3,
												    @NgayThucHien ,
													@HopDongID ,
													@DmNhanVienREF ,
									...
									, (
										CASE WHEN @ChietKhau = 100 THEN  @SoLuong* @DonGia -[dbo].[fn_GetDoanhSoDauKy_DoanhSoHaiDauNganhHangCore]
												(   2,
												    @NgayThucHien ,
													@HopDongID ,
													@DmNhanVienREF ,
