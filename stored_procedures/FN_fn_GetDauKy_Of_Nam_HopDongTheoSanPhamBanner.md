# Function: `fn_GetDauKy_Of_Nam_HopDongTheoSanPhamBanner`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-27 17:43:40.377000
- **Ngày sửa cuối**: 2015-03-27 17:43:40.377000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Nam_HopDongTheoSanPhamBanner] 
(
...
BEGIN
	...
	IF @isSoluong = 0
		...
		(
			...
			FROM rptThucChay_HopDong_TheoSanPham_ViTriBanner_Nam dstchdc
			WHERE 1 = 1
