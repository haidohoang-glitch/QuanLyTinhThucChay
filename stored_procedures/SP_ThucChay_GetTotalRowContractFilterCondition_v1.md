# Stored Procedure: `ThucChay_GetTotalRowContractFilterCondition_v1`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2014-02-25 11:29:45.533000
- **Ngày sửa cuối**: 2014-10-14 10:39:53.990000
...
CREATE PROCEDURE [dbo].[ThucChay_GetTotalRowContractFilterCondition_v1] 
		...
		SET @Sql = '
			...
			(
				SELECT
					...
					ROW_NUMBER() OVER (ORDER BY T2.SHD) AS num
				FROM
				(
					SELECT
