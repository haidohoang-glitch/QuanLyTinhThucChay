# Stored Procedure: `Insert_DoanhSoXuatHoaDonNganhHangCore_ByNgayThucHien`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-06-12 10:47:05.947000
- **Ngày sửa cuối**: 2015-06-12 10:47:05.947000
...
-- =============================================
--EXEC [dbo].[Insert_DoanhSoXuatHoaDonNganhHangCore_ByNgayThucHien] '2015-01-06'
CREATE PROCEDURE [dbo].[Insert_DoanhSoXuatHoaDonNganhHangCore_ByNgayThucHien]
...
BEGIN
	...
	WHILE @@FETCH_STATUS = 0
		BEGIN
					...
					SET @IsPhatSinhGiaTriTD = [dbo].[fn_IsPhatSinhGiaTriTD_DoanhSoXuatHoaDonNganhHangCore_New]
					(
						@NgayThucHien,
						@HopDongID,
						@HopDongChiTietID ,
			...
			IF(@IsPhatSinhGiaTriTD = 0)
				BEGIN	
					EXEC [Insert_DoanhSoXuatHoaDonNganhHangCore_PhatSinhTrongKy] @NgayThucHien, @HopDongID,@HopDongChiTietID ,@DmMaHopDongREF_New ,@ThongTinHoaDonID
					PRINT('Phat Sinh Trong Ky')
				END
			ELSE
				BEGIN
						--EXEC dbo.Insert_DoanhSoXuatHoaDonNganhHangCore_PhatSinhThayDoi @NgayThucHien,@HopDongID
	...
	BEGIN
		...
		WHILE @@FETCH_STATUS = 0
		BEGIN
			--DELETE FROM DoanhSoXuatHoaDonNganhHangCore WHERE HopDongID = @HopDongIDThayDoi AND HopDongChiTietREF = @HopDongChiTietIDThayDoi AND ThongTinHoaDonREF = @ThongTinHoaDonThayDoiID
            EXEC dbo.Insert_DoanhSoXuatHoaDonNganhHangCore_NoiBo_History_Update @NgayThucHien,@HopDongIDThayDoi,@HopDongChiTietIDThayDoi,@ThongTinHoaDonThayDoiID
            EXEC dbo.Insert_DoanhSoXuatHoaDonNganhHangCore_ThucThuKhuyenMai_History_Update @NgayThucHien,@HopDongIDThayDoi,@HopDongChiTietIDThayDoi,@ThongTinHoaDonThayDoiID
