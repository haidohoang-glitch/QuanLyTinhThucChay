# Function: `fn_GetDauKy_Of_Ngay_HinhThucQuangCaoTheoSanPhamViTriBanner`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-27 17:43:37.103000
- **Ngày sửa cuối**: 2015-03-27 17:43:37.103000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Ngay_HinhThucQuangCaoTheoSanPhamViTriBanner] 
(
...
BEGIN
	...
	BEGIN
		...
		(
			...
			FROM rptThucChay_HinhThucQuangCao_TheoSanPham_ViTriBanner_Ngay  dstchdc
			WHERE 1 = 1
