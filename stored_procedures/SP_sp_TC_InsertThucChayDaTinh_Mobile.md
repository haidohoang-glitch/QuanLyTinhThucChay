# Stored Procedure: `sp_TC_InsertThucChayDaTinh_Mobile`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2017-06-23 17:58:23.403000
- **Ngày sửa cuối**: 2018-02-26 09:50:52.600000
...
CREATE PROCEDURE [dbo].[sp_TC_InsertThucChayDaTinh_Mobile]
...
AS
    BEGIN
        ...
        SET @v_DmWebsiteREF = ISNULL(( SELECT TOP 1
        ...
        INSERT  INTO dbo.ThucChayDaTinh
                ...
                FROM    ( SELECT    NEWID() ThucChayDaTinhID ,
                                  ...
                                  , TD.ThanhTienThucChayTruocTrietKhau ,
                                    ...
                                    0 SoLuongKMThayDoi ,
                                    0 GiaTriKMThayDoi ,
                                    N'sp_TC_InsertThucChayDaTinh_Mobile' GhiChu
                          FROM      ( SELECT 
	--ID Hop Dong
                                                D.HopDongID ,
	--Thong tin ve ma so 
