# Stored Procedure: `sp_TC_ExcInsertThucChayDaTinh_KoChietKhau_Mobile_DoiTruVaTinhLai`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2017-11-17 11:31:32.120000
- **Ngày sửa cuối**: 2022-12-01 14:58:44.930000
...
CREATE PROCEDURE [dbo].[sp_TC_ExcInsertThucChayDaTinh_KoChietKhau_Mobile_DoiTruVaTinhLai]
    @DmBannerID INT ,
    ...
    BEGIN
        ...
        WHILE @@FETCH_STATUS = 0
            BEGIN  
                ...
                IF ISNULL(@ThanhTienHDCT, 0) > ISNULL(@ThanhTienThucChay, 0)
                    BEGIN
                            ...
                            GROUP BY A.SoHopDong ,
                                ...
                                EXEC dbo.sp_TC_InsertThucChayDaTinh_KoChietKhau_Mobile_DoiTruVaTinhLai @NgayThucHien,
                ...
                FETCH NEXT FROM icursor   INTO @HopDongChiTietID 
            END   
        CLOSE icursor;  
        DEALLOCATE icursor;  
    END
