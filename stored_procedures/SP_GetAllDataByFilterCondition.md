# Stored Procedure: `GetAllDataByFilterCondition`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2013-06-09 05:50:27.070000
- **Ngày sửa cuối**: 2014-10-14 10:39:59.347000
...
| `@FieldNameOrderBy` | `nvarchar(100)` | No |
...
CREATE PROCEDURE [dbo].[GetAllDataByFilterCondition] 
	-- Add the parameters for the stored procedure here
	@TableName nvarchar(50),
	@FieldNameOrderBy nvarchar(50),
	@StartDate datetime,
	@EndDate datetime,
...
BEGIN
	...
	set @SQLCommand = 'Select *  from '+@TableName +' Where 1=1 '  
	...
	set @SQLCommand = @SQLCommand + ' Order By '+ @FieldNameOrderBy
	exec(@SQLCommand)
	--print @SQLCommand
END
