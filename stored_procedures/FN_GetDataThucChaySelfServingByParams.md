# Function: `GetDataThucChaySelfServingByParams`

- **Loại**: SQL_INLINE_TABLE_VALUED_FUNCTION
- **Ngày tạo**: 2014-07-30 14:53:59.510000
- **Ngày sửa cuối**: 2014-10-14 10:39:36.830000
...
-- =============================================
CREATE FUNCTION [dbo].[GetDataThucChaySelfServingByParams]
(	
	@StartDate datetime,
	@EndDate datetime
)
...
(
		...
		WHERE 
			ThanhTienThucChayNoiBo > 0 OR ThanhTienThucChayKhuyenMai > 0 OR ThanhTienThucThu >= 1 OR GiaTriThayDoi <> 0
