# Function: `fn_GetDauKy_Of_Ngay_HinhThucQuangCaoTheoSanPhamWebsite`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-27 17:43:37.080000
- **Ngày sửa cuối**: 2015-03-27 17:43:37.080000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Ngay_HinhThucQuangCaoTheoSanPhamWebsite] 
(
...
BEGIN
	...
	BEGIN
		...
		(
			...
			FROM rptThucChay_HinhThucQuangCao_TheoSanPham_Website_Ngay  dstchdc
			WHERE 1 = 1
