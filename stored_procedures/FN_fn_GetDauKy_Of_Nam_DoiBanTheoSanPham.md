# Function: `fn_GetDauKy_Of_Nam_DoiBanTheoSanPham`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-07 12:18:25.407000
- **Ngày sửa cuối**: 2015-03-07 12:18:25.407000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Nam_DoiBanTheoSanPham] 
(
...
BEGIN
	...
	IF @isSoluong = 0
		...
		(
			...
			FROM rptThucChay_DoiBan_TheoSanPham_Nam dstchdc
			WHERE 1 = 1
