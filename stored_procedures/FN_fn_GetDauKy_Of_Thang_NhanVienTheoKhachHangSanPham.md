# Function: `fn_GetDauKy_Of_Thang_NhanVienTheoKhachHangSanPham`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-07 12:18:08.843000
- **Ngày sửa cuối**: 2015-03-07 12:18:08.843000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Thang_NhanVienTheoKhachHangSanPham] 
(
...
BEGIN
	...
	IF @isSoluong = 0
		...
		(
			...
			FROM rptThucChay_NhanVien_TheoKhachHang_SanPham_Thang dstchdc
			WHERE 1 = 1
	...
	ELSE
		...
		(
			...
			AND dstchdc.DmKhachHangREF = @DmKhachHangREF
			AND dstchdc.DmSanPhamREF = @DmSanPhamREF
			AND dstchdc.Thang = YEAR(@DateCalc) 
			AND dstchdc.Thang = MONTH(@DateCalc) 
		)
