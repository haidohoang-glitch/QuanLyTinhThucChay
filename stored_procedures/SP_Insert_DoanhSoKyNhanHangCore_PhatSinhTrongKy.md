# Stored Procedure: `Insert_DoanhSoKyNhanHangCore_PhatSinhTrongKy`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-04-22 16:42:53.373000
- **Ngày sửa cuối**: 2015-04-22 16:42:53.373000
...
-- =============================================
--[dbo].[Insert_DoanhSoKyNhanHangCore_PhatSinhTrongKy] '2014-01-01'
CREATE PROCEDURE [dbo].[Insert_DoanhSoKyNhanHangCore_PhatSinhTrongKy]
					...
					BEGIN
							...
							SELECT @NgayThucHien AS NgayThucHien,
								   ...
								   --SoLuongThucThu
									...
									--SoLuongKM
									, (
										CASE WHEN @ChietKhau = 100 THEN [dbo].[fn_GetSoLuongDauKy_DoanhSoKyNhanHangCore]
												(   2,
												    @NgayThucHien ,
													@HopDongID ,
													@DmNhanVienREF ,
									...
									, (
										CASE WHEN @ChietKhau = 100 THEN @ChiSoSLNhanM - [dbo].[fn_GetSoLuongDauKy_DoanhSoKyNhanHangCore]
												(   2,
												    @NgayThucHien ,
													@HopDongID ,
													@DmNhanVienREF ,
									...
									, (
										CASE WHEN @ChietKhau = 100 THEN 0
											ELSE [dbo].[fn_GetSoLuongDauKy_DoanhSoKyNhanHangCore]
												(   3,
												    @NgayThucHien ,
													@HopDongID ,
													@DmNhanVienREF ,
									...
									, (
										CASE WHEN @ChietKhau = 100 THEN 0
											ELSE @ChiSoSLNhanM - [dbo].[fn_GetSoLuongDauKy_DoanhSoKyNhanHangCore]
												(   3,
												    @NgayThucHien ,
													@HopDongID ,
													@DmNhanVienREF ,
									...
									--ThanhTienKM
									, (
										CASE WHEN @ChietKhau = 100 THEN [dbo].[fn_GetDoanhSoDauKy_DoanhSoKyNhanHangCore]
												(   2,
												    @NgayThucHien ,
													@HopDongID ,
													@DmNhanVienREF ,
									...
									, (
										CASE WHEN @ChietKhau = 100 THEN  @ChiSoSLNhanM * @DonGia -
													[dbo].[fn_GetDoanhSoDauKy_DoanhSoKyNhanHangCore]
												(   2,
												    @NgayThucHien ,
													@HopDongID ,
													@DmNhanVienREF ,
									...
									, (
										CASE WHEN @ChietKhau = 100 THEN 0
											ELSE [dbo].[fn_GetDoanhSoDauKy_DoanhSoKyNhanHangCore]
												(   3,
												    @NgayThucHien ,
													@HopDongID ,
													@DmNhanVienREF ,
			  ...
			  BEGIN
							...
							SELECT @NgayThucHien AS NgayThucHien,
								   ...
								   --SoLuongThucThu
									...
									, (
										CASE WHEN @ChietKhau = 100 THEN  @SoLuong - [dbo].[fn_GetSoLuongDauKy_DoanhSoKyNhanHangCore]
												(   2,
												    @NgayThucHien ,
													@HopDongID ,
													@DmNhanVienREF ,
									...
									, (
										CASE WHEN @ChietKhau = 100 THEN 0
											ELSE @SoLuong - [dbo].[fn_GetSoLuongDauKy_DoanhSoKyNhanHangCore]
												(   3,
												    @NgayThucHien ,
													@HopDongID ,
													@DmNhanVienREF ,
									...
									, (
										CASE WHEN @ChietKhau = 100 THEN @SoLuong * @DonGia -[dbo].[fn_GetDoanhSoDauKy_DoanhSoKyNhanHangCore]
												(   2,
												    @NgayThucHien ,
													@HopDongID ,
													@DmNhanVienREF ,
