# Function: `fn_GetDauKy_Of_Nam_KhachHangTheoLoaiNenTang`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-07 12:18:24.517000
- **Ngày sửa cuối**: 2015-03-07 12:18:24.517000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Nam_KhachHangTheoLoaiNenTang] 
(
...
BEGIN
	...
	IF @isSoluong = 0
		...
		(
			...
			FROM rptThucChay_KhachHang_TheoNenTang_Nam dstchdc
			WHERE 1 = 1
