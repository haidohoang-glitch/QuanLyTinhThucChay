# Stored Procedure: `ThucChay_InsertThucChayDaTinh_BoxGiaVang`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2016-03-17 09:21:20.303000
- **Ngày sửa cuối**: 2020-08-03 10:02:17.930000
...
CREATE  PROCEDURE [dbo].[ThucChay_InsertThucChayDaTinh_BoxGiaVang] 
	@StartDate datetime,
	@EndDate datetime
AS
BEGIN
...
BEGIN
	...
	(SELECT TOP (1) ThucChayHopDongChiTiet.ThucChayHopDongChiTietID 
		FROM ThucChayHopDongChiTiet 
		WHERE HopDongChiTietREF = C.HopDongChiTietID
		AND DeletedStatus = 0  
		order by  ThucChayHopDongChiTiet.ThucChayHopDongChiTietID 
	)
	 DotChayBooking,
