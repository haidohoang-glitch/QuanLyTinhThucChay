# Stored Procedure: `Insert_DoanhSoXuatHoaDonNhanHangCore_PhatSinhTrongKy`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-06-12 10:47:04.523000
- **Ngày sửa cuối**: 2015-06-12 10:47:04.523000
...
-- =============================================
--[dbo].[Insert_DoanhSoXuatHoaDonNhanHangCore_PhatSinhTrongKy] '2014-01-01'
CREATE PROCEDURE [dbo].[Insert_DoanhSoXuatHoaDonNhanHangCore_PhatSinhTrongKy]
...
BEGIN
   ...
   --DELETE FROM DoanhSoXuatHoaDonNhanHangCore WHERE HopDongID = @HopDongID AND HopDongChiTietREF = @HopDongChiTietREF AND ThongTinHoaDonREF = @ThongTinHoaDonID
	SELECT 
								   ...
								   --SoLuongThucThu
									...
									, (
									  ...
									  , @TrangThaiHopDong	AS trangthaihd	
										...
										,@NgayXuatHoaDon AS NgayXuatHoaDon
										,@ThongTinHoaDonID AS ThongTinHoaDon
