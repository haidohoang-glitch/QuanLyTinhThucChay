# Function: `ThucChay_GetSoLuongThucChay_TMDT`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2014-06-24 17:08:31.793000
- **Ngày sửa cuối**: 2014-10-14 10:39:31.170000
...
CREATE  FUNCTION [dbo].[ThucChay_GetSoLuongThucChay_TMDT]
(
			...
			BEGIN
					...
					(
						...
						(
							...
							AND tchdct.ThoiGianBatDau <= @NgayThucHien
						)tchdct
					)	
