# Stored Procedure: `Gen_InsertOrUpdate_ThucTreoHopDongChiTietTrinhDuyet_ThucTreo`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2019-05-08 17:46:16.793000
- **Ngày sửa cuối**: 2019-05-08 17:47:04.693000
...
```sql
/*
EXEC [dbo].[Gen_InsertOrUpdate_ThucTreoHopDongChiTietTrinhDuyet_ThucTreo]

*/
CREATE PROCEDURE [dbo].[Gen_InsertOrUpdate_ThucTreoHopDongChiTietTrinhDuyet_ThucTreo] 	
As 	
BEGIN
	...
	SET @NgayThucHien = 
		ISNULL((
			...
			FROM   ThucTreoHopDongChiTietTrinhDuyet_ThucTreo dchdct
		),'2017-01-01')
