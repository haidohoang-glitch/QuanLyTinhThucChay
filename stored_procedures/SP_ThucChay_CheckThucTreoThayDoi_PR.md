# Stored Procedure: `ThucChay_CheckThucTreoThayDoi_PR`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2013-10-11 17:00:59.770000
- **Ngày sửa cuối**: 2014-12-04 15:42:13.027000
...
-- =============================================
CREATE PROCEDURE [dbo].[ThucChay_CheckThucTreoThayDoi_PR] 
...
BEGIN
	...
	BEGIN
	    ...
	    BEGIN
			...
			SET @DmSanPhamREF = (SELECT hdct.DmSanPhamREF
			                       FROM HopDongChiTiet hdct WHERE hdct.HopDongChiTietID = @HopDongChiTietID)
			SET @DmWebsiteREF = (SELECT hdct.DmWebsiteREF
			                       FROM HopDongChiTiet hdct WHERE hdct.HopDongChiTietID = @HopDongChiTietID)
...
--EXEC [ThucChay_CheckThucTreoThayDoi_PR] '2013-09-29', '2013-01-29'
