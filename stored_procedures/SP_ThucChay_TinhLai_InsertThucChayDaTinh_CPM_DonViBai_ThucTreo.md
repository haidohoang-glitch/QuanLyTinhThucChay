# Stored Procedure: `ThucChay_TinhLai_InsertThucChayDaTinh_CPM_DonViBai_ThucTreo`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2021-06-07 11:46:52.657000
- **Ngày sửa cuối**: 2022-01-01 15:56:18.430000
...
-------------------------------------------------------------
CREATE PROCEDURE [dbo].[ThucChay_TinhLai_InsertThucChayDaTinh_CPM_DonViBai_ThucTreo] 
...
BEGIN
	...
	--SET @NgayDanhSoGioiHan = '2021-04-01'
	...
	(
		...
		(
			...
			AND hdct.DmSanPhamREF = 598  AND hdct.DonViTinhREF = 7 AND hdct.DmViTriREF = 9198    --King size, Sponsor Page, Bai 
		...
		BEGIN
			...
			BEGIN
				...
				IF(NOT EXISTS(SELECT tcdt.HopDongChiTietREF, SUM(tcdt.ThanhTienSauTrietKhauThucChay + tcdt.GiaTriThayDoi)  FROM dbo.ThucChayDaTinh tcdt
					...
					AND NOT ( tcdt.DmLoaiBannerREF IN (17,18)OR tcdt.DmHinhThucQuangCao IN (13,42))
				...
				BEGIN
					...
					EXEC [dbo].[ThucChay_InsertGTTD_ThucChayDaTinh_CPM_DonViBai_ThucTreo] 
