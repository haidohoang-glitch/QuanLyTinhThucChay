# Stored Procedure: `Insert_rptThucChay_HopDong_Ngay`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-03-27 17:43:46.340000
- **Ngày sửa cuối**: 2015-03-27 17:43:46.340000
...
-- =============================================
--EXEC [dbo].[Insert_rptThucChay_HopDong_Ngay]  '2013-01-01','2013-01-01'
CREATE PROCEDURE [dbo].[Insert_rptThucChay_HopDong_Ngay] 
...
BEGIN
	...
	WHILE @NgayThucHien <= @ToDate
		BEGIN
			 INSERT INTO rptThucChay_HopDong_Ngay
			 SELECT 
