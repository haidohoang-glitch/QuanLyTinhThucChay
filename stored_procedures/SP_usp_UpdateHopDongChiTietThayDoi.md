# Stored Procedure: `usp_UpdateHopDongChiTietThayDoi`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2013-06-03 14:31:20.440000
- **Ngày sửa cuối**: 2014-11-19 12:16:45.153000
...
-- Stored Procedure Name: [dbo].[usp_UpdateHopDongChiTietThayDoi]
-- Create Date: Monday, June 03, 2013
-- Description: 
--=============================================

CREATE PROCEDURE [dbo].[usp_UpdateHopDongChiTietThayDoi]
