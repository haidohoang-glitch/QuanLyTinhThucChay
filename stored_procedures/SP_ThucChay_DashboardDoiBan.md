# Stored Procedure: `ThucChay_DashboardDoiBan`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2013-06-14 13:08:23.777000
- **Ngày sửa cuối**: 2014-11-19 12:16:43.570000
...
```sql
CREATE PROCEDURE [dbo].[ThucChay_DashboardDoiBan] 
	@FromDate datetime, 
	@ToDate datetime,
