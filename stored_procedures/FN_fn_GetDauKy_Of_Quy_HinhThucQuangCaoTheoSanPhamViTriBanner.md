# Function: `fn_GetDauKy_Of_Quy_HinhThucQuangCaoTheoSanPhamViTriBanner`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-27 17:43:32.463000
- **Ngày sửa cuối**: 2015-03-27 17:43:32.463000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Quy_HinhThucQuangCaoTheoSanPhamViTriBanner] 
(
...
BEGIN
	...
	BEGIN
		...
		(
			...
			FROM rptThucChay_HinhThucQuangCao_TheoSanPham_ViTriBanner_Quy dstchdc
			WHERE 1 = 1
