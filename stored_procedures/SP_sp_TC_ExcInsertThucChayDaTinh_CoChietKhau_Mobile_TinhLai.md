# Stored Procedure: `sp_TC_ExcInsertThucChayDaTinh_CoChietKhau_Mobile_TinhLai`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2017-06-27 14:58:28.607000
- **Ngày sửa cuối**: 2017-07-05 13:03:15.170000
...
-- =============================================
CREATE PROCEDURE [dbo].[sp_TC_ExcInsertThucChayDaTinh_CoChietKhau_Mobile_TinhLai]
...
AS
    BEGIN
        ...
        DECLARE Record_CursorCCK CURSOR
        FOR
            SELECT  A.SoHopDong ,
                    A.TenWebsite ,
                    @HopDongChiTietID ,
        ...
        OPEN Record_CursorCCK

		-- Perform the first fetch.
        FETCH NEXT FROM Record_CursorCCK INTO @SoHopDong, @TenWebsite,
            @HopDongChiTietREF, @TypeProduct, @ProductUnitName, @BannerType,
            @DmBannerREF, @TongViewThucChay, @TongClickThucChay			
        WHILE @@FETCH_STATUS = 0
            BEGIN																	  			
                EXEC sp_TC_InsertThucChayDaTinh_CoChietKhau_Mobile_TinhLai @NgayThucHien,
        ...
        CLOSE Record_CursorCCK
        DEALLOCATE Record_CursorCCK
