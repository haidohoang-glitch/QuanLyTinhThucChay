# Function: `ThucChay_GetSoLuongLechTreoHa`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2013-09-06 18:20:19.543000
- **Ngày sửa cuối**: 2014-10-14 10:39:31.493000
...
-- =============================================
CREATE  FUNCTION [dbo].[ThucChay_GetSoLuongLechTreoHa]
(
...
BEGIN
	...
	DECLARE @ResultValue BIGINT, @MinDate DATETIME
