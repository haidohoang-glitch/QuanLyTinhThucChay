# Stored Procedure: `Insert_rptThucChay_DoiBan_TheoKhachHang_Nam`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-03-07 12:18:30.340000
- **Ngày sửa cuối**: 2015-03-07 12:18:30.340000
...
-- =============================================
CREATE PROCEDURE [dbo].[Insert_rptThucChay_DoiBan_TheoKhachHang_Nam]
...
BEGIN
	...
	-- interfering with SELECT statements.
     ...
     rtchdn.DmKhachHangREF
     ----------------------------------UPDATE DL-----------------------------
     UPDATE rptThucChay_DoiBan_TheoKhachHang_Nam
     SET
     ...
     FROM rptThucChay_DoiBan_TheoKhachHang_Nam rtcdbt
     ...
     AND td.Nam = rtcdbt.Nam
     --------------------------------insert dl-------------------------------------
     INSERT INTO rptThucChay_DoiBan_TheoKhachHang_Nam
				SELECT 
				...
				td.NhomREF,
				'',
				[dbo].[fn_GetDauKy_Of_Nam_DoiBanTheoKhachHang]
				(
				  td.DmKhachHangREF,
				  td.PhongBanREF,
				  td.BoPhanREF,
