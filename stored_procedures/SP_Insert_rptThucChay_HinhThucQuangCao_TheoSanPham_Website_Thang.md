# Stored Procedure: `Insert_rptThucChay_HinhThucQuangCao_TheoSanPham_Website_Thang`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-03-27 17:43:45.370000
- **Ngày sửa cuối**: 2015-03-27 17:43:45.370000
...
-- =============================================
CREATE PROCEDURE [dbo].[Insert_rptThucChay_HinhThucQuangCao_TheoSanPham_Website_Thang]
...
BEGIN
	...
	rtchdn.DmWebsiteREF
	-------------------------------------UPDATE DL--------------------------------
	UPDATE rptThucChay_HinhThucQuangCao_TheoSanPham_Website_Thang
	...
	FROM rptThucChay_HinhThucQuangCao_TheoSanPham_Website_Thang rtchtqct
	...
	AND td.DmWebsiteREF = rtchtqct.DmWebsiteREF
	...
	AND td.Nam = rtchtqct.Nam
	-------------------------------------INSERT DL--------------------------------------
	INSERT INTO rptThucChay_HinhThucQuangCao_TheoSanPham_Website_Thang
				SELECT 
				@NgayThucHien,
				td.Thang,
				td.Nam,
				...
				td.TenWebsite,
				td.DmWebsiteREF,
				[dbo].[fn_GetDauKy_Of_Ngay_HinhThucQuangCaoTheoSanPhamWebsite]
				(
				  td.DmNhanVienREF,
				  td.PhongBanREF,
				  td.BoPhanREF,
