# Function: `ThucChay_ThanhTienThucChay_ThanhTien_CreatorContent`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2021-10-14 16:16:23.723000
- **Ngày sửa cuối**: 2021-10-14 16:16:23.723000
...
-- =============================================
/*
select[dbo].[ThucChay_ThanhTienThucChay_ThanhTien_CreatorContent] 
(
...
*/
create  FUNCTION [dbo].[ThucChay_ThanhTienThucChay_ThanhTien_CreatorContent] 
(
	@TongThanhTienThucChay FLOAT,
	@TongThanhTienThucChayKM FLOAT,
	@NgayThucHien DATETIME,
