# Stored Procedure: `Insert_rptThucChay_SanPham_Nam`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-03-27 17:44:01.677000
- **Ngày sửa cuối**: 2015-03-27 17:44:01.677000
...
-- =============================================
CREATE PROCEDURE [dbo].[Insert_rptThucChay_SanPham_Nam]
	...
	INSERT INTO @TeampData
			...
			GROUP BY 
			   rtchdn.TenNhanVien,
				...
				rtchdn.DmSanPhamREF
	-----------------------------------UPDATE DL-----------------------------
	UPDATE  rptThucChay_SanPham_Nam
		SET rptThucChay_SanPham_Nam.NgayThucHien = @NgayThucHien,
		    rptThucChay_SanPham_Nam.ThucChayPhatSinhTrongKy += td.ThucChayPhatSinhTrongKy,
		    rptThucChay_SanPham_Nam.ThucChayPhatSinhCuoiKy += td.ThucChayPhatSinhTrongKy,
		    rptThucChay_SanPham_Nam.KhuyenMaiPhatSinhTrongKy += td.KhuyenMaiPhatSinhTrongKy,
		    rptThucChay_SanPham_Nam.KhuyenMaiPhatSinhCuoiKy += td.KhuyenMaiPhatSinhTrongKy,
		    rptThucChay_SanPham_Nam.NoiBoPhatSinhTrongKy += td.NoiBoPhatSinhTrongKy,
		    rptThucChay_SanPham_Nam.NoiBoPhatSinhCuoiKy += td.NoiBoPhatSinhTrongKy,
		...
		FROM rptThucChay_SanPham_Nam rtchdt
		...
		AND td.Nam = rtchdt.Nam
		-------------------------------------------------INSERT DL
	    INSERT INTO rptThucChay_SanPham_Nam
				SELECT 
				@NgayThucHien,
				td.Nam,
				td.DmSanPhamREF ,
