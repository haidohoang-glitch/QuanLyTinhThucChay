# Stored Procedure: `sp_Insert_ThucChayDaTinh_ReInsertByHopDong_dev`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2016-10-06 15:36:52.627000
- **Ngày sửa cuối**: 2016-10-06 16:05:38.303000
...
SELECT DISTINCT
	...
	WHERE 1=1 and hdct.HopDongChiTietID = 82915

EXEC [dbo].sp_Insert_ThucChayDaTinh_ReInsertByHopDong_dev '2016-10-04',--@NgayThucHien DATETIME
	37266,--@HopDongID INT,
	82915,--@HopDongChiTietID INT,
	N'QC1140915',--@SoHopDong_new NVARCHAR(50),
	'2015-09-09 00:00:00.000',--@NgayDanhSo_new DATETIME,
	590,--@DmNhanVienREF_new INT,
	N'Công ty TNHH Kinh doanh bất động sản MIK Home',--@DmKhachHangREF_new NVARCHAR(200),
	140, --@DmSanPhamREF_new INT,
	'41930',--@DsNhanHangREF_new NVARCHAR(200),
	5, --@HinhThucQuangCaoREF_new INT, 
	'thuhapham',--@TenDangNhap_new NVARCHAR(50),
	54, --@MaSoHopDong_new INT , 
	'',--@Note NVARCHAR(50), 
	1, --@IsThayDoi INT,
	1000,--@GiaTriThucChay FLOAT,
	0,--@GiaTriThucChayAd FLOAT,
	1, --@IsExistData INT ,
	0--@IsExistData1 INT  
	*/
CREATE PROCEDURE [dbo].[sp_Insert_ThucChayDaTinh_ReInsertByHopDong_dev]
...
BEGIN
		...
		-- 1. Thuc chay da tinh
		--INSERT INTO ThucChayDaTinh_ThayDoi_dev
		SELECT TCDT.*  FROM
		(
			  SELECT newid() AS ID
			  ,[HopDongID]
