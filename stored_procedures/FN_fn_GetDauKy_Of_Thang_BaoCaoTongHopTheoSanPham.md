# Function: `fn_GetDauKy_Of_Thang_BaoCaoTongHopTheoSanPham`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-21 12:58:21.810000
- **Ngày sửa cuối**: 2015-03-21 12:58:21.810000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Thang_BaoCaoTongHopTheoSanPham] 
(
...
BEGIN
	...
	IF @isSoluong = 0
		...
		(
			...
			FROM rptThucChay_BaoCaoTongHopTheoSanPham_Thang dstchdc
			WHERE 1 = 1
