# Stored Procedure: `ThucChayDaTinh_ExcReInsertThucChayDaTinhAdmarketFromOnlineData_doannv`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-06-20 10:10:59.937000
- **Ngày sửa cuối**: 2015-07-09 14:31:32.837000
...
*/
CREATE PROCEDURE [dbo].[ThucChayDaTinh_ExcReInsertThucChayDaTinhAdmarketFromOnlineData_doannv]
	...
	WHERE 1=1
		...
		AND (SELECT COUNT(tcdta.HopDongChiTietREF)
		       FROM ThucChayDaTinhAdmarket tcdta WHERE tcdta.NgayThucHien = @NgayThucHien
					...
					AND tcdta.HopDongChiTietREF IN (SELECT HopDongChiTietID FROM HopDongChiTiet WHERE HopDongChiTiet.TK_AdMarket =@TaiKhoan)
