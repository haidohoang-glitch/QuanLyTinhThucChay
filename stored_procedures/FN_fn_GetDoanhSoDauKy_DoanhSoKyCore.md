# Function: `fn_GetDoanhSoDauKy_DoanhSoKyCore`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-04-22 16:42:51.823000
- **Ngày sửa cuối**: 2015-04-22 16:42:51.823000
...
```sql
CREATE FUNCTION [dbo].[fn_GetDoanhSoDauKy_DoanhSoKyCore]
(
