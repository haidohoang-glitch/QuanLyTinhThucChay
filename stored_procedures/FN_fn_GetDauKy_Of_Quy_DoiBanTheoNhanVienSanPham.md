# Function: `fn_GetDauKy_Of_Quy_DoiBanTheoNhanVienSanPham`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-07 12:18:16.017000
- **Ngày sửa cuối**: 2015-03-07 12:18:16.017000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Quy_DoiBanTheoNhanVienSanPham] 
(
...
BEGIN
	...
	IF @isSoluong = 0
		...
		(
			...
			FROM rptThucChay_DoiBan_TheoNhanVien_SanPham_Quy dstchdc
			WHERE 1 = 1
