# Function: `ThucChay_GetBaoCaoSumByFilterCondition`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2013-06-13 01:12:50.940000
- **Ngày sửa cuối**: 2014-10-14 10:39:32.660000
...
```sql
create function [dbo].[ThucChay_GetBaoCaoSumByFilterCondition] 
(
...
BEGIN
	...
	set @SQLCommand = dbo.ThucChay_GenSQLCommandSumCommandByGroupName(@GroupFieldName,@FilterString,@IsOrderBy)
