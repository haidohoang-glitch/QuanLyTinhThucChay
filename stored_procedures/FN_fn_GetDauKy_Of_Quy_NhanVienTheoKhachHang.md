# Function: `fn_GetDauKy_Of_Quy_NhanVienTheoKhachHang`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-07 12:18:13.927000
- **Ngày sửa cuối**: 2015-03-07 12:18:13.927000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Quy_NhanVienTheoKhachHang] 
(
...
BEGIN
	...
	IF @isSoluong = 0
		...
		(
			...
			FROM rptThucChay_NhanVien_TheoKhachHang_Quy dstchdc
			WHERE 1 = 1
