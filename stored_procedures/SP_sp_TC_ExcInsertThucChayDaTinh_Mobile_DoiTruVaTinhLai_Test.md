# Stored Procedure: `sp_TC_ExcInsertThucChayDaTinh_Mobile_DoiTruVaTinhLai_Test`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2018-05-07 10:35:33.743000
- **Ngày sửa cuối**: 2018-09-14 16:30:17.750000
...
-- =============================================
/*
exec [dbo].[sp_TC_ExcInsertThucChayDaTinh_Mobile_DoiTruVaTinhLai_Test] 	'2018-06-26','2018-09-10', 'QC4710618', '2018-09-12'
*/
CREATE PROCEDURE [dbo].[sp_TC_ExcInsertThucChayDaTinh_Mobile_DoiTruVaTinhLai_Test]--tinh ca truong hop 1 phan bo nhieu banner
    ...
    BEGIN
                    ...
                    FROM    ( SELECT DISTINCT
                            ...
                            FROM   ( SELECT    T.DmBannerID
                                            , (CASE WHEN T.HopDongChiTietREF = 1 THEN 1
                                                    ...
                                                    WHEN ( T.HopDongChiTietREF > 1 AND T.KhuyenMai = 0 )
                                                        OR ( T.HopDongChiTietREF = T.KhuyenMai AND T.HopDongChiTietREF > 1 ) THEN 3
                                                    ELSE 0
											END) TH
        ...
        BEGIN
            ...
            BEGIN
             ...
             BEGIN
				PRINT 'start'
				PRINT dbo.FormatDateTime(GETDATE())
                 EXEC [sp_TC_ExcInsertThucChayDaTinh_Single_Mobile_DoiTruVaTinhLai_dev] @DmBannerREF, @NgayThucHien, @SoHopDong, @DmWebsiteREF
				PRINT 'end'
				PRINT dbo.FormatDateTime(GETDATE())
             END				
