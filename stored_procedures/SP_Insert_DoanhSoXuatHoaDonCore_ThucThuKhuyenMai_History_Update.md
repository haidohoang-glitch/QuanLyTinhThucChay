# Stored Procedure: `Insert_DoanhSoXuatHoaDonCore_ThucThuKhuyenMai_History_Update`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-06-12 10:47:03.030000
- **Ngày sửa cuối**: 2015-06-12 10:47:03.030000
...
-- =============================================
--EXEC [dbo].[Insert_DoanhSoXuatHoaDonCore_NoiBo_History] '2014-01-01'
CREATE PROCEDURE [dbo].[Insert_DoanhSoXuatHoaDonCore_ThucThuKhuyenMai_History_Update]
...
BEGIN
		...
		(SELECT  tthd.HopDongREF,CONVERT(DATE,tthd.NgayXuatHoaDon) AS NgayXuatHoaDon, tthd.ThongTinHoaDonID, tthd.SoHoaDon, tthd.GiaTri,tthd.DeletedStatus
		   FROM ThongTinHoaDon tthd WHERE   
		    tthd.DeletedStatus = 0 AND tthd.ThongTinHoaDonID = @ThongTinHoaDonID) A
		...
		--AND [dbo].[fn_CheckXuatHoaDon_DoanhSoXuatHoaDonCore](@NgayThucHien,hd.HopDongID) > 0
END
