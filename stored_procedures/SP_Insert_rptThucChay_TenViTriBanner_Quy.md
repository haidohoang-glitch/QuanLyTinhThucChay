# Stored Procedure: `Insert_rptThucChay_TenViTriBanner_Quy`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-03-27 17:44:03.533000
- **Ngày sửa cuối**: 2015-03-27 17:44:03.533000
...
-- =============================================
--EXEC [dbo].[Insert_rptThucChay_ViTriBanner_Quy] '2013-01-01'
CREATE PROCEDURE [dbo].[Insert_rptThucChay_TenViTriBanner_Quy]
...
BEGIN
	...
	INSERT INTO @TeampData
			...
			rtchdn.TenNhanVien,
				...
				rtchdn.DmViTriBannerREF
	-----------------------------------UPDATE DL-----------------------------
	UPDATE  rptThucChay_TenViTriBanner_Quy 
		...
		FROM rptThucChay_TenViTriBanner_Quy rtchdt
	   ...
	   td.DmNhanVienREF = rtchdt.DmNhanVienREF
		...
		AND td.Nam = rtchdt.Nam
		-------------------------------------------------INSERT DL
	    INSERT INTO rptThucChay_TenViTriBanner_Quy
				SELECT 
				@NgayThucHien,
				td.Quy,
				td.Nam,
