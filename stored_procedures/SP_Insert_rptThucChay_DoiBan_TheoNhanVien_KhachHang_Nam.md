# Stored Procedure: `Insert_rptThucChay_DoiBan_TheoNhanVien_KhachHang_Nam`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-03-07 12:18:32.513000
- **Ngày sửa cuối**: 2015-03-07 12:18:32.513000
...
-- =============================================
CREATE PROCEDURE [dbo].[Insert_rptThucChay_DoiBan_TheoNhanVien_KhachHang_Nam]
...
BEGIN
	...
	-- interfering with SELECT statements.
     ...
     rtchdn.DmKhachHangREF
     ----------------------------------UPDATE DL-----------------------------
     UPDATE rptThucChay_DoiBan_TheoNhanVien_KhachHang_Nam
     SET
     ...
     FROM rptThucChay_DoiBan_TheoNhanVien_KhachHang_Nam rtcdbt
     ...
     AND td.Nam = rtcdbt.Nam
     --------------------------------insert dl-------------------------------------
     INSERT INTO rptThucChay_DoiBan_TheoNhanVien_KhachHang_Nam
				SELECT 
				...
				td.DmKhachHangREF,
				'',
				[dbo].[fn_GetDauKy_Of_Nam_DoiBanTheoNhanVienKhachHang]
				(
				  td.DmNhanVienREF,
				  td.PhongBanREF,
				  td.BoPhanREF,
