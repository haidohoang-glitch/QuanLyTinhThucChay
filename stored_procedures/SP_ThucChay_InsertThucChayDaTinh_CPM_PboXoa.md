# Stored Procedure: `ThucChay_InsertThucChayDaTinh_CPM_PboXoa`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2016-03-17 09:21:20.837000
- **Ngày sửa cuối**: 2016-03-17 09:21:20.837000
...
--EXEC [ThucChay_InsertThucChayDaTinh_CPM_PboXoa]


CREATE  PROCEDURE [dbo].[ThucChay_InsertThucChayDaTinh_CPM_PboXoa]
	@HopDongChiTiet INT,
	@DmSanPhamREF INT,
...
BEGIN
	...
	FROM 
	(
		SELECT * FROM HopDongChiTiet WHERE DmSanPhamREF in (231,238,339,240,370,531)
		AND HopDongChiTietID = @HopDongChiTiet
		--AND DeletedStatus = 0
		AND DmLoaiREF <> 13 --Khong tinh thuc chay cho HTQC Mua Ngoai
		AND [dbo].[CheckDonViTinhHinhThucCPDAndNotCPD](DonViTinhREF, DonViTinh) = 3 --Ðon v? c?a hình th?c CPM
	) C  
	INNER JOIN  
	 ( 
