# Stored Procedure: `Insert_DoanhSoTienVeCore_PhatSinhThayDoi`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-06-12 10:46:57.653000
- **Ngày sửa cuối**: 2015-06-12 10:46:57.653000
...
CREATE PROCEDURE [dbo].[Insert_DoanhSoTienVeCore_PhatSinhThayDoi]
...
BEGIN
    ...
    DECLARE @NgayGhiAmGanNhat DATETIME
      IF (SELECT COUNT(*) FROM DoanhSoTienVeCore WHERE HopDongID = @HopDongID AND (ThucThuPhatSinhTrongKy<0 OR NoiBoPhatSinhTrongKy < 0)) > 0
		BEGIN
			set @NgayGhiAmGanNhat = (SELECT MAX(NgayThucHien) FROM DoanhSoTienVeCore WHERE HopDongID = @HopDongID AND (ThucThuPhatSinhTrongKy<0 OR NoiBoPhatSinhTrongKy < 0))
		END
	...
	SELECT 
      ...
      ,[ThongTinTienVeREF]
      ,[DmMaHopDongREF]
  FROM [dbo].[DoanhSoTienVeCore] WHERE HopDongID = @HopDongID
