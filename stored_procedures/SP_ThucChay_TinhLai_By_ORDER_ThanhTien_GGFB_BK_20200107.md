# Stored Procedure: `ThucChay_TinhLai_By_ORDER_ThanhTien_GGFB_BK_20200107`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2021-01-07 10:15:43.650000
- **Ngày sửa cuối**: 2021-01-07 10:15:43.650000
...
CREATE PROCEDURE [dbo].[ThucChay_TinhLai_By_ORDER_ThanhTien_GGFB_BK_20200107] 
	@pSoHopDong NVARCHAR(100),
	@pHopDongChiTietID INT,
	@pOperating_Order_Id INT,
	@NgayThucHien DATETIME,
			...
			BEGIN
				...
				BEGIN
					SET @ThanhTienSauTrietKhauThucChay = (SELECT TOP(1) (tcdt.ThanhTienSauTrietKhauThucChay + tcdt.GiaTriThayDoi)  FROM dbo.ThucChayDaTinh tcdt
															...
															AND tcdt.GhiChu NOT LIKE N'%Doi tru thanhtien_GGFB%'
				...
				BEGIN
					...
					BEGIN
						SET @ThanhTienSauTrietKhauThucChay = (SELECT TOP(1) tcdt.ThanhTienSauTrietKhauThucChay + tcdt.GiaTriThayDoi FROM dbo.ThucChayDaTinh tcdt
																...
																AND tcdt.NgayThucHien = @NgayThucHien
																AND (tcdt.ThanhTienSauTrietKhauThucChay+ tcdt.GiaTriThayDoi < @Sell_Money_VND)
																AND tcdt.GhiChu <> N'%Doi tru thanhtien_GGFB%'
																ORDER BY tcdt.CreatedAt DESC)
						IF(@ThanhTienSauTrietKhauThucChay IS NOT NULL)
						BEGIN
