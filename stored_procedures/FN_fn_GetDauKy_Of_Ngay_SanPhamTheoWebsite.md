# Function: `fn_GetDauKy_Of_Ngay_SanPhamTheoWebsite`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-27 17:43:33.970000
- **Ngày sửa cuối**: 2015-03-27 17:43:33.970000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Ngay_SanPhamTheoWebsite] 
(
...
BEGIN
	...
	BEGIN
		...
		(
			...
			FROM rptThucChay_SanPham_TheoWebsite_Ngay dstchdc
			WHERE 1 = 1
