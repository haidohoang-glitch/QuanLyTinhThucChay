# Function: `fn_GetDauKy_Of_Ngay_NhanVienTheoKhachHang`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-07 12:18:18.727000
- **Ngày sửa cuối**: 2015-03-07 12:18:18.727000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Ngay_NhanVienTheoKhachHang] 
(
...
BEGIN
	...
	IF @isSoluong = 0
		...
		(
			...
			FROM rptThucChay_NhanVien_TheoKhachHang_Ngay dstchdc
			WHERE 1 = 1
