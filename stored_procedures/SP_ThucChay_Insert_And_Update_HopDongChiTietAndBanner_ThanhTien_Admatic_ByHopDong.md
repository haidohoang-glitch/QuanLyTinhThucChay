# Stored Procedure: `ThucChay_Insert_And_Update_HopDongChiTietAndBanner_ThanhTien_Admatic_ByHopDong`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2020-09-23 15:23:37.533000
- **Ngày sửa cuối**: 2021-04-02 19:18:43.127000
...
```sql
/*
[ThucChay_Insert_And_Update_HopDongChiTietAndBanner_ThanhTien_Admatic] '2020-07-01'
select * from  [ThucChayHopDongChiTietAndBanner_ThanhTien_Admatic]
where [HopDongREF] = 1024535
*/


CREATE PROCEDURE [dbo].[ThucChay_Insert_And_Update_HopDongChiTietAndBanner_ThanhTien_Admatic_ByHopDong]
	@NgayThucHien DATETIME
	,@HopDongID INT
AS
BEGIN
	DECLARE @NgayDanhSoHopDong Datetime = '2000-07-01'
	CREATE TABLE #ThucChayHopDongChiTietAndBanner_ThanhTien_Admatic(
		...
		ON t.DmBannerREF = dc.DmBannerREF
		AND t.DmSanPhamREF = dc.DmSanPhamREF
		AND t.HopDongChiTietREF = dc.HopDongChiTietREF
