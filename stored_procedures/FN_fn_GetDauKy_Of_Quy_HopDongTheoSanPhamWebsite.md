# Function: `fn_GetDauKy_Of_Quy_HopDongTheoSanPhamWebsite`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-27 17:43:30.730000
- **Ngày sửa cuối**: 2015-03-27 17:43:30.730000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Quy_HopDongTheoSanPhamWebsite] 
(
...
BEGIN
	...
	IF @isSoluong = 0
		...
		(
			...
			FROM rptThucChay_HopDong_TheoSanPham_Website_Quy dstchdc
			WHERE 1 = 1
