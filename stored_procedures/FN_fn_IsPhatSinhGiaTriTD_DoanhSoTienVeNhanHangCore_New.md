# Function: `fn_IsPhatSinhGiaTriTD_DoanhSoTienVeNhanHangCore_New`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-06-12 10:46:55.123000
- **Ngày sửa cuối**: 2015-06-12 10:46:55.123000
...
CREATE FUNCTION [dbo].[fn_IsPhatSinhGiaTriTD_DoanhSoTienVeNhanHangCore_New]
(
...
BEGIN
	...
	DECLARE @v_count INT
	IF(SELECT COUNT(*) FROM DoanhSoTienVeNhanHangCore dsxhdnhc
