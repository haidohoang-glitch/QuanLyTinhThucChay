# Stored Procedure: `ThucChay_NativeAds_GhiNhanThayDoi_ThucChayDaTinh_dev`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2025-10-23 10:11:07.697000
- **Ngày sửa cuối**: 2025-10-23 10:25:10.217000
...
/*
EXEC dbo.[ThucChay_NativeAds_GhiNhanThayDoi_ThucChayDaTinh_dev] @NgayGhiNhan = '2025-10-22',       -- date
                                                          @SoHopDong = N'QC2801025',                  -- nvarchar(50)
                                                          @HopDongChiTietID = 768976              -- int
*/

--DECLARE @DmInterger TABLE (ID INT)
CREATE  PROCEDURE [dbo].[ThucChay_NativeAds_GhiNhanThayDoi_ThucChayDaTinh_dev]
    @NgayGhiNhan DATE,
...
BEGIN
	...
	BEGIN
		...
		WHERE    hdct.DmSanPhamREF IN (821, 5133) AND
				 ...
				 AND hdct.DonViTinhREF NOT IN (3) 
...
GROUP BY  tcdt.HopDongID
	...
	SELECT * FROM @Thucchay_NativeAds_DmTinhlai
