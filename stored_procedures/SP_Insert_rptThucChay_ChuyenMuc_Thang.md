# Stored Procedure: `Insert_rptThucChay_ChuyenMuc_Thang`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-03-27 17:43:50.850000
- **Ngày sửa cuối**: 2015-03-27 17:43:50.850000
...
-- =============================================
CREATE PROCEDURE [dbo].[Insert_rptThucChay_ChuyenMuc_Thang]
...
BEGIN
    ...
    -- Insert statements for procedure here
	 ...
	 dstchdc.DmChuyenMucREF
	 ------------------UPDATE DL-----------------------------
	 UPDATE rptThucChay_ChuyenMuc_Thang
	 SET
	 ...
	 FROM rptThucChay_ChuyenMuc_Thang rtccmt
	 ...
	 AND td.Nam = rtccmt.Nam 
	 ------------------------InsertDL----------------------------------------
	 INSERT INTO rptThucChay_ChuyenMuc_Thang
	 SELECT 
	            @NgayThucHien,
				td.Thang,
				td.Nam,
