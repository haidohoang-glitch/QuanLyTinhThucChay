# Stored Procedure: `sp_TC_InsertThucChayDaTinh_ChiPhiKhac_ByHopDong_dev`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2021-07-01 16:29:11.930000
- **Ngày sửa cuối**: 2021-07-01 16:30:19.467000
...
```sql
/*
EXEC [dbo].[sp_TC_InsertThucChayDaTinh_ChiPhiKhac_ByHopDong_dev] '2021-06-30', 'QC4610421'
*/
-------------------------------------------------------------
CREATE PROCEDURE [dbo].[sp_TC_InsertThucChayDaTinh_ChiPhiKhac_ByHopDong_dev]
