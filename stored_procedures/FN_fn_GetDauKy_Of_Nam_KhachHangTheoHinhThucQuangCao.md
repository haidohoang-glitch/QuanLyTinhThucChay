# Function: `fn_GetDauKy_Of_Nam_KhachHangTheoHinhThucQuangCao`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-27 17:43:39.643000
- **Ngày sửa cuối**: 2015-03-27 17:43:39.643000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Nam_KhachHangTheoHinhThucQuangCao] 
(
...
BEGIN
	...
	IF @isSoluong = 0
		...
		(
			...
			FROM rptThucChay_KhachHang_TheoHinhThucQuangCao_Nam dstchdc
			WHERE 1 = 1
