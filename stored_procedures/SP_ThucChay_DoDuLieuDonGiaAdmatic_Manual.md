# Stored Procedure: `ThucChay_DoDuLieuDonGiaAdmatic_Manual`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2017-10-30 09:33:45.220000
- **Ngày sửa cuối**: 2017-11-22 16:06:31.613000
...
CREATE PROCEDURE [dbo].[ThucChay_DoDuLieuDonGiaAdmatic_Manual]
...
AS
    BEGIN
        ...
        FOR
            ...
            WHERE   NgayThucHien = CONVERT(DATE, @NgayThucHien)
