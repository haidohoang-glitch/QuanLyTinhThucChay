# Function: `fn_TC_GetThanhTienChuanThucChay_Mobile_KoChietKhau_TinhLaiCuoiThang`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2017-09-13 11:32:04.707000
- **Ngày sửa cuối**: 2017-09-13 11:32:04.707000
...
CREATE FUNCTION [dbo].[fn_TC_GetThanhTienChuanThucChay_Mobile_KoChietKhau_TinhLaiCuoiThang]
    (
...
AS
	...
	-- Declare the return variable here
        ...
        SET @SoLuongThucChay = dbo.[fn_TC_GetSoLuongThucChayMobile_KoChietKhau_TinhLaiCuoiThang](@HopDongChiTietID,
        ...
        SET @SoLuongThucChayKM = ( CASE WHEN ( ( ( @IsKhuyenMai = 1 )
                                        ...
                                        THEN ISNULL(dbo.fn_TC_GetSoLuongThucChayKMMobile_TinhLaiCuoiThang(@HopDongChiTietID,
                                                              1,
                                                              @DonGiaTheoDonVi,
                                                              @NgayThucHien,
