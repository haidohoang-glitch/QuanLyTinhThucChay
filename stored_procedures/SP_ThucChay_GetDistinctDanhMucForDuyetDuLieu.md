# Stored Procedure: `ThucChay_GetDistinctDanhMucForDuyetDuLieu`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2013-11-09 11:47:12.133000
- **Ngày sửa cuối**: 2014-11-19 12:16:57.363000
...
-- Description:	ThucChay_GetDistinctDanhMucForDuyetDuLieu
-- =============================================
CREATE PROCEDURE [dbo].[ThucChay_GetDistinctDanhMucForDuyetDuLieu]
	...
	@IsPheDuyet INT, -- 0: chua duyet, 1: da duyet, -1: all
	@IsNoiBo INT,
...
BEGIN
	...
	SET @PhongID = (SELECT PhongBanREF FROM @QuaTrinhCongTacTemp)
		...
		SET @sql = 'SELECT DISTINCT '
					...
					FROM
					('
						+ dbo.ThucChay_GenSQLCommandForDuyetDuLieuQuery(@StartDate,
															@EndDate,
															@DmSanPhamREFList ,
															@DmWebsiteREFList ,
															@SoHopDongList ,
	...
	--				FROM
	--				('
	--					+ dbo.ThucChay_GenSQLCommandForDuyetDuLieuQuery(@TuNgay,
	--														@DenNgay,
	--														@DmSanPhamREFList ,
	--														@DmWebsiteREFList ,
	--														@SoHopDongList ,
