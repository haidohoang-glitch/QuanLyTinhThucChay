# Stored Procedure: `ThucChay_InsertThucChayDaTinh_CPM_DonViBai`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2021-03-03 16:12:15.710000
- **Ngày sửa cuối**: 2021-06-07 12:50:54.660000
...
-------------------------------------------------------------
CREATE PROCEDURE [dbo].[ThucChay_InsertThucChayDaTinh_CPM_DonViBai] 
...
SET @NgayGioiHanTinh = '2021-01-01'
	...
	ISNULL(TD.ThanhTien,0) AS ThanhTienSauTrietKhauThucChay,	
	...
	0 TongClickThucChay,
	0 TongSoBaiViet,
	(CASE when ((C.IsKhuyenMai = 0) OR (C.ChietKhau <> 100)) then C.SoLuong
		else 0
	  END
	) AS SoLuongThucChay,
