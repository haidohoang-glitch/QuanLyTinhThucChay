# Stored Procedure: `Insert_DoanhSoXuatHoaDonCore_NoiBo_History_Update`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-06-12 10:47:02.060000
- **Ngày sửa cuối**: 2015-06-12 10:47:02.060000
...
-- =============================================
--EXEC [dbo].[Insert_DoanhSoXuatHoaDonCore_NoiBo_History] '2013-01-03'
CREATE  PROCEDURE [dbo].[Insert_DoanhSoXuatHoaDonCore_NoiBo_History_Update]
...
BEGIN
		...
		CASE WHEN hdct.ChietKhau = 100 THEN 0
		ELSE 
		[dbo].[fn_GetThanhTienByNgay_DoanhSoXuatHoaDonCore]
			 (
			  @NgayThucHien,
			  hd.HopDongID,
			  A.ThongTinHoaDonID,
