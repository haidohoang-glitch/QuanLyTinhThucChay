# Stored Procedure: `sp_KSTC_CheckSynData_ThucTreoPR`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2020-04-09 15:17:15.473000
- **Ngày sửa cuối**: 2025-12-16 16:13:52.730000
...
-- =============================================
CREATE PROCEDURE [dbo].[sp_KSTC_CheckSynData_ThucTreoPR]
...
SELECT '<=2019'[Nam], A.*,B.*,(A.DonGia- B.GiaTien)LechGia, (A.ChietKhau - B.ChietKhau)LechChietKhau--,
...
SELECT '>=2020'[Nam],A.*,B.*,(A.DonGia- B.GiaTien)LechDonGia, (A.ChietKhau - B.ChietKhau)LechChietKhau, 
--(case when A.Deleted_Status <> B.DeletedStatus then 'True' else 'False' end  ) TrangThaiXoa,
