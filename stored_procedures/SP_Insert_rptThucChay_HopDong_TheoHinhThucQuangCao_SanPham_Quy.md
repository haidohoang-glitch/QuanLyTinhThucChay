# Stored Procedure: `Insert_rptThucChay_HopDong_TheoHinhThucQuangCao_SanPham_Quy`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-03-27 17:43:45.053000
- **Ngày sửa cuối**: 2015-03-27 17:43:45.053000
...
-- =============================================
--EXEC [dbo].[Insert_rptThucChay_HopDong_TheoHinhThucQuangCao_SanPham_Quy_NEW] '2013-01-02'
CREATE PROCEDURE [dbo].[Insert_rptThucChay_HopDong_TheoHinhThucQuangCao_SanPham_Quy]
...
BEGIN
    ...
    -- Tổng hợp dữ liệu theo ngày
	   INSERT INTO @TeampData
		...
		UPDATE  rptThucChay_HopDong_TheoHinhThucQuangCao_SanPham_Quy 
		SET rptThucChay_HopDong_TheoHinhThucQuangCao_SanPham_Quy.NgayThucHien = @NgayThucHien,
		    rptThucChay_HopDong_TheoHinhThucQuangCao_SanPham_Quy.ThucChayPhatSinhTrongKy += td.ThucChayPhatSinhTrongKy,
		    rptThucChay_HopDong_TheoHinhThucQuangCao_SanPham_Quy.ThucChayPhatSinhCuoiKy += td.ThucChayPhatSinhTrongKy,
		    rptThucChay_HopDong_TheoHinhThucQuangCao_SanPham_Quy.KhuyenMaiPhatSinhTrongKy += td.KhuyenMaiPhatSinhTrongKy,
		    rptThucChay_HopDong_TheoHinhThucQuangCao_SanPham_Quy.KhuyenMaiPhatSinhCuoiKy += td.KhuyenMaiPhatSinhTrongKy,
		    rptThucChay_HopDong_TheoHinhThucQuangCao_SanPham_Quy.NoiBoPhatSinhTrongKy += td.NoiBoPhatSinhTrongKy,
		    rptThucChay_HopDong_TheoHinhThucQuangCao_SanPham_Quy.NoiBoPhatSinhCuoiKy += td.NoiBoPhatSinhTrongKy,
		...
		FROM rptThucChay_HopDong_TheoHinhThucQuangCao_SanPham_Quy rtchdt
		...
		SET TrangThai = 1
		FROM @TeampData td
		INNER JOIN rptThucChay_HopDong_TheoHinhThucQuangCao_SanPham_Quy rtchdt
		ON td.HopDongID = rtchdt.HopDongID
		AND td.DmNhanVienREF = rtchdt.DmNhanVienREF
		AND td.PhongBanREF = rtchdt.PhongBanREF
		AND td.BoPhanREF = rtchdt.BoPhanREF
		...
		AND td.DmHinhThucQuangCaoREF = rtchdt.DmHinhThucQuangCaoREF
     ------------------------------------Insert--------------------------------------------
     INSERT INTO rptThucChay_HopDong_TheoHinhThucQuangCao_SanPham_Quy
     SELECT 
				@NgayThucHien,
				td.Quy,
				td.Nam,
