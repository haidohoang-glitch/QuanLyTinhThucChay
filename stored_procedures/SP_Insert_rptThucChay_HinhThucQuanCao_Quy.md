# Stored Procedure: `Insert_rptThucChay_HinhThucQuanCao_Quy`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-03-07 12:18:32.967000
- **Ngày sửa cuối**: 2015-03-07 12:18:32.967000
...
-- =============================================
CREATE PROCEDURE [dbo].[Insert_rptThucChay_HinhThucQuanCao_Quy]
...
BEGIN
	...
	rtchdn.DmHinhThucKhachHangREF
	-------------------------------------UPDATE DL--------------------------------
	UPDATE rptThucChay_HinhThucQuangCao_Quy
	...
	FROM rptThucChay_HinhThucQuangCao_Quy rtchtqct
	...
	AND td.Nam = rtchtqct.Nam
	-------------------------------------INSERT DL--------------------------------------
	INSERT INTO rptThucChay_HinhThucQuangCao_Quy
				SELECT 
				@NgayThucHien,
				td.Quy,
				td.Nam,
				...
				[dbo].[fn_GetDauKy_Of_Quy_HinhThucQuangCao]
				(
				  td.DmHinhThucQuangCaoREF,		
			      @NgayThucHien,
			      1,0
