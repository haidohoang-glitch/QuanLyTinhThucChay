# Stored Procedure: `ThucChayDaTinh_InsertThucChayMobileContractByContractNo_v3`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2014-05-30 14:22:51.410000
- **Ngày sửa cuối**: 2015-04-10 10:23:17.523000
...
-- =============================================
-- EXEC dbo.ThucChayDaTinh_InsertThucChayMobileContractByContractNo_v3 '2014-04-28','QC2170314','cafebiz.vn','VIEW', 4

CREATE PROCEDURE [dbo].[ThucChayDaTinh_InsertThucChayMobileContractByContractNo_v3]
...
BEGIN
	...
	SET @DonGiaSanPham = 0;
	SET @DonGiaSanPham = (
							SELECT TOP 1 dbo.ThucChay_GetDonGiaTheoBaoGiaSanPham(@NgayThucHien, 342, tcmt.BannerType, tcmt.ProductName)																
							FROM ThucChayMobileTemp AS tcmt	                        
							WHERE tcmt.dt = @NgayThucHien
								AND tcmt.[Contract] = @ContractNo
								AND tcmt.SiteName = @SiteName
	...
	SET @DonGiaTheoDonViTinhSP = (
							SELECT distinct
								CASE WHEN @BannerType = 2 THEN dbo.ThucChay_GetDonGiaTheoBaoGiaSanPham(@NgayThucHien, 342, @BannerType, @UnitID)
									 WHEN @BannerType = 3 AND @DonViTinh = 'CLICK' THEN dbo.ThucChay_GetDonGiaTheoBaoGiaSanPham(@NgayThucHien, 342, @BannerType, @UnitID)
									 WHEN @BannerType = 3 AND @DonViTinh = 'VIEW' THEN dbo.ThucChay_GetDonGiaTheoBaoGiaSanPham(@NgayThucHien, 342, @BannerType, @UnitID)/1000
									 WHEN @BannerType = 4 AND @DonViTinh = 'CLICK' THEN dbo.ThucChay_GetDonGiaTheoBaoGiaSanPham(@NgayThucHien, 342, @BannerType, @UnitID)
									 WHEN @BannerType = 4 AND @DonViTinh = 'VIEW' THEN dbo.ThucChay_GetDonGiaTheoBaoGiaSanPham(@NgayThucHien, 342, @BannerType, @UnitID)/1000
									 WHEN @BannerType = 5 THEN dbo.ThucChay_GetDonGiaTheoBaoGiaSanPham(@NgayThucHien, 342, @BannerType, @UnitID)
									 WHEN @BannerType = 10 AND @DonViTinh = 'CLICK' THEN dbo.ThucChay_GetDonGiaTheoBaoGiaSanPham(@NgayThucHien, 342, @BannerType, @UnitID)
									 WHEN @BannerType = 10 AND @DonViTinh = 'VIEW' THEN dbo.ThucChay_GetDonGiaTheoBaoGiaSanPham(@NgayThucHien, 342, @BannerType, @UnitID)/1000
									 WHEN @BannerType = 14 AND @DonViTinh = 'CLICK' THEN dbo.ThucChay_GetDonGiaTheoBaoGiaSanPham(@NgayThucHien, 342, @BannerType, @UnitID)
									 WHEN @BannerType = 14 AND @DonViTinh = 'VIEW' THEN dbo.ThucChay_GetDonGiaTheoBaoGiaSanPham(@NgayThucHien, 342, @BannerType, @UnitID)/1000
									 ELSE 0
								END
							--FROM ThucChayMobileTemp AS tcmt	                        
							--WHERE tcmt.dt = @NgayThucHien
	   ...
	   --                                      FROM   dbo.ThucChay_GetHopDongChiTietChungBanner(@HopDongChiTietID))
		...
		BEGIN		
			...
			BEGIN
				...
				IF(EXISTS(SELECT HopDongChiTietREF FROM ThucChayDaTinhMobileBanner AS tcdt WHERE tcdt.HopDongChiTietREF = @PhanBoId))
				BEGIN
					...
					FROM ThucChayDaTinhMobileBanner AS tcdt
				...
				IF(EXISTS(SELECT tcdt.HopDongID FROM ThucChayDaTinhMobileBanner AS tcdt WHERE tcdt.SoHopDong = @ContractNo AND tcdt.DmSanPhamREF = 342 AND tcdt.HopDongChiTietREF = 0))
