# Stored Procedure: `ThucChay_DashboardHopDong`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2013-06-14 13:08:23.557000
- **Ngày sửa cuối**: 2014-11-19 12:16:43.563000

## Parameters

| Parameter | Type | Output |
|-----------|------|--------|
| `@FromDate` | `nvarchar(100)` | No |
| `@ToDate` | `nvarchar(100)` | No |
...
```sql
CREATE PROCEDURE [dbo].[ThucChay_DashboardHopDong] 
...
BEGIN
	...
	IF @DonViThoiGian >= 0
		Begin
			...
			-- Set GroupBy
			SET @GroupBy = ' A.SoHopDong,dbo.GetDonViThoiGian(NgayThucHien,' + CONVERT(nvarchar(50), @DonViThoiGian) + ')'
			-- Set OrderBy
			SET @OrderBy = ' dbo.GetDonViThoiGian(NgayThucHien,' + CONVERT(nvarchar(50), @DonViThoiGian) + '), A.SoHopDong'
		End
	ELSE IF @DonViThoiGian = -1
		Begin 
			-- Set GroupBy
			SET @GroupBy = ' A.SoHopDong '
			-- Set OrderBy
			SET @OrderBy = ' A.SoHopDong '
		End
