# Function: `fn_GetDauKy_Of_Thang_HopDongTheoSanPhamBanner`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-27 17:43:25.823000
- **Ngày sửa cuối**: 2015-03-27 17:43:25.823000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Thang_HopDongTheoSanPhamBanner] 
(
...
BEGIN
	...
	IF @isSoluong = 0
		...
		(
			...
			FROM rptThucChay_HopDong_TheoSanPham_ViTriBanner_Thang dstchdc
			WHERE 1 = 1
			...
			AND dstchdc.DmViTriBannerREF = @DmBannerREF 
