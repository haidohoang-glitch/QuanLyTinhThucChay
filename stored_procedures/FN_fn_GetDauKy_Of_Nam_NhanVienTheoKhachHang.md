# Function: `fn_GetDauKy_Of_Nam_NhanVienTheoKhachHang`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-07 12:18:23.683000
- **Ngày sửa cuối**: 2015-03-07 12:18:23.683000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Nam_NhanVienTheoKhachHang] 
(
...
BEGIN
	...
	IF @isSoluong = 0
		...
		(
			...
			FROM rptThucChay_NhanVien_TheoKhachHang_Nam dstchdc
			WHERE 1 = 1
