# Stored Procedure: `usp_UpdateDmLoaiTrangThietBi`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2013-08-20 16:13:09.123000
- **Ngày sửa cuối**: 2014-11-19 12:16:45.027000
...
--=============================================
-- Author:   Nhat Mai Quy
-- Stored Procedure Name: [dbo].[usp_UpdateDmLoaiTrangThietBi]
-- Create Date: Monday, August 19, 2013
-- Description: 
--=============================================

CREATE PROCEDURE [dbo].[usp_UpdateDmLoaiTrangThietBi]
...
UPDATE [dbo].[DmLoaiTrangThietBi] SET
	[MaLoaiTrangThietBi] = @MaLoaiTrangThietBi,
	[TenLoaiTrangThietBi] = @TenLoaiTrangThietBi,
	[GhiChu] = @GhiChu,
	[Active] = @Active,
