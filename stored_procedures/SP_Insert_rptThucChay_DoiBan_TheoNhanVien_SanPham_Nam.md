# Stored Procedure: `Insert_rptThucChay_DoiBan_TheoNhanVien_SanPham_Nam`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-03-07 12:18:35.210000
- **Ngày sửa cuối**: 2015-03-07 12:18:35.210000
...
-- =============================================
CREATE PROCEDURE [dbo].[Insert_rptThucChay_DoiBan_TheoNhanVien_SanPham_Nam]
...
BEGIN
	...
	-- interfering with SELECT statements.
     ...
     rtchdn.DmSanPhamREF
     ----------------------------------UPDATE DL-----------------------------
     UPDATE rptThucChay_DoiBan_TheoNhanVien_SanPham_Nam
     SET
     ...
     FROM rptThucChay_DoiBan_TheoNhanVien_SanPham_Nam rtcdbt
     ...
     AND td.Nam = rtcdbt.Nam
     --------------------------------insert dl-------------------------------------
     INSERT INTO rptThucChay_DoiBan_TheoNhanVien_SanPham_Nam
				SELECT 
				...
				td.DmSanPhamREF,
				'',
				[dbo].[fn_GetDauKy_Of_Nam_DoiBanTheoNhanVienSanPham]
				(
				  td.DmNhanVienREF,
				  td.PhongBanREF,
				  td.BoPhanREF,
