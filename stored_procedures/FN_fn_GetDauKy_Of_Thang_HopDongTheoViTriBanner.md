# Function: `fn_GetDauKy_Of_Thang_HopDongTheoViTriBanner`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-27 17:43:24.953000
- **Ngày sửa cuối**: 2015-03-27 17:43:24.953000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Thang_HopDongTheoViTriBanner] 
(
...
BEGIN
	...
	IF @isSoluong = 0
		...
		(
			...
			FROM rptThucChay_HopDong_TheoViTriBanner_Thang dstchdc
			WHERE 1 = 1
