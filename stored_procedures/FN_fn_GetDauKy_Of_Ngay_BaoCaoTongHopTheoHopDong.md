# Function: `fn_GetDauKy_Of_Ngay_BaoCaoTongHopTheoHopDong`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-27 17:43:38.010000
- **Ngày sửa cuối**: 2015-03-27 17:43:38.010000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Ngay_BaoCaoTongHopTheoHopDong] 
(
...
BEGIN
	...
	IF @isSoluong = 0
		...
		(
			...
			FROM rptThucChay_BaoCaoTongHopTheoHopDong_Ngay dstchdc
			WHERE 1 = 1
