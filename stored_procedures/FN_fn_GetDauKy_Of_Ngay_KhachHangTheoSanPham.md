# Function: `fn_GetDauKy_Of_Ngay_KhachHangTheoSanPham`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-27 17:43:35.240000
- **Ngày sửa cuối**: 2015-03-27 17:43:35.240000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Ngay_KhachHangTheoSanPham] 
(
...
BEGIN
	...
	IF @isSoluong = 0
		...
		(
			...
			FROM rptThucChay_KhachHang_TheoSanPham_Ngay dstchdc
			WHERE 1 = 1
