# Stored Procedure: `ThucChay_CPMDonViGoi_GhiNhanThayDoi_ThucChayDaTinh_Manual`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2025-10-06 09:46:36.850000
- **Ngày sửa cuối**: 2025-12-09 09:21:31.143000
...
```sql
/*
EXEC dbo.[ThucChay_CPMDonViGoi_GhiNhanThayDoi_ThucChayDaTinh] @NgayGhiNhan = '2025-12-08',
                                                            @SoHopDong = N'QC2350724',            -- nvarchar(50)
                                                            @HopDongChiTietID = 734351              -- int

*/
     

--DECLARE @DmInterger TABLE (ID INT)
CREATE PROCEDURE [dbo].[ThucChay_CPMDonViGoi_GhiNhanThayDoi_ThucChayDaTinh_Manual]
    @NgayGhiNhan DATE,
