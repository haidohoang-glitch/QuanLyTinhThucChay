# Stored Procedure: `ThucChay_CPMDonViGoi_GhiNhanPhatSinh_ThucChayDaTinh`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2025-03-07 17:19:46.930000
- **Ngày sửa cuối**: 2025-09-09 09:32:13.703000
...
CREATE PROCEDURE [dbo].[ThucChay_CPMDonViGoi_GhiNhanPhatSinh_ThucChayDaTinh] 
    @NgayGhiNhan DATE,
...
BEGIN
	...
	--HAIDH COMMENT 20250825 TINH CHO TRUONG HOP DON VI BAI, TINH THEO SO LUONG BAI
	UPDATE temp
	...
	SET  	SoLuongThucChay_GhiNhan = IIF(DonGiaSauCK <> 0, ThanhTienTC_GhiNhan/DonGiaSauCK, 0),
			...
			ThanhTienLechTreoHa = IIF(ChietKhau = 100,(ThanhTienKM - ThanhTienKM_GhiNhan), ((ThanhTienSauCK/(100-ChietKhau))*100 + ThanhTienKM - (ThanhTienTC_GhiNhan/(100-ChietKhau))*100 - ThanhTienKM_GhiNhan))
	FROM #DmThucChay temp
