# Stored Procedure: `ThucChay_Update_GTTD_ThucChayDaTinh_HopDongInventory_test`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2021-01-06 11:48:06.850000
- **Ngày sửa cuối**: 2021-09-27 17:51:58.093000
...
```sql
/*
[dbo].[ThucChay_Update_GTTD_ThucChayDaTinh_HopDongInventory_test] 
	@NgayThucHien = '2021-09-25'
*/

-------------------------------------------------------------
CREATE PROCEDURE [dbo].[ThucChay_Update_GTTD_ThucChayDaTinh_HopDongInventory_test] 
...
BEGIN
		...
		and hdcttd.HopDongChiTietREF = 629668
		...
		WHILE @@FETCH_STATUS = 0
			BEGIN
				...
				END
				print @ThanhTien_HopDongChiTiet
				print @ThanhTien_ThucChayDaTinh
