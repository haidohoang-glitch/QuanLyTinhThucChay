# Stored Procedure: `ThucChayDaTinhAdmarket_MissingCanculate`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2014-09-28 21:30:05.007000
- **Ngày sửa cuối**: 2014-11-19 17:35:59.970000
...
-- =============================================
/*
 *    EXEC dbo.ThucChayDaTinhAdmarket_MissingCanculate '2014-01-01', '2014-09-26',
 			'vn_isvietnam',
 			'2014-09-20 00:00:00.000', 
 			'2014-09-26 00:00:00.000'
 */
CREATE PROCEDURE [dbo].[ThucChayDaTinhAdmarket_MissingCanculate]
...
BEGIN
	...
	BEGIN
		...
		SET @NgayThucHien = '2014-09-26' -- CAST((SELECT DATEADD(s,-1,DATEADD(mm, DATEDIFF(m,0,@MaxDate)+1,0))) AS DATE);
