# Function: `fn_GetDauKy_Of_Nam_BaoCaoTongHopTheoWebsite`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-27 17:43:42.397000
- **Ngày sửa cuối**: 2015-03-27 17:43:42.397000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Nam_BaoCaoTongHopTheoWebsite] 
(
...
BEGIN
	...
	IF @isSoluong = 0
		...
		(
			...
			FROM rptThucChay_BaoCaoTongHopTheoWebsite_Nam dstchdc
			WHERE 1 = 1
