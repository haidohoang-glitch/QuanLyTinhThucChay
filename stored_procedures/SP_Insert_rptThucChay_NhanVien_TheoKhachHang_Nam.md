# Stored Procedure: `Insert_rptThucChay_NhanVien_TheoKhachHang_Nam`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-03-07 12:18:44.640000
- **Ngày sửa cuối**: 2015-03-07 12:18:44.640000
...
-- =============================================
CREATE PROCEDURE [dbo].[Insert_rptThucChay_NhanVien_TheoKhachHang_Nam]
...
BEGIN
    ...
    -----------------------------Du lieu phat sinh-----
	 ...
	 SELECT DISTINCT
	     ...
	     GROUP BY
		       ...
		       rtchdn.DmHinhThucKhachHangREF
	---------------------------------UPDATE DL----------------------------------------
	UPDATE rptThucChay_NhanVien_TheoKhachHang_Nam
	...
	FROM rptThucChay_NhanVien_TheoKhachHang_Nam r
	...
	-----------------------------------------INSERT---------------------------------------
	INSERT INTO rptThucChay_NhanVien_TheoKhachHang_Nam
				SELECT 
				@NgayThucHien,
				td.Nam,
			    td.TenNhanVien, 
	           ...
	           '',
				[dbo].[fn_GetDauKy_Of_Nam_NhanVienTheoKhachHang]
				(
				  td.DmNhanVienREF ,
				  td.PhongBanREF ,
				  td.BoPhanREF ,
