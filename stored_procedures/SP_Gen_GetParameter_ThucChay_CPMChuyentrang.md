# Stored Procedure: `Gen_GetParameter_ThucChay_CPMChuyentrang`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2014-08-26 09:53:42.253000
...
```sql
CREATE PROCEDURE [dbo].[Gen_GetParameter_ThucChay_CPMChuyentrang] 	
As 	
Begin 	
Select 	
