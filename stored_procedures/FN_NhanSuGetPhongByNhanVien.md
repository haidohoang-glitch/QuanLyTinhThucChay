# Function: `NhanSuGetPhongByNhanVien`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2013-09-13 15:03:28.087000
- **Ngày sửa cuối**: 2014-10-14 10:39:34.657000
...
-- =============================================
CREATE FUNCTION [dbo].[NhanSuGetPhongByNhanVien]
(
...
BEGIN
	...
	SET @ResultValue = (SELECT A.DmPhongBanREF
