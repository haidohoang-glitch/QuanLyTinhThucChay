# Stored Procedure: `Insert_rptThucChay_ChuyenMuc_Quy`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-03-27 17:43:51.060000
- **Ngày sửa cuối**: 2015-03-27 17:43:51.060000
...
-- =============================================
CREATE PROCEDURE [dbo].[Insert_rptThucChay_ChuyenMuc_Quy]
...
BEGIN
    ...
    -- Insert statements for procedure here
	 ...
	 dstchdc.DmChuyenMucREF
	 ------------------UPDATE DL-----------------------------
	 UPDATE rptThucChay_ChuyenMuc_Quy
	 SET
	 ...
	 FROM rptThucChay_ChuyenMuc_Quy rtccmt
	 ...
	 AND td.Nam = rtccmt.Nam 
	 ------------------------InsertDL----------------------------------------
	 INSERT INTO rptThucChay_ChuyenMuc_Quy
	 SELECT 
	            @NgayThucHien,
				td.Quy,
				td.Nam,
