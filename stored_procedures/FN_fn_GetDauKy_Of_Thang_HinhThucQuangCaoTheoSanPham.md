# Function: `fn_GetDauKy_Of_Thang_HinhThucQuangCaoTheoSanPham`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-27 17:43:27.127000
- **Ngày sửa cuối**: 2015-03-27 17:43:27.127000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Thang_HinhThucQuangCaoTheoSanPham] 
(
...
BEGIN
	...
	BEGIN
		...
		(
			...
			FROM rptThucChay_HinhThucQuangCao_TheoSanPham_Thang dstchdc
			WHERE 1 = 1
