# Stored Procedure: `ThucChay_CPMDonViGoi_GhiNhanPhatSinh_ThucChayDaTinh_dev`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2025-08-22 16:58:59.383000
- **Ngày sửa cuối**: 2025-08-26 09:01:43.080000
...
/*
EXEC [dbo].[ThucChay_CPMDonViGoi_GhiNhanPhatSinh_ThucChayDaTinh_dev] 
 @NgayGhiNhan = '2025-08-25',
	@NgayPhatSinh_Tu = '2025-08-01',
	@NgayPhatSinh_Den = '2025-08-12',
	@NgayDanhSoGioiHan  = '2024-01-12',
	@SoHopDong  = N'TD0030625',
	@HopDongChiTietID = 759513
*/

CREATE PROCEDURE [dbo].[ThucChay_CPMDonViGoi_GhiNhanPhatSinh_ThucChayDaTinh_dev] 
    @NgayGhiNhan DATE,
...
BEGIN
 ...
 --           AND (@HopDongChiTietID IS NULL OR hdct.HopDongChiTietID = @HopDongChiTietID)
	...
	SET  	SoLuongThucChay_GhiNhan = IIF(DonGiaSauCK <> 0, ThanhTienTC_GhiNhan/DonGiaSauCK, 0),
			...
			SoLuongLechTreoHa = round(SoLuongKM + SoLuongThucChay -  IIF(DonGiaSauCK <> 0, ThanhTienTC_GhiNhan/DonGiaSauCK, 0) - IIF(DonGiaKM <> 0, ThanhTienKM_GhiNhan/DonGiaKM, 0),0),
			--ThanhTienLechTreoHa = ThanhTienSauCK/(1-ChietKhau/100) + ThanhTienKM - ThanhTienTC_GhiNhan/(1-ChietKhau/100) - ThanhTienKM_GhiNhan
			ThanhTienLechTreoHa = (ThanhTienSauCK/(100-ChietKhau))*100 + ThanhTienKM - (ThanhTienTC_GhiNhan/(100-ChietKhau))*100 - ThanhTienKM_GhiNhan
	FROM #DmThucChay temp
	...
	HAVING SUM(SoLuongThucChay_GhiNhan) <> 0 OR 
		   ...
		   SUM(SoLuongLechTreoHa) <> 0
		   	...
		   	SELECT * FROM @Thucchay_CPMDonViGoi_DmTinhMoi
	--WHERE DmSanPhamREF = 735
