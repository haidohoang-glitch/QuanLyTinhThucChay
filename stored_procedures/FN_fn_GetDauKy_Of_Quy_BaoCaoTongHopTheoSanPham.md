# Function: `fn_GetDauKy_Of_Quy_BaoCaoTongHopTheoSanPham`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-21 12:58:27.267000
- **Ngày sửa cuối**: 2015-03-21 12:58:27.267000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Quy_BaoCaoTongHopTheoSanPham] 
(
...
BEGIN
	...
	IF @isSoluong = 0
		...
		(
			...
			FROM rptThucChay_BaoCaoTongHopTheoSanPham_Quy dstchdc
			WHERE 1 = 1
