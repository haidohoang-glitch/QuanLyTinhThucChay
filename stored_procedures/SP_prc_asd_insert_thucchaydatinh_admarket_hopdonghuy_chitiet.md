# Stored Procedure: `prc_asd_insert_thucchaydatinh_admarket_hopdonghuy_chitiet`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2017-09-11 15:02:51.987000
- **Ngày sửa cuối**: 2017-10-28 09:27:09.430000
...
-- =============================================
CREATE PROCEDURE [dbo].[prc_asd_insert_thucchaydatinh_admarket_hopdonghuy_chitiet]
...
BEGIN
	...
	FROM hopdongchitiet
	WHERE hopdongfk = @HopDongID and DmSanPhamREF in (585,628,144)
