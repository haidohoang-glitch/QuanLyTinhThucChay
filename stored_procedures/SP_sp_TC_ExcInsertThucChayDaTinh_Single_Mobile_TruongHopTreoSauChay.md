# Stored Procedure: `sp_TC_ExcInsertThucChayDaTinh_Single_Mobile_TruongHopTreoSauChay`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2017-06-16 10:50:43.907000
- **Ngày sửa cuối**: 2017-12-09 10:07:55.087000
...
-- =============================================
CREATE PROCEDURE [dbo].[sp_TC_ExcInsertThucChayDaTinh_Single_Mobile_TruongHopTreoSauChay]
...
AS
    BEGIN
        ...
        FOR
            ...
            WHERE   CONVERT(NVARCHAR(50), tc.DmBannerID) = @DmBannerID
		...
		-- Perform the first fetch.
                ...
                WHILE @@FETCH_STATUS = 0
                    BEGIN																	  			
                        EXEC sp_TC_InsertThucChayDaTinh_Mobile_TruongHopTreoSauChay @NgayThucHien,
