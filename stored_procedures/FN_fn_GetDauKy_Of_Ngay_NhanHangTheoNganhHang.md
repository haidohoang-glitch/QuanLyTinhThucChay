# Function: `fn_GetDauKy_Of_Ngay_NhanHangTheoNganhHang`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-31 11:21:02.410000
- **Ngày sửa cuối**: 2015-03-31 11:21:02.410000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Ngay_NhanHangTheoNganhHang] 
(
...
BEGIN
	...
	BEGIN
		...
		(
			...
			FROM rptThucChay_NhanHang_TheoNganhHang_Ngay dstchdc
			WHERE 1 = 1
