# Stored Procedure: `Insert_DoanhSoThucChayNhanHangCore_ThucThuKhuyenMai`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2016-09-26 16:00:09.893000
- **Ngày sửa cuối**: 2016-09-26 16:00:09.893000
...
--EXEC [Insert_DoanhSoThucChayNhanHangCore_ThucThuKhuyenMai] '2016-09-20'

CREATE  PROCEDURE [dbo].[Insert_DoanhSoThucChayNhanHangCore_ThucThuKhuyenMai] 
	           ...
	           RIGHT JOIN (
	                    ...
	                    FROM   (
	                               SELECT DISTINCT tcdt.SoHopDong,
	                                      ...
	                                      tcdt.TenNhanVien,
	                                      tcdt.SysNhanVienREF,
	                                      ISNULL(tcdt.NhanHang,0) NhanHang
	    	        ...
	    	        BEGIN
	    	            ...
	    	            FROM   (
	    	                       ...
	    	                       WHERE  tcdt.HopDongChiTietREF = @HopDongChiTietID
	    	                              ...
	    	                              AND tcdt.TenSanPham=@TenSanPham
	    	                       GROUP BY
	    	                              tcdt.HopDongID,
	    	                              tcdt.SoHopDong,
	    	                              tcdt.TenNhanVien,
