# Stored Procedure: `ThucChay_HopDongChiTietAndBannerByDmSanPhamREFAndHopDongID`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2017-03-22 15:15:42.950000
- **Ngày sửa cuối**: 2017-03-22 15:15:52.883000
...
-- =============================================
--EXEC [ThucChay_HopDongChiTietAndBannerByDmSanPhamREFAndHopDongID] 342, '2017-02-24',48772
CREATE PROCEDURE [dbo].[ThucChay_HopDongChiTietAndBannerByDmSanPhamREFAndHopDongID]
...
BEGIN
	...
	SET @DsNhanHangREF = ''
	-------------Xoa ThucChayHopDongChiTietAndBanner cua HopDong dang check ------------------------
	DELETE FROM 
	ThucChayHopDongChiTietAndBanner WHERE HopDongREF = @HopDongID AND HopDongChiTietREF IN (SELECT hdct.HopDongChiTietID
	                            FROM HopDongChiTiet hdct WHERE hdct.DmSanPhamREF = 342 AND hdct.HopDongFK = @HopDongID)
