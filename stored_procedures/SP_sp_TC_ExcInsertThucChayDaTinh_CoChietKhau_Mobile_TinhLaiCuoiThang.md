# Stored Procedure: `sp_TC_ExcInsertThucChayDaTinh_CoChietKhau_Mobile_TinhLaiCuoiThang`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2017-09-13 09:27:08.360000
- **Ngày sửa cuối**: 2017-09-13 09:27:08.360000
...
-- =============================================
CREATE PROCEDURE [dbo].[sp_TC_ExcInsertThucChayDaTinh_CoChietKhau_Mobile_TinhLaiCuoiThang]
...
AS
    BEGIN
		...
		-- Perform the first fetch.
                ...
                WHILE @@FETCH_STATUS = 0
                    BEGIN																	  			
                        EXEC sp_TC_InsertThucChayDaTinh_CoChietKhau_Mobile_TinhLaiCuoiThang @NgayThucHien,
