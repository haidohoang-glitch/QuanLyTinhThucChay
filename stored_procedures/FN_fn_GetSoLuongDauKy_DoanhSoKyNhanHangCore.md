# Function: `fn_GetSoLuongDauKy_DoanhSoKyNhanHangCore`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-04-22 16:42:50.770000
- **Ngày sửa cuối**: 2015-04-22 16:42:50.770000
...
```sql
CREATE FUNCTION [dbo].[fn_GetSoLuongDauKy_DoanhSoKyNhanHangCore]
(
...
BEGIN
	...
	(
		...
		FROM DoanhSoKyNhanHangCore dstchdc
		WHERE 1 = 1
