# Stored Procedure: `usp_UpdateDmDatNuoc`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2013-08-20 16:13:03.810000
- **Ngày sửa cuối**: 2014-11-19 12:16:45.040000
...
--=============================================
-- Author:   Nhat Mai Quy
-- Stored Procedure Name: [dbo].[usp_UpdateDmDatNuoc]
-- Create Date: Monday, August 19, 2013
-- Description: 
--=============================================

CREATE PROCEDURE [dbo].[usp_UpdateDmDatNuoc]
	@DmDatNuocID int,
...
UPDATE [dbo].[DmDatNuoc] SET
	[MaDatNuoc] = @MaDatNuoc,
	[TenDatNuoc] = @TenDatNuoc,
	[GhiChu] = @GhiChu,
	[Active] = @Active,
