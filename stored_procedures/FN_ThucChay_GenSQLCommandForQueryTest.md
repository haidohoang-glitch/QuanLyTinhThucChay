# Function: `ThucChay_GenSQLCommandForQueryTest`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2013-09-13 14:36:32.677000
- **Ngày sửa cuối**: 2014-10-14 10:39:33.097000
...
-- =============================================
CREATE FUNCTION [dbo].[ThucChay_GenSQLCommandForQueryTest] 
(
	@StartDate datetime,
	@EndDate datetime,
...
BEGIN
	...
	SET @Sql = '
		SELECT * FROM dbo.GetDataThucChayByParams('+ @DauNhay  + CONVERT(VARCHAR(50),@StartDate) + @DauNhay + ',' + @DauNhay  + CONVERT(VARCHAR(50),@EndDate) + @DauNhay + ')'
