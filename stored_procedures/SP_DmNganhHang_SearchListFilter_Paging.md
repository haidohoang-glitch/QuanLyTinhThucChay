# Stored Procedure: `DmNganhHang_SearchListFilter_Paging`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2014-01-25 17:11:33.337000
- **Ngày sửa cuối**: 2014-11-19 12:16:44.497000
...
```sql
CREATE PROCEDURE [dbo].[DmNganhHang_SearchListFilter_Paging] 
