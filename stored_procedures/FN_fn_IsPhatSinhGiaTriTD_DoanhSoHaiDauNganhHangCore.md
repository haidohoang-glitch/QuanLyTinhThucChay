# Function: `fn_IsPhatSinhGiaTriTD_DoanhSoHaiDauNganhHangCore`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-04-22 16:42:50.613000
- **Ngày sửa cuối**: 2015-04-22 16:42:50.613000
...
CREATE FUNCTION [dbo].[fn_IsPhatSinhGiaTriTD_DoanhSoHaiDauNganhHangCore]
(
	@HopDongID INT,
...
BEGIN
	...
	SET @v_count = 0
	SET @c_change =0
	IF(SELECT COUNT(dskc.DoanhSoHaiDauNganhHangCoreID) 
	FROM DoanhSoHaiDauNganhHangCore dskc
	...
	SELECT TOP 1  @SoHopDong_Bef = dskc.SoHopDong
				...
				, @DmNganhHangREF_Bef = dskc.DmNganhHangREF
