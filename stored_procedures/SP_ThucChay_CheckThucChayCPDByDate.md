# Stored Procedure: `ThucChay_CheckThucChayCPDByDate`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-04-07 18:04:55.953000
- **Ngày sửa cuối**: 2015-04-08 11:32:44.577000
...
-- =============================================
CREATE PROCEDURE [dbo].[ThucChay_CheckThucChayCPDByDate]
...
BEGIN
	...
	(	
		...
		WHERE @NgayThucHien BETWEEN dchdct.ThoiGianBatDau AND dchdct.ThoiGianKetThuc	
			AND hdct.DmSanPhamREF IN (140, 228, 564, 549 -- CPD
										, 241, 242, 243, 244, 248, 249, 264, 268, 270, 300 -- TMĐT	
									  ) 
	...
	(
		SELECT tchdct.HopDongREF
			...
			, COUNT(tchdct.ThucChayHopDongChiTietID) AS SoLuongChay_Test
