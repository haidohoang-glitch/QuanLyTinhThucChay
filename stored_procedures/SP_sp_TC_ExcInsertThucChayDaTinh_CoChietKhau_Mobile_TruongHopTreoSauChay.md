# Stored Procedure: `sp_TC_ExcInsertThucChayDaTinh_CoChietKhau_Mobile_TruongHopTreoSauChay`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2017-06-24 11:06:44.983000
- **Ngày sửa cuối**: 2017-12-09 10:09:19.490000
...
-- =============================================
CREATE PROCEDURE [dbo].[sp_TC_ExcInsertThucChayDaTinh_CoChietKhau_Mobile_TruongHopTreoSauChay]
...
AS
    BEGIN
		...
		-- Perform the first fetch.
                ...
                WHILE @@FETCH_STATUS = 0
                    BEGIN																	  			
                        EXEC sp_TC_InsertThucChayDaTinh_CoChietKhau_Mobile_TruongHopTreoSauChay @NgayThucHien,
