# Stored Procedure: `ThucChay_InsertThucChayDaTinh_CPDBySoHopDong`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2016-03-17 09:21:23.137000
- **Ngày sửa cuối**: 2016-03-30 14:25:47.687000
...
CREATE  PROCEDURE [dbo].[ThucChay_InsertThucChayDaTinh_CPDBySoHopDong] 
	@StartDate datetime,
	@EndDate DATETIME,
...
BEGIN
	...
	(CASE when TD.IsKhuyenMai=1 then ISNULL(dbo.ThucChay_GetSoLuongThucChayChuanByDonViTinh_CPD(@NgayThucHien, TD.HopDongChiTietID),0)
		else 0
	  END
...
--EXEC [ThucChay_InsertThucChayDaTinh_CPDBySoHopDong] '2014-05-15','2014-05-15', 'SH020514', 370
