# Function: `fn_GetDauKy_Of_Thang_LoaiNenTang`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-07 12:18:09.453000
- **Ngày sửa cuối**: 2015-03-07 12:18:09.453000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Thang_LoaiNenTang] 
(
...
BEGIN
	...
	BEGIN
		...
		(
			...
			FROM rptThucChay_LoaiNenTang_Thang dstchdc
			WHERE 1 = 1
