# Function: `fn_GetDauKy_Of_Quy_SanPhamTheoWebsite`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-27 17:43:28.703000
- **Ngày sửa cuối**: 2015-03-27 17:43:28.703000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Quy_SanPhamTheoWebsite] 
(
...
BEGIN
	...
	BEGIN
		...
		(
			...
			FROM rptThucChay_SanPham_TheoWebsite_Quy dstchdc
			WHERE 1 = 1
