# Stored Procedure: `Syn_ThucTreoHopDongChiTietTrinhDuyet_ThucTreo`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2020-05-26 11:23:38.567000
- **Ngày sửa cuối**: 2020-05-26 11:23:54.127000
...
```sql
/*
EXEC [dbo].[Syn_ThucTreoHopDongChiTietTrinhDuyet_ThucTreo] 

*/
CREATE PROCEDURE [dbo].[Syn_ThucTreoHopDongChiTietTrinhDuyet_ThucTreo]
As 	
BEGIN
	...
	SET @NgayThucHien = DATEADD(day,-30,@NgayThucHien)
	...
	WHERE LastModifiedAt > @NgayThucHien
	...
	CREATE TABLE #ThucTreoHopDongChiTietTrinhDuyet_Thuctreo (
	  ...
	  record_status SMALLINT
		...
		SELECT tc.Id AS ThucTreoHopDongChiTietTrinhDuyetID,
               ...
               tc.DeletedStatus,
			   '' AS linkBai,
			   (select top (1) tca.NhanVien_Id from  [192.168.23.217].ThucTreo.dbo.[ThucTreo_ChiPhi_Account] tca where tca.thuctreo_chiphi_REF = tc.id and tca.deleted_status = 0) AS ListNhanVienREF,
               0 status_table FROM [192.168.23.217].ThucTreo.dbo.ThucTreo_ChiPhi tc
