# Stored Procedure: `sp_ThucChayDaTinh_ReInsertByHopDong_dev`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2020-05-22 16:08:18.830000
- **Ngày sửa cuối**: 2020-05-25 16:43:09.843000
...
--EXEC [dbo].[sp_ThucChayDaTinh_ReInsertByHopDong_dev] '2020-05-24'
CREATE PROCEDURE [dbo].[sp_ThucChayDaTinh_ReInsertByHopDong_dev]
...
BEGIN
	...
	BEGIN   
		...
		IF(@HinhThucQuangCaoREF_new = 13 OR @DmLoaiBannerREF_new = 18)
		BEGIN
			...
			BEGIN
				...
				if @IsThayDoi = 1 SET @Note_MuaNgoai = 'THAY DOI THONG TIN HOP DONG ' + @NoiDungThayDoi
				if @IsThayDoi = 2 SET @Note_MuaNgoai = 'PHAN BO BI XOA ' + @NoiDungThayDoi
				if @IsThayDoi = 3 SET @Note_MuaNgoai = 'THAY DOI DANH SACH NHAN HANG ' + @NoiDungThayDoi
				if @IsThayDoi = 4 SET @Note_MuaNgoai = 'HUY HOP DONG ' + @NoiDungThayDoi
				if @IsThayDoi = 5 SET @Note_MuaNgoai = 'Admatic Thay Doi Thong Tin HD ' + @NoiDungThayDoi
				...
				@Note = @Note_MuaNgoai, 
				@IsThayDoi = @IsExistDataLaiMuaNgoai,
