# Stored Procedure: `ThucChayDaTinh_InsertThucChayMobileContractByContractNo_v4`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2014-09-18 10:19:33.997000
- **Ngày sửa cuối**: 2015-04-10 10:24:48.787000
...
-- =============================================
-- EXEC dbo.ThucChayDaTinh_InsertThucChayMobileContractByContractNo_v3 '2014-06-11','CPC920514','kenh14.vn','CLICK', 5
CREATE PROCEDURE [dbo].[ThucChayDaTinh_InsertThucChayMobileContractByContractNo_v4]
...
BEGIN
	...
	ELSE SET @SoLuongThucChay = @TotalView;
	
	SET @DonGiaTheoDonViTinhSP = (
							SELECT 
								CASE WHEN tcmt.BannerType = 2 THEN dbo.ThucChay_GetDonGiaTheoBaoGiaSanPham(@NgayThucHien, 342, tcmt.BannerType, tcmt.ProductName)
									 WHEN tcmt.BannerType = 3 AND tcmt.UnitName = 'CLICK' THEN dbo.ThucChay_GetDonGiaTheoBaoGiaSanPham(@NgayThucHien, 342, tcmt.BannerType, tcmt.ProductName)
									 WHEN tcmt.BannerType = 3 AND tcmt.UnitName = 'VIEW' THEN dbo.ThucChay_GetDonGiaTheoBaoGiaSanPham(@NgayThucHien, 342, tcmt.BannerType, tcmt.ProductName)/1000
									 WHEN tcmt.BannerType = 4 AND tcmt.UnitName = 'CLICK' THEN dbo.ThucChay_GetDonGiaTheoBaoGiaSanPham(@NgayThucHien, 342, tcmt.BannerType, tcmt.ProductName)
									 WHEN tcmt.BannerType = 4 AND tcmt.UnitName = 'VIEW' THEN dbo.ThucChay_GetDonGiaTheoBaoGiaSanPham(@NgayThucHien, 342, tcmt.BannerType, tcmt.ProductName)/1000
									 WHEN tcmt.BannerType = 5 THEN dbo.ThucChay_GetDonGiaTheoBaoGiaSanPham(@NgayThucHien, 342, tcmt.BannerType, tcmt.ProductName)
									 WHEN tcmt.BannerType = 10 AND tcmt.UnitName = 'CLICK' THEN dbo.ThucChay_GetDonGiaTheoBaoGiaSanPham(@NgayThucHien, 342, tcmt.BannerType, tcmt.ProductName)
									 WHEN tcmt.BannerType = 10 AND tcmt.UnitName = 'VIEW' THEN dbo.ThucChay_GetDonGiaTheoBaoGiaSanPham(@NgayThucHien, 342, tcmt.BannerType, tcmt.ProductName)/1000
									 WHEN tcmt.BannerType = 14 AND tcmt.UnitName = 'CLICK' THEN dbo.ThucChay_GetDonGiaTheoBaoGiaSanPham(@NgayThucHien, 342, tcmt.BannerType, tcmt.ProductName)
									 WHEN tcmt.BannerType = 14 AND tcmt.UnitName = 'VIEW' THEN dbo.ThucChay_GetDonGiaTheoBaoGiaSanPham(@NgayThucHien, 342, tcmt.BannerType, tcmt.ProductName)/1000
									 ELSE 0
								END
	...
	SET @ThanhTienThucChay = (SELECT ISNULL(SUM(tcdt.ThanhTienSauTrietKhauThucChay + tcdt.GiaTriThayDoi),0)
							  FROM ThucChayDaTinh tcdt
							  WHERE tcdt.HopDongChiTietREF = @HopDongChiTietREF 
							  AND tcdt.DmSanPhamREF = 342 
							  AND tcdt.NgayThucHien < @NgayThucHien)
							
	SET @ThanhTienHD = (SELECT ISNULL(ThanhTien,0) FROM HopDongChiTiet hdct WHERE hdct.HopDongChiTietID = @HopDongChiTietREF AND hdct.DeletedStatus <> 1)
	
	
	IF (@ThanhTienThucChay < @ThanhTienHD) -- tinh thuc chay
		SELECT 1
	
	ELSE -- dua vao lech treo ha
		BEGIN
			SET @TypeInsert = 3;
			SET @SoLuongLechTreoHa = @SoLuongThucChay;
	...
	SET @DonGiaSanPham = 0;
	SET @DonGiaSanPham = (
							SELECT dbo.ThucChay_GetDonGiaTheoBaoGiaSanPham(@NgayThucHien, 342, tcmt.BannerType, tcmt.UnitID)								
							FROM ThucChayMobileTemp AS tcmt	                        
							WHERE tcmt.dt = @NgayThucHien
								AND tcmt.[Contract] = @ContractNo
								AND tcmt.SiteName = @SiteName
	...
	SET @DonGiaTheoDonViTinhSP = (
							SELECT 
								CASE WHEN tcmt.BannerType = 2 THEN dbo.ThucChay_GetDonGiaTheoBaoGiaSanPham(@NgayThucHien, 342, tcmt.BannerType, tcmt.UnitID)
									 WHEN tcmt.BannerType = 3 AND tcmt.UnitName = 'CLICK' THEN dbo.ThucChay_GetDonGiaTheoBaoGiaSanPham(@NgayThucHien, 342, tcmt.BannerType, tcmt.UnitID)
									 WHEN tcmt.BannerType = 3 AND tcmt.UnitName = 'VIEW' THEN dbo.ThucChay_GetDonGiaTheoBaoGiaSanPham(@NgayThucHien, 342, tcmt.BannerType, tcmt.UnitID)/1000
									 WHEN tcmt.BannerType = 4 AND tcmt.UnitName = 'CLICK' THEN dbo.ThucChay_GetDonGiaTheoBaoGiaSanPham(@NgayThucHien, 342, tcmt.BannerType, tcmt.UnitID)
									 WHEN tcmt.BannerType = 4 AND tcmt.UnitName = 'VIEW' THEN dbo.ThucChay_GetDonGiaTheoBaoGiaSanPham(@NgayThucHien, 342, tcmt.BannerType, tcmt.UnitID)/1000
									 WHEN tcmt.BannerType = 5 THEN dbo.ThucChay_GetDonGiaTheoBaoGiaSanPham(@NgayThucHien, 342, tcmt.BannerType, tcmt.UnitID)
									 WHEN tcmt.BannerType = 10 AND tcmt.UnitName = 'CLICK' THEN dbo.ThucChay_GetDonGiaTheoBaoGiaSanPham(@NgayThucHien, 342, tcmt.BannerType, tcmt.UnitID)
									 WHEN tcmt.BannerType = 10 AND tcmt.UnitName = 'VIEW' THEN dbo.ThucChay_GetDonGiaTheoBaoGiaSanPham(@NgayThucHien, 342, tcmt.BannerType, tcmt.UnitID)/1000
									 WHEN tcmt.BannerType = 14 AND tcmt.UnitName = 'CLICK' THEN dbo.ThucChay_GetDonGiaTheoBaoGiaSanPham(@NgayThucHien, 342, tcmt.BannerType, tcmt.UnitID)
									 WHEN tcmt.BannerType = 14 AND tcmt.UnitName = 'VIEW' THEN dbo.ThucChay_GetDonGiaTheoBaoGiaSanPham(@NgayThucHien, 342, tcmt.BannerType, tcmt.UnitID)/1000
									 ELSE 0
								END
							FROM ThucChayMobileTemp AS tcmt	                        
							WHERE tcmt.dt = @NgayThucHien
	...
	BEGIN	
		...
		BEGIN		
			...
			BEGIN
				...
				IF(EXISTS(SELECT tcdt.HopDongID FROM ThucChayDaTinh AS tcdt WHERE tcdt.SoHopDong = @ContractNo AND tcdt.DmSanPhamREF = 342 AND tcdt.HopDongChiTietREF = 0))
				...
				BEGIN
					...
					BEGIN
						...
						SET @ThanhTienThucChayTruocCK = dbo.ThucChay_GetThanhTienChuanThucChay(@SoLuongPhanBoHopDong,@DonViTinhPhanBo,@DonGiaPhanBo,@NgayKyHopDong,@SoLuongThucChay,@SoLuongThucChay,0,@NgayThucHien,@PhanBoId)
