# Stored Procedure: `usp_UpdateDmTinhThanhPho`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2013-08-20 16:13:15.060000
- **Ngày sửa cuối**: 2014-11-19 12:16:45.120000
...
| `@MaTinhThanhPho` | `nvarchar(100)` | No |
...
--=============================================
-- Author:   Nhat Mai Quy
-- Stored Procedure Name: [dbo].[usp_UpdateDmTinhThanhPho]
-- Create Date: Monday, August 19, 2013
-- Description: 
--=============================================

CREATE PROCEDURE [dbo].[usp_UpdateDmTinhThanhPho]
	@DmTinhThanhPhoID int,
	@MaTinhThanhPho nvarchar(50),
