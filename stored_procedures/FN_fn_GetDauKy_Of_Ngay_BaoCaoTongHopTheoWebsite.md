# Function: `fn_GetDauKy_Of_Ngay_BaoCaoTongHopTheoWebsite`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-27 17:43:37.993000
- **Ngày sửa cuối**: 2015-03-27 17:43:37.993000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Ngay_BaoCaoTongHopTheoWebsite] 
(
...
BEGIN
	...
	IF @isSoluong = 0
		...
		(
			...
			FROM rptThucChay_BaoCaoTongHopTheoWebsite_Ngay dstchdc
			WHERE 1 = 1
