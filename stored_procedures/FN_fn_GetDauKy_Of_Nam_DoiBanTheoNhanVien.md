# Function: `fn_GetDauKy_Of_Nam_DoiBanTheoNhanVien`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-07 12:18:26.043000
- **Ngày sửa cuối**: 2015-03-07 12:18:26.043000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Nam_DoiBanTheoNhanVien] 
(
...
BEGIN
	...
	IF @isSoluong = 0
		...
		(
			...
			FROM rptThucChay_DoiBan_TheoNhanVien_Nam dstchdc
			WHERE 1 = 1
