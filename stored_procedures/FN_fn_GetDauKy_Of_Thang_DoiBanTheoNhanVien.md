# Function: `fn_GetDauKy_Of_Thang_DoiBanTheoNhanVien`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-07 12:18:11.537000
- **Ngày sửa cuối**: 2015-03-07 12:18:11.537000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Thang_DoiBanTheoNhanVien] 
(
...
BEGIN
	...
	IF @isSoluong = 0
		...
		(
			...
			FROM rptThucChay_DoiBan_TheoNhanVien_Thang dstchdc
			WHERE 1 = 1
