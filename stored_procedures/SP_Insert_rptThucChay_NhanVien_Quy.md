# Stored Procedure: `Insert_rptThucChay_NhanVien_Quy`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-03-27 17:44:00.693000
- **Ngày sửa cuối**: 2015-03-27 17:44:00.693000
...
-- =============================================
CREATE PROCEDURE [dbo].[Insert_rptThucChay_NhanVien_Quy]
...
BEGIN
    ...
    -----------------------------Du lieu phat sinh-----
	 ...
	 SELECT DISTINCT
	     ...
	     GROUP BY
		       ...
		       rtchdn.UserName
	---------------------------------UPDATE DL----------------------------------------
	UPDATE rptThucChay_NhanVien_Quy
	...
	FROM rptThucChay_NhanVien_Quy r
	...
	AND td.Quy = r.Quy
	-----------------------------------------INSERT---------------------------------------
	INSERT INTO rptThucChay_NhanVien_Quy
				SELECT 
				@NgayThucHien,
				td.Quy,
				td.Nam,
