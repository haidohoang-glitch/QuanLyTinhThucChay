# Stored Procedure: `usp_InsertHopDongChiTiet`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2013-05-29 03:13:12.823000
- **Ngày sửa cuối**: 2014-11-19 12:16:57.200000
...
-- Stored Procedure Name: [dbo].[usp_InsertHopDongChiTiet]
-- Create Date: Tuesday, May 28, 2013
-- Description: 
--=============================================

CREATE PROCEDURE [dbo].[usp_InsertHopDongChiTiet]
...
SET NOCOUNT ON
if(exists(select * from [HopDongChiTiet] where [HopDongChiTietID] = @HopDongChiTietID and DeletedStatus <> 1))
