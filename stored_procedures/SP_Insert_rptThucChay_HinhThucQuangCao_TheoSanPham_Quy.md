# Stored Procedure: `Insert_rptThucChay_HinhThucQuangCao_TheoSanPham_Quy`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-03-27 17:43:48.287000
- **Ngày sửa cuối**: 2015-03-27 17:43:48.287000
...
-- =============================================
CREATE PROCEDURE [dbo].[Insert_rptThucChay_HinhThucQuangCao_TheoSanPham_Quy]
...
BEGIN
	...
	rtchdn.DmSanPhamREF
	-------------------------------------UPDATE DL--------------------------------
	UPDATE rptThucChay_HinhThucQuangCao_TheoSanPham_Quy
	...
	FROM rptThucChay_HinhThucQuangCao_TheoSanPham_Quy rtchtqct
	...
	AND td.Nam = rtchtqct.Nam
	-------------------------------------INSERT DL--------------------------------------
	INSERT INTO rptThucChay_HinhThucQuangCao_TheoSanPham_Quy
				SELECT 
				@NgayThucHien,
				td.Quy,
				td.Nam,
