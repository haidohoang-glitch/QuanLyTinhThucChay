# Stored Procedure: `Insert_rptThucChay_KhachHang_TheoSanPham_Thang`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-03-27 17:43:58.557000
- **Ngày sửa cuối**: 2015-03-27 17:43:58.557000
...
-- =============================================
CREATE PROCEDURE [dbo].[Insert_rptThucChay_KhachHang_TheoSanPham_Thang]
...
BEGIN
	...
	-- interfering with SELECT statements.
	 DECLARE @TeampData TABLE 
	  ...
	  rtchdn.UserName
	  ------------------------------------UPDATE dl------------------------
	  UPDATE  rptThucChay_KhachHang_TheoSanPham_Thang 
		SET rptThucChay_KhachHang_TheoSanPham_Thang.NgayThucHien = @NgayThucHien,
		    rptThucChay_KhachHang_TheoSanPham_Thang.ThucChayPhatSinhTrongKy += td.ThucChayPhatSinhTrongKy,
		    rptThucChay_KhachHang_TheoSanPham_Thang.ThucChayPhatSinhCuoiKy += td.ThucChayPhatSinhTrongKy,
		    rptThucChay_KhachHang_TheoSanPham_Thang.KhuyenMaiPhatSinhTrongKy += td.KhuyenMaiPhatSinhTrongKy,
		    rptThucChay_KhachHang_TheoSanPham_Thang.KhuyenMaiPhatSinhCuoiKy += td.KhuyenMaiPhatSinhTrongKy,
		    rptThucChay_KhachHang_TheoSanPham_Thang.NoiBoPhatSinhTrongKy += td.NoiBoPhatSinhTrongKy,
		    rptThucChay_KhachHang_TheoSanPham_Thang.NoiBoPhatSinhCuoiKy += td.NoiBoPhatSinhTrongKy,
		...
		FROM rptThucChay_KhachHang_TheoSanPham_Thang rtchdt
		...
		AND td.Nam = rtchdt.Nam
		----------------------------------INSERT dl------------------------------------
		INSERT INTO rptThucChay_KhachHang_TheoSanPham_Thang
				SELECT 
				@NgayThucHien,
				td.Thang,
				td.Nam,
	            ...
	            td.DmSanPhamREF,
	            '',
				[dbo].[fn_GetDauKy_Of_Ngay_KhachHangTheoSanPham]
				(
					td.DmNhanVienREF,
					td.PhongBanREF,
					td.BoPhanREF,
