# Stored Procedure: `Insert_rptThucChay_NhanVien_TheoSanPham_Ngay`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-03-07 12:18:46.723000
- **Ngày sửa cuối**: 2015-03-07 12:18:46.723000
...
CREATE PROCEDURE [dbo].[Insert_rptThucChay_NhanVien_TheoSanPham_Ngay] 
...
BEGIN
	...
	WHILE @NgayThucHien <= @ToDate
		BEGIN
			 INSERT INTO rptThucChay_NhanVien_TheoSanPham_Ngay
			 SELECT 
				...
				'' AS DienGiai,
			   [dbo].[fn_GetDauKy_Of_Ngay_NhanVienTheoSanPham] 
				(
                 dstchdc.DmNhanVienREF,
                 dstchdc.PhongBanREF,
                 dstchdc.BoPhanREF,
