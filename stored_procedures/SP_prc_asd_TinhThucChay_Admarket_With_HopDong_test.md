# Stored Procedure: `prc_asd_TinhThucChay_Admarket_With_HopDong_test`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2021-04-17 09:20:14.763000
- **Ngày sửa cuối**: 2021-04-17 09:21:49.227000
...
CREATE PROCEDURE [dbo].[prc_asd_TinhThucChay_Admarket_With_HopDong_test]
...
BEGIN
	...
	BEGIN   
		...
		IF(EXISTS(SELECT TOP (1) hdct.HopDongChiTietID FROM dbo.HopDongChiTiet hdct 
				...
				AND hdct.ThanhTien >= (@ThanhTienThucChayDaTinh + @TienThucChay_GhiNhan)
			...
			ISNULL((SELECT --tcdta.HopDongID, tcdta.HopDongChiTietREF, DmViTriREF, 
				...
				BEGIN
					...
					SET @TenViTri  = (CASE WHEN @DmViTriID = 1 THEN N'AdX'
											...
											WHEN @DmViTriID = 2 THEN N'AdX Ecommerce'
										ELSE N''
									END)
