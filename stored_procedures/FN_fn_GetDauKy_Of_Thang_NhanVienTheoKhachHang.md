# Function: `fn_GetDauKy_Of_Thang_NhanVienTheoKhachHang`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-07 12:18:09.050000
- **Ngày sửa cuối**: 2015-03-07 12:18:09.050000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Thang_NhanVienTheoKhachHang] 
(
...
BEGIN
	...
	IF @isSoluong = 0
		...
		(
			...
			FROM rptThucChay_NhanVien_TheoKhachHang_Thang dstchdc
			WHERE 1 = 1
