# Function: `fn_GetDauKy_Of_Nam_HopDongTheoViTriBanner`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-27 17:43:39.927000
- **Ngày sửa cuối**: 2015-03-27 17:43:39.927000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Nam_HopDongTheoViTriBanner] 
(
...
BEGIN
	...
	IF @isSoluong = 0
		...
		(
			...
			FROM rptThucChay_HopDong_TheoViTriBanner_Nam dstchdc
			WHERE 1 = 1
