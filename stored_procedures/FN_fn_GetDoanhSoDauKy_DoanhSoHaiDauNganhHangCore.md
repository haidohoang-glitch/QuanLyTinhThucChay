# Function: `fn_GetDoanhSoDauKy_DoanhSoHaiDauNganhHangCore`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-04-22 16:42:52.123000
- **Ngày sửa cuối**: 2015-04-22 16:42:52.123000
...
```sql
CREATE FUNCTION [dbo].[fn_GetDoanhSoDauKy_DoanhSoHaiDauNganhHangCore]
(
...
BEGIN
	...
	(
		...
		FROM DoanhSoHaiDauNganhHangCore dstchdc
		WHERE 1 = 1
