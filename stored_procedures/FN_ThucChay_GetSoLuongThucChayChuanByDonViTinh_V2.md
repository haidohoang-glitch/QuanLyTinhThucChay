# Function: `ThucChay_GetSoLuongThucChayChuanByDonViTinh_V2`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2014-08-13 15:56:04.967000
- **Ngày sửa cuối**: 2014-10-14 10:39:30.510000
...
-- =============================================
CREATE  FUNCTION [dbo].[ThucChay_GetSoLuongThucChayChuanByDonViTinh_V2] 
(
...
BEGIN
	...
	DECLARE @v_TongViewCPVBanner BIGINT, @v_TongCPVBanner INT
	...
	BEGIN
		...
		BEGIN
			...
			BEGIN
				...
				SET @TongViewThucChay = (@TongViewThucChay/@v_TongViewCPVBanner)*@v_TongCPVBanner
			END
