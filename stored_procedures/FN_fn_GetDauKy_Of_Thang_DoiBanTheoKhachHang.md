# Function: `fn_GetDauKy_Of_Thang_DoiBanTheoKhachHang`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-07 12:18:11.740000
- **Ngày sửa cuối**: 2015-03-07 12:18:11.740000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Thang_DoiBanTheoKhachHang] 
(
...
BEGIN
	...
	IF @isSoluong = 0
		...
		(
			...
			FROM rptThucChay_DoiBan_TheoKhachHang_Thang dstchdc
			WHERE 1 = 1
