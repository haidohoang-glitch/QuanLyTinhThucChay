# Stored Procedure: `Gen_InsertOrUpdate_ThucChayHopDongChiTiet_ThucTreoChiPhi_ByThucTreoID`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2020-03-26 17:02:23.327000
- **Ngày sửa cuối**: 2024-12-03 09:46:15.533000
...
EXEC [dbo].[Gen_InsertOrUpdate_ThucChayHopDongChiTiet_ThucTreoChiPhi_ByThucTreoID]
*/
CREATE PROCEDURE [dbo].[Gen_InsertOrUpdate_ThucChayHopDongChiTiet_ThucTreoChiPhi_ByThucTreoID]
	@ThucTreoID INT
AS
BEGIN
    ...
    WHERE 1=1 
	AND tt.ThucTreoHopDongChiTietTrinhDuyetID >= @ThucTreoID
