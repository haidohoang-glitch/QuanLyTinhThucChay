# Function: `fn_GetDauKy_Of_Quy_KhachHangTheoSanPham`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-27 17:43:29.800000
- **Ngày sửa cuối**: 2015-03-27 17:43:29.800000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Quy_KhachHangTheoSanPham] 
(
...
BEGIN
	...
	IF @isSoluong = 0
		...
		(
			...
			FROM rptThucChay_KhachHang_TheoSanPham_Quy dstchdc
			WHERE 1 = 1
