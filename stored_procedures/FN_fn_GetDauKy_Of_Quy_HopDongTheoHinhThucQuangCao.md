# Function: `fn_GetDauKy_Of_Quy_HopDongTheoHinhThucQuangCao`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-27 17:43:31.813000
- **Ngày sửa cuối**: 2015-03-27 17:43:31.813000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Quy_HopDongTheoHinhThucQuangCao] 
(
...
BEGIN
	...
	IF @isSoluong = 0
		...
		(
			...
			FROM rptThucChay_HopDong_TheoHinhThucQuangCao_Quy dstchdc
			WHERE 1 = 1
