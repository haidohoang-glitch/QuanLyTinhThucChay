# Stored Procedure: `ThucChayDaTinh_ExecThucChayMuaNgoaiChiTiet_ByHopDongChiTietID_DEV`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2022-04-25 14:45:32.120000
- **Ngày sửa cuối**: 2022-04-25 14:58:03.450000
...
-- =============================================
/*
	EXEC  [dbo].[ThucChayDaTinh_ExecThucChayMuaNgoaiChiTiet_ByHopDongChiTietID_DEV] 646775 , '2022-04-22'
*/
CREATE PROCEDURE [dbo].[ThucChayDaTinh_ExecThucChayMuaNgoaiChiTiet_ByHopDongChiTietID_DEV]
...
BEGIN
	...
	BEGIN
		...
		BEGIN
			...
			SELECT @ThanhTienPhanBo
			SELECT @TongThanhTienThucChay
			SELECT @ThanhTienThucChayBanSauCK
