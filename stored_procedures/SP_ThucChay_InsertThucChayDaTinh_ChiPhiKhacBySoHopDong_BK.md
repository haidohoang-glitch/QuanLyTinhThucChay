# Stored Procedure: `ThucChay_InsertThucChayDaTinh_ChiPhiKhacBySoHopDong_BK`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2014-05-20 16:52:49.020000
- **Ngày sửa cuối**: 2014-11-19 12:24:50.110000
...
```sql
--------------------------------------------------------
CREATE PROCEDURE [dbo].[ThucChay_InsertThucChayDaTinh_ChiPhiKhacBySoHopDong_BK] 
	@StartDate datetime,
	@EndDate DATETIME, 
...
BEGIN
	...
	(CASE when ((TD.IsKhuyenMai=1) OR (TD.ChietKhau = 100)) then ISNULL(dbo.ThucChay_GetSoLuongThucChayChuanByDonViTinh_PR(@NgayThucHien,@NgayGioiHanTinh ,TD.HopDongChiTietID),0)
		else 0
	  END
