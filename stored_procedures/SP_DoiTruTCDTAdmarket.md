# Stored Procedure: `DoiTruTCDTAdmarket`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2020-12-25 10:45:02.087000
- **Ngày sửa cuối**: 2020-12-25 10:46:47.363000
...
```sql
      CREATE Procedure [dbo].[DoiTruTCDTAdmarket]
	  @ThucChayDaTinhID nvarchar(50),
	  @NgayThucHien datetime,
	  --@HopDongID int, @HopDongChiTietID int
	  @DmSanPhamREF int,@GhiChu nvarchar(200)
	  as
	  begin
