# Stored Procedure: `Insert_DoanhSoTienVeNganhHangCore_ThucThuKhuyenMai_History_Update`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-06-12 10:47:01.180000
- **Ngày sửa cuối**: 2015-06-12 10:47:01.180000
...
-- =============================================
--EXEC [dbo].[Insert_DoanhSoTienVeNganhHangCore_ThucThuKhuyenMai_History] '2014-01-01'
CREATE PROCEDURE [dbo].[Insert_DoanhSoTienVeNganhHangCore_ThucThuKhuyenMai_History_Update]
...
BEGIN
    ...
    DECLARE @NgayThanhToan DATETIME, @SoHoaDon NVARCHAR(50), @ThongTinTienVeID INT;
    ...
    ,@NgayThanhToan,@ThongTinTienVeID
