# Stored Procedure: `sp_TC_TinhGiaTriThayDoi_PR_bk20181018`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2018-10-18 15:46:54.750000
- **Ngày sửa cuối**: 2018-10-18 15:46:54.750000
...
CREATE PROCEDURE [dbo].[sp_TC_TinhGiaTriThayDoi_PR_bk20181018] 
	...
	-- Declare the return variable here
        ...
        FROM    ( SELECT    tchdctp.HopDongREF ,
                  ...
                  WHERE     tchdctp.ThoiGianBatDau IS NOT NULL --AND tchdctp.HopDongREF = 500395
							...
							--AND tchdctp.ThucChayHopDongChiTietPRID = 71342 
							--AND hdct.HopDongChiTietID = 94506
							--AND tchdctp.HopDongREF = 502805
                ) A
