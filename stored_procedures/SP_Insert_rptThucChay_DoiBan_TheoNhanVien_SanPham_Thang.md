# Stored Procedure: `Insert_rptThucChay_DoiBan_TheoNhanVien_SanPham_Thang`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-03-07 12:18:34.577000
- **Ngày sửa cuối**: 2015-03-07 12:18:34.577000
...
-- =============================================
CREATE PROCEDURE [dbo].[Insert_rptThucChay_DoiBan_TheoNhanVien_SanPham_Thang]
...
BEGIN
	...
	-- interfering with SELECT statements.
     ...
     rtchdn.DmSanPhamREF
     ----------------------------------UPDATE DL-----------------------------
     UPDATE rptThucChay_DoiBan_TheoNhanVien_SanPham_Thang
     SET
     ...
     FROM rptThucChay_DoiBan_TheoNhanVien_SanPham_Thang rtcdbt
     ...
     AND td.Nam = rtcdbt.Nam
     --------------------------------insert dl-------------------------------------
     INSERT INTO rptThucChay_DoiBan_TheoNhanVien_SanPham_Thang
				SELECT 
				...
				td.DmSanPhamREF,
				'',
				[dbo].[fn_GetDauKy_Of_Thang_DoiBanTheoNhanVienSanPham]
				(
				  td.DmNhanVienREF,
				  td.PhongBanREF,
				  td.BoPhanREF,
