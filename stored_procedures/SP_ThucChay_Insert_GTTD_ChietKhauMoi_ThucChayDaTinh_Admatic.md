# Stored Procedure: `ThucChay_Insert_GTTD_ChietKhauMoi_ThucChayDaTinh_Admatic`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2018-07-23 15:59:07.367000
- **Ngày sửa cuối**: 2018-07-23 16:32:44.867000
...
| `@ThucChayDaTinhID` | `nvarchar(4000)` | No |
...
CREATE  PROCEDURE [dbo].[ThucChay_Insert_GTTD_ChietKhauMoi_ThucChayDaTinh_Admatic] 
	@NgayThucHien DATETIME,
	@HopDongID INT, 
	@HopDongChiTietID INT,
	@ThucChayDaTinhID NVARCHAR(2000),
...
BEGIN
	...
	SELECT  NEWID() ThucChayDaTinhIDd ,
	          tcdt.HopDongID ,
	          tcdt.SoHopDong ,
	          tcdt.DmMaHopDongREF ,
	          tcdt.TenMaHopDong ,
	          ...
	          (CASE when (tcdt.DonViTinh = 'VIEW') 
					...
					(
						(CASE WHEN ((hdct.IsKhuyenMai=0) AND (tcdt.DonViTinh = 'VIEW')) 
							...
							THEN ISNULL([dbo].[ThucChay_GetSoLuongThucChay_Admatic_v1] (tcdt.TongViewThucChay,tcdt.TongClickThucChay,tcdt.TongSoBaiViet,tt.DonGia_Banner ,tcdt.DonViTinh,@NgayThucHien, tcdt.HopDongChiTietREF,hdct.SoLuong, hdct.DonGia, hdct.ThanhTien, hdct.ChietKhau),0)
							ELSE 0
						END
						)
					)*(100-hdct.ChietKhau)/100
					  else  tt.DonGia_Banner*ISNULL([dbo].[ThucChay_GetSoLuongThucChay_Admatic_v1] (tcdt.TongViewThucChay,tcdt.TongClickThucChay,tcdt.TongSoBaiViet,tt.DonGia_Banner ,tcdt.DonViTinh,@NgayThucHien, tcdt.HopDongChiTietREF,hdct.SoLuong, hdct.DonGia, hdct.ThanhTien, hdct.ChietKhau),0)*(100-hdct.ChietKhau)/100
				  END
	          ...
	          '' PheDuyetBy ,
	          NULL PheDuyetAt ,
	          ISNULL([dbo].[ThucChay_GetSoLuongThucChay_Admatic_v1] (tcdt.TongViewThucChay,tcdt.TongClickThucChay,tcdt.TongSoBaiViet,tt.DonGia_Banner ,tcdt.DonViTinh,@NgayThucHien, tcdt.HopDongChiTietREF,hdct.SoLuong, hdct.DonGia, hdct.ThanhTien, hdct.ChietKhau),0) SoLuongThayDoi , --SOLUONG THAY DOI
	          0 SoLuongKMThayDoi ,
	          0 GiaTriKMThayDoi ,
	          @Note + ', ThucChayDaTinhID =' + tcdt.ThucChayDaTinhID GhiChu
			...
			WHERE 1=1
			AND tcdt.ThucChayDaTinhID =  @ThucChayDaTinhID
