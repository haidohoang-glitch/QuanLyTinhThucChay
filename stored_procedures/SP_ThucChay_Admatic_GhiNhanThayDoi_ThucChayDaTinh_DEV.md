# Stored Procedure: `ThucChay_Admatic_GhiNhanThayDoi_ThucChayDaTinh_DEV`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2025-09-29 14:28:19.957000
- **Ngày sửa cuối**: 2025-10-30 10:37:49.390000
...
/*
exec [dbo].[ThucChay_Admatic_GhiNhanThayDoi_ThucChayDaTinh_dev]
	@NgayGhiNhan = '2025-10-29',
    @NgayCheckThayDoi = '2025-10-29',
	@NgayDanhSoGioiHan = '2023-10-01'
*/

CREATE PROCEDURE [dbo].[ThucChay_Admatic_GhiNhanThayDoi_ThucChayDaTinh_DEV]
	@NgayGhiNhan DATE,
...
BEGIN
	...
	, @ghiChu_Tinhlai NVARCHAR(2000) = N'Tính lại: SP tối ưu + MKT-FEE [dbo].[ThucChay_Admatic_GhiNhanThayDoi_ThucChayDaTinh] do '
	, @ghiChu_DoiTru NVARCHAR(2000) = N'Đối trừ: SP tối ưu + MKT-FEE [dbo].[ThucChay_Admatic_GhiNhanThayDoi_ThucChayDaTinh] do '
	...
	SET  temp.SoLuongThucChay_GhiNhan = IIF(temp.DonGiaSauCK <>0 , ThanhTienTC_GhiNhan/temp.DonGiaSauCK, 0),
		 ...
		 temp.ThanhTienLechTreoHa =  IIF(temp.DonGiaKM <>0 AND temp.ChietKhau = 100, temp.ThanhTienKM - ThanhTienKM_GhiNhan, (temp.ThanhTienSauCK - ThanhTienTC_GhiNhan)*100/(100-temp.ChietKhau))
	FROM #DmTinhLai temp
	...
	--SET temp.SoLuongLechTreoHa = IIF(temp.DonGiaKM <> 0, temp.ThanhTienLechTreoHa/temp.DonGiaKM, temp.ThanhTienLechTreoHa/temp.DonGiaSauCK)
		SET temp.SoLuongLechTreoHa = IIF(temp.ChietKhau = 100, (temp.SoLuongThucChay - temp.SoLuongKM_GhiNhan), (temp.SoLuongThucChay - temp.SoLuongThucChay_GhiNhan))
	FROM #DmTinhLai temp
...
SELECT	  NEWID()
		...
		, DonViTinh
		, DonGia
		, round(DonGiaTheoDonVi,0)DonGiaTheoDonVi
		, ChietKhau
		, GiamGia
		, ThanhTien
		, TiLeTuVan
