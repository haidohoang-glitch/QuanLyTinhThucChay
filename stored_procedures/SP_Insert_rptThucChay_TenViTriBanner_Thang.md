# Stored Procedure: `Insert_rptThucChay_TenViTriBanner_Thang`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-03-27 17:44:03.310000
- **Ngày sửa cuối**: 2015-03-27 17:44:03.310000
...
-- =============================================
--EXEC [dbo].[Insert_rptThucChay_ViTriBanner_Thang] '2013-01-01'
CREATE PROCEDURE [dbo].[Insert_rptThucChay_TenViTriBanner_Thang]
...
BEGIN
	...
	INSERT INTO @TeampData
			...
			rtchdn.TenNhanVien,
				...
				rtchdn.DmViTriBannerREF
	-----------------------------------UPDATE DL-----------------------------
	UPDATE  rptThucChay_TenViTriBanner_Thang 
		...
		FROM rptThucChay_TenViTriBanner_Thang rtchdt
	   ...
	   td.DmNhanVienREF = rtchdt.DmNhanVienREF
		...
		AND td.Nam = rtchdt.Nam
		-------------------------------------------------INSERT DL
	    INSERT INTO rptThucChay_TenViTriBanner_Thang
				SELECT 
				@NgayThucHien,
				td.Thang,
				td.Nam,
				td.TenViTriBanner, 
			    td.DmViTriBannerREF ,
				[dbo].[fn_GetDauKy_Of_Ngay_ViTriBanner]
				(
				  td.DmNhanVienREF,
	             td.PhongBanREF,
	             td.BoPhanREF,
