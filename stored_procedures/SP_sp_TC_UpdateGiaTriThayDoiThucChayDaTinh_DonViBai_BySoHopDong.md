# Stored Procedure: `sp_TC_UpdateGiaTriThayDoiThucChayDaTinh_DonViBai_BySoHopDong`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2021-04-15 16:13:39.693000
- **Ngày sửa cuối**: 2021-04-15 16:13:39.693000
...
-- =============================================
create  PROCEDURE [dbo].[sp_TC_UpdateGiaTriThayDoiThucChayDaTinh_DonViBai_BySoHopDong] 
                        ...
                        IF ( @SoLuongThucChayBF > 0)
                            BEGIN
                                IF ( @count_HDCT > 0 )
                                    ...
                                    EXEC  [dbo].[sp_TC_CheckHopDongCoThayDoi_DonViBai] 
                                ...
                                ELSE
                                    ...
                                    EXEC [dbo].[sp_TC_CheckHopDongXoaPhanBo_DonViBai]
