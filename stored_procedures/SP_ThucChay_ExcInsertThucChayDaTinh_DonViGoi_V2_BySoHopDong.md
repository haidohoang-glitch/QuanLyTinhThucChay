# Stored Procedure: `ThucChay_ExcInsertThucChayDaTinh_DonViGoi_V2_BySoHopDong`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2021-10-29 17:11:09.800000
- **Ngày sửa cuối**: 2023-08-22 17:03:01.010000
...
/*
exec [dbo].[ThucChay_ExcInsertThucChayDaTinh_DonViGoi_V2_BySoHopDong] 
	@StartDate = '2023-05-03',
	@EndDate = '2023-05-03',
	@SoHopDong  = 'QC5020423'
*/

CREATE PROCEDURE [dbo].[ThucChay_ExcInsertThucChayDaTinh_DonViGoi_V2_BySoHopDong] 
	@StartDate datetime,
	@EndDate datetime,
...
BEGIN
	...
	DECLARE @HopDongID INT, @HopDongChiTietID INT, @ThucChayHopDongChiTietID INT, @DmSanPhamREF INT, @TenWebsite NVARCHAR(50), @DmWebsiteREF INT, @DmBannerREF INT
		...
		WHILE @@FETCH_STATUS = 0
			BEGIN
				...
				BEGIN
					...
					--EXEC [dbo].[ThucChay_InsertThucChayDaTinh_ByHD_DonViGoi_V2_test] 
