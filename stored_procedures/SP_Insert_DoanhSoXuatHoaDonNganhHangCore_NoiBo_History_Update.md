# Stored Procedure: `Insert_DoanhSoXuatHoaDonNganhHangCore_NoiBo_History_Update`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-06-12 10:47:03.677000
- **Ngày sửa cuối**: 2015-06-12 10:47:03.677000
...
-- =============================================
CREATE PROCEDURE [dbo].[Insert_DoanhSoXuatHoaDonNganhHangCore_NoiBo_History_Update]
	-- Add the parameters for the stored procedure here
	@NgayThucHien DATETIME,
	@HopDongID_in INT,
	@HopDongChiTietID_int INT,
	@ThongTinHoaDonID_in int
AS
BEGIN
	...
	DECLARE @DmMaSoHopDong INT,@NgayXuatHoaDon DATETIME, @SoHoaDon NVARCHAR(50), @ThongTinHoaDonID INT;
	...
	FROM HopDong hd
		...
		(SELECT  tthd.HopDongREF,CONVERT(DATE,tthd.NgayXuatHoaDon) AS NgayXuatHoaDon, tthd.ThongTinHoaDonID, tthd.SoHoaDon, tthd.GiaTri
		   FROM ThongTinHoaDon tthd WHERE  tthd.DeletedStatus = 0 AND tthd.ThongTinHoaDonID = @ThongTinHoaDonID_in) A
