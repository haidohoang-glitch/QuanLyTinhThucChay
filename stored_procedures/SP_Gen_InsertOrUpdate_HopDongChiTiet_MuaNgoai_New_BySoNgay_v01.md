# Stored Procedure: `Gen_InsertOrUpdate_HopDongChiTiet_MuaNgoai_New_BySoNgay_v0.1`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2020-06-23 11:47:40.353000
- **Ngày sửa cuối**: 2021-04-19 11:10:55.480000
...
CREATE PROCEDURE [dbo].[Gen_InsertOrUpdate_HopDongChiTiet_MuaNgoai_New_BySoNgay_v0.1]
...
BEGIN
	...
	, 0 Statuss
	 ...
	 (
		...
		FROM [asd14].PMS.dbo.B_DuToan_ChiTiet ct WHERE ct.IsDeleted = 0 AND  ISNULL(ct.PhanBoId,0) <> 0
