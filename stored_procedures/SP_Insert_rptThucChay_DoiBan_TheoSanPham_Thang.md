# Stored Procedure: `Insert_rptThucChay_DoiBan_TheoSanPham_Thang`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-03-07 12:18:33.520000
- **Ngày sửa cuối**: 2015-03-07 12:18:33.520000
...
-- =============================================
CREATE PROCEDURE [dbo].[Insert_rptThucChay_DoiBan_TheoSanPham_Thang]
...
BEGIN
	...
	-- interfering with SELECT statements.
     ...
     rtchdn.DmSanPhamREF
     ----------------------------------UPDATE DL-----------------------------
     UPDATE rptThucChay_DoiBan_TheoSanPham_Thang
     SET
     ...
     FROM rptThucChay_DoiBan_TheoSanPham_Thang rtcdbt
     ...
     AND td.Nam = rtcdbt.Nam
     --------------------------------insert dl-------------------------------------
     INSERT INTO rptThucChay_DoiBan_TheoSanPham_Thang
				SELECT 
				...
				td.NhomREF,
				'',
				[dbo].[fn_GetDauKy_Of_Thang_DoiBanTheoSanPham]
				(
				  td.DmSanPhamREF,
				  td.PhongBanREF,
				  td.BoPhanREF,
