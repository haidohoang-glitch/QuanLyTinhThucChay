# Stored Procedure: `usp_InsertDmTinhTrangLamViec`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2013-08-20 16:13:15.800000
- **Ngày sửa cuối**: 2014-11-19 12:16:43.810000
...
--=============================================
-- Author:   Nhat Mai Quy
-- Stored Procedure Name: [dbo].[usp_InsertDmTinhTrangLamViec]
-- Create Date: Monday, August 19, 2013
-- Description: 
--=============================================

CREATE PROCEDURE [dbo].[usp_InsertDmTinhTrangLamViec]
...
INSERT INTO [dbo].[DmTinhTrangLamViec] (
