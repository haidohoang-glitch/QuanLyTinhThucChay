# Stored Procedure: `usp_InsertKhachHangNguoiLienHeFull`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2013-08-20 16:14:29.310000
- **Ngày sửa cuối**: 2014-11-19 12:16:44.097000
...
--=============================================
-- Author:   Nhat Mai Quy
-- Stored Procedure Name: [dbo].[usp_InsertKhachHangNguoiLienHeFull]
-- Create Date: Tuesday, August 20, 2013
-- Description: 
--=============================================

CREATE PROCEDURE [dbo].[usp_InsertKhachHangNguoiLienHeFull]
...
SET NOCOUNT ON
IF(EXISTS(SELECT * FROM dbo.KhachHangNguoiLienHeFull WHERE KhachHangNguoiLienHeID=@KhachHangNguoiLienHeID AND DeletedStatus <> 1))
...
INSERT INTO [dbo].[KhachHangNguoiLienHeFull] (
