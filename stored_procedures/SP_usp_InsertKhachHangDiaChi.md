# Stored Procedure: `usp_InsertKhachHangDiaChi`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2013-08-20 16:14:27.660000
- **Ngày sửa cuối**: 2014-11-19 12:16:43.627000
...
--=============================================
-- Author:   Nhat Mai Quy
-- Stored Procedure Name: [dbo].[usp_InsertKhachHangDiaChi]
-- Create Date: Tuesday, August 20, 2013
-- Description: 
--=============================================

CREATE PROCEDURE [dbo].[usp_InsertKhachHangDiaChi]
...
SET NOCOUNT ON
IF(EXISTS(SELECT * FROM dbo.KhachHangDiaChi WHERE KhachHangDiaChiID = @KhachHangDiaChiID AND DeletedStatus<> 1))
...
INSERT INTO [dbo].[KhachHangDiaChi] (
	[KhachHangDiaChiID],
	[KhachHangREF],
	[TruSoChinh],
	[ChiNhanh],
