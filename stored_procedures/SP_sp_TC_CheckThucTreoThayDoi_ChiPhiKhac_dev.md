# Stored Procedure: `sp_TC_CheckThucTreoThayDoi_ChiPhiKhac_dev`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2021-05-21 15:36:01.390000
- **Ngày sửa cuối**: 2021-06-03 11:03:48.810000
...
-- =============================================
-- EXEC[sp_TC_CheckThucTreoThayDoi_ChiPhiKhac_DEV] '2021-06-01','2010-01-01'
CREATE PROCEDURE [dbo].[sp_TC_CheckThucTreoThayDoi_ChiPhiKhac_DEV] 
	...
	-- Declare the return variable here
        ...
        FROM    ( SELECT    tchdctp.HopDongREF ,
                  ...
                  FROM      (SELECT * FROM dbo.ThucChayHopDongChiTiet tchdctp 
                            ...
                            INNER JOIN 
							(SELECT hdct.HopDongChiTietID, hdct.HopDongFK, hdct.DmSanPhamREF, hdct.TenSanPham, hdct.DmLoaiREF, hdct.DmLoaiBannerREF 
							FROM dbo.HopDongChiTiet hdct 
										WHERE 1=1 
										AND NOT ( hdct.DmLoaiREF = 13
												  OR hdct.DmLoaiBannerREF = 18
												)-- khong tinh mua ngoai
										AND NOT (hdct.DmLoaiREF = 42 AND hdct.DmLoaiNenTangREF = 9 AND hdct.DmSanPhamREF = 817) --INVENTORY ADMATIC , haidh comment 29/04/2021
				...
				WHERE A.HopDongChiTietREF = 614751
	...
	-- Perform the first fetch.
        ...
        WHILE @@FETCH_STATUS = 0
            BEGIN
                ...
                SET @isKhuyenMai = ( SELECT TOP (1) hdct.ChietKhau
                                     FROM   dbo.HopDongChiTiet hdct
                ...
                IF ( @isKhuyenMai <> 100 )
                    ...
                    END
					PRINT 'VAO DAY'
					PRINT @ThanhTienDaTinh
					PRINT @ThanhTienThucTreo
