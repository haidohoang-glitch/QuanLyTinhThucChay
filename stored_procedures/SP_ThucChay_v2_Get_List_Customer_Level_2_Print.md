# Stored Procedure: `ThucChay_v2_Get_List_Customer_Level_2_Print`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2014-06-04 12:02:34.410000
- **Ngày sửa cuối**: 2014-11-19 12:17:54.383000
...
-- ThucChay_v2_Get_List_Customer_Level_2_Print '2014-05-10', '2014-05-10', NULL, NULL, NULL, NULL, NULL, NULL
-- ThucChay_v2_Get_List_Customer_Level_2_Print '2014-05-10', '2014-05-10', NULL, NULL, NULL, NULL, NULL, N'''VIEW'''		
...
-- =============================================
CREATE PROCEDURE [dbo].[ThucChay_v2_Get_List_Customer_Level_2_Print]
(		
...
BEGIN
	...
	SELECT @Sql = '
					...
					FROM
					(
						SELECT B.DmKhachHangREF AS ID, B.TenKhachHang AS GroupFieldName, B.SoHopDong AS SoHopDong,							
						...
						WHERE ' + @Filter + ' 							
						GROUP BY B.DmKhachHangREF, B.TenKhachHang, B.SoHopDong, A.TenMaHopDong	
					) T1
					GROUP BY T1.ID, T1.GroupFieldName, T1.SoHopDong'					
