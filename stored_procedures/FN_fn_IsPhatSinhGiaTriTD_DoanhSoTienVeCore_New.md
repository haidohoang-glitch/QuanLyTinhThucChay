# Function: `fn_IsPhatSinhGiaTriTD_DoanhSoTienVeCore_New`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-06-12 10:46:55.623000
- **Ngày sửa cuối**: 2015-06-12 10:46:55.623000
...
CREATE FUNCTION [dbo].[fn_IsPhatSinhGiaTriTD_DoanhSoTienVeCore_New]
(
...
BEGIN
	...
	DECLARE @v_count INT
	IF (SELECT COUNT(*) FROM DoanhSoTienVeCore dsxhdc WHERE 
	dsxhdc.HopDongID = @HopDongID
	AND dsxhdc.HopDongChiTietREF = @HopDongChiTietID 
	AND dsxhdc.ThongTinTienVeREF = @ThongTinTienVeREF) > 0
