# Stored Procedure: `ThucChayKiemTra_CPM_Insert_Manual_v10`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2017-12-11 10:19:51.320000
- **Ngày sửa cuối**: 2022-12-01 18:24:33.357000
...
CREATE PROCEDURE [dbo].[ThucChayKiemTra_CPM_Insert_Manual_v10]
...
BEGIN
	...
	SELECT SoHopDong,
	       ...
	       0,
	       SUM(TongViewThucChay) AS TongViewKiemTra,
	       0,
	       SUM(TongClickThucChay) AS TongClickKiemTra,
	       0,
	       0,
	       '',
	       ''
	FROM   dbo.ThucChay
	WHERE  dbo.GetProductIDByTypeProduct(typeproduct) IN (231, 238, 339, 337, 240, 370, 598,613,732,735, 5056,680)
	       AND NgayThucHien = @NgayThucHien
		   AND CONVERT(NVARCHAR(50),DmBannerREF) NOT IN (SELECT DmBannerREF FROM dbo.ThucChayHopDongChiTiet WHERE DmHinhThucQuangCaoREF = 42 AND DeletedStatus = 0)
		  AND CreatedBy <> 'From API_Admatic'  -- PThao comment 01.12.22
	GROUP BY
	       SoHopDong,
	       NgayThucHien,
	       typeproduct
