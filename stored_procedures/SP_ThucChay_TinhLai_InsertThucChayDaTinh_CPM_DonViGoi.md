# Stored Procedure: `ThucChay_TinhLai_InsertThucChayDaTinh_CPM_DonViGoi`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2021-04-12 15:36:54.813000
- **Ngày sửa cuối**: 2021-12-23 10:13:53.017000
...
```sql
--EXEC [ThucChay_TinhLai_InsertThucChayDaTinh_CPM_DonViGoi]
-------------------------------------------------------------
CREATE PROCEDURE [dbo].[ThucChay_TinhLai_InsertThucChayDaTinh_CPM_DonViGoi] 
	...
	SELECT  NEWID() AS ThucChayDaTinhID,
		...
		(SELECT hd.HopDongID,
			...
			(SELECT * FROM dbo.HopDongChiTiet hdct 
				...
				AND hdct.DmSanPhamREF IN (339, 240, 598, 342, 5056, 733)
