# Function: `fn_GetDauKy_Of_Ngay_SanPham`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-27 17:43:34.600000
- **Ngày sửa cuối**: 2015-03-27 17:43:34.600000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Ngay_SanPham] 
(
...
BEGIN
	...
	BEGIN
		...
		(
			...
			FROM rptThucChay_SanPham_Ngay dstchdc
			WHERE 1 = 1
