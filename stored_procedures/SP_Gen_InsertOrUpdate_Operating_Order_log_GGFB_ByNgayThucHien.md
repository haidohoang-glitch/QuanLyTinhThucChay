# Stored Procedure: `Gen_InsertOrUpdate_Operating_Order_log_GGFB_ByNgayThucHien`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2025-10-24 16:15:06.813000
- **Ngày sửa cuối**: 2025-10-24 16:15:12.647000
...
```sql
CREATE PROCEDURE [dbo].[Gen_InsertOrUpdate_Operating_Order_log_GGFB_ByNgayThucHien] 	
	@FromDate DATETIME,
	@ToDate DATETIME
AS	
BEGIN
