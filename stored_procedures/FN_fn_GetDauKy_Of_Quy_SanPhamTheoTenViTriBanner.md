# Function: `fn_GetDauKy_Of_Quy_SanPhamTheoTenViTriBanner`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-27 17:43:28.910000
- **Ngày sửa cuối**: 2015-03-27 17:43:28.910000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Quy_SanPhamTheoTenViTriBanner] 
(
...
BEGIN
    ...
    SET @DateCalc = DATEADD(MONTH,-1,@QuyThucHien)
	...
	BEGIN
		...
		(
			...
			FROM rptThucChay_SanPham_TheoViTriBanner_Quy dstchdc
			WHERE 1 = 1
