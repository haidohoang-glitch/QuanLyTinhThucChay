# Function: `fn_GetDauKy_Of_Nam_NhanVienTheoSanPham`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-07 12:18:23.253000
- **Ngày sửa cuối**: 2015-03-07 12:18:23.253000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Nam_NhanVienTheoSanPham] 
(
...
BEGIN
	...
	IF @isSoluong = 0
		...
		(
			...
			FROM rptThucChay_NhanVien_TheoSanPham_Nam dstchdc
			WHERE 1 = 1
