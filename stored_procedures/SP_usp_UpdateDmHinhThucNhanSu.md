# Stored Procedure: `usp_UpdateDmHinhThucNhanSu`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2013-08-20 16:13:04.870000
- **Ngày sửa cuối**: 2014-11-19 12:16:44.170000
...
--=============================================
-- Author:   Nhat Mai Quy
-- Stored Procedure Name: [dbo].[usp_UpdateDmHinhThucNhanSu]
-- Create Date: Monday, August 19, 2013
-- Description: 
--=============================================

CREATE PROCEDURE [dbo].[usp_UpdateDmHinhThucNhanSu]
...
UPDATE [dbo].[DmHinhThucNhanSu] SET
	[MaHinhThucNhanSu] = @MaHinhThucNhanSu,
	[TenHinhThucNhanSu] = @TenHinhThucNhanSu,
	[GhiChu] = @GhiChu,
	[Active] = @Active,
