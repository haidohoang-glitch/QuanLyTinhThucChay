# Stored Procedure: `Insert_rptThucChay_NhanVien_TheoSanPham_Quy`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-03-07 12:18:46.313000
- **Ngày sửa cuối**: 2015-03-07 12:18:46.313000
...
-- =============================================
CREATE PROCEDURE [dbo].[Insert_rptThucChay_NhanVien_TheoSanPham_Quy]
...
BEGIN
    ...
    -----------------------------Du lieu phat sinh-----
	 ...
	 SELECT DISTINCT
	     ...
	     GROUP BY
		       ...
		       rtchdn.DmSanPhamREF
	---------------------------------UPDATE DL----------------------------------------
	UPDATE rptThucChay_NhanVien_TheoSanPham_Quy
	...
	FROM rptThucChay_NhanVien_TheoSanPham_Quy r
    ...
    AND td.Nam = r.Nam
	-----------------------------------------INSERT---------------------------------------
	INSERT INTO rptThucChay_NhanVien_TheoSanPham_Quy
				SELECT 
				@NgayThucHien,
				td.Quy,
				td.Nam,
	           ...
	           td.DmSanPhamREF,
	           '',
				[dbo].[fn_GetDauKy_Of_Quy_NhanVienTheoSanPham]
				(
				  td.DmNhanVienREF ,
				  td.PhongBanREF ,
				  td.BoPhanREF ,
