# Function: `fn_GetDauKy_Of_Thang_DoiBanTheoNhanVienSanPham`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-07 12:18:11.120000
- **Ngày sửa cuối**: 2015-03-07 12:18:11.120000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Thang_DoiBanTheoNhanVienSanPham] 
(
...
BEGIN
	...
	IF @isSoluong = 0
		...
		(
			...
			FROM rptThucChay_DoiBan_TheoNhanVien_SanPham_Thang dstchdc
			WHERE 1 = 1
