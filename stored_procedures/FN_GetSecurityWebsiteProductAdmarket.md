# Function: `GetSecurityWebsiteProductAdmarket`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2013-12-25 17:19:24.610000
- **Ngày sửa cuối**: 2014-10-14 10:39:35.717000
...
CREATE FUNCTION [dbo].[GetSecurityWebsiteProductAdmarket]
(
...
BEGIN
	...
	BEGIN
		...
		IF @GroupPermision <> -1		
		BEGIN
			--SET @FilterSecurity = @FilterSecurity + @ToanTu 
			...
			ELSE IF (@ListSanPhamID = '' )
				SET @FilterSecurity = @FilterSecurity + ' AND (' + @TenDangNhapColumn + ' = ' + @DauNhay + @TenDangNhap + @DauNhay + ')'
