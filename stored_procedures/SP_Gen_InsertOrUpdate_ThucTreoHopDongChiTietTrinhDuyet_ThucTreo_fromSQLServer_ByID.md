# Stored Procedure: `Gen_InsertOrUpdate_ThucTreoHopDongChiTietTrinhDuyet_ThucTreo_fromSQLServer_ByID`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2024-12-03 09:45:20.910000
- **Ngày sửa cuối**: 2024-12-24 14:27:49.657000
...
*/
CREATE PROCEDURE [dbo].[Gen_InsertOrUpdate_ThucTreoHopDongChiTietTrinhDuyet_ThucTreo_fromSQLServer_ByID] 	
	@ThucTreoID INT
As 	
BEGIN
	...
	SET @SQL +=	
		...
		WHERE tc.Id = ' + Convert(nvarchar(50),@ThucTreoID) + ' '
	...
	EXEC [dbo].[Gen_InsertOrUpdate_ThucChayHopDongChiTiet_ThucTreoChiPhi_ByThucTreoID] @ThucTreoID = @ThucTreoID
