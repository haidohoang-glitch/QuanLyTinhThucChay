# Stored Procedure: `sp_TC_UpdateGiaTriThayDoiThucChayDaTinh_DonViGoi_dev`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2021-06-30 10:08:25.013000
- **Ngày sửa cuối**: 2022-07-07 14:24:02.260000
...
*/
CREATE  PROCEDURE [dbo].[sp_TC_UpdateGiaTriThayDoiThucChayDaTinh_DonViGoi_dev] 
                ...
                SET @SoLuongThucChayBF = 0
					...
					(
						...
						(
							...
							WHERE 1=1
							AND hdct.DmSanPhamREF IN (339, 240, 598, 342, 5056,821, 5133)
							AND convert(date,hdct.LastModifiedAt) = @NgayThucHien
						)tt
						INNER JOIN 
						(
                ...
                WHILE @@FETCH_STATUS = 0
                    BEGIN
                        ...
                        WHERE   CONVERT(DATE, NgayThucHien) = @NgayThucHien
								...
								AND DmSanPhamREF IN (339, 240, 598, 342, 5056,821, 5133)--CPM va Native Ads, OnImage
