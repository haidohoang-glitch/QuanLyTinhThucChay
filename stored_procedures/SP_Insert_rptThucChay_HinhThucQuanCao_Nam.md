# Stored Procedure: `Insert_rptThucChay_HinhThucQuanCao_Nam`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-03-07 12:18:33.180000
- **Ngày sửa cuối**: 2015-03-07 12:18:33.180000
...
-- =============================================
CREATE PROCEDURE [dbo].[Insert_rptThucChay_HinhThucQuanCao_Nam]
...
BEGIN
	...
	rtchdn.DmHinhThucKhachHangREF
	-------------------------------------UPDATE DL--------------------------------
	UPDATE rptThucChay_HinhThucQuangCao_Nam
	...
	FROM rptThucChay_HinhThucQuangCao_Nam rtchtqct
	...
	AND td.Nam = rtchtqct.Nam
	-------------------------------------INSERT DL--------------------------------------
	INSERT INTO rptThucChay_HinhThucQuangCao_Nam
				SELECT 
				@NgayThucHien,
				td.Nam,
				td.TenHinhThucQuangCao,
				td.DmHinhThucQuangCaoREF,
				[dbo].[fn_GetDauKy_Of_Nam_HinhThucQuangCao]
				(
				  td.DmHinhThucQuangCaoREF,		
			      @NgayThucHien,
			      1,0
