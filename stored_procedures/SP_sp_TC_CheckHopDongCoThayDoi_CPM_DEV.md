# Stored Procedure: `sp_TC_CheckHopDongCoThayDoi_CPM_DEV`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2023-08-11 15:05:54.720000
- **Ngày sửa cuối**: 2023-08-11 15:06:14.087000
...
-- =============================================
--EXEC [sp_TC_CheckHopDongCoThayDoi_CPM_DEV] 1051392,'QC3290323',598,694330,'2023-08-10'

CREATE  PROCEDURE [dbo].[sp_TC_CheckHopDongCoThayDoi_CPM_DEV] 
...
BEGIN
	...
	BEGIN
		...
		SELECT @count_HDCT = COUNT(tcdt.HopDongChiTietREF) FROM dbo.ThucChayDaTinh tcdt
		...
		BEGIN
			...
			--EXEC dbo.[sp_TC_UpdateGiaTriTDTCCPMSanPhamByNgayLog] @NgayThucHien ,	@HopDongREF ,	@DmSanPhamREF,	@CONTENT_LOG 
		END
	END
	--ELSE
	--BEGIN
