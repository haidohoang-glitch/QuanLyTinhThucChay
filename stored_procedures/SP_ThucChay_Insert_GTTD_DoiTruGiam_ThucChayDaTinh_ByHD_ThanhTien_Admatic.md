# Stored Procedure: `ThucChay_Insert_GTTD_DoiTruGiam_ThucChayDaTinh_ByHD_ThanhTien_Admatic`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2020-06-24 14:54:51.410000
- **Ngày sửa cuối**: 2021-07-14 17:01:00.083000
...
CREATE  PROCEDURE [dbo].[ThucChay_Insert_GTTD_DoiTruGiam_ThucChayDaTinh_ByHD_ThanhTien_Admatic] 
	@FromDate DATETIME,
	@ToDate DATETIME,
	@NgayGhiNhanThucChay DATETIME,
	@HopDongID INT,
...
BEGIN
		...
		SELECT NEWID() AS ThucChayDaTinhID,
			...
			--and DmSanPhamREF = @DmSanPhamREF --haidh comment ngày 01/10/2020
