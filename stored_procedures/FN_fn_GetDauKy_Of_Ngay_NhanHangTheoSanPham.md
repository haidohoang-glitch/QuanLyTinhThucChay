# Function: `fn_GetDauKy_Of_Ngay_NhanHangTheoSanPham`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-31 11:21:02.197000
- **Ngày sửa cuối**: 2015-03-31 11:21:02.197000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Ngay_NhanHangTheoSanPham] 
(
...
BEGIN
	...
	BEGIN
		...
		(
			...
			FROM rptThucChay_NhanHang_TheoSanPham_Ngay dstchdc
			WHERE 1 = 1
