# Stored Procedure: `Insert_rptThucChay_NhanVien_TheoKhachHang_SanPham_Thang`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-03-07 12:18:45.263000
- **Ngày sửa cuối**: 2015-03-07 12:18:45.263000
...
-- =============================================
CREATE PROCEDURE [dbo].[Insert_rptThucChay_NhanVien_TheoKhachHang_SanPham_Thang]
...
BEGIN
    ...
    -----------------------------Du lieu phat sinh-----
	 ...
	 SELECT DISTINCT
	     ...
	     GROUP BY
		       ...
		       rtchdn.DmSanPhamREF
	---------------------------------UPDATE DL----------------------------------------
	UPDATE rptThucChay_NhanVien_TheoKhachHang_SanPham_Thang
	...
	FROM rptThucChay_NhanVien_TheoKhachHang_SanPham_Thang r
	...
	AND td.DmSanPhamREF = r.DmSanPhamREF
	AND td.Nam = r.Nam
	...
	AND td.Thang = r.Thang
	-----------------------------------------INSERT---------------------------------------
	INSERT INTO rptThucChay_NhanVien_TheoKhachHang_SanPham_Thang
				SELECT 
				@NgayThucHien,
				td.Thang,
				td.Nam,
	           ...
	           td.DmSanPhamREF,
	           '',
				[dbo].[fn_GetDauKy_Of_Thang_NhanVienTheoKhachHangSanPham]
				(
				  td.DmNhanVienREF ,
				  td.PhongBanREF ,
				  td.BoPhanREF ,
