# Function: `fn_GetDauKy_Of_Quy_HopDongTheoSanPhamHinhThucQuangCao`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-27 17:43:30.993000
- **Ngày sửa cuối**: 2015-03-27 17:43:30.993000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Quy_HopDongTheoSanPhamHinhThucQuangCao] 
(
...
BEGIN
	...
	IF @isSoluong = 0
		...
		(
			...
			FROM rptThucChay_HopDong_TheoHinhThucQuangCao_SanPham_Quy dstchdc
			WHERE 1 = 1
