# Stored Procedure: `sp_TC_InsertThucChayDaTinh_CoChietKhau_Mobile_TinhLai`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2017-07-05 11:45:34.857000
- **Ngày sửa cuối**: 2018-02-26 10:12:09.470000
...
CREATE PROCEDURE [dbo].[sp_TC_InsertThucChayDaTinh_CoChietKhau_Mobile_TinhLai]
                ...
                FROM    ( SELECT    NEWID() ThucChayDaTinhID ,
                                    ...
                                    ISNULL(( TD.ThanhTienThucChayTruocTrietKhau
                                             - ( TD.ThanhTienThucChayTruocTrietKhau
                                                 * TD.ChietKhau ) / 100 ), 0) AS GiaTriThayDoi ,
