# Function: `fn_GetDauKy_Of_Quy_DoiBanTheoKhachHang`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-07 12:18:16.617000
- **Ngày sửa cuối**: 2015-03-07 12:18:16.617000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Quy_DoiBanTheoKhachHang] 
(
...
BEGIN
	...
	IF @isSoluong = 0
		...
		(
			...
			FROM rptThucChay_DoiBan_TheoKhachHang_Quy dstchdc
			WHERE 1 = 1
