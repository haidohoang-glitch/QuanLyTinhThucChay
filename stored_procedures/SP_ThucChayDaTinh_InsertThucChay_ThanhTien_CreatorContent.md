# Stored Procedure: `ThucChayDaTinh_InsertThucChay_ThanhTien_CreatorContent`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2021-06-25 16:33:35.830000
- **Ngày sửa cuối**: 2023-07-13 10:08:05.720000
...
```sql
CREATE PROCEDURE [dbo].[ThucChayDaTinh_InsertThucChay_ThanhTien_CreatorContent]
...
BEGIN
	...
	SELECT HopDongID    = HD.HopDongID,         
			...
			NhanHang = ISNULL(HDCT.DanhSachNhanHangREF,'0'),				
			...
			SoLuongThucChay = (CASE WHEN (HDCT.IsKhuyenMai = 1 OR HDCT.ChietKhau = 100) THEN 0
								ELSE @SoLuongThucChay --THEO YÊU CAU CỦA BAN KS THUCCHAY #13539 20042022
			...
			ThanhTienSauTrietKhauThucChay = (CASE WHEN (HDCT.IsKhuyenMai = 1 OR HDCT.ChietKhau = 100)  THEN 0
												ELSE @ThanhTienThucChaySauCK ----THEO YÊU CAU CỦA BAN KS THUCCHAY #13539 20042022
			...
			GiaTriHoaHongThucChay = 0,         
			ThanhTienThucThu = 0,               
			ThanhTienKM = (CASE WHEN (HDCT.IsKhuyenMai = 1 OR HDCT.ChietKhau = 100)  THEN @DonGia*@SoLuongThucChay ----THEO YÊU CAU CỦA BAN KS THUCCHAY #13539 20042022
																						--[dbo].[ThucChay_ThanhTienThucChay_ThanhTien_CreatorContent](
																						--	@ThanhTienThucChaySauCK,
																						--	@DonGia*@SoLuongThucChay,
																						--	@NgayThucHien ,
												...
												ELSE 0
											END),                            
			SoLuongThucChayKM = (CASE WHEN (HDCT.IsKhuyenMai = 1 OR HDCT.ChietKhau = 100) THEN @SoLuongThucChay ----THEO YÊU CAU CỦA BAN KS THUCCHAY #13539 20042022
										--[dbo].[ThucChay_GetSoLuongThucChay_ThanhTien_CreatorContent] 
										--(
										--	-- Add the parameters for the function here
										--	@SoLuongThucChay,
