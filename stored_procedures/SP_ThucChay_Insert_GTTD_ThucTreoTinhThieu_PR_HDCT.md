# Stored Procedure: `ThucChay_Insert_GTTD_ThucTreoTinhThieu_PR_HDCT`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2022-05-16 14:49:43.743000
- **Ngày sửa cuối**: 2022-05-16 15:05:15.157000
...
CREATE PROCEDURE [dbo].[ThucChay_Insert_GTTD_ThucTreoTinhThieu_PR_HDCT]
...
AS
    BEGIN
        DECLARE @NgayGioiHanTinh DATETIME ,
			...
			, @v_ThucchayDatinhID NVARCHAR(500) = ''
       ...
       --DA THUC HIEN TINH CHUA?????????
	   IF(NOT EXISTS(SELECT Top 1 tcdt.HopDongID FROM dbo.ThucChayDaTinh tcdt 
			WHERE tcdt.HopDongChiTietREF = @HopDongChiTietID 
			AND tcdt.HopDongID = @HopDongID
			AND tcdt.DotChayBooking = @ThucChayHopDongChiTietPRID
			AND tcdt.NgayThucHien <= @NgayThucHien ORDER BY tcdt.ThucChayDaTinhID))
		BEGIN
