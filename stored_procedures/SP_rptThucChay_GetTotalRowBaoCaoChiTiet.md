# Stored Procedure: `rptThucChay_GetTotalRowBaoCaoChiTiet`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-03-27 17:43:53.010000
- **Ngày sửa cuối**: 2015-03-27 17:43:53.010000
...
--EXEC [rptThucChay_GetTotalRowBaoCaoChiTiet] '01','TenSanPham','2013-01-01','2013-01-31','','','','','','','','Phuongvtt','','','',-1,0,0,0,'',''
CREATE PROCEDURE [dbo].[rptThucChay_GetTotalRowBaoCaoChiTiet]
...
BEGIN
 ...
 --   SET @ToUserName = (SELECT ToUserName FROM MappingUser A WHERE A.FromUserName = @TenDangNhap)
    ...
    END
   SELECT 
		COUNT(T.GroupFieldID) AS MaxRecords		
	FROM
    (
       SELECT 
			GroupFieldName,
