# Function: `fn_IsPhatSinhGiaTriTD_DoanhSoXuatHoaDonCore_New`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-06-12 10:46:57.873000
- **Ngày sửa cuối**: 2015-06-12 10:46:57.873000
...
CREATE FUNCTION [dbo].[fn_IsPhatSinhGiaTriTD_DoanhSoXuatHoaDonCore_New]
(
...
BEGIN
	...
	DECLARE @v_count INT
	IF (SELECT COUNT(*) FROM DoanhSoXuatHoaDonCore dsxhdc WHERE 
	dsxhdc.HopDongID = @HopDongID
	AND dsxhdc.HopDongChiTietREF = @HopDongChiTietID 
	AND dsxhdc.ThongTinHoaDonREF = @ThongTinHoaDonREF) > 0
