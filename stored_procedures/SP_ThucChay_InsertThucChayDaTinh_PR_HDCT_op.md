# Stored Procedure: `ThucChay_InsertThucChayDaTinh_PR_HDCT_op`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2021-05-21 12:19:00.320000
- **Ngày sửa cuối**: 2021-05-24 12:14:55.127000
...
CREATE PROCEDURE [dbo].[ThucChay_InsertThucChayDaTinh_PR_HDCT_op] 
	@HopDongID INT,
...
BEGIN
	...
	DECLARE @TABLE_OP TABLE(ThucChayDaTinhID nvarchar(100), HopDongID int, HopDongChiTietID int, ThucChayHopDongChiTietID int)
	...
	INSERT INTO dbo.ThucChayDaTinh
		...
		OUTPUT inserted.ThucChayDaTinhID, inserted.HopDongID, inserted.HopDongChiTietREF, inserted.DotChayBooking into @TABLE_OP
		SELECT  NEWID() , T.*
	...
	SET @ThucChayDaTinhID_output = ISNULL((SELECT TOP (1) TC.ThucChayDaTinhID FROM @TABLE_OP TC ORDER BY TC.ThucChayDaTinhID),'')
