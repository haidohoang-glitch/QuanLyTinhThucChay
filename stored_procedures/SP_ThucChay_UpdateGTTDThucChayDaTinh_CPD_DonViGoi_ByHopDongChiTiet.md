# Stored Procedure: `ThucChay_UpdateGTTDThucChayDaTinh_CPD_DonViGoi_ByHopDongChiTiet`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2022-10-05 15:44:15.120000
- **Ngày sửa cuối**: 2022-11-23 16:01:32.397000
...
CREATE  PROCEDURE [dbo].[ThucChay_UpdateGTTDThucChayDaTinh_CPD_DonViGoi_ByHopDongChiTiet] 
...
DECLARE  @NgayDanhSo_GioiHan DATETIME
	...
	SET @TongThanhTienThucChay = ISNULL((SELECT SUM(tcdt.ThanhTienSauTrietKhauThucChay + tcdt.GiaTriThayDoi) 
									...
									AND tcdt.NgayThucHien <= @NgayGhiNhanThucChay),0)

	IF(ROUND(@TongThanhTienThucChay,0) = 0)
	BEGIN
