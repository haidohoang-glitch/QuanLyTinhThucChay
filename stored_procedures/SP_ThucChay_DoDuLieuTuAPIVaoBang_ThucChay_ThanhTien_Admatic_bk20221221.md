# Stored Procedure: `ThucChay_DoDuLieuTuAPIVaoBang_ThucChay_ThanhTien_Admatic_bk20221221`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2022-12-21 14:37:32.273000
- **Ngày sửa cuối**: 2022-12-21 14:37:32.273000
...
-- Description: 
--=============================================
--EXEC [dbo].[ThucChay_DoDuLieuTuAPIVaoBang_ThucChay_ThanhTien_Admatic] '2018-08-20', 342
create PROCEDURE [dbo].[ThucChay_DoDuLieuTuAPIVaoBang_ThucChay_ThanhTien_Admatic_bk20221221] 
		...
		IF @NgayThucHien IS NULL
            ...
            BEGIN
				...
				SELECT contract_number AS [SoHopDong]
					  ...
					  ,(CASE WHEN ISNULL(CONVERT(BIGINT,Campaign_id),0) >= @V_Campaign_id THEN CONVERT(FLOAT,ISNULL(domain_tt_money,0))/1.08
					  ...
					  ,(CASE WHEN ISNULL(CONVERT(BIGINT,Campaign_id),0) >= @V_Campaign_id THEN CONVERT(FLOAT,ISNULL(domain_tt_promotion,0))/1.08
