# Stored Procedure: `ThucChayDaTinh_MuaNgoai_InsertThucChayDaTinh`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-01-12 11:55:02.337000
- **Ngày sửa cuối**: 2018-11-01 19:39:21.230000
...
-- =============================================
/*
	EXEC [ThucChayDaTinh_MuaNgoai_InsertThucChayDaTinh] '2018-11-01', 539829
*/

CREATE PROCEDURE [dbo].[ThucChayDaTinh_MuaNgoai_InsertThucChayDaTinh] 
...
BEGIN
	...
	SET @IsMuaNgoaiChot=
	(
		SELECT COUNT(CONTRACT_DETAIL_ID) FROM dbo.ThucChayMuaNgoaiChot
	...
	BEGIN
		...
		SELECT
			...
			@donViTinhThucChay = dbo.FormatDonViTinh(tc.DonViTinhThucChayMuaNgoai)
