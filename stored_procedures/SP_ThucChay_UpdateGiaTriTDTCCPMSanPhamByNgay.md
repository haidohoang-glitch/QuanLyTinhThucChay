# Stored Procedure: `ThucChay_UpdateGiaTriTDTCCPMSanPhamByNgay`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2014-04-07 09:41:21.537000
- **Ngày sửa cuối**: 2014-11-19 12:16:56.130000
...
-- =============================================
--EXEC [ThucChay_UpdateGiaTriTDTCCPMSanPhamByNgay] '2014-05-28', 23533, 370
CREATE PROCEDURE [dbo].[ThucChay_UpdateGiaTriTDTCCPMSanPhamByNgay] 
...
BEGIN
	...
	SET @MinDate = (
	        ...
	        WHERE  tcdt.DmSanPhamREF = @DmSanPhamID
	               ...
	               AND [dbo].[CheckDonViTinhHinhThucCPDAndNotCPD](0, tcdt.DonViTinh)  = 3 --Đơn vị của hình thức CPM
	    )
