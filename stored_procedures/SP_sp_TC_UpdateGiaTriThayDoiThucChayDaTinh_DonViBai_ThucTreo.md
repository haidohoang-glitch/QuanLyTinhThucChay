# Stored Procedure: `sp_TC_UpdateGiaTriThayDoiThucChayDaTinh_DonViBai_ThucTreo`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2021-06-07 11:38:32.520000
- **Ngày sửa cuối**: 2021-06-11 09:26:45.253000
...
-- =============================================
CREATE  PROCEDURE [dbo].[sp_TC_UpdateGiaTriThayDoiThucChayDaTinh_DonViBai_ThucTreo] 
                        ...
                        IF ( @SoLuongThucChayBF > 0)
                            BEGIN
								...
								BEGIN
                                    ...
                                    EXEC [dbo].[sp_TC_CheckHopDongXoaPhanBo_DonViBai_ThucTreo]
