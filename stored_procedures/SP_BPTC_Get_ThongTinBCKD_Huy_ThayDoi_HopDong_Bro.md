# Stored Procedure: `BPTC_Get_ThongTinBCKD_Huy_ThayDoi_HopDong_Bro`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-06-11 18:17:50.963000
- **Ngày sửa cuối**: 2015-06-11 18:17:50.963000
...
-- =============================================
CREATE PROCEDURE [dbo].[BPTC_Get_ThongTinBCKD_Huy_ThayDoi_HopDong_Bro]
	@NgayBatDau DATETIME ,
...
AND Year(hd.NgayDanhSoHopDong) < YEAR(@NgayBatDau)
...
AND hd.DeletedStatus=0
AND Year(hd.NgayDanhSoHopDong) < YEAR(@NgayBatDau)
INSERT INTO [dbo].[BPTC_ThongTinBCKD_Huy_ThayDoi_HopDong_Bro]
	  (
...
WHERE A.GiaTriHopDongTD<=-500000000
