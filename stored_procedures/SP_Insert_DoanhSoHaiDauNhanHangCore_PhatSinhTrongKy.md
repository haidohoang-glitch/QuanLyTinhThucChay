# Stored Procedure: `Insert_DoanhSoHaiDauNhanHangCore_PhatSinhTrongKy`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-04-22 16:42:54.183000
- **Ngày sửa cuối**: 2015-04-22 16:42:54.183000
...
-- =============================================
--[dbo].[Insert_DoanhSoHaiDauNhanHangCore_PhatSinhTrongKy] '2014-01-01'
CREATE PROCEDURE [dbo].[Insert_DoanhSoHaiDauNhanHangCore_PhatSinhTrongKy]
					...
					BEGIN
							...
							SELECT @NgayThucHien AS NgayThucHien,
								   ...
								   --SoLuongThucThu
									...
									--SoLuongKM
									, (
										CASE WHEN @ChietKhau = 100 THEN [dbo].[fn_GetSoLuongDauKy_DoanhSoHaiDauNhanHangCore]
												(   2,
												    @NgayThucHien ,
													@HopDongID ,
													@DmNhanVienREF ,
									...
									, (
										CASE WHEN @ChietKhau = 100 THEN @ChiSoSLNhanM - [dbo].[fn_GetSoLuongDauKy_DoanhSoHaiDauNhanHangCore]
												(   2,
												    @NgayThucHien ,
													@HopDongID ,
													@DmNhanVienREF ,
									...
									, (
										CASE WHEN @ChietKhau = 100 THEN 0
											ELSE [dbo].[fn_GetSoLuongDauKy_DoanhSoHaiDauNhanHangCore]
												(   3,
												    @NgayThucHien ,
													@HopDongID ,
													@DmNhanVienREF ,
									...
									, (
										CASE WHEN @ChietKhau = 100 THEN 0
											ELSE @ChiSoSLNhanM - [dbo].[fn_GetSoLuongDauKy_DoanhSoHaiDauNhanHangCore]
												(   3,
												    @NgayThucHien ,
													@HopDongID ,
													@DmNhanVienREF ,
									...
									--ThanhTienKM
									, (
										CASE WHEN @ChietKhau = 100 THEN [dbo].[fn_GetDoanhSoDauKy_DoanhSoHaiDauNhanHangCore]
												(   2,
												    @NgayThucHien ,
													@HopDongID ,
													@DmNhanVienREF ,
									...
									, (
										CASE WHEN @ChietKhau = 100 THEN  @ChiSoSLNhanM * @DonGia -
													[dbo].[fn_GetDoanhSoDauKy_DoanhSoHaiDauNhanHangCore]
												(   2,
												    @NgayThucHien ,
													@HopDongID ,
													@DmNhanVienREF ,
									...
									, (
										CASE WHEN @ChietKhau = 100 THEN 0
											ELSE [dbo].[fn_GetDoanhSoDauKy_DoanhSoHaiDauNhanHangCore]
												(   3,
												    @NgayThucHien ,
													@HopDongID ,
													@DmNhanVienREF ,
									...
									, (
									  ...
									  , @TrangThaiHopDong	AS trangthaihd	
										...
										, 0 PrintStatus
										, 1 TypeRecordStatus 
										,@NgayDanhSo NgayDanhSo
										,@NgayKyHopDong NgayKyHD
										,@DmListNhanHangREF dmlist
										, @DmMaHopDongREF dmmahopdong
							) A
			  ...
			  BEGIN
							...
							SELECT @NgayThucHien AS NgayThucHien,
								   ...
								   --SoLuongThucThu
									...
									, (
										CASE WHEN @ChietKhau = 100 THEN  @SoLuong - [dbo].[fn_GetSoLuongDauKy_DoanhSoHaiDauNhanHangCore]
												(   2,
												    @NgayThucHien ,
													@HopDongID ,
													@DmNhanVienREF ,
									...
									, (
										CASE WHEN @ChietKhau = 100 THEN 0
											ELSE @SoLuong - [dbo].[fn_GetSoLuongDauKy_DoanhSoHaiDauNhanHangCore]
												(   3,
												    @NgayThucHien ,
													@HopDongID ,
													@DmNhanVienREF ,
									...
									, (
										CASE WHEN @ChietKhau = 100 THEN @SoLuong * @DonGia -[dbo].[fn_GetDoanhSoDauKy_DoanhSoHaiDauNhanHangCore]
												(   2,
												    @NgayThucHien ,
													@HopDongID ,
													@DmNhanVienREF ,
