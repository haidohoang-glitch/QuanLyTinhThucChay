# Stored Procedure: `Insert_rptThucChay_NhanHang_Thang`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-03-31 11:21:03.097000
- **Ngày sửa cuối**: 2015-03-31 11:21:03.097000
...
-- =============================================
CREATE PROCEDURE [dbo].[Insert_rptThucChay_NhanHang_Thang]
	...
	INSERT INTO @TeampData
			...
			GROUP BY 
			   rtchdn.TenNhanVien,
				...
				rtchdn.DmNhanHangREF
	-----------------------------------UPDATE DL-----------------------------
	UPDATE  rptThucChay_NhanHang_Thang
		SET rptThucChay_NhanHang_Thang.NgayThucHien = @NgayThucHien,
		    rptThucChay_NhanHang_Thang.ThucChayPhatSinhTrongKy += td.ThucChayPhatSinhTrongKy,
		    rptThucChay_NhanHang_Thang.ThucChayPhatSinhCuoiKy += td.ThucChayPhatSinhTrongKy,
		    rptThucChay_NhanHang_Thang.KhuyenMaiPhatSinhTrongKy += td.KhuyenMaiPhatSinhTrongKy,
		    rptThucChay_NhanHang_Thang.KhuyenMaiPhatSinhCuoiKy += td.KhuyenMaiPhatSinhTrongKy,
		    rptThucChay_NhanHang_Thang.NoiBoPhatSinhTrongKy += td.NoiBoPhatSinhTrongKy,
		    rptThucChay_NhanHang_Thang.NoiBoPhatSinhCuoiKy += td.NoiBoPhatSinhTrongKy,
		...
		FROM rptThucChay_NhanHang_Thang rtchdt
		...
		AND td.Nam = rtchdt.Nam
		-------------------------------------------------INSERT DL
	    INSERT INTO rptThucChay_NhanHang_Thang
				SELECT 
				@NgayThucHien,
				td.Thang,
				td.Nam,
