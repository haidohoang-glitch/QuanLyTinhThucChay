# Stored Procedure: `ThucChay_CheckHopDongCoThayDoi_CPDDotChay_bk20170919`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2017-09-19 09:46:51.310000
- **Ngày sửa cuối**: 2017-09-19 09:46:51.310000
...
CREATE PROCEDURE [dbo].[ThucChay_CheckHopDongCoThayDoi_CPDDotChay_bk20170919] 
...
BEGIN
	...
	IF((@TongGiaTriThucChayDaTinhHT <> @TongGiaTriThucChayDaTinh) AND (ABS(@TongGiaTriThucChayDaTinh-@ThanhTienHDCT) > 1))
	BEGIN
		SET @CountHDTD = 
		(
