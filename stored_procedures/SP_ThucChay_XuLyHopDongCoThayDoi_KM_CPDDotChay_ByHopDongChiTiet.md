# Stored Procedure: `ThucChay_XuLyHopDongCoThayDoi_KM_CPDDotChay_ByHopDongChiTiet`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2024-08-21 14:49:54.960000
- **Ngày sửa cuối**: 2024-08-21 14:49:54.960000
...
CREATE PROCEDURE [dbo].[ThucChay_XuLyHopDongCoThayDoi_KM_CPDDotChay_ByHopDongChiTiet] 
	@HopDongREF INT,	
...
BEGIN
	...
	DECLARE @soluongpbBF INT, @soluongpbHT INT, @SoLuongThucChayHT INT, @SoLuongThucChayBF INT, @SoLuongHT INT,
	@ThanhTienHDCT FLOAT, @SoHopDong NVARCHAR(50)
