# Stored Procedure: `usp_UpdateDmTrangThaiKhachHang`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2013-08-20 16:13:16.840000
- **Ngày sửa cuối**: 2014-11-19 12:16:43.780000
...
--=============================================
-- Author:   Nhat Mai Quy
-- Stored Procedure Name: [dbo].[usp_UpdateDmTrangThaiKhachHang]
-- Create Date: Monday, August 19, 2013
-- Description: 
--=============================================

CREATE PROCEDURE [dbo].[usp_UpdateDmTrangThaiKhachHang]
...
UPDATE [dbo].[DmTrangThaiKhachHang] SET
	[MaTrangThaiKhachHang] = @MaTrangThaiKhachHang,
	[TenTrangThaiKhachHang] = @TenTrangThaiKhachHang,
	[GhiChu] = @GhiChu,
	[Active] = @Active,
