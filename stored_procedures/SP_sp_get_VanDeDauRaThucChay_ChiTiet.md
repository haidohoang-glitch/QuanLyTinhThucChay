# Stored Procedure: `sp_get_VanDeDauRaThucChay_ChiTiet`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2017-08-22 15:01:14.200000
- **Ngày sửa cuối**: 2017-09-11 14:59:09.243000
...
```sql
--sp_get_VanDeDauRaThucChay_ChiTiet '07/09/2017',1,512678,503672,-1,-1,-1,1,10,10 
CREATE PROCEDURE [dbo].[sp_get_VanDeDauRaThucChay_ChiTiet]
    @NgayThucHien DATETIME = '1900-01-01' ,
    @DmNhomSanPham INT = -1 ,
	@HopDongChiTietREF INT=-1,
    @HopDongID INT = -1 ,
...
AS
	...
	SET @HopDongChiTietREF = ISNULL(@HopDongChiTietREF,-1)
        ...
        FROM    ( SELECT DISTINCT
                  ...
                  WHERE     (@NgayThucHien='1900-01-01' OR NgayThucHien = @NgayThucHien)
                            ...
                            AND @TinhTrangXuLy = CASE WHEN @TinhTrangXuLy = -1
                                                 ...
                                                 END
							AND @HopDongChiTietREF= CASE WHEN @HopDongChiTietREF = -1
                                                      THEN -1
                                                      ELSE A.HopDongChiTietREF
                                                 END
                ) A;
