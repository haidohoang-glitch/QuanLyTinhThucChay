# Function: `fn_IsPhatSinhGiaTriTD_DoanhSoXuatHoaDonNhanHangCore_New`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-06-12 10:46:58.167000
- **Ngày sửa cuối**: 2015-06-12 10:46:58.167000
...
CREATE FUNCTION [dbo].[fn_IsPhatSinhGiaTriTD_DoanhSoXuatHoaDonNhanHangCore_New]
(
...
BEGIN
	...
	DECLARE @v_count INT
	IF(SELECT COUNT(*) FROM DoanhSoXuatHoaDonNhanHangCore dsxhdnhc
	   WHERE dsxhdnhc.HopDongID = @HopDongID
		AND dsxhdnhc.HopDongChiTietREF = @HopDongChiTietID
		AND dsxhdnhc.ThongTinHoaDonREF = @ThongTinHoaDonREF) > 0
