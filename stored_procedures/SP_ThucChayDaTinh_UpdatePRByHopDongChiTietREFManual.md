# Stored Procedure: `ThucChayDaTinh_UpdatePRByHopDongChiTietREFManual`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2014-12-09 16:53:55.940000
- **Ngày sửa cuối**: 2014-12-09 16:53:55.940000
...
-- =============================================
CREATE PROCEDURE dbo.ThucChayDaTinh_UpdatePRByHopDongChiTietREFManual
...
BEGIN
	INSERT INTO thucchaydatinh
 	...
 	FROM 
 	(
 		SELECT * FROM HopDongChiTiet WHERE DmSanPhamREF in (141) 
...
SELECT 
 NEWID() ThuChay_LogNNTinhGiaTriThayDoiID,
 	...
 	DmWebsiteREF	,
 	 ...
 	 'ThucChayHopDongChiTietPR'NguonLog	,
 	 GhiChu	,
 	 'asd' CreatedBy	,
 	 getdate() CreatedAt	,
 	 'asd' LastModifiedBy	,
 	 ...
 	 0 PrintStatus	,
 	 0 RecordStatus	
FROM ThucChayDaTinh tcdt WHERE tcdt.HopDongChiTietREF = @HopDongChiTietREF
