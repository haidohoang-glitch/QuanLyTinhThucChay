# Function: `fn_GetDauKy_Of_Quy_KhachHang`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-27 17:43:30.237000
- **Ngày sửa cuối**: 2015-03-27 17:43:30.237000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Quy_KhachHang] 
(
...
BEGIN
	...
	BEGIN
		...
		(
			...
			FROM rptThucChay_KhachHang_Quy dstchdc
			WHERE 1 = 1
