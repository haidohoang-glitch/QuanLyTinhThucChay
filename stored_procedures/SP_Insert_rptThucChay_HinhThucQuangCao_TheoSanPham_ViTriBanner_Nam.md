# Stored Procedure: `Insert_rptThucChay_HinhThucQuangCao_TheoSanPham_ViTriBanner_Nam`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-03-27 17:43:49.133000
- **Ngày sửa cuối**: 2015-03-27 17:43:49.133000
...
-- =============================================
CREATE PROCEDURE [dbo].[Insert_rptThucChay_HinhThucQuangCao_TheoSanPham_ViTriBanner_Nam]
...
BEGIN
	...
	rtchdn.DmViTriBannerREF
	-------------------------------------UPDATE DL--------------------------------
	UPDATE rptThucChay_HinhThucQuangCao_TheoSanPham_ViTriBanner_Nam
	...
	FROM rptThucChay_HinhThucQuangCao_TheoSanPham_ViTriBanner_Nam rtchtqct
	...
	AND td.Nam = rtchtqct.Nam
	-------------------------------------INSERT DL--------------------------------------
	INSERT INTO rptThucChay_HinhThucQuangCao_TheoSanPham_ViTriBanner_Nam
				SELECT 
				@NgayThucHien,
				td.Nam,
