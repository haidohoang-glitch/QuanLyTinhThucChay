# Function: `fn_TC_GetThanhTienChuanThucChay_CoChietKhau_Mobile`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2017-06-23 17:55:45.550000
- **Ngày sửa cuối**: 2017-11-01 09:31:26.180000
...
CREATE FUNCTION [dbo].[fn_TC_GetThanhTienChuanThucChay_CoChietKhau_Mobile]
    (
...
AS
	...
	-- Declare the return variable here
        ...
        SET @SoLuongThucChay = dbo.[fn_TC_GetSoLuongThucChayMobile_CoChietKhau](@HopDongChiTietID,
        ...
        SET @SoLuongThucChayKM = ( CASE WHEN ( ( ( @IsKhuyenMai = 1 )
                                        ...
                                        THEN ISNULL(dbo.fn_TC_GetSoLuongThucChayKMMobile_CoChietKhau(@HopDongChiTietID,
                                                              1,
                                                              @DonGiaTheoDonVi,
                                                              @NgayThucHien,
                                                              @TongViewThucChay, 0),
