# Stored Procedure: `usp_InsertCongNo`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2013-08-20 16:13:01.790000
- **Ngày sửa cuối**: 2014-11-19 12:16:48.207000
...
--=============================================
-- Author:   Nhat Mai Quy
-- Stored Procedure Name: [dbo].[usp_InsertCongNo]
-- Create Date: Monday, August 19, 2013
-- Description: 
--=============================================

CREATE PROCEDURE [dbo].[usp_InsertCongNo]
	@CongNoID int,
	@HopDongREF int,
	@SoHoaDon int,
	@NgayXuat datetime,
...
SET NOCOUNT ON
IF(EXISTS(SELECT * FROM dbo.CongNo WHERE CongNoID = @CongNoID AND DeletedStatus <> 1))
