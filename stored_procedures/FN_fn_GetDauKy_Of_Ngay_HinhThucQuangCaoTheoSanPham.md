# Function: `fn_GetDauKy_Of_Ngay_HinhThucQuangCaoTheoSanPham`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-27 17:43:37.280000
- **Ngày sửa cuối**: 2015-03-27 17:43:37.280000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Ngay_HinhThucQuangCaoTheoSanPham] 
(
...
BEGIN
	...
	BEGIN
		...
		(
			...
			FROM rptThucChay_HinhThucQuangCao_TheoSanPham_Ngay  dstchdc
			WHERE 1 = 1
