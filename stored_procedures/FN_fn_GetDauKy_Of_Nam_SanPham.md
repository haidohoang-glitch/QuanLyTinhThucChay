# Function: `fn_GetDauKy_Of_Nam_SanPham`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-27 17:43:38.953000
- **Ngày sửa cuối**: 2015-03-27 17:43:38.953000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Nam_SanPham] 
(
...
BEGIN
	...
	BEGIN
		...
		(
			...
			FROM rptThucChay_SanPham_Nam dstchdc
			WHERE 1 = 1
