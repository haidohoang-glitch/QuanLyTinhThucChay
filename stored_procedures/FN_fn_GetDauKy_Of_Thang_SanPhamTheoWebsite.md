# Function: `fn_GetDauKy_Of_Thang_SanPhamTheoWebsite`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-27 17:43:23.360000
- **Ngày sửa cuối**: 2015-03-27 17:43:23.360000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Thang_SanPhamTheoWebsite] 
(
...
BEGIN
	...
	BEGIN
		...
		(
			...
			FROM rptThucChay_SanPham_TheoWebsite_Thang dstchdc
			WHERE 1 = 1
