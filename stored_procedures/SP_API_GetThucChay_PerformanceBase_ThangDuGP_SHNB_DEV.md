# Stored Procedure: `API_GetThucChay_PerformanceBase_ThangDuGP_SHNB_DEV`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2022-08-24 17:10:57.390000
- **Ngày sửa cuối**: 2025-06-27 15:49:40.383000
...
--[dbo].[API_GetThucChay_PerformanceBase_ThangDuGP_SHNB_DEV] N'S-NB0011122'
-- =============================================
CREATE PROCEDURE [dbo].[API_GetThucChay_PerformanceBase_ThangDuGP_SHNB_DEV] 
...
--------------------------------------------------1. Lay thuc chay do team san pham tra ve cua acc------------------------------------------
	...
	FROM dbo.[ThucChay_PerformanceBase_ViewAll_NB] tcdta1 
