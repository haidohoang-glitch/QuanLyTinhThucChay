# Stored Procedure: `sp_TC_UpdateGiaTriThayDoiThucChayDaTinh_CPM_With_DonViTinh_Ngay_dev`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2020-06-05 15:28:22.370000
- **Ngày sửa cuối**: 2021-12-07 16:52:20.517000
...
EXEC [dbo].[sp_TC_UpdateGiaTriThayDoiThucChayDaTinh_CPM_With_DonViTinh_Ngay] 
   ...
   '2020-06-11'
*/
CREATE  PROCEDURE [dbo].[sp_TC_UpdateGiaTriThayDoiThucChayDaTinh_CPM_With_DonViTinh_Ngay_dev] 
	-- Add the parameters for the stored procedure here
    @StartDate DATETIME ,
    @EndDate DATETIME
AS
    BEGIN
        ...
        WHILE @@FETCH_STATUS = 0
                ...
                IF ( @SoLuongThucChayBF > 0 )
                    BEGIN
                        IF ( @count_HDCT > 0 )
							...
							begin
									print 'sp_TC_CheckHopDongCoThayDoi_CPM_With_DonViTinh_Ngay'
          --                  EXEC [dbo].[sp_TC_CheckHopDongCoThayDoi_CPM_With_DonViTinh_Ngay] 
						...
						begin
							print 'sp_TC_UpdateGiaTriThayDoi_DoiTruToanBo_CPM_With_DonViTinh_Ngay'
