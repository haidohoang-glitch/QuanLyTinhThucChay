# Stored Procedure: `ThucChayDaTinh_TinhLai_ThanhTien_CreatorContent`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2021-06-25 16:31:45.973000
- **Ngày sửa cuối**: 2023-06-26 11:01:09.367000
...
```sql
CREATE PROCEDURE [dbo].[ThucChayDaTinh_TinhLai_ThanhTien_CreatorContent]
...
BEGIN
	...
	SELECT HopDongID    = HD.HopDongID,         
			...
			SoLuongThucChay = (CASE WHEN (HDCT.IsKhuyenMai = 1 OR HDCT.ChietKhau = 100) THEN 0
								ELSE @SoLuongThucChay --THUC HIEN GHI NHAN THEO YEU CAU #13539 CỦA BEN KS THUC CHAY NGAY 20402022
									--[dbo].[ThucChay_GetSoLuongThucChay_ThanhTien_CreatorContent] 
									--	(
			...
			ThanhTienSauTrietKhauThucChay = (CASE WHEN (HDCT.IsKhuyenMai = 1 OR HDCT.ChietKhau = 100)  THEN 0
												ELSE @ThanhTienThucChaySauCK --THUC HIEN GHI NHAN THEO YEU CAU #13539 CỦA BEN KS THUC CHAY NGAY 20402022
													--[dbo].[ThucChay_ThanhTienThucChay_ThanhTien_CreatorContent](
													--	@ThanhTienThucChaySauCK,
			...
			GiaTriHoaHongThucChay = 0,         
			ThanhTienThucThu = 0,               
			ThanhTienKM = (CASE WHEN (HDCT.IsKhuyenMai = 1 OR HDCT.ChietKhau = 100)  THEN @DonGia*@SoLuongThucChay --THUC HIEN GHI NHAN THEO YEU CAU #13539 CỦA BEN KS THUC CHAY NGAY 20402022
																					--[dbo].[ThucChay_ThanhTienThucChay_ThanhTien_CreatorContent](
																					--		@ThanhTienThucChaySauCK,
																					--		@DonGia*@SoLuongThucChay,
																					--		@NgayThucHien ,
												...
												ELSE 0
											END),                            
			SoLuongThucChayKM = (CASE WHEN (HDCT.IsKhuyenMai = 1 OR HDCT.ChietKhau = 100) THEN @SoLuongThucChay --THUC HIEN GHI NHAN THEO YEU CAU #13539 CỦA BEN KS THUC CHAY NGAY 20402022
										--[dbo].[ThucChay_GetSoLuongThucChay_ThanhTien_CreatorContent] 
										--(
										--	-- Add the parameters for the function here
										--	@SoLuongThucChay,
