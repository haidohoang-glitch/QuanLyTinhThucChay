# Stored Procedure: `sp_TC_CheckHopDongCoThayDoi_Mobile_Test`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2023-05-11 16:12:08.300000
- **Ngày sửa cuối**: 2023-05-12 14:34:12.963000
...
CREATE PROCEDURE [dbo].[sp_TC_CheckHopDongCoThayDoi_Mobile_Test] 
			...
			--NEU CO THAY DOI VE SO LUONG		
                ...
                IF @SoHopDong_new <> @SoHopDong_old
                    ...
                    BEGIN 
						...
						SET @CONTENT_LOG = @CONTENT_LOG
                            + N'thong tin'
							select @SoHopDong_new , @SoHopDong_old
								, @NgayDanhSo_new , @NgayDanhSo_old
								, @DmNhanVienREF_new , @DmNhanVienREF_old
								, @TenKhachHang_new , @TenKhachHang_old
								, @DmSanPhamREF_new , @DmSanPhamREF_old
								, @DsTenNhanHang_new , @DsTenNhanHang_old
								, @HinhThucQuangCaoREF_new , @HinhThucQuangCaoREF_old
								, @MaSoHopDong_new , @MaSoHopDong_old
								, @TenDangNhap_new , @TenDangNhap_old
                    END 
                ...
                IF @IsThayDoi = 1
                    BEGIN
						print N'EXEC [sp_TC_ThayDoiSoLuong_Mobile]'
						print @CONTENT_LOG
