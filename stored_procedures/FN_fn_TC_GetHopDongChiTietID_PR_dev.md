# Function: `fn_TC_GetHopDongChiTietID_PR_dev`

- **Loại**: SQL_TABLE_VALUED_FUNCTION
- **Ngày tạo**: 2017-06-15 17:11:50.330000
- **Ngày sửa cuối**: 2018-09-19 13:47:32.500000
...
*/
CREATE FUNCTION [dbo].[fn_TC_GetHopDongChiTietID_PR_dev]
    (
...
AS
    BEGIN
        ...
        IF NOT EXISTS ( SELECT  *
                        FROM    @ListHopDongChiTietID lhdcti WHERE lhdcti.Vitri = 1)
            BEGIN
                INSERT  INTO @ListHopDongChiTietID
