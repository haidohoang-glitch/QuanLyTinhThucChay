# Stored Procedure: `ThucChay_GetBaoCaoLechTreoHaAllSanPham`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2014-07-17 08:28:13.917000
- **Ngày sửa cuối**: 2014-11-19 12:16:58.453000
...
-- =============================================
CREATE PROCEDURE [dbo].[ThucChay_GetBaoCaoLechTreoHaAllSanPham]
	@PageIndex				INT,
	@RecordCount			INT,
	@StartDate				datetime,
	@EndDate				datetime,
...
BEGIN
	...
	SELECT 
		num AS ItemIndex,
		DmSanPhamREF, TenSanPham, dbo.FormatText(DonViTinh) AS DonViTinh,
	...
	(
		SELECT 	
			...
			CASE DonViTinh 
				WHEN 'VIEW' THEN SUM(CAST(SoLuongHopDong*1000 AS BIGINT))
				ELSE SUM(CAST(SoLuongHopDong AS BIGINT)) 
			END AS SoLuongHopDong,
