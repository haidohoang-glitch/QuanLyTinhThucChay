# Stored Procedure: `ThucChay_GetPrintSummaryBaoCaoLechTreoHa`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2013-09-12 15:20:47.463000
- **Ngày sửa cuối**: 2014-11-19 12:17:55.030000
...
-- =============================================
CREATE PROCEDURE [dbo].[ThucChay_GetPrintSummaryBaoCaoLechTreoHa]
	@StartDate DATETIME,
	@EndDate DATETIME,
...
BEGIN
	...
	BEGIN
		...
		SET @Sql = '
			...
			ORDER BY SUM(ThanhTienThucChay) DESC'
	...
	BEGIN
		...
		BEGIN
			...
			WHILE @@FETCH_STATUS = 0
			   BEGIN
	   				...
	   				SET @Sql = '
						...
						')T1
						GROUP BY T1.DmSanPhamREF, T1.TenSanPham
	   				'
	   				PRINT @Sql
			...
			ORDER BY T.ThanhTienThucChay DESC
