# Stored Procedure: `Insert_DoanhSoThucChayHopDongCore_HDOnline_NoiBo`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-03-27 17:43:43.280000
- **Ngày sửa cuối**: 2015-03-27 17:43:43.280000
...
CREATE PROCEDURE [dbo].[Insert_DoanhSoThucChayHopDongCore_HDOnline_NoiBo] 
...
BEGIN
	...
	SELECT * FROM 
	(
	SELECT tcdt.NgayThucHien, ISNULL(tcdt.DmMaHopDongREF,0) AS DmMaHopDongREF, ISNULL(tcdt.TenMaHopDong,'') AS TenMaHopDong, 0 AS HopDongID, 'MuaOnline' AS SoHopDong, '' AS TenNhanVien
