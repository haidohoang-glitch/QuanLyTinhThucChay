# Stored Procedure: `Gen_InsertOrUpdate_Operating_Result_Map_Order_Log_GGFB`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2020-08-31 10:36:46.323000
- **Ngày sửa cuối**: 2025-10-24 14:06:20.290000
...
```sql
CREATE PROCEDURE [dbo].[Gen_InsertOrUpdate_Operating_Result_Map_Order_Log_GGFB] 	
As 	
BEGIN
...
SET @NgayThucHien = 
	ISNULL((
        ...
        FROM   dbo.[ADS_Operating_Result_Map_Order_Log]  
    ),'1900-01-01')
