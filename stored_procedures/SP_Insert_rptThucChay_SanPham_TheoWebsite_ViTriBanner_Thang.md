# Stored Procedure: `Insert_rptThucChay_SanPham_TheoWebsite_ViTriBanner_Thang`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-03-27 17:44:02.820000
- **Ngày sửa cuối**: 2015-03-27 17:44:02.820000
...
-- =============================================
--EXEC [dbo].[Insert_rptThucChay_SanPham_TheoWebsite_ViTriBanner_Thang] '2013-01-01'
CREATE PROCEDURE [dbo].[Insert_rptThucChay_SanPham_TheoWebsite_ViTriBanner_Thang]
	...
	INSERT INTO @TeampData
			...
			DISTINCT
			 ...
			 GROUP BY 
				...
				rtchdn.DmViTriBannerREF
	-----------------------------------UPDATE DL-----------------------------
	UPDATE  rptThucChay_SanPham_TheoWebsite_ViTriBanner_Thang 
		...
		FROM rptThucChay_SanPham_TheoWebsite_ViTriBanner_Thang rtchdt
		...
		AND td.Nam = rtchdt.Nam
		-------------------------------------------------INSERT DL
	    INSERT INTO rptThucChay_SanPham_TheoWebsite_ViTriBanner_Thang
				SELECT 
				@NgayThucHien,
				td.Thang,
				td.Nam,
