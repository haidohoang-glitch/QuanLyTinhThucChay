# Stored Procedure: `ThucChayDaTinh_MuaNgoai_DoiTru_ThanhTien_CreatorContent_ThayDoiKQVH`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2022-01-12 10:30:28.740000
- **Ngày sửa cuối**: 2022-01-12 17:48:09.653000
...
CREATE PROCEDURE [dbo].[ThucChayDaTinh_MuaNgoai_DoiTru_ThanhTien_CreatorContent_ThayDoiKQVH]
...
BEGIN
	...
	INSERT INTO [dbo].[ThucChayDaTinh_MuaNgoai]
           ...
           ,-SUM(ISNULL([SoLuongThucChayLechTreoHa],0)) AS [SoLuongThucChayLechTreoHa]                         -- số lượng vượt phân bổ
           ,-SUM(ISNULL([ThanhTienLechTreoHa],0)) AS [ThanhTienLechTreoHa]								-- thành tiền vượt phân bổ
