# Function: `fn_GetDauKy_Of_Ngay_ChuyenMuc`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-27 17:43:37.747000
- **Ngày sửa cuối**: 2015-03-27 17:43:37.747000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Ngay_ChuyenMuc] 
(
...
BEGIN
	...
	BEGIN
		...
		(
			...
			FROM rptThucChay_ChuyenMuc_Ngay dstchdc
			WHERE 1 = 1
