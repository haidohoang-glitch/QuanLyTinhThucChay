# Stored Procedure: `usp_UpdateNhanSuTrangThietBi`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2013-08-20 16:13:23.263000
- **Ngày sửa cuối**: 2014-11-19 12:16:44.013000
...
--=============================================
-- Author:   Nhat Mai Quy
-- Stored Procedure Name: [dbo].[usp_UpdateNhanSuTrangThietBi]
-- Create Date: Monday, August 19, 2013
-- Description: 
--=============================================

CREATE PROCEDURE [dbo].[usp_UpdateNhanSuTrangThietBi]
...
UPDATE [dbo].[NhanSuTrangThietBi] SET
	[NhanSuSoYeuLyLichREF] = @NhanSuSoYeuLyLichREF,
	[DmTrangThietBiREF] = @DmTrangThietBiREF,
	[NgayCap] = @NgayCap,
