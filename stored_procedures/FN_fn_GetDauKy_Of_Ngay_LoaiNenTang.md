# Function: `fn_GetDauKy_Of_Ngay_LoaiNenTang`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-07 12:18:19.120000
- **Ngày sửa cuối**: 2015-03-07 12:18:19.120000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Ngay_LoaiNenTang] 
(
...
BEGIN
	...
	BEGIN
		...
		(
			...
			FROM rptThucChay_LoaiNenTang_Ngay dstchdc
			WHERE 1 = 1
