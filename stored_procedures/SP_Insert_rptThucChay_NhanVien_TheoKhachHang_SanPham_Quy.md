# Stored Procedure: `Insert_rptThucChay_NhanVien_TheoKhachHang_SanPham_Quy`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-03-07 12:18:45.473000
- **Ngày sửa cuối**: 2015-03-07 12:18:45.473000
...
-- =============================================
CREATE PROCEDURE [dbo].[Insert_rptThucChay_NhanVien_TheoKhachHang_SanPham_Quy]
...
BEGIN
    ...
    -----------------------------Du lieu phat sinh-----
	 ...
	 SELECT DISTINCT
	     ...
	     GROUP BY
		       ...
		       rtchdn.DmSanPhamREF
	---------------------------------UPDATE DL----------------------------------------
	UPDATE rptThucChay_NhanVien_TheoKhachHang_SanPham_Quy
	...
	FROM rptThucChay_NhanVien_TheoKhachHang_SanPham_Quy r
	...
	AND td.Quy = r.Quy
	-----------------------------------------INSERT---------------------------------------
	INSERT INTO rptThucChay_NhanVien_TheoKhachHang_SanPham_Quy
				SELECT 
				@NgayThucHien,
				td.Quy,
				td.Nam,
	           ...
	           td.DmSanPhamREF,
	           '',
				[dbo].[fn_GetDauKy_Of_Quy_NhanVienTheoKhachHangSanPham]
				(
				  td.DmNhanVienREF ,
				  td.PhongBanREF ,
				  td.BoPhanREF ,
