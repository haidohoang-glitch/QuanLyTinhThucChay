# Function: `fn_GetDauKy_Of_Nam_Website`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-27 17:43:38.270000
- **Ngày sửa cuối**: 2015-03-27 17:43:38.270000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Nam_Website] 
(
...
BEGIN
	...
	BEGIN
		...
		(
			...
			FROM rptThucChay_Website_Nam dstchdc
			WHERE 1 = 1
