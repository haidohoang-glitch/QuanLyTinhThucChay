# Stored Procedure: `Insert_rptThucChay_DoiBan_Quy`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-03-27 17:43:46.987000
- **Ngày sửa cuối**: 2015-03-27 17:43:46.987000
...
-- =============================================
CREATE PROCEDURE [dbo].[Insert_rptThucChay_DoiBan_Quy]
...
BEGIN
	...
	-- interfering with SELECT statements.
     ...
     FROM rptThucChay_DoiBan_Quy rtcdbt
    ...
    td.DmNhanVienREF = rtcdbt.DmNhanVienREF
     ...
     AND td.Nam = rtcdbt.Nam
     --------------------------------insert dl-------------------------------------
     INSERT INTO rptThucChay_DoiBan_Quy
				SELECT 
				@NgayThucHien,
				td.Quy,
				td.Nam,
