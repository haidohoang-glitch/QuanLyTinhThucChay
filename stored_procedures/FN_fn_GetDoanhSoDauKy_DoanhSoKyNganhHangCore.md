# Function: `fn_GetDoanhSoDauKy_DoanhSoKyNganhHangCore`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-04-22 16:42:51.803000
- **Ngày sửa cuối**: 2015-04-22 16:42:51.803000
...
```sql
CREATE FUNCTION [dbo].[fn_GetDoanhSoDauKy_DoanhSoKyNganhHangCore]
(
...
BEGIN
	...
	(
		...
		FROM DoanhSoKyNganhHangCore dstchdc
		WHERE 1 = 1
