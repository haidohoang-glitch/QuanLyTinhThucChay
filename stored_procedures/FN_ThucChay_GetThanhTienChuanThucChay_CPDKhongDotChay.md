# Function: `ThucChay_GetThanhTienChuanThucChay_CPDKhongDotChay`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2014-07-01 14:32:28.710000
- **Ngày sửa cuối**: 2014-10-14 10:39:29.963000
...
-- =============================================
CREATE FUNCTION [dbo].[ThucChay_GetThanhTienChuanThucChay_CPDKhongDotChay]
(
...
BEGIN
	...
	SET @DonGiaTheoDonVi = ISNULL(dbo.ThucChay_GetDonGiaChuanTheoDonViTinh_CPDKhongDotChay(@SoLuong,@DonViTinh,@DonGia,@NgayKyHopDong, @NgayThucHien, @HopDongChiTietID),0)
