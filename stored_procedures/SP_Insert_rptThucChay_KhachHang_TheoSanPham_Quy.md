# Stored Procedure: `Insert_rptThucChay_KhachHang_TheoSanPham_Quy`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-03-27 17:43:58.793000
- **Ngày sửa cuối**: 2015-03-27 17:43:58.793000
...
-- =============================================
CREATE PROCEDURE [dbo].[Insert_rptThucChay_KhachHang_TheoSanPham_Quy]
...
BEGIN
	...
	-- interfering with SELECT statements.
	 DECLARE @TeampData TABLE 
	  ...
	  rtchdn.UserName
	  ------------------------------------UPDATE dl------------------------
	  UPDATE  rptThucChay_KhachHang_TheoSanPham_Quy 
		SET rptThucChay_KhachHang_TheoSanPham_Quy.NgayThucHien = @NgayThucHien,
		    rptThucChay_KhachHang_TheoSanPham_Quy.ThucChayPhatSinhTrongKy += td.ThucChayPhatSinhTrongKy,
		    rptThucChay_KhachHang_TheoSanPham_Quy.ThucChayPhatSinhCuoiKy += td.ThucChayPhatSinhTrongKy,
		    rptThucChay_KhachHang_TheoSanPham_Quy.KhuyenMaiPhatSinhTrongKy += td.KhuyenMaiPhatSinhTrongKy,
		    rptThucChay_KhachHang_TheoSanPham_Quy.KhuyenMaiPhatSinhCuoiKy += td.KhuyenMaiPhatSinhTrongKy,
		    rptThucChay_KhachHang_TheoSanPham_Quy.NoiBoPhatSinhTrongKy += td.NoiBoPhatSinhTrongKy,
		    rptThucChay_KhachHang_TheoSanPham_Quy.NoiBoPhatSinhCuoiKy += td.NoiBoPhatSinhTrongKy,
		...
		FROM rptThucChay_KhachHang_TheoSanPham_Quy rtchdt
		...
		AND td.Nam = rtchdt.Nam
		----------------------------------INSERT dl------------------------------------
		INSERT INTO rptThucChay_KhachHang_TheoSanPham_Quy
				SELECT 
				@NgayThucHien,
				td.Quy,
				td.Nam,
