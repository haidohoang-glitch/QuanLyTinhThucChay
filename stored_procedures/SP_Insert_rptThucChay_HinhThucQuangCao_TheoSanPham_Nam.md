# Stored Procedure: `Insert_rptThucChay_HinhThucQuangCao_TheoSanPham_Nam`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-03-27 17:43:48.593000
- **Ngày sửa cuối**: 2015-03-27 17:43:48.593000
...
-- =============================================
CREATE PROCEDURE [dbo].[Insert_rptThucChay_HinhThucQuangCao_TheoSanPham_Nam]
...
BEGIN
	...
	rtchdn.DmSanPhamREF
	-------------------------------------UPDATE DL--------------------------------
	UPDATE rptThucChay_HinhThucQuangCao_TheoSanPham_Nam
	...
	FROM rptThucChay_HinhThucQuangCao_TheoSanPham_Nam rtchtqct
	...
	AND td.Nam = rtchtqct.Nam
	-------------------------------------INSERT DL--------------------------------------
	INSERT INTO rptThucChay_HinhThucQuangCao_TheoSanPham_Nam
				SELECT 
				@NgayThucHien,
				td.Nam,
