# Stored Procedure: `ThucChay_GetDistinctDataByFilterCondition`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2013-06-09 06:25:31.517000
- **Ngày sửa cuối**: 2014-10-14 10:39:54.673000
...
CREATE PROCEDURE [dbo].[ThucChay_GetDistinctDataByFilterCondition] 
...
BEGIN
	...
	Declare @DauNhay nvarchar(50),	@TableName nvarchar(50)
	Declare @SQLCommand nvarchar(4000)
	set @DauNhay = ''''
	set @TableName = 'ThucChay_ViewBizAll'
