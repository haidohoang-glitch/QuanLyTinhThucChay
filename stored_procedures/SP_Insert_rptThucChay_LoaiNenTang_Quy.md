# Stored Procedure: `Insert_rptThucChay_LoaiNenTang_Quy`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-03-07 12:18:42.520000
- **Ngày sửa cuối**: 2015-03-07 12:18:42.520000
...
-- =============================================
CREATE PROCEDURE [dbo].[Insert_rptThucChay_LoaiNenTang_Quy]
...
BEGIN
	...
	rtchdn.DmLoaiNenTangREF
	-----------------------------------UPDATE DL----------------------------
	UPDATE rptThucChay_LoaiNenTang_Quy
	SET
	...
	AND td.Nam = rpttclntt.Nam
	-------------------------------INSERT DL-------------------------------------
	INSERT INTO rptThucChay_LoaiNenTang_Quy
				SELECT 
				@NgayThucHien,
				td.Quy,
				td.Nam,
			    td.TenLoaiNenTang,
			    td.DmLoaiNenTangREF,
				[dbo].[fn_GetDauKy_Of_Quy_LoaiNenTang]
				(
				  td.DmLoaiNenTangREF,	
			      @NgayThucHien,
			      1,0
