# Function: `fn_GetDauKy_Of_Quy_HopDongTheoSanPham`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-27 17:43:31.790000
- **Ngày sửa cuối**: 2015-03-27 17:43:31.790000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Quy_HopDongTheoSanPham] 
(
...
BEGIN
	...
	IF @isSoluong = 0
		...
		(
			...
			FROM rptThucChay_HopDong_TheoSanPham_Quy dstchdc
			WHERE 1 = 1
