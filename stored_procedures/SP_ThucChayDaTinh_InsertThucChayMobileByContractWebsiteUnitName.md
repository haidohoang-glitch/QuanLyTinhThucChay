# Stored Procedure: `ThucChayDaTinh_InsertThucChayMobileByContractWebsiteUnitName`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2016-03-17 09:21:22.240000
- **Ngày sửa cuối**: 2016-03-17 09:21:22.240000
...
-- EXEC dbo.ThucChayDaTinh_InsertThucChayMobileByContractWebsiteUnitName '2014-05-10', 'CPC370613'
--
CREATE PROCEDURE [dbo].[ThucChayDaTinh_InsertThucChayMobileByContractWebsiteUnitName]
...
BEGIN
	...
	SET @v_DmWebsiteREF =
	(
		SELECT TOP 1 DmWebsiteReportingdbID FROM DmWebsiteReportingdb 
		WHERE DmWebsiteReportingdb.TenWebsite = @SiteName
	)
	SET @v_DsNhanHangREF = [dbo].[f_ReturnListConcatNhanHangREF_MobileMultilBanner] 
	(
		@ContractNo,
		@v_DmWebsiteREF,
		@NgayThucHien,
