# Stored Procedure: `Insert_rptThucChay_SanPham_TheoTenViTriBanner_Thang`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-03-27 17:44:01.927000
- **Ngày sửa cuối**: 2015-03-27 17:44:01.927000
...
-- =============================================
--EXEC [dbo].[Insert_rptThucChay_SanPham_TheoViTriBanner_Thang] '2013-01-01'
CREATE PROCEDURE [dbo].[Insert_rptThucChay_SanPham_TheoTenViTriBanner_Thang]
...
BEGIN
	...
	INSERT INTO @TeampData
			...
			GROUP BY 
				...
				rtchdn.DmViTriBannerREF
	-----------------------------------UPDATE DL-----------------------------
	UPDATE  rptThucChay_SanPham_TheoViTriBanner_Thang 
		...
		FROM rptThucChay_SanPham_TheoViTriBanner_Thang rtchdt
		...
		AND td.Nam = rtchdt.Nam
		-------------------------------------------------INSERT DL
	    INSERT INTO rptThucChay_SanPham_TheoViTriBanner_Thang
				SELECT 
				@NgayThucHien,
				td.Thang,
				td.Nam,
