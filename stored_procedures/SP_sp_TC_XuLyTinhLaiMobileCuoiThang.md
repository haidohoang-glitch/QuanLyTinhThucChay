# Stored Procedure: `sp_TC_XuLyTinhLaiMobileCuoiThang`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2017-09-13 09:33:32.783000
- **Ngày sửa cuối**: 2017-10-02 15:19:56.020000
...
CREATE PROCEDURE [dbo].[sp_TC_XuLyTinhLaiMobileCuoiThang]
	-- Add the parameters for the stored procedure here
    @StartDate DATETIME ,
    @EndDate DATETIME ,
    @pSoHopDong NVARCHAR(50) ,
	@pDmBannerID NVARCHAR(50) ,
	@pNgayThucHien DATETIME
AS
    BEGIN

		TRUNCATE TABLE dbo.ThucChayDaTinh_TinhLaiCuoiThang
	...
	--Insert vao bang HopDongChiTietAndBanner
		...
		---------------------
                ...
                INSERT  INTO @ThucChayHopDongChiTiet_Temp
                        ...
                        WHERE   hd.SoHopDong = @pSoHopDong
								AND CONVERT(NVARCHAR(50), tc.DmBannerID) = CONVERT(NVARCHAR(50), @pDmBannerID)
		...
		--Duyet tung phan bo
			...
			-- Truong hop map 1-1 
                        IF @TH = 1
                            BEGIN
                                EXEC sp_TC_ExcInsertThucChayDaTinh_Single_Mobile_TinhLaiCuoiThang @DmBannerREF,
			...
			--Tinh cho truong hop 1 banner co tren 2 HĐCT, trong do co HĐ khuyen mai
                        ELSE
                            IF @TH = 2
                                BEGIN
                                    EXEC sp_TC_ExcInsertThucChayDaTinh_CoChietKhau_Mobile_TinhLaiCuoiThang @DmBannerREF,
			...
			--Tinh cho truong hop 1 banner co tren 2 HĐCT, trong do ko co HĐ khuyen mai	
                            ELSE
                                IF @TH = 3
                                    BEGIN 
                                        EXEC sp_TC_ExcInsertThucChayDaTinh_KoChietKhau_Mobile_TinhLaiCuoiThang @DmBannerREF,
                                            @NgayThucHien, @SoHopDong,
                                            @DmWebsiteREF
                                    END
                                ELSE
		...
		------************
			...
			EXEC dbo.sp_TC_XuLyTinhLaiMobileCuoiThang_UpdateGTTDMobile @pSoHopDong , @pDmBannerID , @pNgayThucHien
