# Stored Procedure: `Admarket_ThucChayDaTinhAdmarket_NhanHang_New`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2016-03-30 10:43:27.243000
- **Ngày sửa cuối**: 2016-03-30 10:44:51.067000
...
-- =============================================
--EXEC [dbo].[Admarket_ThucChayDaTinhAdmarket_NhanHang_New] '2016-03-28','2016-03-28'
CREATE PROCEDURE [dbo].[Admarket_ThucChayDaTinhAdmarket_NhanHang_New]
...
BEGIN
    ...
    WHILE @NgayThucHien <= @EndDate
		BEGIN
	    	...
	    	EXEC dbo.Admarket_ThucChaySelfServingUsers_NhanHang_Insert_New @NgayThucHien, @NgayThucHien 
    ...
    --EXEC [dbo].[Admarket_ThucChayAdmarketCanPhanBoUpdateGiamGiaTri]
END
