# Stored Procedure: `ThucChay_InsertThucChayDaTinh_SponsorPostBySoHopDong_BK`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2014-06-18 10:02:19.130000
- **Ngày sửa cuối**: 2014-11-19 12:25:05.213000
...
-- -- =============================================
 ...
 EXEC dbo.[ThucChay_InsertThucChayDaTinh_SponsorPostBySoHopDong_BK]
 ...
 'CLICK' --@DonViTinh
 */
 CREATE PROCEDURE [dbo].[ThucChay_InsertThucChayDaTinh_SponsorPostBySoHopDong_BK]
 	...
 	BEGIN	
 		...
 		BEGIN		
 			...
 			--	PRINT 'WebsiteName :' + CONVERT(nvarchar(50),@DmWebsiteREF)
 				...
 				IF(EXISTS(SELECT tcdt.HopDongID FROM ThucChayDaTinh AS tcdt WHERE tcdt.SoHopDong = @SoHopDong 
 				AND tcdt.DmSanPhamREF = 381 AND tcdt.HopDongChiTietREF = 0))
 				...
 				BEGIN
 					...
 					ELSE -- Phuong phap san pham = 1
 						BEGIN -- BAT DAU PHUONG PHAP SAN PHAM 						
 							...
 							SET @ThanhTienThucChayTruocCK = ISNULL(dbo.ThucChay_GetThanhTienChuanThucChay(@SoLuongPhanBoHopDong,
 																											@DonViTinhPhanBo,
 																											@DonGiaPhanBo,
 																											@NgayKyHopDong,
 																											@SoLuongThucChaySP,
							...
							PRINT '---- @@DonViTinhPhanBo: ' + CONVERT(NVARCHAR(50), @DonViTinhPhanBo)
							PRINT '---- @@DonGiaPhanBo: ' + CONVERT(NVARCHAR(50), @DonGiaPhanBo)
							PRINT '---- @@NgayKyHopDong: ' + CONVERT(NVARCHAR(50), @NgayKyHopDong)
							...
							PRINT '---- @@PhanBoId: ' + CONVERT(NVARCHAR(50), @PhanBoId)
 							...
 							IF @ThanhTienThucChayHopDong < @ThanhTienHopDong 
 								BEGIN
 									...
 									SET @SoLuongThucChay = @ThanhTienThucChay/@DonGiaSauCK-- tuyetnta
 								END
 					...
 					*/
 					...
 					BEGIN
 						...
 						EXEC dbo.[ThucChayDaTinh_InsertThucChayDaTinh_SponsorBySoHopDongWebsite_BK]
 							@NgayThucHien,
 							@SoHopDong,
 							@PhanBoId,
 							'CLICK',--@DonViTinhHD,
