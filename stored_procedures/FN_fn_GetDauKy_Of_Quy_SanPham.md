# Function: `fn_GetDauKy_Of_Quy_SanPham`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-27 17:43:28.970000
- **Ngày sửa cuối**: 2015-03-27 17:43:28.970000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Quy_SanPham] 
(
...
BEGIN
	...
	BEGIN
		...
		(
			...
			FROM rptThucChay_SanPham_Quy dstchdc
			WHERE 1 = 1
