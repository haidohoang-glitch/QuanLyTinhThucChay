# Stored Procedure: `ThucChayDaTinh_InsertThucChayMobileContractByContractNo_Banner_All`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2016-06-21 17:13:43.413000
- **Ngày sửa cuối**: 2016-06-21 17:13:43.413000
...
CREATE PROCEDURE [dbo].[ThucChayDaTinh_InsertThucChayMobileContractByContractNo_Banner_All]
...
BEGIN
	...
	SET @SoLuongThucChaySP = (
		SELECT	CASE WHEN @DonViTinh = 'VIEW' THEN sum(tcm.TongViewThucChay)
					 ELSE sum(tcm.TongClickThucChay)
				END AS SoLuongThucChay
		FROM ThucChay_MobileTemp AS tcm
		WHERE tcm.NgayThucHien = @NgayThucHien 
			AND tcm.SoHopDong = @ContractNo 
			AND tcm.TenWebsite = @SiteName 
