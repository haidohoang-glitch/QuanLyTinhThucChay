# Function: `fn_GetDauKy_Of_Ngay_HopDongTheoViTriBanner`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-27 17:43:35.713000
- **Ngày sửa cuối**: 2015-03-27 17:43:35.713000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Ngay_HopDongTheoViTriBanner] 
(
...
BEGIN
	...
	IF @isSoluong = 0
		...
		(
			...
			FROM rptThucChay_HopDong_TheoViTriBanner_Ngay dstchdc
			WHERE 1 = 1
