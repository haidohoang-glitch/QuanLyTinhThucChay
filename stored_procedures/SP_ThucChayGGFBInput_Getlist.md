# Stored Procedure: `ThucChayGGFBInput_Getlist`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2017-07-31 11:15:57.913000
- **Ngày sửa cuối**: 2018-12-26 15:42:11.790000
...
```sql
--EXEC [dbo].[ThucChayGGFBInput_Getlist] 1,500,'QC2320817',0
CREATE PROCEDURE [dbo].[ThucChayGGFBInput_Getlist] 
...
AS
	...
	-- xác đinh hợp đồng nào đã đươc bình nhập tay
        ...
        SELECT  hd.NgayDanhSoHopDong ,
                ...
                A.ChenhLech ,
               -- A.ThanhTienHopDong ,
				[dbo].[fn_asd_get_giatrihopdong_ggfb](hd.HopDongID,A.DmSanPhamREF, A.DmLoaiBannerREF, A.DonViTinh) AS ThanhTienHopDong,
                [NhanHopDong] = (CASE 
        ...
        FROM    ThucChayGGFBInput AS A
                INNER JOIN dbo.HopDong hd ON A.SoHopDong = hd.SoHopDong
    ...
    -- Insert statements for procedure here
                ...
                FROM    ( SELECT    t.SoHopDong ,
                          ...
                          FROM      ( SELECT    hd.NgayDanhSoHopDong ,
                                      ...
                                      FROM      dbo.HopDong hd
                                                ...
                                                INNER JOIN dbo.DmLoaiBanner dlb ON hdct.DmLoaiBannerREF = dlb.DmLoaiBannerID
		...
		--SELECT * FROM #tempGF WHERE SoHopDong = 'QC2320817'
        PRINT ( 'doannv' );
        IF @Type = 0
            BEGIN
