# Function: `fn_GetDauKy_Of_Quy_KhachHangTheoLoaiNenTang`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-07 12:18:14.763000
- **Ngày sửa cuối**: 2015-03-07 12:18:14.763000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Quy_KhachHangTheoLoaiNenTang] 
(
...
BEGIN
	...
	IF @isSoluong = 0
		...
		(
			...
			FROM rptThucChay_KhachHang_TheoNenTang_Quy dstchdc
			WHERE 1 = 1
