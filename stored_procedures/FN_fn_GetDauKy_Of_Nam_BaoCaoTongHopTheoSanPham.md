# Function: `fn_GetDauKy_Of_Nam_BaoCaoTongHopTheoSanPham`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-21 12:58:38.300000
- **Ngày sửa cuối**: 2015-03-21 12:58:38.300000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Nam_BaoCaoTongHopTheoSanPham] 
(
...
BEGIN
	...
	IF @isSoluong = 0
		...
		(
			...
			FROM rptThucChay_BaoCaoTongHopTheoSanPham_Nam dstchdc
			WHERE 1 = 1
