# Stored Procedure: `rptThucChay_GetTotalSumBaoCaoTongHop`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-03-27 17:43:52.500000
- **Ngày sửa cuối**: 2015-03-27 17:43:52.500000
...
--EXEC [rptThucChay_GetTotalSumBaoCaoTongHop] '01','TenSanPham','2013-01-01','2013-01-31','','','','','','','','Phuongvtt','','','',-1,0,0,0,'',''
CREATE PROCEDURE [dbo].[rptThucChay_GetTotalSumBaoCaoTongHop]
...
BEGIN
 ...
 --   SET @ToUserName = (SELECT ToUserName FROM MappingUser A WHERE A.FromUserName = @TenDangNhap)
    ...
    SELECT 
		...
		SUM(T.ThanhTienThucThu + T.ThanhTienNoiBo) as ThanhTienThucChaySauChietKhau,
		SUM(T.ThanhTienThucThu - T.GiaTriThayDoiTC) AS ThanhTienThucThu,
