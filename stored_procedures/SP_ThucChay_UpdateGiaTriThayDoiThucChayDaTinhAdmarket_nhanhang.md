# Stored Procedure: `ThucChay_UpdateGiaTriThayDoiThucChayDaTinhAdmarket_nhanhang`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2016-09-26 14:00:10.160000
- **Ngày sửa cuối**: 2016-11-22 11:37:10.103000
...
-- =============================================
CREATE PROCEDURE [dbo].[ThucChay_UpdateGiaTriThayDoiThucChayDaTinhAdmarket_nhanhang] 
...
BEGIN
	...
	DECLARE @GhiChu NVARCHAR(200) ='NH_TREO_TD: ' + N'Update nhan hang chuan hoa giam'
	
	DECLARE @GhiChu_tang NVARCHAR(200) ='NH_TREO_TD: ' + N'Update nhan hang chuan hoa tang'
