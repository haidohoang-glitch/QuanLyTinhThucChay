# Stored Procedure: `Insert_rptThucChay_NhanVien_TheoKhachHang_Ngay`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-03-07 12:18:44.427000
- **Ngày sửa cuối**: 2015-03-07 12:18:44.427000
...
CREATE PROCEDURE [dbo].[Insert_rptThucChay_NhanVien_TheoKhachHang_Ngay] 
...
BEGIN
	...
	WHILE @NgayThucHien <= @ToDate
		BEGIN
			 INSERT INTO rptThucChay_NhanVien_TheoKhachHang_Ngay
			 SELECT 
				dstchdc.NgayThucHien,
				dstchdc.TenNhanVien,
				dstchdc.DmNhanVienREF,
				'' AS SoDienThoaiNhanVien,
				dstchdc.TenPhongBan,
				dstchdc.PhongBanREF,
				dstchdc.TenBoPhan,
				dstchdc.BoPhanREF,
				...
				dstchdc.DmHinhThucKhachHangREF as LoaiKhachHang,
				'' AS SoDienThoaiKhachHang,
				'' DienGiai,
			  [dbo].[fn_GetDauKy_Of_Ngay_NhanVienTheoKhachHang] 
				(
                 dstchdc.DmNhanVienREF,
                 dstchdc.PhongBanREF,
                 dstchdc.BoPhanREF,
                 dstchdc.NhomREF,
                 dstchdc.DmKhachHangREF,
                 dstchdc.DmHinhThucKhachHangREF,
			     @NgayThucHien,
			      1,0
