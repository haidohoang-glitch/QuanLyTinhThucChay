# Stored Procedure: `Rpt_InsertNhanHangThongTinChiTiet`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2014-04-22 17:42:34.433000
- **Ngày sửa cuối**: 2014-11-19 12:16:56.587000
...
CREATE  PROCEDURE [dbo].[Rpt_InsertNhanHangThongTinChiTiet] 
...
BEGIN
	...
	DELETE FROM dbo.RptNhanHangThongTinChiTiet
				...
				BEGIN
					...
					BEGIN
						...
						BEGIN
							...
							(
								SELECT distinct	(CASE WHEN khf.DmHinhThucKhachHangREF = 3 THEN N'Ð?i lý'
											ELSE N'Tr?c ti?p'
						      			 END
						      			 ) TenHinhThuc
