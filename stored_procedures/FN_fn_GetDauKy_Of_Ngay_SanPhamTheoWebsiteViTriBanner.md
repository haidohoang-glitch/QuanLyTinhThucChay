# Function: `fn_GetDauKy_Of_Ngay_SanPhamTheoWebsiteViTriBanner`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-27 17:43:33.947000
- **Ngày sửa cuối**: 2015-03-27 17:43:33.947000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Ngay_SanPhamTheoWebsiteViTriBanner] 
(
...
BEGIN
	...
	BEGIN
		...
		(
			...
			FROM rptThucChay_SanPham_TheoWebsite_ViTriBanner_Ngay dstchdc
			WHERE 1 = 1
