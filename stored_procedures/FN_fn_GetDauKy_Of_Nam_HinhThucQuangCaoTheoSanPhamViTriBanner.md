# Function: `fn_GetDauKy_Of_Nam_HinhThucQuangCaoTheoSanPhamViTriBanner`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-27 17:43:41.603000
- **Ngày sửa cuối**: 2015-03-27 17:43:41.603000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Nam_HinhThucQuangCaoTheoSanPhamViTriBanner] 
(
...
BEGIN
	...
	BEGIN
		...
		(
			...
			FROM rptThucChay_HinhThucQuangCao_TheoSanPham_ViTriBanner_Nam dstchdc
			WHERE 1 = 1
