# Stored Procedure: `Insert_rptThucChay_SanPham_TheoWebsite_Quy`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-03-27 17:44:02.467000
- **Ngày sửa cuối**: 2015-03-27 17:44:02.467000
...
-- =============================================
--EXEC [dbo].[Insert_rptThucChay_SanPham_TheoWebsite_Quy] '2013-01-01'
CREATE PROCEDURE [dbo].[Insert_rptThucChay_SanPham_TheoWebsite_Quy]
	...
	INSERT INTO @TeampData
			...
			DISTINCT
			 ...
			 GROUP BY 
				...
				rtchdn.DmWebsiteREF
	-----------------------------------UPDATE DL-----------------------------
	UPDATE  rptThucChay_SanPham_TheoWebsite_Quy 
		...
		FROM rptThucChay_SanPham_TheoWebsite_Quy rtchdt
		...
		AND td.Nam = rtchdt.Nam
		-------------------------------------------------INSERT DL
	    INSERT INTO rptThucChay_SanPham_TheoWebsite_Quy
				SELECT 
				@NgayThucHien,
				td.Quy,
				td.Nam,
