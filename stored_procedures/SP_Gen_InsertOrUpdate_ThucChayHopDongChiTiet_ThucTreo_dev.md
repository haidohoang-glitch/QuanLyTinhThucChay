# Stored Procedure: `Gen_InsertOrUpdate_ThucChayHopDongChiTiet_ThucTreo_dev`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2019-08-14 16:03:28.423000
- **Ngày sửa cuối**: 2019-08-14 16:03:28.423000
...
```sql
/*
EXEC [dbo].[Gen_InsertOrUpdate_ThucChayHopDongChiTiet_ThucTreo_dev] 
*/
CREATE PROCEDURE [dbo].[Gen_InsertOrUpdate_ThucChayHopDongChiTiet_ThucTreo_dev] 	

As 	
BEGIN
    --SELECT TOP 10 * INTO ThucChayHopDongChiTiet_dev FROM dbo.ThucChayHopDongChiTiet t
...
SET @NgayThucHien = 
	(
        ...
        FROM   dbo.ThucChayHopDongChiTiet_dev dchdct
		WHERE ISNULL(loaiThucTreo ,'') = ''
    )

SET @NgayThucHien = DATEADD(HOUR,-300,@NgayThucHien)
--SET @NgayThucHien = '2009-01-01'
PRINT @NgayThucHien
CREATE TABLE #ThucChayHopDongChiTiet_dev(
...
INSERT INTO #ThucChayHopDongChiTiet_dev
(
	...
	SELECT   tt.Id,
			 ...
			 '' LoaiThucTreo,
             0 AS [Status] 
			 FROM [192.168.23.217].ThucTreo.dbo.ThucTreo tt
			WHERE tt.Last_Modified_At >= @NgayThucHien

		UPDATE #ThucChayHopDongChiTiet_dev 
		SET    [STATUS] = 1
		FROM  #ThucChayHopDongChiTiet_dev t INNER JOIN dbo.ThucChayHopDongChiTiet_dev dc
		ON t.ThucChayHopDongChiTietID = dc.ThucChayHopDongChiTietID
	-- Update nhung row da ton ton                                      
	   UPDATE [dbo].[ThucChayHopDongChiTiet_dev]
		...
		FROM   #ThucChayHopDongChiTiet_dev A 
		WHERE  [STATUS] = 1 AND A.ThucChayHopDongChiTietID=ThucChayHopDongChiTiet_dev.ThucChayHopDongChiTietID
	-- Insert Row chua ton tai
	INSERT INTO [dbo].[ThucChayHopDongChiTiet_dev]
			  (
				[ThucChayHopDongChiTietID],
				[HopDongREF],
				[HopDongChiTietREF],
	...
	SELECT 
				...
				[dchdct].[ThanhTien] ,
				[dchdct].[LoaiThucTreo]
	FROM #ThucChayHopDongChiTiet_dev dchdct WHERE dchdct.[STATUS]=0

	DROP TABLE #ThucChayHopDongChiTiet_dev
