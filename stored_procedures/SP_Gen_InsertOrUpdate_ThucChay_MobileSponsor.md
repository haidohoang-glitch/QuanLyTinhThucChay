# Stored Procedure: `Gen_InsertOrUpdate_ThucChay_MobileSponsor`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2014-12-29 17:00:15.420000
- **Ngày sửa cuối**: 2014-12-29 17:00:15.420000
...
| `@BannerTypeName` | `nvarchar(8000)` | No |
...
```sql
CREATE PROCEDURE [dbo].[Gen_InsertOrUpdate_ThucChay_MobileSponsor]
...
BEGIN
	...
	INSERT INTO [dbo].[ThucChay_Mobiles_Sponsor]
	  (
	    [ThucChayID],
	    [SoHopDong],
