# Function: `fn_GetDauKy_Of_Quy_NhanVienTheoKhachHangSanPham`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-07 12:18:13.720000
- **Ngày sửa cuối**: 2015-03-07 12:18:13.720000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Quy_NhanVienTheoKhachHangSanPham] 
(
...
BEGIN
	...
	IF @isSoluong = 0
		...
		(
			...
			FROM rptThucChay_NhanVien_TheoKhachHang_SanPham_Quy dstchdc
			WHERE 1 = 1
