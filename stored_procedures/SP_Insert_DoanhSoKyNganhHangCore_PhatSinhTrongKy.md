# Stored Procedure: `Insert_DoanhSoKyNganhHangCore_PhatSinhTrongKy`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-04-22 16:42:52.710000
- **Ngày sửa cuối**: 2015-04-22 16:42:52.710000
...
-- =============================================
CREATE PROCEDURE [dbo].[Insert_DoanhSoKyNganhHangCore_PhatSinhTrongKy]
	...
	BEGIN
			...
			BEGIN   
				 SET @CountNhan +=1;
					...
					IF @IsHopDongNoiBo =1
					BEGIN
							--- Insert du lieu vao table DoanhSoKyNganhHangCore
							INSERT INTO DoanhSoKyNganhHangCore
							SELECT * FROM 
							(
							SELECT @NgayThucHien AS NgayThucHien,
								   ...
								   --SoLuongThucThu
									...
									--SoLuongKM
									, (
										CASE WHEN @ChietKhau = 100 THEN [dbo].[fn_GetSoLuongDauKy_DoanhSoKyNganhHangCore]
												(   2,
												    @NgayThucHien ,
													@HopDongID ,
													@DmNhanVienREF ,
									...
									, (
										CASE WHEN @ChietKhau = 100 THEN @ChiSoSLNhanM - [dbo].[fn_GetSoLuongDauKy_DoanhSoKyNganhHangCore]
												(   2,
												    @NgayThucHien ,
													@HopDongID ,
													@DmNhanVienREF ,
									...
									, (
										CASE WHEN @ChietKhau = 100 THEN 0
											ELSE [dbo].[fn_GetSoLuongDauKy_DoanhSoKyNganhHangCore]
												(   3,
												    @NgayThucHien ,
													@HopDongID ,
													@DmNhanVienREF ,
									...
									, (
										CASE WHEN @ChietKhau = 100 THEN 0
											ELSE @ChiSoSLNhanM - [dbo].[fn_GetSoLuongDauKy_DoanhSoKyNganhHangCore]
												(   3,
												    @NgayThucHien ,
													@HopDongID ,
													@DmNhanVienREF ,
									...
									--ThanhTienKM
									, (
										CASE WHEN @ChietKhau = 100 THEN [dbo].[fn_GetDoanhSoDauKy_DoanhSoKyNganhHangCore]
												(   2,
												    @NgayThucHien ,
													@HopDongID ,
													@DmNhanVienREF ,
									...
									, (
										CASE WHEN @ChietKhau = 100 THEN  @ChiSoSLNhanM * @DonGia -
													[dbo].[fn_GetDoanhSoDauKy_DoanhSoKyNganhHangCore]
												(   2,
												    @NgayThucHien ,
													@HopDongID ,
													@DmNhanVienREF ,
									...
									, (
										CASE WHEN @ChietKhau = 100 THEN 0
											ELSE [dbo].[fn_GetDoanhSoDauKy_DoanhSoKyNganhHangCore]
												(   3,
												    @NgayThucHien ,
													@HopDongID ,
													@DmNhanVienREF ,
			  ...
			  BEGIN
							...
							SELECT @NgayThucHien AS NgayThucHien,
								   ...
								   --SoLuongThucThu
									...
									, (
										CASE WHEN @ChietKhau = 100 THEN  @SoLuong - [dbo].[fn_GetSoLuongDauKy_DoanhSoKyNganhHangCore]
												(   2,
												    @NgayThucHien ,
													@HopDongID ,
													@DmNhanVienREF ,
									...
									, (
										CASE WHEN @ChietKhau = 100 THEN 0
											ELSE @SoLuong - [dbo].[fn_GetSoLuongDauKy_DoanhSoKyNganhHangCore]
												(   3,
												    @NgayThucHien ,
													@HopDongID ,
													@DmNhanVienREF ,
									...
									, (
										CASE WHEN @ChietKhau = 100 THEN  @SoLuong* @DonGia -[dbo].[fn_GetDoanhSoDauKy_DoanhSoKyNganhHangCore]
												(   2,
												    @NgayThucHien ,
													@HopDongID ,
													@DmNhanVienREF ,
