# Stored Procedure: `sp_TC_InsertThucChayDaTinh_CoChietKhau_Mobile`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2017-06-16 10:50:59.050000
- **Ngày sửa cuối**: 2019-10-08 16:03:14.160000
...
CREATE PROCEDURE [dbo].[sp_TC_InsertThucChayDaTinh_CoChietKhau_Mobile]
...
AS
        ...
        INSERT  INTO dbo.ThucChayDaTinh
                ...
                FROM    ( SELECT    NEWID() ThucChayDaTinhID ,
                                  ...
                                  , TD.ThanhTienThucChayTruocTrietKhau ,
                                    ...
                                    0 SoLuongKMThayDoi ,
                                    0 GiaTriKMThayDoi ,
                                    N'sp_TC_InsertThucChayDaTinh_CoChietKhau_Mobile' GhiChu
                          FROM      ( SELECT 
	--ID Hop Dong
                                                D.HopDongID ,
	--Thong tin ve ma so 
	...
	----Thuc chay
                                      ...
                                      FROM      (SELECT * FROM dbo.HopDongChiTiet C WHERE  C.HopDongChiTietID = @HopDongChiTietID
                                                ...
                                                INNER JOIN (SELECT * FROM dbo.HopDong D WHERE D.TrangThaiHopDong <> 3)D ON D.HopDongID = C.HopDongFK
												WHERE    1=1
                            ) TD
                        ) TC
