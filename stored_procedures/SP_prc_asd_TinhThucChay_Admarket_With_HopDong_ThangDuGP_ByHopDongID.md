# Stored Procedure: `prc_asd_TinhThucChay_Admarket_With_HopDong_ThangDuGP_ByHopDongID`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2023-01-03 10:54:15
- **Ngày sửa cuối**: 2023-01-03 10:54:21.170000
...
CREATE PROCEDURE [dbo].[prc_asd_TinhThucChay_Admarket_With_HopDong_ThangDuGP_ByHopDongID]
...
BEGIN
	...
	,tc.TienThucChayKPI
	,tc.LoaiGhiNhan --0: thuc chay điều chỉnh - chi ap dung voi Adx, Viewplus, CPC admarket, 1: thuc chay thang du giai phap - all san pham
	FROM
	(
	 SELECT  
