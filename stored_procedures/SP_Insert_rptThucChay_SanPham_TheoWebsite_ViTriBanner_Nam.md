# Stored Procedure: `Insert_rptThucChay_SanPham_TheoWebsite_ViTriBanner_Nam`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-03-27 17:44:03.097000
- **Ngày sửa cuối**: 2015-03-27 17:44:03.097000
...
-- =============================================
--EXEC [dbo].[Insert_rptThucChay_SanPham_TheoWebsite_ViTriBanner_Nam] '2013-01-01'
CREATE PROCEDURE [dbo].[Insert_rptThucChay_SanPham_TheoWebsite_ViTriBanner_Nam]
...
BEGIN
	...
	INSERT INTO @TeampData
			...
			GROUP BY 
				...
				rtchdn.DmViTriBannerREF
	-----------------------------------UPDATE DL-----------------------------
	UPDATE  rptThucChay_SanPham_TheoWebsite_ViTriBanner_Nam 
		...
		FROM rptThucChay_SanPham_TheoWebsite_ViTriBanner_Nam rtchdt
		...
		-------------------------------------------------INSERT DL
	    INSERT INTO rptThucChay_SanPham_TheoWebsite_ViTriBanner_Nam
				SELECT 
				@NgayThucHien,
				td.Nam,
			    td.DmSanPhamREF ,
