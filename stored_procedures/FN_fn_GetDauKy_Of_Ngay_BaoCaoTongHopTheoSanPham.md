# Function: `fn_GetDauKy_Of_Ngay_BaoCaoTongHopTheoSanPham`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-21 12:58:32.290000
- **Ngày sửa cuối**: 2015-03-21 12:58:32.290000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Ngay_BaoCaoTongHopTheoSanPham] 
(
...
BEGIN
	...
	IF @isSoluong = 0
		...
		(
			...
			FROM rptThucChay_BaoCaoTongHopTheoSanPham_Ngay dstchdc
			WHERE 1 = 1
