# Function: `ThucChay_GenSQLLabelCommandForQuery`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2014-04-23 17:34:11.077000
- **Ngày sửa cuối**: 2014-10-14 10:39:32.763000
...
-- =============================================
CREATE FUNCTION [dbo].[ThucChay_GenSQLLabelCommandForQuery] 
(
	@StartDate datetime,
	@EndDate datetime,
...
BEGIN
	...
	SET @FilterString =  dbo.GetThucChayLabelFilterString(
														@StartDate ,
														@EndDate ,
														@DmSanPhamREFList ,
														@DmWebsiteREFList ,
	...
	SET @Sql = '
		SELECT * FROM dbo.GetDataThucChayLabelByParams('+ @DauNhay  + CONVERT(VARCHAR(50),@StartDate) + @DauNhay + ',' + @DauNhay  + CONVERT(VARCHAR(50),@EndDate) + @DauNhay + ')'
