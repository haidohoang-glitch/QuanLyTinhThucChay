# Stored Procedure: `ThucChay_InsertThucTreoThayDoi_CPD_BK20230705`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2023-07-05 14:44:19.967000
- **Ngày sửa cuối**: 2023-07-05 14:44:19.967000
...
--EXEC [ThucChay_InsertThucTreoThayDoi_CPD]


CREATE  PROCEDURE [dbo].[ThucChay_InsertThucTreoThayDoi_CPD_BK20230705] 
	@HopDongChiTiet INT,
...
BEGIN
	...
	0 SoLuongKMThayDoi,
	0 GiaTriKMThayDoi,
	'ThucChay_InsertThucTreoThayDoi_CPD ' GhiChu	
	FROM 
	(
	SELECT 
	--ID Hop Dong
	...
	FROM 
	(
		SELECT * FROM HopDongChiTiet WHERE DmSanPhamREF in (140,228,241,564,549,5082)
