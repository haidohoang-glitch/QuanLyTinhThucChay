# Function: `fn_GetDauKy_Of_Thang_SanPhamTheoWebsiteViTriBanner`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-27 17:43:23.337000
- **Ngày sửa cuối**: 2015-03-27 17:43:23.337000
...
| `@ViTriBannerREF` | `int(4)` | No |
| `@ThangThucHien` | `datetime(8)` | No |
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Thang_SanPhamTheoWebsiteViTriBanner] 
(
...
BEGIN
    ...
    SET @DateCalc = DATEADD(MONTH,-1,@ThangThucHien)
	...
	BEGIN
		...
		(
			...
			FROM rptThucChay_SanPham_TheoWebsite_ViTriBanner_Thang dstchdc
			WHERE 1 = 1
		    ...
		    AND dstchdc.DmViTriBannerREF = @ViTriBannerREF
