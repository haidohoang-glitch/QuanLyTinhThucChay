# Function: `fn_GetDauKy_Of_Quy_NhanVien`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-27 17:43:29.173000
- **Ngày sửa cuối**: 2015-03-27 17:43:29.173000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Quy_NhanVien] 
(
...
BEGIN
	...
	BEGIN
		...
		(
			...
			FROM rptThucChay_NhanVien_Quy dstchdc
			WHERE 1 = 1
