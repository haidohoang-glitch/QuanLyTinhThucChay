# Stored Procedure: `Insert_rptThucChay_HopDong_Thang`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-03-27 17:43:46.247000
- **Ngày sửa cuối**: 2015-03-27 17:43:46.247000
...
-- =============================================
--EXEC [dbo].[Insert_rptThucChay_HopDong_Thang_NEW] '2013-01-02'
CREATE PROCEDURE [dbo].[Insert_rptThucChay_HopDong_Thang]
...
BEGIN
    ...
    -- Tổng hợp dữ liệu theo ngày
	   INSERT INTO @TeampData
		...
		UPDATE  rptThucChay_HopDong_Thang 
		SET rptThucChay_HopDong_Thang.NgayThucHien = @NgayThucHien,
		    rptThucChay_HopDong_Thang.ThucChayPhatSinhTrongKy += td.ThucChayPhatSinhTrongKy,
		    rptThucChay_HopDong_Thang.ThucChayPhatSinhCuoiKy += td.ThucChayPhatSinhTrongKy,
		    rptThucChay_HopDong_Thang.KhuyenMaiPhatSinhTrongKy += td.KhuyenMaiPhatSinhTrongKy,
		    rptThucChay_HopDong_Thang.KhuyenMaiPhatSinhCuoiKy += td.KhuyenMaiPhatSinhTrongKy,
		    rptThucChay_HopDong_Thang.NoiBoPhatSinhTrongKy += td.NoiBoPhatSinhTrongKy,
		    rptThucChay_HopDong_Thang.NoiBoPhatSinhCuoiKy += td.NoiBoPhatSinhTrongKy,
		...
		FROM rptThucChay_HopDong_Thang rtchdt
		...
		SET TrangThai = 1
		FROM @TeampData td
		INNER JOIN rptThucChay_HopDong_Thang rtchdt
		ON td.HopDongID = rtchdt.HopDongID
		AND td.DmNhanVienREF = rtchdt.DmNhanVienREF
		AND td.PhongBanREF = rtchdt.PhongBanREF
		AND td.BoPhanREF = rtchdt.BoPhanREF
		...
		AND td.Nam = rtchdt.Nam
     ------------------------------------Insert--------------------------------------------
     INSERT INTO rptThucChay_HopDong_Thang
     SELECT 
				@NgayThucHien,
				td.Thang,
				td.Nam,
				...
				'',
				[dbo].[fn_GetDauKy_Of_Ngay_HopDong] 
				(
				  td.HopDongID,
				  td.DmNhanVienREF,
				  td.PhongBanREF,
