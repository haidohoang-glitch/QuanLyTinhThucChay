# Stored Procedure: `ThucChay_ExcInsertThucChayDaTinh_DonViGoi_V2_test`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2023-05-08 14:19:00.843000
- **Ngày sửa cuối**: 2023-05-08 14:19:45.197000
...
/*
exec [dbo].[ThucChay_ExcInsertThucChayDaTinh_DonViGoi_V2_test] 
	@StartDate = '2023-05-07',
	@EndDate = '2023-05-07'
*/

CREATE PROCEDURE [dbo].[ThucChay_ExcInsertThucChayDaTinh_DonViGoi_V2_test] 
	@StartDate datetime,
	@EndDate datetime
AS
BEGIN
		...
		WHILE @@FETCH_STATUS = 0
			BEGIN
				...
				BEGIN
					...
					print @SoHopDong
					print N', @HopDongChiTietREF:' + CONVERT(NVARCHAR(100),@HopDongChiTietID) 
					print  N', @DmSanPhamREF:' + CONVERT(NVARCHAR(100),@DmSanPhamREF)
					print N', @DmWebsiteREF:' + CONVERT(NVARCHAR(100),@DmWebsiteREF)
					---LOG SP CALL
