# Stored Procedure: `ThucChay_DoDuLieuTuAPIVaoBang_ThucChay_ThanhTien_Admatic_Dev`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2025-09-26 14:10:41.537000
- **Ngày sửa cuối**: 2025-09-26 16:43:03.027000
...
--EXEC [dbo].[ThucChay_DoDuLieuTuAPIVaoBang_ThucChay_ThanhTien_Admatic_Dev] '2025-09-24', 817
CREATE PROCEDURE [dbo].[ThucChay_DoDuLieuTuAPIVaoBang_ThucChay_ThanhTien_Admatic_Dev] 
...
BEGIN
		...
		IF @NgayThucHien IS NULL
            ...
            IF NOT EXISTS ( SELECT TOP (1) DmSanPhamREF
                            FROM    dbo.[ThucChay_ThanhTien_Admatic_dev]
            ...
            BEGIN
                    ...
                    INSERT  INTO dbo.[ThucChay_ThanhTien_Admatic_dev]
                    (
                        SoHopDong,
                        TypeProduct,
                        DmSanPhamREF,
