# Function: `fn_GetDauKy_Of_Ngay_DoiBanTheoKhachHang`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-07 12:18:21.407000
- **Ngày sửa cuối**: 2015-03-07 12:18:21.407000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Ngay_DoiBanTheoKhachHang] 
(
...
BEGIN
    ...
    SET @DateCalc = DATEADD(DD,-1,@NgayThucHien)
	...
	IF @isSoluong = 0
		...
		(
			...
			FROM rptThucChay_DoiBan_TheoKhachHang_Ngay dstchdc
			WHERE 1 = 1
