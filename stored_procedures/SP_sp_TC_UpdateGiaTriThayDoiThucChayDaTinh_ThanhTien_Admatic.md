# Stored Procedure: `sp_TC_UpdateGiaTriThayDoiThucChayDaTinh_ThanhTien_Admatic`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2020-06-23 10:53:48.450000
- **Ngày sửa cuối**: 2024-10-07 15:45:32.933000
...
-- =============================================
CREATE  PROCEDURE [dbo].[sp_TC_UpdateGiaTriThayDoiThucChayDaTinh_ThanhTien_Admatic] 
...
AS
    BEGIN
		...
		SET @NgayDanhSoGioiHan = DATEADD(yyyy,-3,GETDATE()) --HAIDH COMMENT LUI LAI 3 NAM
                ...
                FOR
                    ...
                    FROM    dbo.HopDong hd
							...
							(
								...
								WHERE 1=1 AND hdcttd.DmSanPhamREF IN (231,238,339,240,598,613,370,680, 733,735,821,342,585,5133,5056,5268)
								AND NOT ( hdcttd.DmLoaiBannerREF IN (17,18) OR hdcttd.DmLoaiREF IN (13))
								AND  hdcttd.DmLoaiREF = 42
								AND hdcttd.DonViTinh <> N'BÀI'
