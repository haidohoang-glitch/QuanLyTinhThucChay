# Stored Procedure: `sp_ThucChayDaTinh_ReInsertByHopDong_NhanHang_xulynhan`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2016-10-10 16:18:50.663000
- **Ngày sửa cuối**: 2016-10-20 16:18:39.983000
...
CREATE PROCEDURE [dbo].[sp_ThucChayDaTinh_ReInsertByHopDong_NhanHang_xulynhan]
...
BEGIN
	...
	DELETE FROM ThucChayDaTinh_ThayDoi_xulynhan WHERE  HopDongChiTietREF IN (97964)
	...
	/*
		...
		*/
		SELECT HopDongFK, HopDongChiTietID FROM dbo.HopDongChiTiet WHERE HopDongChiTietID IN (97964)
