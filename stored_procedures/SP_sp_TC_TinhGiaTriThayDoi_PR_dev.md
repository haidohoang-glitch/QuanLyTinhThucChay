# Stored Procedure: `sp_TC_TinhGiaTriThayDoi_PR_dev`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2018-10-31 16:17:15.267000
- **Ngày sửa cuối**: 2018-10-31 17:30:59.547000
...
-- =============================================
/*
EXEC [dbo].[sp_TC_TinhGiaTriThayDoi_PR_dev]    '2018-10-30','2016-01-01'
*/

CREATE PROCEDURE [dbo].[sp_TC_TinhGiaTriThayDoi_PR_dev] 
...
AS
    BEGIN
        ...
        FROM    ( SELECT    tchdctp.HopDongREF ,
				...
				WHERE A.ThucChayHopDongChiTietPRID IN (114101,114106,114107)
                                        ...
                                        ELSE
                                            BEGIN
                                                IF ( ( @GiaTien_Bf <> @GiaTien )
												   ...
												   BEGIN
														SET @LoaiThayDoi = 1; 
														SET @TaiSao = N'PR: Thay đổi thông tin Đơn giá hoặc chiết khấu'
												   END
