# Function: `fn_GetDauKy_Of_Thang_HopDongTheoSanPhamHinhThucQuangCao`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-27 17:43:25.597000
- **Ngày sửa cuối**: 2015-03-27 17:43:25.597000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Thang_HopDongTheoSanPhamHinhThucQuangCao] 
(
...
BEGIN
	...
	IF @isSoluong = 0
		...
		(
			...
			FROM rptThucChay_HopDong_TheoHinhThucQuangCao_SanPham_Thang dstchdc
			WHERE 1 = 1
