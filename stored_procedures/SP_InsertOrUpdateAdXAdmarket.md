# Stored Procedure: `InsertOrUpdateAdXAdmarket`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2014-07-30 14:54:00.180000
- **Ngày sửa cuối**: 2014-11-19 12:16:58.087000
...
```sql
CREATE PROCEDURE [dbo].[InsertOrUpdateAdXAdmarket] (
...
BEGIN
	...
	END	
		...
		INSERT INTO dbo.ThucChayDaTinhAdX
		  (
			ThucChayDaTinhID,
			HopDongID,
			SoHopDong,
