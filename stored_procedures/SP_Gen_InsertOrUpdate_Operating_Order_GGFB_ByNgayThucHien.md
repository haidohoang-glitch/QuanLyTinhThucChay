# Stored Procedure: `Gen_InsertOrUpdate_Operating_Order_GGFB_ByNgayThucHien`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2025-10-24 16:13:13.907000
- **Ngày sửa cuối**: 2025-10-24 16:13:23.090000
...
```sql
CREATE PROCEDURE [dbo].[Gen_InsertOrUpdate_Operating_Order_GGFB_ByNgayThucHien] 	
	@FromDate DATETIME,
	@ToDate DATETIME
AS	
BEGIN
