# Function: `fn_GetDauKy_Of_Ngay_DoiBanTheoNhanVien`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-07 12:18:21.193000
- **Ngày sửa cuối**: 2015-03-07 12:18:21.193000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Ngay_DoiBanTheoNhanVien] 
(
...
BEGIN
	...
	IF @isSoluong = 0
		...
		(
			...
			FROM rptThucChay_DoiBan_TheoNhanVien_Ngay dstchdc
			WHERE 1 = 1
