# Stored Procedure: `ThucChay_UpdateGiaTriTDTCCPMThucTreoByNgay`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2014-04-07 09:40:50.020000
- **Ngày sửa cuối**: 2017-05-16 17:26:37.440000
...
-- =============================================
--EXEC [dbo].[ThucChay_UpdateGiaTriTDTCCPMThucTreoByNgay] '2015-05-14',29906,339,66960
CREATE PROCEDURE [dbo].[ThucChay_UpdateGiaTriTDTCCPMThucTreoByNgay] 
...
BEGIN
	...
	DECLARE @count_HDCT              INT,
	        ...
	        @IsHDFinish				 INT,
			@DanhSachNhanHangTreo	NVARCHAR(200)
	...
	SELECT @DanhSachNhanHangTreo = COALESCE(@DanhSachNhanHangTreo + N', ', N'') + A.DmNhanHangREF 
	FROM 
	...
	SET @DanhSachNhanHangTreo = ISNULL(@DanhSachNhanHangTreo,'')
	...
	BEGIN
	    ...
	    BEGIN
			...
			BEGIN
				...
				SET @SoLuongThucChayDuocTinh = @SoLuongHopDong
	        ...
	        BEGIN
	            ...
	            FROM   (
	                       ...
	                       WHERE  (
	                              ...
	                              AND C.DmSanPhamREF IN (231, 238, 339, 342, 337, 240, 370,598,613,732)
	                   ) TD
