# Stored Procedure: `sp_TC_TinhGiaTriThayDoi_PR`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2017-06-12 16:00:23.347000
- **Ngày sửa cuối**: 2021-05-26 17:16:09.120000
...
-- =============================================
-- EXEC [dbo].[sp_TC_TinhGiaTriThayDoi_PR]    '2017-10-09','2017-10-09'

-- SELECT * FROM dbo.HopDong WHERE SoHopDong = 'QC2130517'
CREATE PROCEDURE [dbo].[sp_TC_TinhGiaTriThayDoi_PR] 
...
AS
    BEGIN
        ...
        DECLARE @NgayDanhSoHopDong DATETIME ,@SysNhanVienREF INT ,@DmMaHopDongREF INT ,@TenDangNhap NVARCHAR(25) ,@DmKhachHangREF INT;
        DECLARE @TenKhachHang NVARCHAR(255);
        DECLARE @TrangThaiHopDong INT
        DECLARE @DeletedStatusHDCT INT
		DECLARE @NgayDanhSoGioiHan DATETIME = '2019-01-01'
		DECLARE @NgayDSGioiTrenHanTinh DATETIME = '2019-12-31'
        ...
        SET @ThoiGianBatDauCheck = '2018-01-01';
        ...
        FROM    ( SELECT    tchdctp.HopDongREF ,
                  ...
                  FROM      dbo.ThucChayHopDongChiTietPR tchdctp
							...
							(SELECT * FROM dbo.HopDong hd 
								...
								AND hd.NgayDanhSoHopDong BETWEEN @NgayDanhSoGioiHan AND @NgayDSGioiTrenHanTinh ---LOAI CAC HOP DONG DUOC DANH SO TU NAM 2015 TRO VE TRUOC
							 )hd ON hd.HopDongID = tchdctp.HopDongREF
                            INNER JOIN dbo.HopDongChiTiet hdct ON tctthdctip.HopDongChiTietID = hdct.HopDongChiTietID
				...
				--WHERE (A.HopDongREF <> 1010653 AND A.DmSanPhamREF <> 141)--Tam thoi loai truong hop HD 7 ty ra khoi viec check gia tri thay doi
                    ...
                    ELSE
                        ...
                        ELSE
                            BEGIN
                                ...
                                IF ( @LoaiThayDoi = 1 )
                                    BEGIN
										--CHO NAY XEM LAI TRUOC KHI TINH HAIDH COMMENT 2018-01-18
