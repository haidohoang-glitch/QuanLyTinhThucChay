# Stored Procedure: `ThucChay_ReInsertThucChayDaTinhCPM_With_DonViTinh_Ngay_ByHopDongChiTiet_AndNgay`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2018-06-29 10:27:24.123000
- **Ngày sửa cuối**: 2018-10-26 15:17:29.153000
...
EXEC [dbo].[ThucChay_ReInsertThucChayDaTinhCPM_With_DonViTinh_Ngay_ByHopDongChiTiet_AndNgay] 
				@FromDate = '2018-10-16' ,
				@ToDate =  '2018-10-19',
				@pSoHopDong = 'QC4141018',
				@pHopDongChiTietID = 538444,
				@DmSanPhamREF = 342,
				@NgayThucHienGhiNhan = '2018-10-25'
*/
CREATE PROCEDURE [dbo].[ThucChay_ReInsertThucChayDaTinhCPM_With_DonViTinh_Ngay_ByHopDongChiTiet_AndNgay] 
	@FromDate DATETIME,
	@ToDate DATETIME,
...
BEGIN
	...
	BEGIN
			...
			(
				...
				(SELECT hd.SoHopDong, hd.HopDongID, hdct.HopDongChiTietID
					...
					(
						...
						AND hdct.DonViTinhREF = 3 --DON VI TINH LA NGAY
		...
		DECLARE Record_Cursor_hd CURSOR FOR 
		...
		OPEN Record_Cursor_hd

		-- Perform the first fetch.
		FETCH NEXT FROM Record_Cursor_hd INTO @SoHopDong, @HopDongID, @HopDongChiTietID, @TypeProduct, @DmWebsiteREF
		...
		CLOSE Record_Cursor_hd
		DEALLOCATE Record_Cursor_hd
