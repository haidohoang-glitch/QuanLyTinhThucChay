# Stored Procedure: `ThucChayDaTinh_ExcReInsertThucChayDaTinhGG_FB_Online_ByAccount`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-04-22 14:01:41.273000
- **Ngày sửa cuối**: 2015-04-24 15:47:00.133000
...
/*
	EXEC dbo.ThucChayDaTinh_ExcReInsertThucChayDaTinhGG_FB_ByAccount 
		...
		423
*/
CREATE PROCEDURE [dbo].[ThucChayDaTinh_ExcReInsertThucChayDaTinhGG_FB_Online_ByAccount]
...
BEGIN
	...
	BEGIN
		...
		SELECT 
			...
			0 RecordStatus,
			DeletedStatus
		FROM ThucChayGoogleFacebookOnline A
		WHERE 1 = 1 
