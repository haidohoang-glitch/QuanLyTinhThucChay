# Stored Procedure: `ThucChay_DoiTruVaTinhLai_ThanhTien_GGFB_GhiChu`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2021-06-10 10:59:36.103000
- **Ngày sửa cuối**: 2022-04-06 15:06:18.063000
...
CREATE PROCEDURE [dbo].[ThucChay_DoiTruVaTinhLai_ThanhTien_GGFB_GhiChu] 
	@pSoHopDong NVARCHAR(100),
	@pHopDongChiTietID INT,
	@pDmSanPhamREF INT,
	@NgayThucHien DATETIME,
...
BEGIN
	...
	SET @GhiChu_DoiTruThucChay = @GhiChu +  N', Doi tru thuc chay thanhtien_GGFB cho SoHopDong: ' + @SoHopDong
	SET @Ghichu_TinhLaiThucChay = @GhiChu + N', Tinh lai thuc chay thanhtien_GGFB cho SoHopDong: ' + @SoHopDong
	...
	AND (DmSanPhamREF in (306,423,5188) OR DmViTriREF in (100093,100478,100774) )
	) hd
	...
	BEGIN
		...
		BEGIN
			...
			EXEC [dbo].[ThucChayDaTinh_InsertThucChay_GTTD_ThanhTien_GGFB]
		...
		ELSE
			...
			BEGIN
				...
				--1. INSERT VAO ThucChayDaTinh
				EXEC [dbo].[ThucChayDaTinh_InsertThucChaySanLuongChot_GTTD_ThanhTien_GGFB]
						@NgayThucHien						= @NgayThucHien,
				...
				BEGIN
					...
					ISNULL(( 
						 SELECT SUM(ISNULL(RS.Total_Money_VND,0)) --TONG TIEN MUA SAU CHIET KHAU
