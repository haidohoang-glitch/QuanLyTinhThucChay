# Stored Procedure: `ThucChayDaTinh_InsertThucChaySanLuongChot_GTTD_ThanhTien_GGFB_DEV`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2021-01-07 10:18:43.123000
- **Ngày sửa cuối**: 2023-08-23 16:19:53.537000
...
```sql
CREATE PROCEDURE [dbo].[ThucChayDaTinh_InsertThucChaySanLuongChot_GTTD_ThanhTien_GGFB_DEV]
...
BEGIN
	...
	SELECT top (1) @ThucChayDaTinhID_output = ISNULL(ThucChayDaTinhID,'') FROM @Table_ThucChayDaTinhID 
