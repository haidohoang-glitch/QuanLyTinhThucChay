# Stored Procedure: `Admarket_ThucChayDaTinhAdmarket_NhanHang_InsertByPhanBoID_GTTD`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2016-03-15 11:27:34.900000
- **Ngày sửa cuối**: 2016-03-24 15:30:50.120000
...
-- =============================================
CREATE PROCEDURE [dbo].[Admarket_ThucChayDaTinhAdmarket_NhanHang_InsertByPhanBoID_GTTD]
...
BEGIN
	...
	SELECT DISTINCT
		...
		CONVERT(NVARCHAR(50),@DmNhanHangREF), D.NgayNhanBanFax, D.NgayNhanHopDongBanCung, D.NgayChuyenHopDongChoKeToan, 
		D.So, D.Thang, D.Nam, 
