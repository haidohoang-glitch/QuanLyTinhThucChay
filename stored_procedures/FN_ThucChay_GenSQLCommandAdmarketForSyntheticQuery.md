# Function: `ThucChay_GenSQLCommandAdmarketForSyntheticQuery`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2014-07-28 16:22:22.427000
- **Ngày sửa cuối**: 2014-10-14 10:39:33.567000
...
-- =============================================
CREATE FUNCTION [dbo].[ThucChay_GenSQLCommandAdmarketForSyntheticQuery] 
(
	@StartDate datetime,
	@EndDate datetime,
...
BEGIN
	...
	SET @Sql = '
		SELECT * FROM dbo.GetDataThucChayAdmarketTongHopByParams('+ @DauNhay  + CONVERT(VARCHAR(50),@StartDate) + @DauNhay + ',' + @DauNhay  + CONVERT(VARCHAR(50),@EndDate) + @DauNhay + ')'
