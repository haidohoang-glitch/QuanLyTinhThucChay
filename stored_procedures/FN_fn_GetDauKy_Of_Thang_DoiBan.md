# Function: `fn_GetDauKy_Of_Thang_DoiBan`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-27 17:43:27.547000
- **Ngày sửa cuối**: 2015-03-27 17:43:27.547000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Thang_DoiBan] 
(
...
BEGIN
	...
	BEGIN
		...
		(
			...
			FROM rptThucChay_DoiBan_Thang dstchdc
			WHERE 1 = 1
