# Stored Procedure: `ThucChayDaTinh_ExcInsertThucChayDaTinhAdmarketByAccount`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-03-09 10:22:07.280000
- **Ngày sửa cuối**: 2015-03-09 18:29:15.110000
...
--
/*
	EXEC dbo.ThucChayDaTinh_ExcInsertThucChayDaTinhAdmarketByAccount 
		'2015-02-04', 
		'2015-02-04',
		'quyenrich',
		144,
	...
	--EXEC dbo.ThucChayDaTinhAdmarket_InsertThucChayNoContract '2015-02-04';

*/

CREATE PROCEDURE [dbo].[ThucChayDaTinh_ExcInsertThucChayDaTinhAdmarketByAccount]
...
BEGIN
    ...
    BEGIN
    	...
    	EXEC dbo.ThucChayDaTinhAdmarket_InsertThucChayNoContractByProduct @NgayThucHien, @DmSanPhamREF
