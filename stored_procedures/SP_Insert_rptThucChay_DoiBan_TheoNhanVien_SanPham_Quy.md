# Stored Procedure: `Insert_rptThucChay_DoiBan_TheoNhanVien_SanPham_Quy`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-03-07 12:18:34.790000
- **Ngày sửa cuối**: 2015-03-07 12:18:34.790000
...
-- =============================================
CREATE PROCEDURE [dbo].[Insert_rptThucChay_DoiBan_TheoNhanVien_SanPham_Quy]
...
BEGIN
	...
	-- interfering with SELECT statements.
     ...
     rtchdn.DmSanPhamREF
     ----------------------------------UPDATE DL-----------------------------
     UPDATE rptThucChay_DoiBan_TheoNhanVien_SanPham_Quy
     SET
     ...
     FROM rptThucChay_DoiBan_TheoNhanVien_SanPham_Quy rtcdbt
     ...
     AND td.Nam = rtcdbt.Nam
     --------------------------------insert dl-------------------------------------
     INSERT INTO rptThucChay_DoiBan_TheoNhanVien_SanPham_Quy
				SELECT 
				...
				td.DmSanPhamREF,
				'',
				[dbo].[fn_GetDauKy_Of_Quy_DoiBanTheoNhanVienSanPham]
				(
				  td.DmNhanVienREF,
				  td.PhongBanREF,
				  td.BoPhanREF,
