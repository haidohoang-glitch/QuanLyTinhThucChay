# Function: `fn_GetDauKy_Of_Nam_KhachHang`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-27 17:43:39.687000
- **Ngày sửa cuối**: 2015-03-27 17:43:39.687000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Nam_KhachHang] 
(
...
BEGIN
	...
	BEGIN
		...
		(
			...
			FROM rptThucChay_KhachHang_Nam dstchdc
			WHERE 1 = 1
		...
		(
			...
			(
				CASE WHEN @LoaiDoanhSo = 1 THEN  isnull(dstchdc.SoLuongPhatSinhCuoiKy,0)
				  ...
				  ELSE isnull(dstchdc.SoLuongPhatSinhCuoiKy,0)
				END
			)DoanhSoPhatSinh
			FROM rptThucChay_KhachHang_Nam dstchdc
			WHERE 1 = 1
