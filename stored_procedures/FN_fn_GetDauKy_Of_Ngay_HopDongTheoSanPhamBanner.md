# Function: `fn_GetDauKy_Of_Ngay_HopDongTheoSanPhamBanner`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-27 17:43:36.620000
- **Ngày sửa cuối**: 2015-03-27 17:43:36.620000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Ngay_HopDongTheoSanPhamBanner] 
(
...
BEGIN
	...
	IF @isSoluong = 0
		...
		(
			...
			FROM rptThucChay_HopDong_TheoSanPham_ViTriBanner_Ngay dstchdc
			WHERE 1 = 1
