# Function: `fn_TC_GetSoLuongThucChayMobile_KoChietKhau_TinhLaiCuoiThang`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2017-09-13 11:30:11.590000
- **Ngày sửa cuối**: 2017-09-13 11:30:11.590000
...
CREATE FUNCTION [dbo].[fn_TC_GetSoLuongThucChayMobile_KoChietKhau_TinhLaiCuoiThang]
    (
            ...
            BEGIN
				...
				IF ISNULL(@TongSoLuongLechTreoHa, 0) > 0
					BEGIN
					    ...
					    SET @SoLuongThucChay = ISNULL(@SoLuongLechTreoHa, 0)
