# Stored Procedure: `Insert_DoanhSoXuatHoaDonCore_ByNgayThucHien`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-06-12 10:47:06.417000
- **Ngày sửa cuối**: 2015-06-12 10:47:06.417000
...
--EXEC [dbo].[Insert_DoanhSoXuatHoaDonCore_ByNgayThucHien] '2015-01-05'
CREATE PROCEDURE [dbo].[Insert_DoanhSoXuatHoaDonCore_ByNgayThucHien]
...
BEGIN
	...
	DECLARE @NgayThucHien_update DATETIME, @HopDongID_Update INT, @HopDongChiTietID_Update INT, @ThongTinHoaDonID_Update INT;
	...
	, hdct.DmBannerREF, hdct.DonViTinh, hdct.DeletedStatus,tthd.ThongTinHoaDonID,tthd.SoHoaDon
	...
	, @DmBannerREF_New, @DonViTinh_New, @DeletedStatus_HDCT_New,@ThongTinHoaDonID,@SoHoaDon
	, @SoLuong,@DonGia,@ChietKhau
			
	WHILE @@FETCH_STATUS = 0
		BEGIN
			PRINT @HopDongChiTietID
			SET @IsPhatSinhGiaTriTD = [dbo].[fn_IsPhatSinhGiaTriTD_DoanhSoXuatHoaDonCore_New]
			(
				@NgayThucHien,
				@HopDongID,
				@HopDongChiTietID ,
			...
			BEGIN
				...
				EXEC [Insert_DoanhSoXuatHoaDonCore_PhatSinhTrongKy] @NgayThucHien, @HopDongID,@HopDongChiTietID ,@DmMaHopDongREF_New ,@ThongTinHoaDonID
			END
	...
	BEGIN
		...
		WHILE @@FETCH_STATUS = 0
		BEGIN
			EXEC dbo.Insert_DoanhSoXuatHoaDonCore_PhatSinhThayDoi @NgayThucHien,@HopDongID_TD
		...
		INNER JOIN ThongTinHoaDon tthd ON hd.HopDongIDTD = tthd.HopDongREF
		WHERE tthd.NgayXuatHoaDon <=@NgayThucHien
		OPEN BU_cursor
		FETCH NEXT FROM BU_cursor INTO @HopDongIDThayDoi,@HopDongChiTietIDThayDoi,@ThongTinHoaDonThayDoiID
		                             
		WHILE @@FETCH_STATUS = 0
		BEGIN
			--DELETE FROM DoanhSoXuatHoaDonCore WHERE HopDongID = @HopDongIDThayDoi AND HopDongChiTietREF = @HopDongChiTietIDThayDoi AND ThongTinHoaDonREF = @ThongTinHoaDonThayDoiID
            EXEC dbo.Insert_DoanhSoXuatHoaDonCore_NoiBo_History_Update @NgayThucHien,@HopDongIDThayDoi,@HopDongChiTietIDThayDoi,@ThongTinHoaDonThayDoiID
            EXEC dbo.Insert_DoanhSoXuatHoaDonCore_ThucThuKhuyenMai_History_Update @NgayThucHien,@HopDongIDThayDoi,@HopDongChiTietIDThayDoi,@ThongTinHoaDonThayDoiID
