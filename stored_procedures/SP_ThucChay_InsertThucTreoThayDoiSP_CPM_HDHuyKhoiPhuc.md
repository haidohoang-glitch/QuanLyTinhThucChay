# Stored Procedure: `ThucChay_InsertThucTreoThayDoiSP_CPM_HDHuyKhoiPhuc`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2014-09-05 15:35:53.767000
- **Ngày sửa cuối**: 2014-11-19 12:16:59.060000
...
CREATE  PROCEDURE [dbo].[ThucChay_InsertThucTreoThayDoiSP_CPM_HDHuyKhoiPhuc]
	@HopDongChiTiet INT,
	@DmSanPhamREF INT,
...
BEGIN
	...
	FROM 
	(
		SELECT * FROM HopDongChiTiet WHERE
		1=1 
		--AND DmSanPhamREF in (231,238,339,240,370,531)
