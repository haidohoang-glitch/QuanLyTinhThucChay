# Stored Procedure: `ThucChay_InsertKhuyenMaiThayDoi_CPD`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2024-08-21 14:49:26.427000
- **Ngày sửa cuối**: 2024-08-21 15:10:57.090000
...
CREATE  PROCEDURE [dbo].[ThucChay_InsertKhuyenMaiThayDoi_CPD] 
...
BEGIN
	...
	SELECT NEWID() AS [ThucChayDaTinhID]
		  ...
		  , N'Đối trừ do thay đổi khuyến mại SP:ThucChay_InsertKhuyenMaiThayDoi_CPD' GhiChu	
	...
	BEGIN
		...
		SELECT  NEWID(), TD.*, 
				...
				@GiatriKMHT  GiaTriKMThayDoi,
				 N'Tính lại do thay đổi chiết khấu, SP:ThucChay_InsertKhuyenMaiThayDoi_CPD' AS GhiChu	
		FROM 
		(SELECT  --ID Hop Dong
				D.HopDongID,
				--Thong tin ve ma so 
