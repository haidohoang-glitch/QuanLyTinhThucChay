# Stored Procedure: `ThucChay_TinhGiaTriThucChay_ThucChay_ThanhTien_Admatic_ByBanner_BK20210629`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2021-06-29 11:01:32.473000
- **Ngày sửa cuối**: 2021-06-29 11:01:32.473000
...
EXEC [dbo].[ThucChay_TinhGiaTriThucChay_ThucChay_ThanhTien_Admatic_ByBanner]
	@SoHopDong = N'QC5600720',
	@DmSanPhamREF = 598,
	@DmBannerREF = 562608
*/

CREATE PROCEDURE [dbo].[ThucChay_TinhGiaTriThucChay_ThucChay_ThanhTien_Admatic_ByBanner_BK20210629]
...
BEGIN
	...
	BEGIN
		...
		SET @FromDate = ISNULL((SELECT TC.NgayThucHienMax FROM [dbo].[INFOBANNER_BRANDING_THANHTIEN_ADMATIC] TC WHERE TC.SOHOPDONG = @SoHopDong
			...
			BEGIN
				...
				(
					...
					, DG.LoaiDonGiaTheoDVT , DG.DonGiaBanner, hdct.ChietKhau FROM
						...
						INNER JOIN 
						(
							 SELECT distinct [DonGiaBanner_VAT]/1.1 AS DonGiaBanner , dmbannerid
