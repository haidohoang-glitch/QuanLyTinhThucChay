# Function: `fn_GetDauKy_Of_Ngay_HopDongTheoSanPhamWebsite`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-27 17:43:35.967000
- **Ngày sửa cuối**: 2015-03-27 17:43:35.967000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Ngay_HopDongTheoSanPhamWebsite] 
(
...
BEGIN
	...
	IF @isSoluong = 0
		...
		(
			...
			FROM rptThucChay_HopDong_TheoSanPham_Website_Ngay dstchdc
			WHERE 1 = 1
