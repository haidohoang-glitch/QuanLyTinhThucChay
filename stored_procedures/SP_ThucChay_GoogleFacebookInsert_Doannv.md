# Stored Procedure: `ThucChay_GoogleFacebookInsert_Doannv`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-07-16 14:53:29.473000
- **Ngày sửa cuối**: 2016-10-25 10:29:20.340000
...
-- =============================================
--EXEC [dbo].[ThucChay_GoogleFacebookInsert_Doannv]
CREATE PROCEDURE [dbo].[ThucChay_GoogleFacebookInsert_Doannv]
...
BEGIN
	...
	SELECT DISTINCT
		...
		0 TongSoBaiViet,
		CASE
		WHEN @TrangThai = 1 then @SoLuongThucChayInsert 
		ELSE  1
		end SoLuongThucChay,
		...
		@ThanhTienThucChayinsert as ThanhTienSauTrietKhauThucChay,
		0 AS GiaTriHoaHongThucChay,
		@ThanhTienThucChayinsert AS ThanhTienThucThu,
		0 as ThanhTienKM,
