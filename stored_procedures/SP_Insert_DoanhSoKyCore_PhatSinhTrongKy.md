# Stored Procedure: `Insert_DoanhSoKyCore_PhatSinhTrongKy`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-04-22 16:42:53.693000
- **Ngày sửa cuối**: 2015-04-22 16:42:53.693000
...
-- =============================================
--EXEC [dbo].[Insert_DoanhSoKyCore_PhatSinhTrongKy] '2013-01-01'
CREATE PROCEDURE [dbo].[Insert_DoanhSoKyCore_PhatSinhTrongKy]
		...
		(
			...
			, (
				CASE WHEN hdct.ChietKhau = 100 THEN 0
					ELSE [dbo].[fn_GetSoLuongDauKy_DoanhSoKyCore]
						(1,
						@NgayThucHien,
													hd.HopDongID,
													hd.SysNhanVienREF,
			...
			, (
				CASE WHEN hdct.ChietKhau = 100 THEN 0
					ELSE hdct.SoLuong - [dbo].[fn_GetSoLuongDauKy_DoanhSoKyCore]
						(1,
						@NgayThucHien,
													hd.HopDongID,
													hd.SysNhanVienREF,
			...
			--SoLuongKM
			, (
				CASE WHEN hdct.ChietKhau = 100 THEN [dbo].[fn_GetSoLuongDauKy_DoanhSoKyCore]
						(2,
						@NgayThucHien,
													hd.HopDongID,
													hd.SysNhanVienREF,
			...
			, (
				CASE WHEN hdct.ChietKhau = 100 THEN hdct.SoLuong - [dbo].[fn_GetSoLuongDauKy_DoanhSoKyCore]
						(2,
						@NgayThucHien,
													hd.HopDongID,
													hd.SysNhanVienREF,
			...
			, (
				CASE WHEN hdct.ChietKhau = 100 THEN 0
					ELSE [dbo].[fn_GetDoanhSoDauKy_DoanhSoKyCore](1,--1 ThucThu, 2 KhuyenMai, 3 NoiBo
													@NgayThucHien,
													hd.HopDongID,
													hd.SysNhanVienREF,
													isnull(hd.DmBoPhanREF,0),
			...
			, (
				CASE WHEN hdct.ChietKhau = 100 THEN 0
					ELSE hdct.ThanhTien -[dbo].[fn_GetDoanhSoDauKy_DoanhSoKyCore](1,--1 ThucThu, 2 KhuyenMai, 3 NoiBo
													@NgayThucHien,
													hd.HopDongID,
													hd.SysNhanVienREF,
													isnull(hd.DmBoPhanREF,0),
			...
			--ThanhTienKM
			, (
				CASE WHEN hdct.ChietKhau = 100 THEN [dbo].[fn_GetDoanhSoDauKy_DoanhSoKyCore](2,--1 ThucThu, 2 KhuyenMai, 3 NoiBo
													@NgayThucHien,
													hd.HopDongID,
													hd.SysNhanVienREF,
													isnull(hd.DmBoPhanREF,0),
			...
			, (
				CASE WHEN hdct.ChietKhau = 100 THEN hdct.SoLuong*hdct.DonGia - [dbo].[fn_GetDoanhSoDauKy_DoanhSoKyCore](2,--1 ThucThu, 2 KhuyenMai, 3 NoiBo
													@NgayThucHien,
													hd.HopDongID,
													hd.SysNhanVienREF,
													isnull(hd.DmBoPhanREF,0),
		...
		BEGIN
			...
			(
				...
				, (
					...
					END		) KhuyenMaiPhatSinhDauKy
				, (
					CASE WHEN hdct.ChietKhau = 100 THEN hdct.ThanhTien -[dbo].[fn_GetDoanhSoDauKy_DoanhSoKyCore](2,--1 ThucThu, 2 KhuyenMai, 3 NoiBo
														@NgayThucHien,
														hd.HopDongID,
														hd.SysNhanVienREF,
														isnull(hd.DmBoPhanREF,0),
				...
				, (
					CASE WHEN hdct.ChietKhau = 100 THEN 0
						ELSE [dbo].[fn_GetDoanhSoDauKy_DoanhSoKyCore](3,--1 ThucThu, 2 KhuyenMai, 3 NoiBo
														@NgayThucHien,
														hd.HopDongID,
														hd.SysNhanVienREF,
														isnull(hd.DmBoPhanREF,0),
				...
				, (
					CASE WHEN hdct.ChietKhau = 100 THEN 0
						ELSE hdct.ThanhTien -[dbo].[fn_GetDoanhSoDauKy_DoanhSoKyCore](3,--1 ThucThu, 2 KhuyenMai, 3 NoiBo
														@NgayThucHien,
														hd.HopDongID,
														hd.SysNhanVienREF,
														isnull(hd.DmBoPhanREF,0),
