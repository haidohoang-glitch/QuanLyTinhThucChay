# Function: `fn_TC_GetThanhTienChuanThucChay_Mobile_KoChietKhau_DoiTruVaTinhLai`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2017-11-29 15:05:05.200000
- **Ngày sửa cuối**: 2017-11-29 15:05:05.200000
...
CREATE FUNCTION [dbo].[fn_TC_GetThanhTienChuanThucChay_Mobile_KoChietKhau_DoiTruVaTinhLai]
    (
...
AS
	...
	-- Declare the return variable here
        ...
        SET @SoLuongThucChay = dbo.[fn_TC_GetSoLuongThucChayMobile_KoChietKhau_DoiTruVaTinhLai](@HopDongChiTietID,
        ...
        SET @SoLuongThucChayKM = ( CASE WHEN ( ( ( @IsKhuyenMai = 1 )
                                        ...
                                        THEN ISNULL(dbo.fn_TC_GetSoLuongThucChayKMMobile_DoiTruVaTinhLai(@HopDongChiTietID,
                                                              1,
                                                              @DonGiaTheoDonVi,
                                                              @NgayThucHien,
