# Function: `fn_GetDauKy_Of_Ngay_DoiBanTheoNhanVienKhachHang`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-07 12:18:20.990000
- **Ngày sửa cuối**: 2015-03-07 12:18:20.990000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Ngay_DoiBanTheoNhanVienKhachHang] 
(
...
BEGIN
	...
	IF @isSoluong = 0
		...
		(
			...
			FROM rptThucChay_DoiBan_TheoNhanVien_KhachHang_Ngay dstchdc
			WHERE 1 = 1
