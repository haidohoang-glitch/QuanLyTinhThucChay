# Stored Procedure: `ThucChay_UpdateThucChayDaTinh_Admatic_Adx_BySoHopDong`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2020-07-30 14:52:48.520000
- **Ngày sửa cuối**: 2020-07-30 15:08:34.443000
...
```sql
/*
EXEC  [dbo].[ThucChay_UpdateThucChayDaTinh_Admatic_Adx_BySoHopDong] 1003848,'2018-06-30'
*/
CREATE  PROCEDURE [dbo].[ThucChay_UpdateThucChayDaTinh_Admatic_Adx_BySoHopDong] 
	@HopDongID INT,
...
BEGIN
	...
	, @COUNT INT = 0
	, @GhiChuDoiTruGiam NVARCHAR(500) = N'Đối trừ giảm Adx của hợp đồng: '
	, @GhiChuTinhLaiThucChay NVARCHAR(500) = N'Tính lại gia trị thực chạy Adx của hợp đồng: '
	...
	SET @GhiChuDoiTruGiam = @GhiChuDoiTruGiam + @SoHopDong
	SET @GhiChuTinhLaiThucChay = @GhiChuTinhLaiThucChay + @SoHopDong

	--THUC HIEN DOI TRU DI DU LIEU THUC CHAY
	EXEC [dbo].[ThucChay_Insert_GTTD_DoiTruGiam_ThucChayDaTinh_ByHD_ADX_Admatic] 
	@FromDate = @NgayThucHien,
	@ToDate = @NgayThucHien,
	@NgayGhiNhanThucChay = @NgayGhiNhanThucChay,
	@HopDongID = @HopDongID,
	@DmSanPhamREF = @DmSanPhamREF,
	@GhiChu = @GhiChuDoiTruGiam
	...
	BEGIN
		...
		BEGIN
			...
			ISNULL((
				...
				WHERE tt.DmBannerID = CONVERT(NVARCHAR(50),@campaign_id)
			...
			BEGIN
				...
				BEGIN
					...
					BEGIN
						...
						EXEC [dbo].[ThucChay_ReInsert_ThucChayDaTinh_Admatic_Adx]
	...
	AND (GhiChu = @GhiChuDoiTruGiam OR GhiChu = @GhiChuTinhLaiThucChay)
