# Stored Procedure: `TablePageNumber_Select`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2013-06-06 18:19:47.803000
- **Ngày sửa cuối**: 2014-11-19 12:16:43.423000
...
```sql
CREATE PROCEDURE [dbo].[TablePageNumber_Select] 
...
BEGIN	
	...
	set @SQL = 'select @MaxRecords=count(*) from '+ @TableName+' where [DeletedStatus] <> 1 and [DeletedStatus] <> 3'
	...
	select [PageIndex],[PageName] from @PageTable
