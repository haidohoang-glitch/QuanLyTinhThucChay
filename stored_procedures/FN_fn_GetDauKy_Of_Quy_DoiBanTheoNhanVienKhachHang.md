# Function: `fn_GetDauKy_Of_Quy_DoiBanTheoNhanVienKhachHang`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-07 12:18:16.217000
- **Ngày sửa cuối**: 2015-03-07 12:18:16.217000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Quy_DoiBanTheoNhanVienKhachHang] 
(
...
BEGIN
	...
	IF @isSoluong = 0
		...
		(
			...
			FROM rptThucChay_DoiBan_TheoNhanVien_KhachHang_Quy dstchdc
			WHERE 1 = 1
