# Stored Procedure: `ThucChay_GetSumFilterCondition_Label_Contract_Print`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2014-06-02 18:34:27.953000
- **Ngày sửa cuối**: 2014-11-19 12:17:54.557000
...
-- =============================================
CREATE PROCEDURE [dbo].[ThucChay_GetSumFilterCondition_Label_Contract_Print]     
...
BEGIN
	...
	SET @Sql = '
		...
		(
			SELECT 
				hd.NhanHopDong GroupFieldName, hd.SoHopDong,
			...
			WHERE ' + @FilterString + '
			GROUP BY hd.NhanHopDong, hd.SoHopDong, tcdt.TenMaHopDong, tcdt.ThanhTienKM
		)A
		GROUP BY A.GroupFieldName, A.SoHopDong'
