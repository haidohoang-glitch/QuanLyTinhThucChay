# Function: `fn_GetDauKy_Of_Ngay_DoiBanTheoSanPham`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-07 12:18:20.600000
- **Ngày sửa cuối**: 2015-03-07 12:18:20.600000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Ngay_DoiBanTheoSanPham] 
(
...
BEGIN
	...
	IF @isSoluong = 0
		...
		(
			...
			FROM rptThucChay_DoiBan_TheoSanPham_Ngay dstchdc
			WHERE 1 = 1
