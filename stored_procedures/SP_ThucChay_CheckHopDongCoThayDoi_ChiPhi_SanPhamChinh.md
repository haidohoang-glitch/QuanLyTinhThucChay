# Stored Procedure: `ThucChay_CheckHopDongCoThayDoi_ChiPhi_SanPhamChinh`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-03-31 16:14:28.323000
- **Ngày sửa cuối**: 2016-11-16 14:56:04.777000
...
CREATE PROCEDURE [dbo].[ThucChay_CheckHopDongCoThayDoi_ChiPhi_SanPhamChinh] 
...
BEGIN
	...
	BEGIN
		...
		SELECT @GiaTien = SUM(ISNULL(ThanhTien/DonGia*DonGia/SoLuong,0))--da co chiet khau
		FROM HopDongChiTiet hdct 
		WHERE hdct.HopDongChiTietID = @HopDongChiTietID
			AND (   CASE 
		...
		SELECT 
		      @SoluongThucChay = COUNT(tchdctp.HopDongChiTietREF) 
	    ...
	    BEGIN
			...
			IF(@ISEXIST_HDCT = 0)
			BEGIN
				EXEC ThucChay_InsertThucTreoThayDoi_ChiPhi_SanPhamChinh @HopDongChiTietID, @NgayThucHien, @GiaTriThayDoiHT
			END
			--1.3 GHI LOG
			...
			VALUES
			  ...
			  0,0,0,@CONTENT_LOG,@NGUON_LOG,'CPK',
