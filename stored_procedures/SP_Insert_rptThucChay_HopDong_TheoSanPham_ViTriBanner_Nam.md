# Stored Procedure: `Insert_rptThucChay_HopDong_TheoSanPham_ViTriBanner_Nam`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-03-27 17:43:54.830000
- **Ngày sửa cuối**: 2015-03-27 17:43:54.830000
...
-- =============================================
--EXEC [dbo].[Insert_rptThucChay_HopDong_TheoSanPham_ViTriBanner_Nam] '2013-01-02'
CREATE PROCEDURE [dbo].[Insert_rptThucChay_HopDong_TheoSanPham_ViTriBanner_Nam]
...
BEGIN
    ...
    -- Tổng hợp dữ liệu theo ngày
	   INSERT INTO @TeampData
		...
		UPDATE  rptThucChay_HopDong_TheoSanPham_ViTriBanner_Nam 
		SET rptThucChay_HopDong_TheoSanPham_ViTriBanner_Nam.NgayThucHien = @NgayThucHien,
		    rptThucChay_HopDong_TheoSanPham_ViTriBanner_Nam.ThucChayPhatSinhTrongKy += td.ThucChayPhatSinhTrongKy,
		    rptThucChay_HopDong_TheoSanPham_ViTriBanner_Nam.ThucChayPhatSinhCuoiKy += td.ThucChayPhatSinhTrongKy,
		    rptThucChay_HopDong_TheoSanPham_ViTriBanner_Nam.KhuyenMaiPhatSinhTrongKy += td.KhuyenMaiPhatSinhTrongKy,
		    rptThucChay_HopDong_TheoSanPham_ViTriBanner_Nam.KhuyenMaiPhatSinhCuoiKy += td.KhuyenMaiPhatSinhTrongKy,
		    rptThucChay_HopDong_TheoSanPham_ViTriBanner_Nam.NoiBoPhatSinhTrongKy += td.NoiBoPhatSinhTrongKy,
		    rptThucChay_HopDong_TheoSanPham_ViTriBanner_Nam.NoiBoPhatSinhCuoiKy += td.NoiBoPhatSinhTrongKy,
		...
		FROM rptThucChay_HopDong_TheoSanPham_ViTriBanner_Nam rtchdt
		...
		SET TrangThai = 1
		FROM @TeampData td
		INNER JOIN rptThucChay_HopDong_TheoSanPham_ViTriBanner_Nam rtchdt
		ON td.HopDongID = rtchdt.HopDongID
		AND td.DmNhanVienREF = rtchdt.DmNhanVienREF
		AND td.PhongBanREF = rtchdt.PhongBanREF
		AND td.BoPhanREF = rtchdt.BoPhanREF
		...
		AND td.ViTriBannerREF = rtchdt.DmViTriBannerREF
     ------------------------------------Insert--------------------------------------------
     INSERT INTO rptThucChay_HopDong_TheoSanPham_ViTriBanner_Nam
     SELECT 
				@NgayThucHien,
				td.Nam,
				td.HopDongID,
