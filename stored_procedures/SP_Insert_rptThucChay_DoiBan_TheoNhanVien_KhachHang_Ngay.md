# Stored Procedure: `Insert_rptThucChay_DoiBan_TheoNhanVien_KhachHang_Ngay`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-03-07 12:18:32.090000
- **Ngày sửa cuối**: 2015-03-07 12:18:32.090000
...
CREATE PROCEDURE [dbo].[Insert_rptThucChay_DoiBan_TheoNhanVien_KhachHang_Ngay] 
...
BEGIN
	...
	WHILE @NgayThucHien <= @ToDate
		BEGIN
			 INSERT INTO rptThucChay_DoiBan_TheoNhanVien_KhachHang_Ngay
			 SELECT 
				...
				'',
			   [dbo].[fn_GetDauKy_Of_Ngay_DoiBanTheoNhanVienKhachHang] 
				(
				  dstchdc.DmNhanVienREF,
				  dstchdc.PhongBanREF,
	              dstchdc.BoPhanREF,
