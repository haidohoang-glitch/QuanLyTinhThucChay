# Stored Procedure: `Insert_DoanhSoHaiDauNganhHangCore_PhatSinhGiaTriThayDoi`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-04-22 16:42:54.763000
- **Ngày sửa cuối**: 2015-04-22 16:42:54.763000
...
-- =============================================
CREATE PROCEDURE [dbo].[Insert_DoanhSoHaiDauNganhHangCore_PhatSinhGiaTriThayDoi]
...
BEGIN
	...
	FROM DoanhSoHaiDauNganhHangCore dsknhc 
	...
	AND dsknhc.NgayThucHien = (SELECT MAX(NgayThucHien)FROM DoanhSoHaiDauNganhHangCore WHERE HopDongID = @HopDongID AND HopDongChiTietREF = @HopDongChiTietREF)
