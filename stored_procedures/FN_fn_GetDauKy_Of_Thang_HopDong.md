# Function: `fn_GetDauKy_Of_Thang_HopDong`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-27 17:43:26.493000
- **Ngày sửa cuối**: 2015-03-27 17:43:26.493000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Thang_HopDong] 
(
...
BEGIN
	...
	IF @isSoluong = 0
		...
		(
			...
			FROM rptThucChay_HopDong_Thang dstchdc
			WHERE 1 = 1
