# Stored Procedure: `ThucChay_TrueView_Insert_ThucChayDaTinh`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2025-03-07 17:16:49.377000
- **Ngày sửa cuối**: 2025-03-08 08:49:10.060000

## Parameters

| Parameter | Type | Output |
|-----------|------|--------|
| `@Thucchay_TrueView_DmTinhMoi` | `DataType_Thucchay_CPMthuan_DmTinhMoi` | No |

## Definition (Source Code)

```sql
--CREATE TYPE DataType_Thucchay_CPMthuan_DmTinhMoi AS TABLE
--	(
...
CREATE PROCEDURE [dbo].[ThucChay_TrueView_Insert_ThucChayDaTinh] 
	@Thucchay_TrueView_DmTinhMoi DataType_Thucchay_CPMthuan_DmTinhMoi READONLY
AS
BEGIN
	...
	SELECT NEWID(), HopDongID = hd.HopDongID,
					...
					DotChayHopDong = N'Tính mới TrueView',--ISNULL(dbo.GetDotChayBookingByHopDongChiTiet(tc.HopDongChiTietREF,'Y'),''),
					...
					GiaTriKMThayDoi = 0 ,
					GhiChu =  tc.GhiChu
			FROM @Thucchay_TrueView_DmTinhMoi tc
