# Stored Procedure: `ThucChay_UpdateThucChayHopDongChiTiet`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2014-02-26 17:28:50.580000
- **Ngày sửa cuối**: 2014-11-19 12:16:44.577000
...
```sql
---------------------------------------------------------------
CREATE PROCEDURE [dbo].[ThucChay_UpdateThucChayHopDongChiTiet]
