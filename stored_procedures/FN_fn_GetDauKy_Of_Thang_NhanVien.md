# Function: `fn_GetDauKy_Of_Thang_NhanVien`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-27 17:43:23.817000
- **Ngày sửa cuối**: 2015-03-27 17:43:23.817000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Thang_NhanVien] 
(
...
BEGIN
	...
	BEGIN
		...
		(
			...
			FROM rptThucChay_NhanVien_Thang dstchdc
			WHERE 1 = 1
