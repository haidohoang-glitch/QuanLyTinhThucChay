# Stored Procedure: `ThucChay_NativeAds_GhiNhanThayDoi_ThucChayDaTinh_Manual_dev`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2025-12-23 09:16:52.573000
- **Ngày sửa cuối**: 2025-12-23 09:19:16.680000
...
```sql
/*
EXEC [dbo].[ThucChay_NativeAds_GhiNhanThayDoi_ThucChayDaTinh_Manual_dev]
    @NgayGhiNhan = '2025-12-22',       -- date
    @SoHopDong = N'QC4031125',                  -- nvarchar(50)
    @HopDongChiTietID = 771978              -- int
*/

--DECLARE @DmInterger TABLE (ID INT)
CREATE  PROCEDURE [dbo].[ThucChay_NativeAds_GhiNhanThayDoi_ThucChayDaTinh_Manual_dev]
    @NgayGhiNhan DATE,
