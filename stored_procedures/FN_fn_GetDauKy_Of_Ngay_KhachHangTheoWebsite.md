# Function: `fn_GetDauKy_Of_Ngay_KhachHangTheoWebsite`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-27 17:43:35.027000
- **Ngày sửa cuối**: 2015-03-27 17:43:35.027000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Ngay_KhachHangTheoWebsite] 
(
...
BEGIN
	...
	IF @isSoluong = 0
		...
		(
			...
			FROM rptThucChay_KhachHang_TheoWebsite_Ngay dstchdc
			WHERE 1 = 1
