# Function: `fn_GetDauKy_Of_Nam_BaoCaoTongHopTheoHopDong`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-27 17:43:42.607000
- **Ngày sửa cuối**: 2015-03-27 17:43:42.607000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Nam_BaoCaoTongHopTheoHopDong] 
(
...
BEGIN
	...
	IF @isSoluong = 0
		...
		(
			...
			FROM rptThucChay_BaoCaoTongHopTheoHopDong_Nam dstchdc
			WHERE 1 = 1
