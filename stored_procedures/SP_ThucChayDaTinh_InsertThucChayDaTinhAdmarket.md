# Stored Procedure: `ThucChayDaTinh_InsertThucChayDaTinhAdmarket`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2014-06-09 15:19:35.643000
- **Ngày sửa cuối**: 2015-04-23 10:54:04.180000
...
-- =============================================
-- EXEC dbo.ThucChayDaTinh_InsertThucChayDaTinhAdmarket '2014-10-08', 144, 'fargo', 'CLICK',''
-- =============================================
CREATE PROCEDURE [dbo].[ThucChayDaTinh_InsertThucChayDaTinhAdmarket] 
	...
	BEGIN
		...
		BEGIN	
			...
			BEGIN
				...
				ELSE
					BEGIN
					IF @DonGiaMotDonViTinh <> 0  						
						SET @SoLuongThucChay = CONVERT(INT,(@ThanhTienThucChay/@DonGiaMotDonViTinh));
