# Function: `fn_GetDauKy_Of_Ngay_DoiBan`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-27 17:43:37.537000
- **Ngày sửa cuối**: 2015-03-27 17:43:37.537000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Ngay_DoiBan] 
(
...
BEGIN
	...
	BEGIN
		...
		(
			...
			FROM rptThucChay_DoiBan_Ngay dstchdc
			WHERE 1 = 1
