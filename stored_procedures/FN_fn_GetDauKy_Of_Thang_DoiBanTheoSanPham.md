# Function: `fn_GetDauKy_Of_Thang_DoiBanTheoSanPham`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-07 12:18:10.883000
- **Ngày sửa cuối**: 2015-03-07 12:18:10.883000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Thang_DoiBanTheoSanPham] 
(
...
BEGIN
	...
	IF @isSoluong = 0
		...
		(
			...
			FROM rptThucChay_DoiBan_TheoSanPham_Thang dstchdc
			WHERE 1 = 1
