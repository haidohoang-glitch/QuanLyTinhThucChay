# Stored Procedure: `ThucChay_InsertThucChayDaTinh_HopDongInventory_DEV`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2021-05-31 16:59:33.343000
- **Ngày sửa cuối**: 2021-05-31 17:12:11.797000
...
```sql
/*
dbo.[ThucChay_InsertThucChayDaTinh_HopDongInventory_DEV]	@NgayThucHien = '2016-10-10',
	@HopDongID INT,
...
-------------------------------------------------------------
CREATE PROCEDURE [dbo].[ThucChay_InsertThucChayDaTinh_HopDongInventory_DEV] 
...
BEGIN
	...
	--SET @isInsertThucChayDaTinh_YN =
	--(
	--	SELECT COUNT(HopDongREF) soluong FROM dbo.DmThongTinHopDongBanInventory
	--	WHERE HopDongREF =@HopDongID
	--	AND ISNULL(HopDongChiTietREF,0) NOT IN (@HopDongChitietID)
	--)
	--select @isInsertThucChayDaTinh_YN
