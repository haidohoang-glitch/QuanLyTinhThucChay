# Stored Procedure: `ThucChay_UpdateGiaTriThayDoi_HDHuyKhoiPhuc`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2014-09-05 15:36:35.857000
- **Ngày sửa cuối**: 2014-11-19 12:16:59.650000
...
CREATE PROCEDURE [dbo].[ThucChay_UpdateGiaTriThayDoi_HDHuyKhoiPhuc] 
...
BEGIN
	...
	AND DotChayHopDong = 'HDHUY_KHOIPHUC'
	...
	BEGIN
	    SET @CONTENT_LOG = N'Hợp đồng ' + @SoHopDong + N' hủy ngày khôi phục ' + CONVERT(NVARCHAR(50),@NgayThucHien) + ' ,Website :' + @TenWebsite
	    --GHI LOG VIEC THAY DOI
	      ...
	      PRINT 'So hop dong: ' + @SoHopDong
	        ...
	        BEGIN
	        	PRINT 'ThucTreo: '
				EXEC  ThucChay_InsertThucTreoThayDoiSP_CPM_HDHuyKhoiPhuc @HopDongChiTietID, @DmSanPhamREF,@TenSanPham, @NgayThucHien, @GiaTriThayDoi,@DmWebsiteREF, @TenWebsite, @SoLuongThucChayByWebiste
	        END
			ELSE
				BEGIN
					PRINT 'SanPham: '
					...
					EXEC  ThucChay_InsertThucTreoThayDoiPPSP_CPM_HDHuyKhoiPhuc @HopDongREF, @DmSanPhamREF, @TenSanPham, @NgayThucHien, @GiaTriThayDoi,@DmWebsiteREF, @TenWebsite, @SoLuongThucChayByWebiste	
				END
