# Function: `fn_GetDauKy_Of_Nam_HinhThucQuangCaoTheoSanPham`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-27 17:43:41.810000
- **Ngày sửa cuối**: 2015-03-27 17:43:41.810000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Nam_HinhThucQuangCaoTheoSanPham] 
(
...
BEGIN
	...
	BEGIN
		...
		(
			...
			FROM rptThucChay_HinhThucQuangCao_TheoSanPham_Nam dstchdc
			WHERE 1 = 1
