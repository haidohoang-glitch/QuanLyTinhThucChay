# Stored Procedure: `ThucChay_ExecThucChayDaTinh_HopDongInventory_AdmaticProgrammatic_dev`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2021-05-31 16:56:33.117000
- **Ngày sửa cuối**: 2021-06-29 10:04:36.400000
...
```sql
--exec [dbo].[ThucChay_ExecThucChayDaTinh_HopDongInventory_AdmaticProgrammatic_dev]  '2021-06-26'
-------------------------------------------------------------
CREATE PROCEDURE [dbo].[ThucChay_ExecThucChayDaTinh_HopDongInventory_AdmaticProgrammatic_dev] 
...
BEGIN
	...
	and hdct.HopDongChiTietID = 626163
