# Function: `GetDataThucChayAdmarketByParams`

- **Loại**: SQL_INLINE_TABLE_VALUED_FUNCTION
- **Ngày tạo**: 2014-07-28 16:45:33.387000
- **Ngày sửa cuối**: 2015-01-06 16:27:19.027000
...
-- =============================================
CREATE FUNCTION [dbo].[GetDataThucChayAdmarketByParams]
(	
	@StartDate datetime,
	@EndDate datetime
)
