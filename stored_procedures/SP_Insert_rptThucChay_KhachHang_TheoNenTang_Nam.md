# Stored Procedure: `Insert_rptThucChay_KhachHang_TheoNenTang_Nam`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-03-07 12:18:41.253000
- **Ngày sửa cuối**: 2015-03-07 12:18:41.253000
...
-- =============================================
CREATE PROCEDURE [dbo].[Insert_rptThucChay_KhachHang_TheoNenTang_Nam]
...
BEGIN
	...
	-- interfering with SELECT statements.
	 DECLARE @TeampData TABLE 
	  ...
	  rtchdn.DmLoaiNenTangREF
	  ------------------------------------UPDATE dl------------------------
	  UPDATE  rptThucChay_KhachHang_TheoNenTang_Nam 
		SET rptThucChay_KhachHang_TheoNenTang_Nam.NgayThucHien = @NgayThucHien,
		    rptThucChay_KhachHang_TheoNenTang_Nam.ThucChayPhatSinhTrongKy += td.ThucChayPhatSinhTrongKy,
		    rptThucChay_KhachHang_TheoNenTang_Nam.ThucChayPhatSinhCuoiKy += td.ThucChayPhatSinhTrongKy,
		    rptThucChay_KhachHang_TheoNenTang_Nam.KhuyenMaiPhatSinhTrongKy += td.KhuyenMaiPhatSinhTrongKy,
		    rptThucChay_KhachHang_TheoNenTang_Nam.KhuyenMaiPhatSinhCuoiKy += td.KhuyenMaiPhatSinhTrongKy,
		    rptThucChay_KhachHang_TheoNenTang_Nam.NoiBoPhatSinhTrongKy += td.NoiBoPhatSinhTrongKy,
		    rptThucChay_KhachHang_TheoNenTang_Nam.NoiBoPhatSinhCuoiKy += td.NoiBoPhatSinhTrongKy,
		...
		FROM rptThucChay_KhachHang_TheoNenTang_Nam rtchdt
		...
		AND td.Nam = rtchdt.Nam
		----------------------------------INSERT dl------------------------------------
		INSERT INTO rptThucChay_KhachHang_TheoNenTang_Nam
				SELECT 
				@NgayThucHien,
				td.Nam,
				td.TenKhachHang,
	            ...
	            td.DmLoaiNenTangREF,
	            '',
				[dbo].[fn_GetDauKy_Of_Nam_KhachHangTheoLoaiNenTang]
				(
				  td.DmKhachHangREF,	
				  td.DmHinhThucKhachHangREF	,
				  td.DmLoaiNenTangREF,
