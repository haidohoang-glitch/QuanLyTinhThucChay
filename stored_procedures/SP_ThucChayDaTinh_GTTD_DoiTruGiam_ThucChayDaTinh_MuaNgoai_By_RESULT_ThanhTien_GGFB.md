# Stored Procedure: `ThucChayDaTinh_GTTD_DoiTruGiam_ThucChayDaTinh_MuaNgoai_By_RESULT_ThanhTien_GGFB`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2020-10-19 11:12:48.357000
- **Ngày sửa cuối**: 2022-06-03 15:51:54.473000
...
-- =============================================
CREATE PROCEDURE [dbo].[ThucChayDaTinh_GTTD_DoiTruGiam_ThucChayDaTinh_MuaNgoai_By_RESULT_ThanhTien_GGFB]
	@HopDongID INT,
...
BEGIN
	...
	INSERT INTO [dbo].[ThucChayDaTinh_MuaNgoai]
	  ...
	  AND (DmSanPhamREF in (306,423,5160,5188,772)  OR DmViTriREF in (100093,100478) )
	  AND DmSanPhamREF <> 585 --Khong phai san pham Adx
	  AND DmChienDichREF = @Operating_Order_Id
	  AND ThucChayMuaNgoaiChiTietREF = @ADS_OPERATING_RESULT_MAP_ORDER_OR_QUANTITY_ID
