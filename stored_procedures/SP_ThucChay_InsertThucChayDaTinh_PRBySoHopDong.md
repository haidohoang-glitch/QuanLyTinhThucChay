# Stored Procedure: `ThucChay_InsertThucChayDaTinh_PRBySoHopDong`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2013-07-19 17:52:21.053000
- **Ngày sửa cuối**: 2016-01-20 18:38:38.520000
...
--EXEC [ThucChay_InsertThucChayDaTinh_PR] '2016-01-04','2016-01-04','DT0011115',141,85114


CREATE PROCEDURE [dbo].[ThucChay_InsertThucChayDaTinh_PRBySoHopDong] 
	@StartDate datetime,
	@EndDate DATETIME,
...
BEGIN
	...
	FROM 
	(
		SELECT * FROM HopDongChiTiet WHERE DmSanPhamREF = @DmSanPhamREF --PR
	...
	INNER JOIN  
	 ...
	 (
		...
		AND tchdctp.HopDongChiTietREF = @HopDongChiTietREF
