# Stored Procedure: `sp_TC_InsertThucChayDaTinh_PR_ByHopDongID`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2017-09-12 09:07:14.223000
- **Ngày sửa cuối**: 2018-01-06 09:11:12.447000
...
-- [dbo].[sp_TC_InsertThucChayDaTinh_PR] '2017-06-15','2017-06-15', NULL

CREATE PROCEDURE [dbo].[sp_TC_InsertThucChayDaTinh_PR_ByHopDongID]
    @StartDate DATETIME ,
    @EndDate DATETIME ,
    @pHopDongID INT = NULL
AS
    BEGIN
--@NgayThucHien DATETIME = '2017-04-10'
      ...
      --                          ) 
						--AND ( @pHopDongID IS NULL
      --                            OR HopDongREF = @pHopDongID
      --                          )
						--		)
    ...
    --                )
            ...
            BEGIN
                ...
                FOR
					...
					SELECT  ThucChayHopDongChiTietPRID ,
                            ...
                            GiaTien ,
                            SoLuong
                    FROM    ThucChayHopDongChiTietPR PR
		...
		--Thuc chay
                                              ...
                                              FROM      ( SELECT
                                                          ...
                                                          FROM
                                                              ThucChayHopDongChiTietPR tchpctpr
        ...
        --AND hd.HopDongID = 501482; 
                ...
                EXEC [sp_TC_UpdateRecordStatus_ThucChayHopDongChiTietPR] @NgayThucHien, @pHopDongID
...
--EXEC [ThucChay_InsertThucChayDaTinh_PR_GoiHD_vt] '2017-02-02', '2017-02-02';
