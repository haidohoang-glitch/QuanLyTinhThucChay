# Function: `NhanSuGetBoPhanByNhanVien`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2013-09-13 15:03:48.990000
- **Ngày sửa cuối**: 2014-10-14 10:39:34.757000
...
-- =============================================
CREATE FUNCTION [dbo].[NhanSuGetBoPhanByNhanVien]
(
...
BEGIN
	...
	SET @ResultValue = (SELECT A.DmBoPhanREF
