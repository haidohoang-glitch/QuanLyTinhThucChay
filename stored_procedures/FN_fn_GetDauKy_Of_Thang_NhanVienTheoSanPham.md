# Function: `fn_GetDauKy_Of_Thang_NhanVienTheoSanPham`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-07 12:18:08.637000
- **Ngày sửa cuối**: 2015-03-07 12:18:08.637000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Thang_NhanVienTheoSanPham] 
(
...
BEGIN
	...
	IF @isSoluong = 0
		...
		(
			...
			FROM rptThucChay_NhanVien_TheoSanPham_Thang dstchdc
			WHERE 1 = 1
