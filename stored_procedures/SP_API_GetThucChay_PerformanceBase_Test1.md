# Stored Procedure: `API_GetThucChay_PerformanceBase_Test1`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2021-04-16 13:54:05.113000
- **Ngày sửa cuối**: 2021-04-16 13:54:05.113000
...
--[API_GetThucChay_PerformanceBase_Test] N'qc0180720'
create PROCEDURE [dbo].[API_GetThucChay_PerformanceBase_Test1]
...
from (
  ...
  hdct.HopDongFK hopDongId,
            ...
            WHERE 1=1 and exists (select 1 from @dshd where 1=1 and HopDongChiTietID = hdct.HopDongChiTietID)
                  AND DmSanPhamREF IN ( 144, 585, 628 )
                  AND DmLoaiREF <> 42
...
from @tcdtacchd t1
outer apply
(select DmViTriREF,0 ThucChayTCDT_VAT,null ThucChayDenNgay  from @tcacc t2 where t1.DmSanPhamREF = t2.DmSanPhamREF) t
)A
