# Stored Procedure: `DongBoDuLieu_20200605`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2020-05-07 22:40:17.373000
- **Ngày sửa cuối**: 2020-05-07 22:42:42.537000
...
CREATE PROCEDURE [dbo].[DongBoDuLieu_20200605]
...
BEGIN
	...
	WHILE (@NgayThucHien <= @EndDate)
		...
		WHERE tcdt.NgayThucHien = @NgayThucHien and HopDongChiTietREF <> 575932
		...
		INSERT INTO  ABM_Data_Partner.dbo.ThucChayDaTinh
			...
			WHERE NgayThucHien = @NgayThucHien and HopDongChiTietREF <> 575932
