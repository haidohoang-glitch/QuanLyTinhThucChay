# Stored Procedure: `KiemTra_DauVao_DangTin_HTQCThucTreoKhacHD`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2016-11-24 18:08:35.157000
- **Ngày sửa cuối**: 2016-11-24 18:08:35.157000
...
CREATE PROCEDURE [dbo].[KiemTra_DauVao_DangTin_HTQCThucTreoKhacHD]
...
BEGIN
	...
	SELECT A.*, B.* FROM 
(
SELECT DISTINCT hd.SoHopDong, hd.HopDongID, hdct.DmSanPhamREF,  hdct.DmLoaiREF,hdct.TenLoai, hd.TrangThaiHopDong
...
RIGHT JOIN 
(
SELECT DISTINCT HopDongREF, dbo.GetSoHopDongByID(HopDongREF)Shd, DmSanPhamREF, DmHinhThucQuangCaoREF
...
WHERE A.DmLoaiREF <> B.DmHinhThucQuangCaoREF OR a.DmLoaiREF IS NULL OR B.DmHinhThucQuangCaoREF IS null
