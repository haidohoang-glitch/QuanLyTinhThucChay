# Stored Procedure: `Insert_rptThucChay_NhanVien_Ngay`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-03-27 17:44:00.943000
- **Ngày sửa cuối**: 2015-03-27 17:44:00.943000
...
--EXEC [Insert_rptThucChay_NhanVien_Ngay] '2013-01-01', '2013-01-15'
CREATE PROCEDURE [dbo].[Insert_rptThucChay_NhanVien_Ngay]
	@FromDate DATETIME,
	@ToDate DATETIME
AS
BEGIN
	...
	BEGIN
	    ...
	    FROM   DoanhSoThucChayWebsiteTheoThoiGian dstchdc
	           LEFT JOIN NhanSuSoYeuLyLich nssyll
	                ON  nssyll.NhanSuSoYeuLyLichID = dstchdc.DmNhanVienREF
