# Stored Procedure: `Insert_rptThucChay_DoiBan_TheoNhanVien_Quy`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-03-07 12:18:30.587000
- **Ngày sửa cuối**: 2015-03-07 12:18:30.587000
...
-- =============================================
CREATE PROCEDURE [dbo].[Insert_rptThucChay_DoiBan_TheoNhanVien_Quy]
...
BEGIN
	...
	-- interfering with SELECT statements.
     ...
     rtchdn.DmNhanVienREF
     ----------------------------------UPDATE DL-----------------------------
     UPDATE rptThucChay_DoiBan_TheoNhanVien_Quy
     SET
     ...
     FROM rptThucChay_DoiBan_TheoNhanVien_Quy rtcdbt
     ...
     AND td.Nam = rtcdbt.Nam
     --------------------------------insert dl-------------------------------------
     INSERT INTO rptThucChay_DoiBan_TheoNhanVien_Quy
				SELECT 
				...
				td.NhomREF,
				'',
				[dbo].[fn_GetDauKy_Of_Quy_DoiBanTheoNhanVien]
				(
				  td.DmNhanVienREF,
				  td.PhongBanREF,
				  td.BoPhanREF,
