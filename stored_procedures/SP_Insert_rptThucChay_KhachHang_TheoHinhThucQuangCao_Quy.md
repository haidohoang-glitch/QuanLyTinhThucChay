# Stored Procedure: `Insert_rptThucChay_KhachHang_TheoHinhThucQuangCao_Quy`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-03-27 17:43:58.040000
- **Ngày sửa cuối**: 2015-03-27 17:43:58.040000
...
-- =============================================
CREATE PROCEDURE [dbo].[Insert_rptThucChay_KhachHang_TheoHinhThucQuangCao_Quy]
...
BEGIN
	...
	-- interfering with SELECT statements.
	 DECLARE @TeampData TABLE 
	  ...
	  rtchdn.UserName
	  ------------------------------------UPDATE dl------------------------
	  UPDATE  rptThucChay_KhachHang_TheoHinhThucQuangCao_Quy 
		SET rptThucChay_KhachHang_TheoHinhThucQuangCao_Quy.NgayThucHien = @NgayThucHien,
		    rptThucChay_KhachHang_TheoHinhThucQuangCao_Quy.ThucChayPhatSinhTrongKy += td.ThucChayPhatSinhTrongKy,
		    rptThucChay_KhachHang_TheoHinhThucQuangCao_Quy.ThucChayPhatSinhCuoiKy += td.ThucChayPhatSinhTrongKy,
		    rptThucChay_KhachHang_TheoHinhThucQuangCao_Quy.KhuyenMaiPhatSinhTrongKy += td.KhuyenMaiPhatSinhTrongKy,
		    rptThucChay_KhachHang_TheoHinhThucQuangCao_Quy.KhuyenMaiPhatSinhCuoiKy += td.KhuyenMaiPhatSinhTrongKy,
		    rptThucChay_KhachHang_TheoHinhThucQuangCao_Quy.NoiBoPhatSinhTrongKy += td.NoiBoPhatSinhTrongKy,
		    rptThucChay_KhachHang_TheoHinhThucQuangCao_Quy.NoiBoPhatSinhCuoiKy += td.NoiBoPhatSinhTrongKy,
		...
		FROM rptThucChay_KhachHang_TheoHinhThucQuangCao_Quy rtchdt
		...
		AND td.Nam = rtchdt.Nam
		----------------------------------INSERT dl------------------------------------
		INSERT INTO rptThucChay_KhachHang_TheoHinhThucQuangCao_Quy
				SELECT 
				@NgayThucHien,
				td.Quy,
				td.Nam,
