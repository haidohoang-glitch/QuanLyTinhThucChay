# Stored Procedure: `Insert_rptThucChay_KhachHang_TheoHinhThucQuangCao_Thang`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-03-27 17:43:57.817000
- **Ngày sửa cuối**: 2015-03-27 17:43:57.817000
...
-- =============================================
CREATE PROCEDURE [dbo].[Insert_rptThucChay_KhachHang_TheoHinhThucQuangCao_Thang]
...
BEGIN
	...
	-- interfering with SELECT statements.
	 DECLARE @TeampData TABLE 
	  ...
	  rtchdn.UserName
	  ------------------------------------UPDATE dl------------------------
	  UPDATE  rptThucChay_KhachHang_TheoHinhThucQuangCao_Thang 
		SET rptThucChay_KhachHang_TheoHinhThucQuangCao_Thang.NgayThucHien = @NgayThucHien,
		    rptThucChay_KhachHang_TheoHinhThucQuangCao_Thang.ThucChayPhatSinhTrongKy += td.ThucChayPhatSinhTrongKy,
		    rptThucChay_KhachHang_TheoHinhThucQuangCao_Thang.ThucChayPhatSinhCuoiKy += td.ThucChayPhatSinhTrongKy,
		    rptThucChay_KhachHang_TheoHinhThucQuangCao_Thang.KhuyenMaiPhatSinhTrongKy += td.KhuyenMaiPhatSinhTrongKy,
		    rptThucChay_KhachHang_TheoHinhThucQuangCao_Thang.KhuyenMaiPhatSinhCuoiKy += td.KhuyenMaiPhatSinhTrongKy,
		    rptThucChay_KhachHang_TheoHinhThucQuangCao_Thang.NoiBoPhatSinhTrongKy += td.NoiBoPhatSinhTrongKy,
		    rptThucChay_KhachHang_TheoHinhThucQuangCao_Thang.NoiBoPhatSinhCuoiKy += td.NoiBoPhatSinhTrongKy,
		...
		FROM rptThucChay_KhachHang_TheoHinhThucQuangCao_Thang rtchdt
		...
		AND td.Nam = rtchdt.Nam
		----------------------------------INSERT dl------------------------------------
		INSERT INTO rptThucChay_KhachHang_TheoHinhThucQuangCao_Thang
				SELECT 
				@NgayThucHien,
				td.Thang,
				td.Nam,
