# Function: `ThucChay_GetBaoCaoByFilterConditionV2`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2013-06-14 12:56:55.113000
- **Ngày sửa cuối**: 2014-10-14 10:39:32.693000
...
-- =============================================
CREATE FUNCTION [dbo].[ThucChay_GetBaoCaoByFilterConditionV2] 
(
...
BEGIN
	...
	set @SQLCommand = dbo.GenderSQLCommandStringByGroupName1(@GroupFieldName,@FilterString,@IsOrderBy)
