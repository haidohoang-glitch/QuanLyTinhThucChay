# Stored Procedure: `InsertOrUpdateViewPlusAdmarketForDomain`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-05-13 18:13:44.090000
- **Ngày sửa cuối**: 2015-06-25 17:27:51.830000
...
CREATE PROCEDURE [dbo].[InsertOrUpdateViewPlusAdmarketForDomain]
    (
	...
	--Check Website
        ...
        IF @siteid IS NULL 
            BEGIN
                ...
                VALUES  ( @domain ,	-- TenWebsite - nvarchar(200)
                ...
                SET @siteid = @@IDENTITY
            END	
		-- delete dữ liệu đã tồn tại truoc khi tinh 
		--DELETE FROM ThucChayDatinhViewPlusForDomain
		--WHERE Convert(date,NgayThucHien) = @NgayThucHien
		--AND DmSanPhamREF = @DmSanPhamREF
		--AND DonViTinh = @DonViTinh
		-- insert
        INSERT  INTO dbo.ThucChayDatinhViewPlusForDomain
                ( ThucChayDaTinhID ,
                  HopDongID ,
                  SoHopDong ,
                  DmMaHopDongREF ,
        ...
        VALUES  ( NEWID() ,	-- ThucChayDaTinhID - nvarchar(50)
                  0 ,	-- HopDongID - int
