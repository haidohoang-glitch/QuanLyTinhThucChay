# Stored Procedure: `Insert_rptThucChay_BaoCaoTongHopTheoWebsite_Quy`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-03-27 17:43:50.183000
- **Ngày sửa cuối**: 2015-03-27 17:43:50.183000
...
-- =============================================
--EXEC [dbo].[Insert_rptThucChay_BaoCaoTongHopTheoWebsite_Quy_NEW] '2013-01-02'
CREATE PROCEDURE [dbo].[Insert_rptThucChay_BaoCaoTongHopTheoWebsite_Quy]
...
BEGIN
    ...
    -- Tổng hợp dữ liệu theo ngày
	   INSERT INTO @TeampData
		...
		UPDATE  rptThucChay_BaoCaoTongHopTheoWebsite_Quy 
		SET rptThucChay_BaoCaoTongHopTheoWebsite_Quy.NgayThucHien = @NgayThucHien,
		    rptThucChay_BaoCaoTongHopTheoWebsite_Quy.ThucChayPhatSinhTrongKy += td.ThucChayPhatSinhTrongKy,
		    rptThucChay_BaoCaoTongHopTheoWebsite_Quy.ThucChayPhatSinhCuoiKy += td.ThucChayPhatSinhTrongKy,
		    rptThucChay_BaoCaoTongHopTheoWebsite_Quy.KhuyenMaiPhatSinhTrongKy += td.KhuyenMaiPhatSinhTrongKy,
		    rptThucChay_BaoCaoTongHopTheoWebsite_Quy.KhuyenMaiPhatSinhCuoiKy += td.KhuyenMaiPhatSinhTrongKy,
		    rptThucChay_BaoCaoTongHopTheoWebsite_Quy.NoiBoPhatSinhTrongKy += td.NoiBoPhatSinhTrongKy,
		    rptThucChay_BaoCaoTongHopTheoWebsite_Quy.NoiBoPhatSinhCuoiKy += td.NoiBoPhatSinhTrongKy,
		...
		FROM rptThucChay_BaoCaoTongHopTheoWebsite_Quy rtchdt
		...
		SET TrangThai = 1
		FROM @TeampData td
		INNER JOIN rptThucChay_BaoCaoTongHopTheoWebsite_Quy rtchdt
		ON td.HopDongID = rtchdt.HopDongID
		AND td.DmNhanVienREF = rtchdt.DmNhanVienREF
		AND td.PhongBanREF = rtchdt.PhongBanREF
		AND td.BoPhanREF = rtchdt.BoPhanREF
		...
		AND td.DmViTriBannerREF = rtchdt.DmViTriBannerREF
     ------------------------------------Insert--------------------------------------------
     INSERT INTO rptThucChay_BaoCaoTongHopTheoWebsite_Quy
     SELECT 
				@NgayThucHien,
				td.Quy,
				td.Nam,
