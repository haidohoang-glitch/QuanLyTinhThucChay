# Stored Procedure: `sp_TC_CheckHopDongXoaPhanBo_CPM_BySanPham`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2017-09-18 16:35:18.137000
- **Ngày sửa cuối**: 2017-09-18 16:35:18.137000
...
-- =============================================
CREATE  PROCEDURE [dbo].[sp_TC_CheckHopDongXoaPhanBo_CPM_BySanPham] 
			...
			BEGIN
				...
				ELSE
					BEGIN
						...
						BEGIN
							EXEC sp_TC_InsertThucTreoThayDoi_CPM_BySanPham @HopDongChiTietID, @NgayThucHien,	@GiaTriThayDoi,	@DmWebsiteREF ,	@TenWebsite, @DmBannerID, @DmSanPhamREF
						END
						ELSE
							BEGIN
							     EXEC	sp_TC_InsertThucTreoThayDoi_CPMBySoHopDong_BySanPham	@HopDongREF ,@SoHopDong ,	@DmSanphamREF ,	@TenSanPham ,@HopDongChiTietID,	@NgaythucHien,	@GiaTriThayDoi,	@DmWebsiteREF,	@TenWebsite , @DmBannerID
							END
					END
