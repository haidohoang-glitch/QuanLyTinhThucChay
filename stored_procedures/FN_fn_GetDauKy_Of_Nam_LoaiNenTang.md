# Function: `fn_GetDauKy_Of_Nam_LoaiNenTang`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-07 12:18:24.103000
- **Ngày sửa cuối**: 2015-03-07 12:18:24.103000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Nam_LoaiNenTang] 
(
...
BEGIN
	...
	BEGIN
		...
		(
			...
			FROM rptThucChay_LoaiNenTang_Nam dstchdc
			WHERE 1 = 1
