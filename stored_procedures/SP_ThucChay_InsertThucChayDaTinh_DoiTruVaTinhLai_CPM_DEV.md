# Stored Procedure: `ThucChay_InsertThucChayDaTinh_DoiTruVaTinhLai_CPM_DEV`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2023-08-11 15:56:39.707000
- **Ngày sửa cuối**: 2023-08-15 16:02:25.407000
...
CREATE  PROCEDURE [dbo].[ThucChay_InsertThucChayDaTinh_DoiTruVaTinhLai_CPM_DEV]
	  ...
	  (
                ...
                FROM    ( SELECT 
                          ...
                          FROM      ( SELECT    A.NgayThucHien ,
                                                ...
                                                A.TenWebsite ,
                                                A.DmBannerREF
                                      FROM      (SELECT A.* FROM dbo.ThucChayTemp A WHERE 1=1 
