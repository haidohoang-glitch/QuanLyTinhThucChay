# Stored Procedure: `ThucChay_v2_Get_List_Customer_Level_1_TotalRow`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2014-05-19 09:08:01.157000
- **Ngày sửa cuối**: 2014-11-19 12:16:44.543000
...
-- ThucChay_v2_Get_List_Customer_Level_1_TotalRow '2014-05-10', '2014-05-10', NULL, NULL, NULL, NULL, NULL, NULL
-- ThucChay_v2_Get_List_Customer_Level_1_TotalRow '2014-05-10', '2014-05-10', NULL, NULL, NULL, NULL, NULL, N'''VIEW'''		
-- SELECT dbo.ThucChay_v2_Get_Filter_String('2014-05-10', '2014-05-10', NULL, NULL, NULL, NULL, NULL, NULL)
-- =============================================
CREATE PROCEDURE [dbo].[ThucChay_v2_Get_List_Customer_Level_1_TotalRow]
(	
...
BEGIN
	...
	SELECT 
		COUNT(T.GroupFieldName) AS MaxRecords
	FROM
	(
		SELECT 
			T1.ID, 
