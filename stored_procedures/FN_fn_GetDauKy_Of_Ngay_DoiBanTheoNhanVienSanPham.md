# Function: `fn_GetDauKy_Of_Ngay_DoiBanTheoNhanVienSanPham`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-07 12:18:20.783000
- **Ngày sửa cuối**: 2015-03-07 12:18:20.783000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Ngay_DoiBanTheoNhanVienSanPham] 
(
...
BEGIN
	...
	IF @isSoluong = 0
		...
		(
			...
			FROM rptThucChay_DoiBan_TheoNhanVien_SanPham_Ngay dstchdc
			WHERE 1 = 1
