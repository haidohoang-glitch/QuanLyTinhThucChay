# Function: `fn_GetDauKy_Of_Nam_DoiBanTheoKhachHang`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-07 12:18:26.253000
- **Ngày sửa cuối**: 2015-03-07 12:18:26.253000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Nam_DoiBanTheoKhachHang] 
(
...
BEGIN
	...
	IF @isSoluong = 0
		...
		(
			...
			FROM rptThucChay_DoiBan_TheoKhachHang_Nam dstchdc
			WHERE 1 = 1
