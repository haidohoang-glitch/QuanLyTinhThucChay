# Function: `fn_GetDauKy_Of_Thang_KhachHang`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-27 17:43:24.520000
- **Ngày sửa cuối**: 2015-03-27 17:43:24.520000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Thang_KhachHang] 
(
...
BEGIN
	...
	BEGIN
		...
		(
			...
			FROM rptThucChay_KhachHang_Thang dstchdc
			WHERE 1 = 1
