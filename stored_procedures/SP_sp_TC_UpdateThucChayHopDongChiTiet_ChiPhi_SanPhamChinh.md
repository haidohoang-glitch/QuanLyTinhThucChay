# Stored Procedure: `sp_TC_UpdateThucChayHopDongChiTiet_ChiPhi_SanPhamChinh`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2017-06-12 09:25:02.567000
- **Ngày sửa cuối**: 2019-03-21 15:53:23.153000
...
CREATE PROCEDURE [dbo].[sp_TC_UpdateThucChayHopDongChiTiet_ChiPhi_SanPhamChinh]
...
BEGIN
	...
	(SELECT
		...
		(
			...
			AND hdct.DmSanPhamREF IN (140,228,549,564,375,231,238,337,531,370,339,342,381,680,821)
