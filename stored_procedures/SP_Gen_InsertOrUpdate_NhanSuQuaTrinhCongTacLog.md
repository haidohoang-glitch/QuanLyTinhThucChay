# Stored Procedure: `Gen_InsertOrUpdate_NhanSuQuaTrinhCongTacLog`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2014-10-07 16:37:39.713000
- **Ngày sửa cuối**: 2014-11-19 12:16:52.140000
...
```sql
CREATE PROCEDURE [dbo].[Gen_InsertOrUpdate_NhanSuQuaTrinhCongTacLog] 	
...
@RecordStatus int 	
As 	
if(exists(select * from [NhanSuQuaTrinhCongTacLog] where [NhanSuQuaTrinhCongTacLogID] = @NhanSuQuaTrinhCongTacLogID))	
UPDATE [dbo].[NhanSuQuaTrinhCongTacLog] SET 	
...
[RecordStatus] = @RecordStatus where [NhanSuQuaTrinhCongTacLogID] = @NhanSuQuaTrinhCongTacLogID	
else 	
INSERT INTO [dbo].[NhanSuQuaTrinhCongTacLog] (	
