# Function: `fn_GetDauKy_Of_Nam_HopDongTheoSanPhamWebsite`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-27 17:43:40.147000
- **Ngày sửa cuối**: 2015-03-27 17:43:40.147000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Nam_HopDongTheoSanPhamWebsite] 
(
...
BEGIN
	...
	IF @isSoluong = 0
		...
		(
			...
			FROM rptThucChay_HopDong_TheoSanPham_Website_Nam dstchdc
			WHERE 1 = 1
