# Function: `ThucChay_GetDonViTinhSponsorByHopDongChiTietID`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2014-12-19 17:38:45.100000
- **Ngày sửa cuối**: 2014-12-19 17:38:45.100000
...
-- =============================================
CREATE FUNCTION [dbo].[ThucChay_GetDonViTinhSponsorByHopDongChiTietID]
(
...
BEGIN
	...
	SET @ResultValue = (CASE WHEN @DonViTinh IN ('CPC') THEN @DonViTinh
