# Stored Procedure: `Gen_InsertOrUpdate_ThucTreoHopDongChiTietTrinhDuyet_ThucTreo_fromSQLServer_asd14`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2021-08-31 10:51:06.397000
- **Ngày sửa cuối**: 2021-08-31 10:51:06.397000
...
```sql
/*
EXEC [dbo].[Gen_InsertOrUpdate_ThucTreoHopDongChiTietTrinhDuyet_ThucTreo_fromSQLServer_asd14]

*/
create PROCEDURE [dbo].[Gen_InsertOrUpdate_ThucTreoHopDongChiTietTrinhDuyet_ThucTreo_fromSQLServer_asd14] 	
As 	
BEGIN
	...
	CREATE TABLE #ThucTreoHopDongChiTietTrinhDuyet_Thuctreo (
	  ...
	  record_status SMALLINT
		...
		SELECT tc.Id AS ThucTreoHopDongChiTietTrinhDuyetID,
               ...
               tc.DeletedStatus,
			   '' AS linkBai,
			   (select top (1) tca.NhanVien_Id from  asd14.ThucTreo.dbo.[ThucTreo_ChiPhi_Account] tca where tca.thuctreo_chiphi_REF = tc.id and tca.deleted_status = 0) AS ListNhanVienREF,
               0 status_table FROM asd14.ThucTreo.dbo.ThucTreo_ChiPhi tc
