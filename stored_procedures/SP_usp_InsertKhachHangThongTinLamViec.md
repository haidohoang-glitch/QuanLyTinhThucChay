# Stored Procedure: `usp_InsertKhachHangThongTinLamViec`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2013-08-20 16:13:21.567000
- **Ngày sửa cuối**: 2014-11-19 12:16:46.040000
...
--=============================================
-- Author:   Nhat Mai Quy
-- Stored Procedure Name: [dbo].[usp_InsertKhachHangThongTinLamViec]
-- Create Date: Monday, August 19, 2013
-- Description: 
--=============================================

CREATE PROCEDURE [dbo].[usp_InsertKhachHangThongTinLamViec]
...
INSERT INTO [dbo].[KhachHangThongTinLamViec] (
