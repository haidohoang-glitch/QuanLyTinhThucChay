# Stored Procedure: `Gen_InsertOrUpdate_ThongTinKhachhang`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2014-09-16 15:42:59.110000
- **Ngày sửa cuối**: 2017-01-08 09:29:38.080000
...
```sql
CREATE PROCEDURE [dbo].[Gen_InsertOrUpdate_ThongTinKhachhang] 	
...
@tinh_thanhpho int 	
As 	
if(exists(select * from [ThongTinKhachhang] where 1>2))	
UPDATE [dbo].[ThongTinKhachhang] SET 	
[KhachHangThongTinChungID] = @KhachHangThongTinChungID,	
...
[quanhuyen] = @quanhuyen,	
[tinh_thanhpho] = @tinh_thanhpho where 1>2	
else 	
INSERT INTO [dbo].[ThongTinKhachhang] (	
