# Stored Procedure: `ThucChay_CPMDonViGoi_GhiNhanThayDoi_ThucChayDaTinh_Manual_dev`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2026-02-09 09:52:44.297000
- **Ngày sửa cuối**: 2026-02-09 10:06:41.920000
...
```sql
/*
EXEC dbo.[ThucChay_CPMDonViGoi_GhiNhanThayDoi_ThucChayDaTinh_Manual_dev]
    @NgayGhiNhan = '2026-02-08',  -- date
    @NgayDanhSoGioiHan = '2023-02-08',  -- date
    @SoHopDong = N'QC0440226',  -- nvarchar
    @HopDongChiTietID = 777603  -- int
*/
     

--DECLARE @DmInterger TABLE (ID INT)
CREATE PROCEDURE [dbo].[ThucChay_CPMDonViGoi_GhiNhanThayDoi_ThucChayDaTinh_Manual_dev]
    @NgayGhiNhan DATE,
