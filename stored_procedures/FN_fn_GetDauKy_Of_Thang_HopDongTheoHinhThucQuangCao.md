# Function: `fn_GetDauKy_Of_Thang_HopDongTheoHinhThucQuangCao`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-27 17:43:26.247000
- **Ngày sửa cuối**: 2015-03-27 17:43:26.247000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Thang_HopDongTheoHinhThucQuangCao] 
(
...
BEGIN
	...
	IF @isSoluong = 0
		...
		(
			...
			FROM rptThucChay_HopDong_TheoHinhThucQuangCao_Thang dstchdc
			WHERE 1 = 1
