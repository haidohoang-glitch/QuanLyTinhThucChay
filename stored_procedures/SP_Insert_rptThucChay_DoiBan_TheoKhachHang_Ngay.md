# Stored Procedure: `Insert_rptThucChay_DoiBan_TheoKhachHang_Ngay`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-03-07 12:18:30.127000
- **Ngày sửa cuối**: 2015-03-07 12:18:30.127000
...
CREATE PROCEDURE [dbo].[Insert_rptThucChay_DoiBan_TheoKhachHang_Ngay] 
...
BEGIN
	...
	WHILE @NgayThucHien <= @ToDate
		BEGIN
			 INSERT INTO rptThucChay_DoiBan_TheoKhachHang_Ngay
			 SELECT 
				...
				dstchdc.NhomREF,
				'' DienGiai,
			  [dbo].[fn_GetDauKy_Of_Ngay_DoiBanTheoKhachHang] 
				(
				  dstchdc.DmKhachHangREF,
				  dstchdc.PhongBanREF,
	              dstchdc.BoPhanREF,
