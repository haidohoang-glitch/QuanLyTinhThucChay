# Stored Procedure: `ThucChayDaTinh_ExcReInsertThucChayDaTinhAdmarket_haidh`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-06-10 16:07:03.990000
- **Ngày sửa cuối**: 2017-06-29 16:58:13.120000
...
-- =============================================
/*
	EXEC dbo.ThucChayDaTinh_ExcReInsertThucChayDaTinhAdmarket_haidh '2015-03-09'
*/
CREATE PROCEDURE [dbo].[ThucChayDaTinh_ExcReInsertThucChayDaTinhAdmarket_haidh]
...
BEGIN
	...
	WHERE 1=1
		AND A.DmSanPhamREF IN (144, 299, 337, 585, 628)
	...
	BEGIN
		...
		BEGIN 
			...
			*/
			...
			IF (@sanPhamId = 585 OR @sanPhamId = 144 OR @sanPhamId = 628)
				SET @donViTinh = 'CLICK'
