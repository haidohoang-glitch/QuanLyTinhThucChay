# Stored Procedure: `Insert_rptThucChay_NhanVien_TheoKhachHang_SanPham_Nam`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-03-07 12:18:45.897000
- **Ngày sửa cuối**: 2015-03-07 12:18:45.897000
...
-- =============================================
CREATE PROCEDURE [dbo].[Insert_rptThucChay_NhanVien_TheoKhachHang_SanPham_Nam]
...
BEGIN
    ...
    -----------------------------Du lieu phat sinh-----
	 ...
	 SELECT DISTINCT
	     ...
	     GROUP BY
		       ...
		       rtchdn.DmSanPhamREF
	---------------------------------UPDATE DL----------------------------------------
	UPDATE rptThucChay_NhanVien_TheoKhachHang_SanPham_Nam
	...
	FROM rptThucChay_NhanVien_TheoKhachHang_SanPham_Nam r
	...
	-----------------------------------------INSERT---------------------------------------
	INSERT INTO rptThucChay_NhanVien_TheoKhachHang_SanPham_Nam
				SELECT 
				@NgayThucHien,
				td.Nam,
			    td.TenNhanVien, 
	           ...
	           td.DmSanPhamREF,
	           '',
				[dbo].[fn_GetDauKy_Of_Nam_NhanVienTheoKhachHangSanPham]
				(
				  td.DmNhanVienREF ,
				  td.PhongBanREF ,
				  td.BoPhanREF ,
