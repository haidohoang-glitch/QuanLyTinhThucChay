# Stored Procedure: `Insert_rptThucChay_DoiBan_Nam`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-03-27 17:43:47.307000
- **Ngày sửa cuối**: 2015-03-27 17:43:47.307000
...
-- =============================================
CREATE PROCEDURE [dbo].[Insert_rptThucChay_DoiBan_Nam]
...
BEGIN
	...
	-- interfering with SELECT statements.
     ...
     FROM rptThucChay_DoiBan_Nam rtcdbt
     ...
     AND td.Nam = rtcdbt.Nam
     --------------------------------insert dl-------------------------------------
     INSERT INTO rptThucChay_DoiBan_Nam
				SELECT 
				@NgayThucHien,
				td.Nam,
				td.TenPhongBan,
