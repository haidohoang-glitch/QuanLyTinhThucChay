# Stored Procedure: `ThucChay_ExcInsertThucChayDaTinhMobile_v3`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-01-08 16:19:30.870000
- **Ngày sửa cuối**: 2015-02-25 17:50:51.530000
...
CREATE PROCEDURE [dbo].[ThucChay_ExcInsertThucChayDaTinhMobile_v3] 
	@StartDate datetime,
	@EndDate DATETIME,
...
BEGIN
	...
	DECLARE @SoHopDong NVARCHAR(50), @ProductUnitName NVARCHAR(50),@BannerType INT,
			@TenWebsite NVARCHAR(50), @TypeProduct INT,
	...
	Begin
		...
		DECLARE Record_Cursor CURSOR FOR 
			...
			AND A.HopDongChiTietREF = @HopDongChiTietREF
