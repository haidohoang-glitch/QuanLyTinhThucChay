# Stored Procedure: `prc_asd_xuly_confirm_data_vuothopdong`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2017-09-11 15:02:53.080000
- **Ngày sửa cuối**: 2017-09-11 15:02:53.100000
...
-- =============================================
CREATE PROCEDURE [dbo].[prc_asd_xuly_confirm_data_vuothopdong] 
...
BEGIN
	...
	----------------------------------------------------------------------------------------------
	create table #ThucChayAdmarket_ViewPlus_HopDongVuotGiaTri_team
	(
	...
	----------------------------------------------------------------------------------------------
	insert into #ThucChayAdmarket_ViewPlus_HopDongVuotGiaTri_team
	select 
		[user_id],
		[username] ,
		[isnoibo],
	...
	from [dbo].[ThucChayAdmarket_ViewPlus_HopDong_online] 
	where 1=1
	...
	inner join #ThucChayAdmarket_ViewPlus_HopDongVuotGiaTri_team b
	...
	declare 
			...
			@data_type int ,
			@giatrilech money
	DECLARE db_cursor_xuly_viewplus_vuot_hopdong CURSOR FOR  
	SELECT 
			 [contract_number],
			 [contract_number_change],
			 [user_id],
			 ...
			 [domain_tt_view],
			 [data_type]
	FROM #ThucChayAdmarket_ViewPlus_HopDongVuotGiaTri_team
	WHERE domain_money > 0

	OPEN db_cursor_xuly_viewplus_vuot_hopdong   
	FETCH NEXT FROM db_cursor_xuly_viewplus_vuot_hopdong INTO   @SoHopDong ,
																@SoHopDong_change ,
																@user_id , 
																@DmSanPhamREF ,
																@TenSanPham ,
	...
	BEGIN  
		   ...
		   exec prc_insert_ThucChayAdmarket_ViewPlus_HopDong_online     @user_id ,
																		...
																		4 
	       --------------------------------------------------------------------------------- 
		   exec [dbo].[prc_asd_xuly_confirm_data_vuothopdong_chitiet] @SoHopDong ,
																@SoHopDong_change ,
																@user_id , 
																@DmSanPhamREF ,
																@TenSanPham ,
	...
	CLOSE db_cursor_xuly_viewplus_vuot_hopdong   
	DEALLOCATE db_cursor_xuly_viewplus_vuot_hopdong
	----------------------------------------------------------------------------------------------
	drop table #ThucChayAdmarket_ViewPlus_HopDongVuotGiaTri_team
