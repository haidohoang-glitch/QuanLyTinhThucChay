# Stored Procedure: `Rpt_InsertWebsiteProductByNgayThucHien`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2014-10-16 15:21:35.427000
- **Ngày sửa cuối**: 2014-11-19 12:17:55.003000
...
```sql
--EXEC Rpt_InsertWebsiteProductByNgayThucHien '2014-01-01'
CREATE PROCEDURE [dbo].[Rpt_InsertWebsiteProductByNgayThucHien]
	@NgayThucHien DATETIME
AS
BEGIN
	INSERT INTO rptWebsiteProduct
	SELECT
	b.TenWebsite
	, b.DmWebsiteREF 
	, sum(b.Adpage)Adpage
	, SUM(b.Sponsorpost)Sponsorpost
	, SUM(b.DangTin)DangTin
	, SUM(b.BalloonAds)BalloonAds 
	, SUM(b.TVCOnline)TVCOnline
	, SUM(b.CPMMass)CPMMass
	, SUM(b.Mobile)Mobile
	...
	,
	( CASE WHEN (a.DmSanPhamREF = 585) THEN (a.ThanhTienSauTrietKhauThucChay + a.GiaTriThayDoi)
		ELSE 0 
		END
	) Adx
	,
	( CASE WHEN (a.DmSanPhamREF NOT IN (240,241,243,271,381,247,342,242,269,423,250,563,306,141,531,238,231,337,
		299,144,420,251,560,535,561,253,252,385,564,370,339,245,549,140,339,305,585)) THEN (a.ThanhTienSauTrietKhauThucChay + a.GiaTriThayDoi)
		ELSE 0 
		END
	) SPKhac
	, a.DmWebsiteREF
	...
	--(year(a.NgayThucHien) = @year AND MONTH(a.NgayThucHien) = @month)
	AND (a.TenMaHopDong NOT IN ('SH','NB'))
	)b
	WHERE b.DmWebsiteREF IN 
	(
		SELECT rptDmWebsite.DmWebsiteREF FROM rptDmWebsite
	)
	GROUP BY b.DmWebsiteREF, b.TenWebsite
	UNION
	SELECT
	N'Website Khác' website_khac
	, 0 dmwebsite
	, sum(b.Adpage)Adpage
	, SUM(b.Sponsorpost)Sponsorpost
	, SUM(b.DangTin)DangTin
