# Stored Procedure: `Syn_ThucTreoHopDongChiTietTrinhDuyet_ThucTreo_fromSQLServer_ByID`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2020-06-25 09:55:27.343000
- **Ngày sửa cuối**: 2021-11-16 11:01:43.453000
...
*/
CREATE PROCEDURE [dbo].[Syn_ThucTreoHopDongChiTietTrinhDuyet_ThucTreo_fromSQLServer_ByID] 	
@Id int
As 	
BEGIN
	...
	WHERE ThucTreoHopDongChiTietTrinhDuyetID = @Id
	...
	CREATE TABLE #ThucTreoHopDongChiTietTrinhDuyet_Thuctreo (
	  ...
	  record_status SMALLINT
		...
		where dc.ThucTreoHopDongChiTietTrinhDuyetID = @Id
	...
	and B.ThucTreoHopDongChiTietTrinhDuyetID = @Id
	...
	and dchdct.ThucTreoHopDongChiTietTrinhDuyetID = @Id
