# Stored Procedure: `ThucChay_InsertThucChayDaTinh_CPR_TruongHopTreoSauChay`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2017-12-12 15:44:13.010000
- **Ngày sửa cuối**: 2017-12-12 15:44:13.010000
...
CREATE  PROCEDURE [dbo].[ThucChay_InsertThucChayDaTinh_CPR_TruongHopTreoSauChay]
    ...
    BEGIN
        ...
        INSERT  INTO dbo.ThucChayDaTinh
                SELECT  NEWID()
                      ...
                      , 0 SoLuongKMThayDoi
                      , 0 GiaTriKMThayDoi
                      , 'CPM: ThucChay_InsertThucChayDaTinh_CPR_TruongHopTreoSauChay' GhiChu
                FROM    ( SELECT 
