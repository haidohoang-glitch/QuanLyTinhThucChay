# Stored Procedure: `ThucChay_InsertThucTreoThayDoi_CPD`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2016-03-17 09:21:21.303000
- **Ngày sửa cuối**: 2023-07-05 14:49:31.550000
...
CREATE  PROCEDURE [dbo].[ThucChay_InsertThucTreoThayDoi_CPD] 
	@HopDongChiTiet INT,
...
BEGIN
	...
	'' PheDuyetBy,
	'' PheDuyetAt,
	(CASE WHEN TD.ChietKhau <> 100 THEN @SoLuongThayDoi	ELSE 0	END) SoLuongThayDoi,
	(CASE WHEN TD.ChietKhau <> 100 THEN 0	ELSE @SoLuongThayDoi	END) SoLuongKMThayDoi,
	(CASE WHEN TD.ChietKhau <> 100 THEN 0	ELSE @GiaTriThayDoi	END) GiaTriKMThayDoi,
	...
	(CASE WHEN C.ChietKhau <> 100 THEN @GiaTriThayDoi
	ELSE 0
