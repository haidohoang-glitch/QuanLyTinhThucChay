# Function: `ThucChay_GenSQLCommandAdmarketForQuery`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2014-07-28 16:22:23.390000
- **Ngày sửa cuối**: 2015-08-05 15:13:35.450000
...
-- =============================================
CREATE FUNCTION [dbo].[ThucChay_GenSQLCommandAdmarketForQuery] 
(
	@StartDate datetime,
	@EndDate datetime,
...
BEGIN
	...
	SET @Sql = '
		SELECT * FROM dbo.GetDataThucChayAdmarketByParams('+ @DauNhay  + CONVERT(VARCHAR(50),@StartDate) + @DauNhay + ',' + @DauNhay  + CONVERT(VARCHAR(50),@EndDate) + @DauNhay + ')'
