# Stored Procedure: `Insert_rptThucChay_DoiBan_TheoNhanVien_SanPham_Ngay`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-03-07 12:18:34.993000
- **Ngày sửa cuối**: 2015-03-07 12:18:34.993000
...
CREATE PROCEDURE [dbo].[Insert_rptThucChay_DoiBan_TheoNhanVien_SanPham_Ngay] 
...
BEGIN
	...
	WHILE @NgayThucHien <= @ToDate
		BEGIN
			 INSERT INTO rptThucChay_DoiBan_TheoNhanVien_SanPham_Ngay
			 SELECT 
				...
				'',
			   [dbo].[fn_GetDauKy_Of_Ngay_DoiBanTheoNhanVienSanPham] 
				(
				  dstchdc.DmNhanVienREF,
				  dstchdc.PhongBanREF,
	              dstchdc.BoPhanREF,
