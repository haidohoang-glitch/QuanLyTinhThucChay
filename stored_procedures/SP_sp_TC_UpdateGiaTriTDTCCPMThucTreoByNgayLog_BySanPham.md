# Stored Procedure: `sp_TC_UpdateGiaTriTDTCCPMThucTreoByNgayLog_BySanPham`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2017-09-18 16:15:04.143000
- **Ngày sửa cuối**: 2017-09-18 16:15:04.143000
...
-- =============================================
CREATE PROCEDURE [dbo].[sp_TC_UpdateGiaTriTDTCCPMThucTreoByNgayLog_BySanPham] 
	        ...
	        BEGIN
	            ...
	            FROM   (
	                       ...
	                       WHERE  (
	                              ...
	                              AND C.DmSanPhamREF = @DmSanPhamID
	                   ) TD
