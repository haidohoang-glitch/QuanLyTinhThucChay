# Stored Procedure: `ThucChayDaTinh_CheckVaUpdateGiaTriThayDoi_CreatorContent_ByHopDongChiTiet`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2025-12-13 09:34:46.827000
- **Ngày sửa cuối**: 2025-12-13 10:01:01.447000
...
-- =============================================
/*
	EXEC [dbo].[ThucChayDaTinh_CheckVaUpdateGiaTriThayDoi_CreatorContent_ByHopDongChiTiet]
	-- Add the parameters for the stored procedure here
	@NgayThucHien = '2025-12-12',
	@HopDongChiTietREF = 768441
*/
CREATE PROCEDURE [dbo].[ThucChayDaTinh_CheckVaUpdateGiaTriThayDoi_CreatorContent_ByHopDongChiTiet]
	-- Add the parameters for the stored procedure here
	...
	BEGIN
		...
		BEGIN
			...
			BEGIN
				...
				BEGIN
					--HAIDH THUC HIEN COMMENT DO CO TRƯƠNG HỢP HOP DONG THAY DOI SL = ROI THAY DOI LẠI => KO TINH LẠI DƯỢC 13122025
					--print 'thay doi thanh tien t.SELL_MONEY_VND > t.SELL_MONEY_VND_BF'
					----NEU TON TAI THUC CHAY VOI HOPDONGCHITIET
					--IF(EXISTS(SELECT top (1) tcdt.HopDongChiTietREF FROM DBO.ThucChayDaTinh tcdt
					--WHERE tcdt.HopDongId = @CONTRACT_ID
					--AND tcdt.HopDongChiTietREF = @CONTRACT_DETAIL_ID
					...
					--BEGIN
					--	print N' thuc hien tinh gia tri thay doi'
				...
				BEGIN
					...
					BEGIN
						print 'thay doi thanh tien t.SELL_MONEY_VND < t.SELL_MONEY_VND_BF 1111'
						SET @GhiChu_DoiTruThucChay = N'Thay doi thanhtien '  + N' ,Doi tru CreatorContent cho hdct: ' + CONVERT(NVARCHAR(50),@CONTRACT_DETAIL_ID) 
						SET @Ghichu_TinhLaiThucChay = N'Thay doi thanhtien '  + N' ,Tinh lai CreatorContent cho hdct: ' + CONVERT(NVARCHAR(50),@CONTRACT_DETAIL_ID) 
						print @GhiChu_DoiTruThucChay
						EXEC [dbo].[sp_ThucChay_DoiTruVaTinhLai_CreatorContent]
