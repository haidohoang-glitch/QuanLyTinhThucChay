# Stored Procedure: `KiemTra_DaTinh_NhanHangCPCAdmarket_TinhDungDu`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2016-11-21 10:37:50.690000
- **Ngày sửa cuối**: 2016-11-21 10:37:50.690000
...
-- =============================================
CREATE PROCEDURE [dbo].[KiemTra_DaTinh_NhanHangCPCAdmarket_TinhDungDu]
...
BEGIN
 ...
 --AND t1.ThanhTien > 0  AND (ABS(T1.moneys - ISNULL(T2.TienThucChay_tcdt,0)) > 100000) AND (ABS(T1.ThanhTien -T2.TienThucChay_tcdt) > 2  )
 -----------------------------------------------------------
