# Stored Procedure: `ThucChay_CPMthuan_DoiTruTinhLai_ThucChayDaTinh`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2025-04-15 10:06:48.880000
- **Ngày sửa cuối**: 2025-04-15 10:07:52.170000

## Parameters

| Parameter | Type | Output |
|-----------|------|--------|
| `@Thucchay_CPMthuan_DmTinhlai` | `DataType_Thucchay_CPMthuan_DmTinhlai` | No |

## Definition (Source Code)

```sql

CREATE PROCEDURE [dbo].[ThucChay_CPMthuan_DoiTruTinhLai_ThucChayDaTinh] 
    @Thucchay_CPMthuan_DmTinhlai DataType_Thucchay_CPMthuan_DmTinhlai READONLY
AS
BEGIN
	...
	SELECT NEWID(), HopDongID = hd.HopDongID,
					...
					DotChayHopDong =  N'Tính lại CPM',--ISNULL(dbo.GetDotChayBookingByHopDongChiTiet(tc.HopDongChiTietREF,'Y'),''),
					...
					GhiChu =  N'Tính lại: SP tối ưu [dbo].[ThucChay_CPMthuan_DoiTruTinhLai_ThucChayDaTinh] do ' + tc.LyDo
			FROM @Thucchay_CPMthuan_DmTinhlai tc
