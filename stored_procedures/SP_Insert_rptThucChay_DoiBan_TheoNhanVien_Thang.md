# Stored Procedure: `Insert_rptThucChay_DoiBan_TheoNhanVien_Thang`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-03-07 12:18:34.367000
- **Ngày sửa cuối**: 2015-03-07 12:18:34.367000
...
-- =============================================
CREATE PROCEDURE [dbo].[Insert_rptThucChay_DoiBan_TheoNhanVien_Thang]
...
BEGIN
	...
	-- interfering with SELECT statements.
     ...
     rtchdn.DmNhanVienREF
     ----------------------------------UPDATE DL-----------------------------
     UPDATE rptThucChay_DoiBan_TheoNhanVien_Thang
     SET
     ...
     FROM rptThucChay_DoiBan_TheoNhanVien_Thang rtcdbt
     ...
     AND td.Nam = rtcdbt.Nam
     --------------------------------insert dl-------------------------------------
     INSERT INTO rptThucChay_DoiBan_TheoNhanVien_Thang
				SELECT 
				...
				td.NhomREF,
				'',
				[dbo].[fn_GetDauKy_Of_Thang_DoiBanTheoNhanVien]
				(
				  td.DmNhanVienREF,
				  td.PhongBanREF,
				  td.BoPhanREF,
