# Function: `fn_GetDauKy_Of_Ngay_NganhHangTheoSanPham`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-31 11:21:02.870000
- **Ngày sửa cuối**: 2015-03-31 11:21:02.870000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Ngay_NganhHangTheoSanPham] 
(
...
BEGIN
	...
	BEGIN
		...
		(
			...
			FROM rptThucChay_NganhHang_TheoSanPham_Ngay dstchdc
			WHERE 1 = 1
