# Stored Procedure: `Insert_rptThucChay_DoiBan_TheoSanPham_Nam`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-03-07 12:18:34.163000
- **Ngày sửa cuối**: 2015-03-07 12:18:34.163000
...
-- =============================================
CREATE PROCEDURE [dbo].[Insert_rptThucChay_DoiBan_TheoSanPham_Nam]
...
BEGIN
	...
	-- interfering with SELECT statements.
     ...
     rtchdn.DmSanPhamREF
     ----------------------------------UPDATE DL-----------------------------
     UPDATE rptThucChay_DoiBan_TheoSanPham_Nam
     SET
     ...
     FROM rptThucChay_DoiBan_TheoSanPham_Nam rtcdbt
     ...
     AND td.Nam = rtcdbt.Nam
     --------------------------------insert dl-------------------------------------
     INSERT INTO rptThucChay_DoiBan_TheoSanPham_Nam
				SELECT 
				...
				td.NhomREF,
				'',
				[dbo].[fn_GetDauKy_Of_Nam_DoiBanTheoSanPham]
				(
				  td.DmSanPhamREF,
				  td.PhongBanREF,
				  td.BoPhanREF,
