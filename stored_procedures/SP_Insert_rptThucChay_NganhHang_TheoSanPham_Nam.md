# Stored Procedure: `Insert_rptThucChay_NganhHang_TheoSanPham_Nam`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-03-31 11:21:05.267000
- **Ngày sửa cuối**: 2015-03-31 11:21:05.267000
...
-- =============================================
CREATE PROCEDURE [dbo].[Insert_rptThucChay_NganhHang_TheoSanPham_Nam]
	...
	INSERT INTO @TeampData
			...
			GROUP BY 
			   rtchdn.TenNhanVien,
				...
				rtchdn.DmSanPhamREF
	-----------------------------------UPDATE DL-----------------------------
	UPDATE  rptThucChay_NganhHang_TheoSanPham_Nam
		SET rptThucChay_NganhHang_TheoSanPham_Nam.NgayThucHien = @NgayThucHien,
		    rptThucChay_NganhHang_TheoSanPham_Nam.ThucChayPhatSinhTrongKy += td.ThucChayPhatSinhTrongKy,
		    rptThucChay_NganhHang_TheoSanPham_Nam.ThucChayPhatSinhCuoiKy += td.ThucChayPhatSinhTrongKy,
		    rptThucChay_NganhHang_TheoSanPham_Nam.KhuyenMaiPhatSinhTrongKy += td.KhuyenMaiPhatSinhTrongKy,
		    rptThucChay_NganhHang_TheoSanPham_Nam.KhuyenMaiPhatSinhCuoiKy += td.KhuyenMaiPhatSinhTrongKy,
		    rptThucChay_NganhHang_TheoSanPham_Nam.NoiBoPhatSinhTrongKy += td.NoiBoPhatSinhTrongKy,
		    rptThucChay_NganhHang_TheoSanPham_Nam.NoiBoPhatSinhCuoiKy += td.NoiBoPhatSinhTrongKy,
		...
		FROM rptThucChay_NganhHang_TheoSanPham_Nam rtchdt
		...
		AND td.Nam = rtchdt.Nam
		-------------------------------------------------INSERT DL
	    INSERT INTO rptThucChay_NganhHang_TheoSanPham_Nam
				SELECT 
				@NgayThucHien,
				td.Nam,
				 td.TenNganhHang, 
