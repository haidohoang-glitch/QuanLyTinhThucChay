# Stored Procedure: `sp_ThucChayDaTinh_ReInsertByHopDong_ThucTreoThayDoi_dev`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2025-06-04 09:44:46.773000
- **Ngày sửa cuối**: 2025-06-04 09:51:56.157000
...
--EXEC [dbo].[sp_ThucChayDaTinh_ReInsertByHopDong_ThucTreoThayDoi_dev]  '2025-06-03'
CREATE PROCEDURE [dbo].[sp_ThucChayDaTinh_ReInsertByHopDong_ThucTreoThayDoi_dev]
...
BEGIN
	...
	FROM dbo.ThucChayHopDongChiTiet tc 
		...
		WHERE (EXISTS(SELECT TOP (1) ch.ID  FROM dbo.CauHinhNhomTinhDoanhSoThucChay ch 
			...
			AND tc.HopDongChiTietREF = 755111
