# Stored Procedure: `sp_ThucChayDaTinh_Mobile_UpdateGiaTriThayDoi_Test`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2023-05-12 14:29:51.800000
- **Ngày sửa cuối**: 2023-05-12 14:32:20.633000
...
-- =============================================
--EXEC [sp_ThucChayDaTinh_Mobile_UpdateGiaTriThayDoi_Test]  '2023-05-11 00:00:00.000' ,'2023-05-11 00:00:00.000', N'QC1660323'
CREATE PROCEDURE [dbo].[sp_ThucChayDaTinh_Mobile_UpdateGiaTriThayDoi_Test]
                    ...
                    BEGIN			
                        ...
                        IF @count_HDCT > 0
                            BEGIN		
								...
								PRINT @count_HDCT
								PRINT N'sp_TC_CheckHopDongCoThayDoi_Mobile_Test'
                                EXEC dbo.sp_TC_CheckHopDongCoThayDoi_Mobile_Test @HopDongID,
                                    @SoHopDong, 342, @HopDongChiTietID,
                                    @NgayThucHien, @BannerType, @DmBannerREF
                            END
                        ELSE
                            BEGIN
								print N'sp_TC_CheckHopDongXoaPhanBo_Mobile'
