# Function: `fn_GetDauKy_Of_Nam_KhachHangTheoSanPham`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-27 17:43:39.430000
- **Ngày sửa cuối**: 2015-03-27 17:43:39.430000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Nam_KhachHangTheoSanPham] 
(
...
BEGIN
	...
	IF @isSoluong = 0
		...
		(
			...
			FROM rptThucChay_KhachHang_TheoSanPham_Nam dstchdc
			WHERE 1 = 1
