# Stored Procedure: `ThucChay_TablePageNumber_v1`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2014-02-25 11:31:10.810000
- **Ngày sửa cuối**: 2014-10-14 10:39:52.653000
...
```sql
CREATE PROCEDURE [dbo].[ThucChay_TablePageNumber_v1] 
...
BEGIN	
	...
	BEGIN
		...
		SET @Sql = '
			...
			(
				SELECT
					T2.'+ @GroupFieldName+',T2.ID, T2.DonViTinh,SUM(0) AS HopDongChiTietREF,T2.LechBooking,
