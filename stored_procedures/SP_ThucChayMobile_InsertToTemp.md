# Stored Procedure: `ThucChayMobile_InsertToTemp`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2014-05-21 10:45:26.493000
- **Ngày sửa cuối**: 2016-06-16 17:43:19.207000
...
CREATE PROCEDURE [dbo].[ThucChayMobile_InsertToTemp] 
...
BEGIN
	...
	-- Delete if exists
	DELETE ThucChayMobileTemp WHERE dt BETWEEN @StartDate AND @EndDate AND typeproduct = 10

	-- Insert Data to temp table
	INSERT INTO ThucChayMobileTemp
    SELECT 
	...
	(
		...
		FROM dbo.ThucChay AS tcm
		WHERE tcm.TypeProduct = 10
