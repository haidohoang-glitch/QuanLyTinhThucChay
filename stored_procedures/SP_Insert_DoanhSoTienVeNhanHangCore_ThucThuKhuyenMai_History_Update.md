# Stored Procedure: `Insert_DoanhSoTienVeNhanHangCore_ThucThuKhuyenMai_History_Update`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-06-12 10:47:00.667000
- **Ngày sửa cuối**: 2015-06-12 10:47:00.667000
...
-- =============================================
--EXEC [dbo].[Insert_DoanhSoTienVeNhanHangCore_ThucThuKhuyenMai_History] '2013-01-01'
CREATE PROCEDURE [dbo].[Insert_DoanhSoTienVeNhanHangCore_ThucThuKhuyenMai_History_Update]
	-- Add the parameters for the stored procedure here
	@NgayThucHien DATETIME,
	@HopDongID_in INT,
	@HopDongChiTietID_in INT,
...
BEGIN
	...
	DECLARE @ChietKhau FLOAT, @DonGia FLOAT, @SoLuong BIGINT, @ThanhTien FLOAT,@TrangThaiHopDong INT ,@DmMaHopDongREF INT;
	DECLARE @NgayDanhSo DATETIME, @NgayKyHopDong DATETIME, @NgayThanhToan DATETIME, @SoHoaDon NVARCHAR(50), @ThongTinTienVeID INT;
	...
	FROM HopDong hd
		...
		(SELECT  tthd.HopDongREF,CONVERT(DATE,tthd.NgayThanhToan) AS NgayThanhToan, tthd.ThongTinTienVeID, tthd.GiaTri
		   FROM ThongTinTienVe tthd WHERE  
		     tthd.DeletedStatus = 0 AND tthd.ThongTinTienVeID = @ThongTinTienVeID_in) A
		...
		AND hdct.HopDongChiTietID = @HopDongChiTietID_in
	...
	,@NgayThanhToan,@ThongTinTienVeID,@DmMaHopDongREF
	WHILE @@FETCH_STATUS = 0   
	BEGIN   
		   SET @DmNhanHangREF = 0
			SET @TenNhanHang = ''
			SET @CountNhan = 0
			SET @ThanhTienHoaDon = (SELECT dbo.fn_GetThanhTienByNgay_DoanhSoTienVeCore(@NgayThanhToan,@HopDongID,@ThongTinTienVeID,@ThanhTien))
