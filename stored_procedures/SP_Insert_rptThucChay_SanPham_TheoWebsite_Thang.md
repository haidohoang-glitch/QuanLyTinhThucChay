# Stored Procedure: `Insert_rptThucChay_SanPham_TheoWebsite_Thang`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-03-27 17:44:02.433000
- **Ngày sửa cuối**: 2015-03-27 17:44:02.433000
...
-- =============================================
--EXEC [dbo].[Insert_rptThucChay_SanPham_TheoWebsite_Thang] '2013-01-01'
CREATE PROCEDURE [dbo].[Insert_rptThucChay_SanPham_TheoWebsite_Thang]
...
BEGIN
	...
	INSERT INTO @TeampData
			...
			GROUP BY 
				...
				rtchdn.DmWebsiteREF
	-----------------------------------UPDATE DL-----------------------------
	UPDATE  rptThucChay_SanPham_TheoWebsite_Thang 
		...
		FROM rptThucChay_SanPham_TheoWebsite_Thang rtchdt
		...
		AND td.Nam = rtchdt.Nam
		-------------------------------------------------INSERT DL
	    INSERT INTO rptThucChay_SanPham_TheoWebsite_Thang
				SELECT 
				@NgayThucHien,
				td.Thang,
				td.Nam,
	            ...
	            td.TenWebsite,
	            td.DmWebsiteREF,
				[dbo].[fn_GetDauKy_Of_Ngay_SanPhamTheoWebsite]
				(
				td.DmNhanVienREF,
				  td.PhongBanREF,
				  td.BoPhanREF,
