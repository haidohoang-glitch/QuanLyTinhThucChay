# Stored Procedure: `Insert_rptThucChay_SanPham_TheoWebsite_Nam`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-03-27 17:44:02.790000
- **Ngày sửa cuối**: 2015-03-27 17:44:02.790000
...
-- =============================================
--EXEC [dbo].[Insert_rptThucChay_SanPham_TheoWebsite_Nam] '2013-01-01'
CREATE PROCEDURE [dbo].[Insert_rptThucChay_SanPham_TheoWebsite_Nam]
...
BEGIN
	...
	INSERT INTO @TeampData
			...
			GROUP BY 
				...
				rtchdn.DmWebsiteREF
	-----------------------------------UPDATE DL-----------------------------
	UPDATE  rptThucChay_SanPham_TheoWebsite_Nam 
		...
		FROM rptThucChay_SanPham_TheoWebsite_Nam rtchdt
		...
		-------------------------------------------------INSERT DL
	    INSERT INTO rptThucChay_SanPham_TheoWebsite_Nam
				SELECT 
				@NgayThucHien,
				td.Nam,
			    td.DmSanPhamREF ,
