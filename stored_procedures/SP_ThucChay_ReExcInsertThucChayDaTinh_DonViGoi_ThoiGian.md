# Stored Procedure: `ThucChay_ReExcInsertThucChayDaTinh_DonViGoi_ThoiGian`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2021-06-25 18:13:22.483000
- **Ngày sửa cuối**: 2021-11-01 18:14:06.323000
...
CREATE PROCEDURE [dbo].[ThucChay_ReExcInsertThucChayDaTinh_DonViGoi_ThoiGian] 
	@StartDate datetime,
	@EndDate datetime,
...
AS
BEGIN
	DECLARE  @Count INT =0, @NgayGioiHanHopDong DATETIME = '2020-01-01'
	...
	(
		...
		, tc.BannerTypeName, SUM(tc.TongViewThucChay) TongViewThucChay, SUM(tc.TongClickThucChay) TongClickThucChay  FROM dbo.ThucChay tc
