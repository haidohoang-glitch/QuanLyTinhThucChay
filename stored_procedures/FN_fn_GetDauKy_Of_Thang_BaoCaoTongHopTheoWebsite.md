# Function: `fn_GetDauKy_Of_Thang_BaoCaoTongHopTheoWebsite`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-27 17:43:27.810000
- **Ngày sửa cuối**: 2015-03-27 17:43:27.810000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Thang_BaoCaoTongHopTheoWebsite] 
(
...
BEGIN
	...
	IF @isSoluong = 0
		...
		(
			...
			FROM rptThucChay_BaoCaoTongHopTheoWebsite_Thang dstchdc
			WHERE 1 = 1
