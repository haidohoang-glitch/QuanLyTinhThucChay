# Stored Procedure: `ThucChay_CPMDonViGoi_DoiTruTinhLai_ThucChayDaTinh`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2025-03-07 17:18:53.317000
- **Ngày sửa cuối**: 2025-03-08 08:51:19.547000

## Parameters

| Parameter | Type | Output |
|-----------|------|--------|
| `@Thucchay_CPMDonViGoi_DmTinhlai` | `DataType_Thucchay_CPMDonViGoi_DmTinhlai` | No |

## Definition (Source Code)

```sql

--CREATE TYPE DataType_Thucchay_CPMDonViGoi_DmTinhlai AS TABLE 
--	(		DmWebsiteREF INT,
...
CREATE PROCEDURE [dbo].[ThucChay_CPMDonViGoi_DoiTruTinhLai_ThucChayDaTinh] 
    @Thucchay_CPMDonViGoi_DmTinhlai DataType_Thucchay_CPMDonViGoi_DmTinhlai READONLY
AS
BEGIN
	...
	SELECT NEWID(), HopDongID = hd.HopDongID,
					...
					DotChayHopDong =  N'Tính lại CPMDonViGoi',--ISNULL(dbo.GetDotChayBookingByHopDongChiTiet(tc.HopDongChiTietREF,'Y'),''),
					...
					GhiChu =  N'Tính lại: SP tối ưu [dbo].[ThucChay_CPMDonViGoi_DoiTruTinhLai_ThucChayDaTinh] do ' + tc.LyDo
			FROM @Thucchay_CPMDonViGoi_DmTinhlai tc
