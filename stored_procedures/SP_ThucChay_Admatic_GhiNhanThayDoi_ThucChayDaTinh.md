# Stored Procedure: `ThucChay_Admatic_GhiNhanThayDoi_ThucChayDaTinh`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2025-03-10 17:06:42.223000
- **Ngày sửa cuối**: 2025-10-30 10:42:08.480000
...
/*
exec [dbo].[ThucChay_Admatic_GhiNhanThayDoi_ThucChayDaTinh]
	@NgayGhiNhan = '2025-10-01',
    @NgayCheckThayDoi = '2025-10-01',
	@NgayDanhSoGioiHan = '2023-10-01'
*/

CREATE PROCEDURE [dbo].[ThucChay_Admatic_GhiNhanThayDoi_ThucChayDaTinh]
	@NgayGhiNhan DATE,
...
BEGIN
	...
	SET  temp.SoLuongThucChay_GhiNhan = IIF(temp.DonGiaSauCK <>0, ThanhTienTC_GhiNhan/temp.DonGiaSauCK, 0),
		 ...
		 temp.ThanhTienLechTreoHa =  IIF(temp.DonGiaKM <>0 AND temp.ChietKhau = 100, temp.ThanhTienKM - ThanhTienKM_GhiNhan, (temp.ThanhTienSauCK - temp.ThanhTienTC_GhiNhan)*100/(100-temp.ChietKhau))
	FROM #DmTinhLai temp
