# Function: `fn_GetDauKy_Of_Quy_ChuyenMuc`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-27 17:43:33
- **Ngày sửa cuối**: 2015-03-27 17:43:33
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Quy_ChuyenMuc] 
(
...
BEGIN
	...
	BEGIN
		...
		(
			...
			FROM rptThucChay_ChuyenMuc_Quy dstchdc
			WHERE 1 = 1
