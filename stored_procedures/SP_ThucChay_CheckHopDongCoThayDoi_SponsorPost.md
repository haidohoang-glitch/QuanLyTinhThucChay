# Stored Procedure: `ThucChay_CheckHopDongCoThayDoi_SponsorPost`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2014-06-30 10:21:15.960000
- **Ngày sửa cuối**: 2014-11-19 12:24:58.260000
...
-- =============================================
--exec [ThucChay_CheckHopDongCoThayDoi_SponsorPost] 25611, 'DT160514', 57511, '2014-05-22'
CREATE PROCEDURE [dbo].[ThucChay_CheckHopDongCoThayDoi_SponsorPost] 
...
BEGIN
	...
	--XOA BAN NHUNG BAN GHI DA THUC HIEN INSERT VOI TRUONG HOP CHI CO GIA TRI THAY DOI
		...
		AND DotChayBooking = 'PS Update GTTD Sponsor Post'
	...
	BEGIN
	    ...
	    BEGIN
			...
			IF(@ISEXIST_HDCT = 0)
			BEGIN
				EXEC [ThucChay_InsertGiaTriThayDoi_SponsorPost] @HopDongChiTietID, @NgayThucHien, @GiaTriThayDoiHT
			END
			--1.3 GHI LOG
			SET @CONTENT_LOG = @CONTENT_LOG + N' (Có thay đổi hợp đồng, Giá trị:' + CONVERT(NVARCHAR(20),convert(bigint,@ThanhTienDaTinh)) + '->' + CONVERT(NVARCHAR(20),convert(bigint,@GiaTienSauCK)) 
			SET @NGUON_LOG = 'Table:ThucChayDaTinh, NgayThucHien:' + CONVERT(NVARCHAR(20),@NgayThucHien) + ', HDCT:' + CONVERT(NVARCHAR(20),@HopDongChiTietID)
			...
			VALUES
			  ...
			  0,0,0,@CONTENT_LOG,@NGUON_LOG,'Sponsor Post',
