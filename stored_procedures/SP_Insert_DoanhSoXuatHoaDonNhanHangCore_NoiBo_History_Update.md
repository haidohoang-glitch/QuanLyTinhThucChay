# Stored Procedure: `Insert_DoanhSoXuatHoaDonNhanHangCore_NoiBo_History_Update`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-06-12 10:47:04.993000
- **Ngày sửa cuối**: 2015-06-12 10:47:04.993000
...
-- =============================================
CREATE PROCEDURE [dbo].[Insert_DoanhSoXuatHoaDonNhanHangCore_NoiBo_History_Update]
...
BEGIN
	...
	DECLARE @NgayDanhSo DATETIME, @NgayKyHopDong DATETIME,@DmMaSohopDong int, @NgayXuatHoaDon DATETIME, @SoHoaDon NVARCHAR(50), @ThongTinHoaDonID INT;
	...
	FROM HopDong hd
		...
		INNER JOIN
		(SELECT  tthd.HopDongREF,CONVERT(DATE,tthd.NgayXuatHoaDon) AS NgayXuatHoaDon, tthd.ThongTinHoaDonID, tthd.SoHoaDon, tthd.GiaTri, tthd.DeletedStatus
	...
	, @SoHoaDon,@NgayXuatHoaDon,@ThongTinHoaDonID,@DmMaSohopDong
