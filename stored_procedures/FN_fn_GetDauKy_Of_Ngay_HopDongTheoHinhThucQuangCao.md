# Function: `fn_GetDauKy_Of_Ngay_HopDongTheoHinhThucQuangCao`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-27 17:43:36.857000
- **Ngày sửa cuối**: 2015-03-27 17:43:36.857000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Ngay_HopDongTheoHinhThucQuangCao] 
(
...
BEGIN
	...
	IF @isSoluong = 0
		...
		(
			...
			FROM rptThucChay_HopDong_TheoHinhThucQuangCao_Ngay dstchdc
			WHERE 1 = 1
