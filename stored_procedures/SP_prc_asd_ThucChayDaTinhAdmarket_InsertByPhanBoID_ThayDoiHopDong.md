# Stored Procedure: `prc_asd_ThucChayDaTinhAdmarket_InsertByPhanBoID_ThayDoiHopDong`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2017-09-11 15:02:52.370000
- **Ngày sửa cuối**: 2023-12-13 11:23:23.267000
...
-- =============================================
CREATE PROCEDURE [dbo].[prc_asd_ThucChayDaTinhAdmarket_InsertByPhanBoID_ThayDoiHopDong]
...
BEGIN
	...
	END
		set @i +=1;
	END
	--update [dbo].ThucChayAdmarket_ADX_CPC_HopDong_online set trangthai = 1 where contract_number = @SoHopDong and user_id = @User_id
	END
END
