# Stored Procedure: `prc_asd_TinhThucChay_Admarket_ThayDoiGiaTri_HopDong_Dev`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2023-12-13 09:54:54.790000
- **Ngày sửa cuối**: 2023-12-13 09:56:34.887000
...
-- exec [dbo].[prc_asd_TinhThucChay_Admarket_ThayDoiGiaTri_HopDong_Dev] '2013-12-11'
-- =============================================
CREATE PROCEDURE [dbo].[prc_asd_TinhThucChay_Admarket_ThayDoiGiaTri_HopDong_Dev]
...
BEGIN
	...
	BEGIN   
		   ...
		   exec [prc_asd_TinhGiaTri_ThayDoi_HopDong_Per] @NgayThucHien,@HopDongFK,@HopDongChiTietREF,@DmSanPhamREF , @TenSanPham,@ThanhTien , @ThanhTien_old;    
		   FETCH NEXT FROM db_cursor INTO @stt  , @HopDongFK , @HopDongChiTietREF , @DmSanPhamREF , @TenSanPham ,@ThanhTien , @ThanhTien_old    
	END   
