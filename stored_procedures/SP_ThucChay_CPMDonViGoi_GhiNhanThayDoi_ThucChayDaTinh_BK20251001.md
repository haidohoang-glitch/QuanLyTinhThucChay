# Stored Procedure: `ThucChay_CPMDonViGoi_GhiNhanThayDoi_ThucChayDaTinh_BK20251001`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2025-10-01 10:49:12.550000
- **Ngày sửa cuối**: 2025-10-01 10:49:12.550000
...
```sql
/*
EXEC [dbo].[ThucChay_CPMDonViGoi_GhiNhanThayDoi_ThucChayDaTinh]
    @NgayGhiNhan  = '2025-08-24',
    @NgayCheckThayDoi = '2025-08-12',
	@NgayDanhSoGioiHan  = '2024-01-12',
	@SoHopDong  = N'TD0030625' ,
	@HopDongChiTietID = 759513

*/
     

--DECLARE @DmInterger TABLE (ID INT)
CREATE PROCEDURE [dbo].[ThucChay_CPMDonViGoi_GhiNhanThayDoi_ThucChayDaTinh_BK20251001]
    @NgayGhiNhan DATE,
