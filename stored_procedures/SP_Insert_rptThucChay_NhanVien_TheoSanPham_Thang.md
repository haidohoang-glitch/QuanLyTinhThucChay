# Stored Procedure: `Insert_rptThucChay_NhanVien_TheoSanPham_Thang`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-03-07 12:18:46.103000
- **Ngày sửa cuối**: 2015-03-07 12:18:46.103000
...
-- =============================================
CREATE PROCEDURE [dbo].[Insert_rptThucChay_NhanVien_TheoSanPham_Thang]
...
BEGIN
    ...
    -----------------------------Du lieu phat sinh-----
	 ...
	 SELECT DISTINCT
	     ...
	     GROUP BY
		       ...
		       rtchdn.DmSanPhamREF
	---------------------------------UPDATE DL----------------------------------------
	UPDATE rptThucChay_NhanVien_TheoSanPham_Thang
	...
	FROM rptThucChay_NhanVien_TheoSanPham_Thang r
    ...
    AND td.Nam = r.Nam
	-----------------------------------------INSERT---------------------------------------
	INSERT INTO rptThucChay_NhanVien_TheoSanPham_Thang
				SELECT 
				@NgayThucHien,
				td.Thang,
				td.Nam,
	           ...
	           td.DmSanPhamREF,
	           '',
				[dbo].[fn_GetDauKy_Of_Thang_NhanVienTheoSanPham]
				(
				  td.DmNhanVienREF ,
				  td.PhongBanREF ,
				  td.BoPhanREF ,
