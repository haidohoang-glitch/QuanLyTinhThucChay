# Stored Procedure: `Insert_rptThucChay_NhanVien_Nam`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-03-27 17:44:01.157000
- **Ngày sửa cuối**: 2015-03-27 17:44:01.157000
...
-- =============================================
CREATE PROCEDURE [dbo].[Insert_rptThucChay_NhanVien_Nam]
...
BEGIN
    ...
    -----------------------------Du lieu phat sinh-----
	 ...
	 SELECT DISTINCT
	     ...
	     GROUP BY
		       ...
		       rtchdn.UserName
	---------------------------------UPDATE DL----------------------------------------
	UPDATE rptThucChay_NhanVien_Nam
	...
	FROM rptThucChay_NhanVien_Nam r
	...
	-----------------------------------------INSERT---------------------------------------
	INSERT INTO rptThucChay_NhanVien_Nam
				SELECT 
				@NgayThucHien,
				td.Nam,
			    td.TenNhanVien, 
