# Stored Procedure: `Insert_rptThucChay_ChuyenMuc_Ngay`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-03-27 17:43:51.083000
- **Ngày sửa cuối**: 2015-03-27 17:43:51.083000
...
--EXEC Insert_rptThucChay_ChuyenMuc_Ngay '2013-01-01', '2013-01-15'
CREATE PROCEDURE [dbo].[Insert_rptThucChay_ChuyenMuc_Ngay]
	@FromDate DATETIME,
	@ToDate DATETIME
AS
BEGIN
	...
	DELETE 
	FROM   rptThucChay_ChuyenMuc_Ngay
	WHERE  1 = 1
	       AND NgayThucHien BETWEEN @FromDate AND @ToDate
	
	WHILE @NgayThucHien <= @ToDate
	BEGIN
	    INSERT INTO rptThucChay_ChuyenMuc_Ngay
	    ...
	    LEFT JOIN DmChuyenMuc dmcm ON dmcm.DmChuyenMucID = dstchdc.DmChuyenMucREF
