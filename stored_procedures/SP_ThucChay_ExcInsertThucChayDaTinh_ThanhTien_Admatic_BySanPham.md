# Stored Procedure: `ThucChay_ExcInsertThucChayDaTinh_ThanhTien_Admatic_BySanPham`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2022-10-25 12:02:39.420000
- **Ngày sửa cuối**: 2022-10-25 12:06:11.230000
...
/*
EXEC [dbo].[ThucChay_ExcInsertThucChayDaTinh_ThanhTien_Admatic] '2020-07-07','2020-07-07'
*/

CREATE PROCEDURE [dbo].[ThucChay_ExcInsertThucChayDaTinh_ThanhTien_Admatic_BySanPham] 
	@StartDate datetime,
	@EndDate datetime,
	@pDmSanPhamREF INT
AS
BEGIN
	...
	BEGIN
		...
		AND tc.[DmSanPhamREF] = @pDmSanPhamREF
		...
		SELECT distinct A.SoHopDong, A.DmSanPhamREF, A.DmWebsiteID, A.TenWebsite, A.DmBannerID
		  FROM
			(
				...
				WHERE tct.DmSanPhamREF = @pDmSanPhamREF
			)A
