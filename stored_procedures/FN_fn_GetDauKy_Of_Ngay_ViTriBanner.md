# Function: `fn_GetDauKy_Of_Ngay_ViTriBanner`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-27 17:43:33.693000
- **Ngày sửa cuối**: 2015-03-27 17:43:33.693000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Ngay_ViTriBanner] 
(
...
BEGIN
	...
	BEGIN
		...
		(
			...
			FROM rptThucChay_TenViTriBanner_Ngay dstchdc
			WHERE 1 = 1
