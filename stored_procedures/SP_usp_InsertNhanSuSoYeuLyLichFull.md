# Stored Procedure: `usp_InsertNhanSuSoYeuLyLichFull`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2013-08-20 16:14:29.910000
- **Ngày sửa cuối**: 2014-11-19 12:16:43.507000
...
--=============================================
-- Author:   Nhat Mai Quy
-- Stored Procedure Name: [dbo].[usp_InsertNhanSuSoYeuLyLichFull]
-- Create Date: Tuesday, August 20, 2013
-- Description: 
--=============================================

CREATE PROCEDURE [dbo].[usp_InsertNhanSuSoYeuLyLichFull]
...
SET NOCOUNT ON
IF(EXISTS(SELECT * FROM dbo.NhanSuSoYeuLyLichFull WHERE NhanSuSoYeuLyLichID = @NhanSuSoYeuLyLichID AND DeletedStatus <> 1))
...
INSERT INTO [dbo].[NhanSuSoYeuLyLichFull] (
	[NhanSuSoYeuLyLichID],
	[MaNhanSu],
	[HoVaTen],
	[BiDanh],
