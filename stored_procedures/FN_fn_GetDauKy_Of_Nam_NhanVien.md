# Function: `fn_GetDauKy_Of_Nam_NhanVien`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-27 17:43:39.157000
- **Ngày sửa cuối**: 2015-03-27 17:43:39.157000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Nam_NhanVien] 
(
...
BEGIN
	...
	BEGIN
		...
		(
			...
			FROM rptThucChay_NhanVien_Nam dstchdc
			WHERE 1 = 1
