# Stored Procedure: `sp_TC_TinhGiaTriThayDoiThucChayDaTinh_PR_ByHopDongID_dev`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2018-09-19 10:41:54.653000
- **Ngày sửa cuối**: 2018-09-19 14:53:55.933000
...
/*
EXEC [dbo].[sp_TC_TinhGiaTriThayDoiThucChayDaTinh_PR_ByHopDongID_dev]   '2017-01-10', '2018-09-18',  '2018-09-18', 141 , 1000752
*/

CREATE PROCEDURE [dbo].[sp_TC_TinhGiaTriThayDoiThucChayDaTinh_PR_ByHopDongID_dev]
    @StartDate DATETIME ,
    @EndDate DATETIME ,
...
AS
    BEGIN
		...
		BEGIN
			...
			--THUC HIEN TINH THUC CHAY VOI GIA TRI THUC TREO CO TRONG SO CAO NHAT 
