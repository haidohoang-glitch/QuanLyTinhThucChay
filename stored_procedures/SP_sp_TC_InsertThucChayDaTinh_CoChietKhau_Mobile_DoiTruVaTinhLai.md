# Stored Procedure: `sp_TC_InsertThucChayDaTinh_CoChietKhau_Mobile_DoiTruVaTinhLai`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2017-11-17 11:27:29.973000
- **Ngày sửa cuối**: 2022-12-01 14:57:49.267000
...
CREATE PROCEDURE [dbo].[sp_TC_InsertThucChayDaTinh_CoChietKhau_Mobile_DoiTruVaTinhLai]
...
AS
    BEGIN
        ...
        (
            ...
            So,Thang,Nam,GiaTriHopDong,CongNo,HopDongChiTietREF,
            DangSuDung,IsGiayPhep,TrangThaiHopDong,IsBanCung,
            DmPhongBanREF,TenPhongBan,DmBoPhanREF,TenBoPhan,DmNhomLamViecREF,TenNhomLamViec,DmDiaDiemLamViecREF,TenDiaDiemLamViec,
            SysNhanVienREF,TenDangNhap,TenNhanVien,TenKhachHang,
			--------
            NhanHang,DmNhomNganhREF,TenNhomNganh,DmHinhThucQuangCao,TenHinhThucQuangCao,DmSanPhamREF,TenSanPham,
            DmNhomWebsiteREF,TenNhomWebsite,DmChuyenMucREF,TenChuyenMuc,DmLoaiBannerREF,TenLoaiBanner,DmViTriREF,TenViTri,
            DotChayHopDong,SoLuongDotChayHD,DotChayBooking,SoLuongDotChayBooking,
            SoLuong,DonViTinh,DonGia,DonGiaTheoDonVi,ChietKhau,GiamGia,ThanhTien,
            TiLeTuVan,ChiPhiTuVan,IsKhuyenMai,KhuyenMai,
			------
            DmBannerREF,DmChienDichREF,DmWebsiteREF,TenWebsite,
            TongViewThucChay,
            TongClickThucChay,
            TongSoBaiViet,
            SoLuongThucChay,
            ...
            GhiChu
                ...
                SELECT  TC.ThucChayDaTinhID ,
                                    TC.HopDongID, TC.SoHopDong, TC.DmMaHopDongREF, TC.TenMaHopDong, TC.NgayDanhSoHopDong, TC.NgayKyHopDong
                                  ...
                                  , TC.DangSuDung, TC.IsGiayPhep, TC.TrangThaiHopDong, TC.IsBanCung, TC.DmPhongBanREF, TC.TenPhongBan
                                  , TC.DmBoPhanREF, TC.TenBoPhan, TC.DmNhomLamViecREF, TC.TenNhom, TC.DmDiaDiemLamViecREF, TC.TenDiaDiemLamViec
								  ...
								  --thong tin soluong,dongia, chietkhau, thanhtien,.. cua hopdongchitiet
                ...
                FROM    ( SELECT    NEWID() ThucChayDaTinhID ,
                                  ...
                                  , TD.ThanhTienThucChayTruocTrietKhau ,
                                    ...
                                    ( CASE WHEN ( ( ( TD.IsKhuyenMai = 1 )
                                           ...
                                           THEN ISNULL(dbo.fn_TC_GetSoLuongThucChayKMMobile_CoChietKhau(TD.HopDongChiTietREF,
                                                              1,
                                                              TD.DonGiaTheoDonViTinh,
                                                              TD.NgayThucHien,
                                                              TD.TongViewThucChay,
                                    ...
                                    0 SoLuongKMThayDoi ,
                                    0 GiaTriKMThayDoi ,
                                    N'sp_TC_InsertThucChayDaTinh_CoChietKhau_Mobile_DoiTruVaTinhLai' GhiChu
                          FROM      ( SELECT 
                                                D.HopDongID ,
                                                D.SoHopDong ,
                                                D.DmMaHopDongREF ,
                                                ...
                                                * dbo.ThucChay_GetSoLuongChuanTheoDonViTinhNotCPD(C.DonViTinh) AS SoLuong ,
                                                ...
                                                0 TongSoBaiViet ,
                                                ISNULL(dbo.[fn_TC_GetSoLuongThucChayMobile_CoChietKhau](@HopDongChiTietID,
                                                ...
                                                0 AS GiaTriThayDoi ,
                                                ISNULL(dbo.fn_TC_GetThanhTienChuanThucChay_CoChietKhau_Mobile(0,--@SoLuong 
                                                              @ProductUnitName,-- 
                                                              0,--@DonGia,
                                                              '',--@NgayKyHopDong,
                                                              @TongViewThucChay,
                                      ...
                                      FROM      (SELECT * FROM dbo.HopDongChiTiet C WHERE C.HopDongChiTietID = @HopDongChiTietID
																					AND C.DeletedStatus = 0
																					AND C.DmSanPhamREF = 342
																					AND C.DonViTinhREF <> 3 --THUC CHAY CPM THEO NGAY
																					AND C.DmLoaiBannerREF NOT IN (17, 18 )
																					AND C.DmLoaiNenTangREF <> 8
												) C
                                                INNER JOIN (SELECT * FROM dbo.HopDong WHERE TrangThaiHopDong NOT IN (0,3)) D ON D.HopDongID = C.HopDongFK
                                      WHERE    1=1
