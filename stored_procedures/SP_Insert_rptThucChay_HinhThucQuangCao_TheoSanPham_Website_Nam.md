# Stored Procedure: `Insert_rptThucChay_HinhThucQuangCao_TheoSanPham_Website_Nam`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-03-27 17:43:46.037000
- **Ngày sửa cuối**: 2015-03-27 17:43:46.037000
...
-- =============================================
CREATE PROCEDURE [dbo].[Insert_rptThucChay_HinhThucQuangCao_TheoSanPham_Website_Nam]
...
BEGIN
	...
	rtchdn.DmWebsiteREF
	-------------------------------------UPDATE DL--------------------------------
	UPDATE rptThucChay_HinhThucQuangCao_TheoSanPham_Website_Nam
	...
	FROM rptThucChay_HinhThucQuangCao_TheoSanPham_Website_Nam rtchtqct
	...
	AND td.Nam = rtchtqct.Nam
	-------------------------------------INSERT DL--------------------------------------
	INSERT INTO rptThucChay_HinhThucQuangCao_TheoSanPham_Website_Nam
				SELECT 
				@NgayThucHien,
				td.Nam,
