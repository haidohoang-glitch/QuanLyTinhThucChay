# Stored Procedure: `Insert_DoanhSoKyNhanHangCore_PhatSinhGiaTriThayDoi`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-04-22 16:42:53.480000
- **Ngày sửa cuối**: 2015-04-22 16:42:53.480000
...
-- =============================================
CREATE PROCEDURE [dbo].[Insert_DoanhSoKyNhanHangCore_PhatSinhGiaTriThayDoi]
...
BEGIN
	...
	SELECT @CountBefor = COUNT(dskc.DoanhSoKyNhanHangCoreID) 
	  FROM DoanhSoKyNhanHangCore dskc WHERE dskc.HopDongID = @HopDongID
	...
	FROM DoanhSoKyNhanHangCore dsknhc 
	...
	AND dsknhc.NgayThucHien = (SELECT MAX(NgayThucHien)FROM DoanhSoKyNhanHangCore WHERE HopDongID = @HopDongID AND HopDongChiTietREF = @HopDongChiTietREF)
	ORDER BY NgayThucHien DESC
    -- Insert statements for procedure here
   SELECT @CountAffter = COUNT(dskc.DoanhSoKyNhanHangCoreID) 
	  FROM DoanhSoKyNhanHangCore dskc WHERE dskc.HopDongID = @HopDongID
	AND dskc.HopDongChiTietREF = @HopDongChiTietREF
