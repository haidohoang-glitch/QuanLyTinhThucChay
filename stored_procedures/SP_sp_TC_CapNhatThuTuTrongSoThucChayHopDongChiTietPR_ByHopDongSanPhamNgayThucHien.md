# Stored Procedure: `sp_TC_CapNhatThuTuTrongSoThucChayHopDongChiTietPR_ByHopDongSanPhamNgayThucHien`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2018-10-23 15:33:04.230000
- **Ngày sửa cuối**: 2019-04-22 15:32:01.740000
...
/*
EXEC [dbo].[sp_TC_CapNhatThuTuTrongSoThucChayHopDongChiTietPR_ByHopDongSanPham]  '2018-10-14', 141 , 1005948
*/

CREATE PROCEDURE [dbo].[sp_TC_CapNhatThuTuTrongSoThucChayHopDongChiTietPR_ByHopDongSanPhamNgayThucHien]
    @EndDate DATETIME ,
	@DmSanPhamREF INT,
    @pHopDongID INT
AS
        ...
        WHILE @@FETCH_STATUS = 0
            BEGIN  
                BEGIN
					IF(@ChietKhau = 100)
					BEGIN
						INSERT  INTO dbo.[ThucChayHopDongChiTietPR_ThuTuTrongSo_Temp]
                            SELECT  @pHopDongID,*
                            FROM    [dbo].[fn_TC_Get_ThuThu_HopDongChiTietID_PR_KM] (@ThucChayHopDongChiTietPRID,
                                                        @HopDongREF,
                                                        @ChietKhau,
                                                        @ThucChayHopDongChiTietPrREF,
                                                        @HopDongChiTietREF,
