# Stored Procedure: `Insert_rptThucChay_TenViTriBanner_Nam`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-03-27 17:44:04.010000
- **Ngày sửa cuối**: 2015-03-27 17:44:04.010000
...
-- =============================================
--EXEC [dbo].[Insert_rptThucChay_ViTriBanner_Nam] '2013-01-01'
CREATE PROCEDURE [dbo].[Insert_rptThucChay_TenViTriBanner_Nam]
...
BEGIN
	...
	INSERT INTO @TeampData
			...
			GROUP BY 
				...
				rtchdn.DmViTriBannerREF
	-----------------------------------UPDATE DL-----------------------------
	UPDATE  rptThucChay_TenViTriBanner_Nam 
		...
		FROM rptThucChay_TenViTriBanner_Nam rtchdt
		...
		AND td.Nam = rtchdt.Nam
		-------------------------------------------------INSERT DL
	    INSERT INTO rptThucChay_TenViTriBanner_Nam
				SELECT 
				@NgayThucHien,
				td.Nam,
				td.TenViTriBanner, 
