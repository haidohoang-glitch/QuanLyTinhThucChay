# Function: `fn_GetDauKy_Of_Ngay_KhachHangTheoHinhThucQuangCao`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-27 17:43:35.260000
- **Ngày sửa cuối**: 2015-03-27 17:43:35.260000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Ngay_KhachHangTheoHinhThucQuangCao] 
(
...
BEGIN
	...
	IF @isSoluong = 0
		...
		(
			...
			FROM rptThucChay_KhachHang_TheoHinhThucQuangCao_Ngay dstchdc
			WHERE 1 = 1
