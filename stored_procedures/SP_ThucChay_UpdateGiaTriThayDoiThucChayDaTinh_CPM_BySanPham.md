# Stored Procedure: `ThucChay_UpdateGiaTriThayDoiThucChayDaTinh_CPM_BySanPham`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2016-03-17 09:21:24.037000
- **Ngày sửa cuối**: 2016-03-17 09:21:24.037000
...
-- =============================================
CREATE  PROCEDURE [dbo].[ThucChay_UpdateGiaTriThayDoiThucChayDaTinh_CPM_BySanPham] 
...
BEGIN
	...
	BEGIN
		...
		AND hdcttd.DmSanPhamREF =@DmSanPhamin
		WHERE 1=1
		AND hdcttd.DmLoaiREF <> 13 --Khong update gia tri thay doi cho HTQC Mua Ngoai 
