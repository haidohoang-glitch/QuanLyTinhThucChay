# Stored Procedure: `ThucChay_TinhLaiDothaydoikhuyenmai_CPD_DonViGoi`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2024-08-21 16:16:30.903000
- **Ngày sửa cuối**: 2024-08-21 16:16:30.903000
...
CREATE  PROCEDURE [dbo].[ThucChay_TinhLaiDothaydoikhuyenmai_CPD_DonViGoi]   
...
DECLARE  @NgayDanhSo_GioiHan DATETIME
	...
	INSERT INTO [dbo].[ThucChayDaTinh]
		...
		0 TongClickThucChay,
		0 TongSoBaiViet,
		(CASE when (C.ChietKhau = 100) then ISNULL(dbo.ThucChay_GetSoLuongThucChayChuanByDonViTinh_CPDDotChay(@NgayThucHien, C.HopDongChiTietID),0)
			else 0
			END
		) as SoLuongThucChay,
		--Thanh Tien Thuc Chay
