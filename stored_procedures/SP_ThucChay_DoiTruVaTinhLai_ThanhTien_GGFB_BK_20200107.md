# Stored Procedure: `ThucChay_DoiTruVaTinhLai_ThanhTien_GGFB_BK_20200107`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2021-01-07 10:15:01.120000
- **Ngày sửa cuối**: 2021-01-07 10:15:01.120000
...
CREATE PROCEDURE [dbo].[ThucChay_DoiTruVaTinhLai_ThanhTien_GGFB_BK_20200107] 
	@pSoHopDong NVARCHAR(100),
	@pHopDongChiTietID INT,
	@pDmSanPhamREF INT,
	@NgayThucHien DATETIME
...
BEGIN
	...
	INNER JOIN (SELECT * FROM dbo.HopDongChiTiet hdct WHERE hdct.HopDongChiTietID = @HopDongChiTietID AND hdct.DeletedStatus = 0 AND hdct.HopDongFK = @HopDongID) hd
			...
			BEGIN
				...
				BEGIN
					SET @ThanhTienSauTrietKhauThucChay = (SELECT TOP(1) (tcdt.ThanhTienSauTrietKhauThucChay + tcdt.GiaTriThayDoi)  FROM dbo.ThucChayDaTinh tcdt
															...
															AND tcdt.GhiChu <> @GhiChu_DoiTruThucChay
