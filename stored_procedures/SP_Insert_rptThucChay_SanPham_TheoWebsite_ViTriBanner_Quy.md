# Stored Procedure: `Insert_rptThucChay_SanPham_TheoWebsite_ViTriBanner_Quy`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-03-27 17:44:02.853000
- **Ngày sửa cuối**: 2015-03-27 17:44:02.853000
...
-- =============================================
--EXEC [dbo].[Insert_rptThucChay_SanPham_TheoWebsite_ViTriBanner_Quy] '2013-01-01'
CREATE PROCEDURE [dbo].[Insert_rptThucChay_SanPham_TheoWebsite_ViTriBanner_Quy]
	...
	INSERT INTO @TeampData
			...
			DISTINCT
			 ...
			 GROUP BY 
				...
				rtchdn.DmViTriBannerREF
	-----------------------------------UPDATE DL-----------------------------
	UPDATE  rptThucChay_SanPham_TheoWebsite_ViTriBanner_Quy 
		...
		FROM rptThucChay_SanPham_TheoWebsite_ViTriBanner_Quy rtchdt
		...
		AND td.Nam = rtchdt.Nam
		-------------------------------------------------INSERT DL
	    INSERT INTO rptThucChay_SanPham_TheoWebsite_ViTriBanner_Quy
				SELECT 
				@NgayThucHien,
				td.Quy,
				td.Nam,
