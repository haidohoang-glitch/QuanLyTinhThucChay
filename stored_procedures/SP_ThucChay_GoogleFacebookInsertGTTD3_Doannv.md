# Stored Procedure: `ThucChay_GoogleFacebookInsertGTTD3_Doannv`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-07-16 14:53:29.340000
- **Ngày sửa cuối**: 2016-10-25 10:28:45.710000
...
-- =============================================
--EXEC  [dbo].[ThucChay_GoogleFacebookInsertGTTD3_Doannv] '2015-06-12','NB050515','Facebook Ads',100,100000,'Gói'
CREATE PROCEDURE [dbo].[ThucChay_GoogleFacebookInsertGTTD3_Doannv]
...
BEGIN
   ...
   --- Kiểm tra đơn vị tính
	...
	SELECT DISTINCT
		...
		'' PheDuyetBy,
		'' PheDuyetAt,
	    CASE WHEN @TrangThai = 1  
		THEN @SoLuongThucChayInsert 
		ELSE 0
	    END SoLuongThayDoi,
