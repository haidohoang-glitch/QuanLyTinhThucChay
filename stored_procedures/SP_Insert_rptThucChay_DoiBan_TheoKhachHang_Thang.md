# Stored Procedure: `Insert_rptThucChay_DoiBan_TheoKhachHang_Thang`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-03-07 12:18:29.703000
- **Ngày sửa cuối**: 2015-03-07 12:18:29.703000
...
-- =============================================
CREATE PROCEDURE [dbo].[Insert_rptThucChay_DoiBan_TheoKhachHang_Thang]
...
BEGIN
	...
	-- interfering with SELECT statements.
     ...
     rtchdn.DmKhachHangREF
     ----------------------------------UPDATE DL-----------------------------
     UPDATE rptThucChay_DoiBan_TheoKhachHang_Thang
     SET
     ...
     FROM rptThucChay_DoiBan_TheoKhachHang_Thang rtcdbt
     ...
     AND td.Nam = rtcdbt.Nam
     --------------------------------insert dl-------------------------------------
     INSERT INTO rptThucChay_DoiBan_TheoKhachHang_Thang
				SELECT 
				...
				td.NhomREF,
				'',
				[dbo].[fn_GetDauKy_Of_Thang_DoiBanTheoKhachHang]
				(
				  td.DmKhachHangREF,
				  td.PhongBanREF,
				  td.BoPhanREF,
