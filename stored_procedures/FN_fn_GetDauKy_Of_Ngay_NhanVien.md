# Function: `fn_GetDauKy_Of_Ngay_NhanVien`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-27 17:43:34.820000
- **Ngày sửa cuối**: 2015-03-27 17:43:34.820000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Ngay_NhanVien] 
(
...
BEGIN
	...
	BEGIN
		...
		(
			...
			FROM rptThucChay_NhanVien_Ngay dstchdc
			WHERE 1 = 1
