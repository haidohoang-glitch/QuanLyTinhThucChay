# Function: `fn_GetDauKy_Of_Thang_KhachHangTheoWebsite`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-27 17:43:23.837000
- **Ngày sửa cuối**: 2015-03-27 17:43:23.837000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Thang_KhachHangTheoWebsite] 
(
...
BEGIN
	...
	IF @isSoluong = 0
		...
		(
			...
			FROM rptThucChay_KhachHang_TheoWebsite_Thang dstchdc
			WHERE 1 = 1
