# Function: `fn_IsPhatSinhGiaTriTD_DoanhSoKyNhanHangCore`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-04-22 16:42:50.143000
- **Ngày sửa cuối**: 2015-04-22 16:42:50.143000
...
CREATE FUNCTION [dbo].[fn_IsPhatSinhGiaTriTD_DoanhSoKyNhanHangCore]
(
	@HopDongID INT,
...
BEGIN
	...
	SET @v_count = 0
	IF(SELECT COUNT(dskc.DoanhSoKyNhanHangCoreID)
	     FROM DoanhSoKyNhanHangCore dskc
