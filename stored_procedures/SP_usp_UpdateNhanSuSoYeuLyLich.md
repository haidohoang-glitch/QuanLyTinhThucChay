# Stored Procedure: `usp_UpdateNhanSuSoYeuLyLich`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2013-08-20 16:13:22.777000
- **Ngày sửa cuối**: 2014-10-14 10:39:38.733000
...
--=============================================
-- Author:   Nhat Mai Quy
-- Stored Procedure Name: [dbo].[usp_UpdateNhanSuSoYeuLyLich]
-- Create Date: Monday, August 19, 2013
-- Description: 
--=============================================

CREATE PROCEDURE [dbo].[usp_UpdateNhanSuSoYeuLyLich]
...
UPDATE [dbo].[NhanSuSoYeuLyLich] SET
	[MaNhanSu] = @MaNhanSu,
	...
	[CvFIleNameEncode] = @CvFIleNameEncode,
	[Code] = @Code,
	[GhiChu] = @GhiChu,
	[Active] = @Active,
