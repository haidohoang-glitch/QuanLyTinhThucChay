# Stored Procedure: `sp_TC_InsertThucChayDaTinh_KoChietKhau_Mobile`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2017-06-16 10:51:40.627000
- **Ngày sửa cuối**: 2018-02-26 10:28:32.130000
...
CREATE PROCEDURE [dbo].[sp_TC_InsertThucChayDaTinh_KoChietKhau_Mobile]
...
AS
        ...
        INSERT  INTO dbo.ThucChayDaTinh
                ...
                FROM    ( SELECT    NEWID() ThucChayDaTinhID ,
                                    ...
                                    ( CASE WHEN ( TD.DonViTinh = 'VIEW' )
                                           THEN dbo.fn_TC_GetSoLuongLechTreoHaThucChayMobile_KoChietKhau(TD.HopDongChiTietREF,
                                                              TD.DonGiaTheoDonViTinh,
                                                              TD.NgayThucHien,
                                                              TD.TongViewThucChay,
                                                              TD.DmBannerREF,
                                    ...
                                    0 SoLuongKMThayDoi ,
                                    0 GiaTriKMThayDoi ,
                                    N'sp_TC_InsertThucChayDaTinh_KoChietKhau_Mobile' GhiChu
                          FROM      ( SELECT 
	--ID Hop Dong
                                                D.HopDongID ,
	--Thong tin ve ma so 
	...
	--(SELECT TOP 1 DmWebsiteReportingdbID FROM DmWebsiteReportingdb WHERE DmWebsiteReportingdb.TenWebsite = @TenWebsite) DmWebsiteREF,
                                                ...
                                                0 TongSoBaiViet ,
                                                ISNULL(dbo.[fn_TC_GetSoLuongThucChayMobile_KoChietKhau](@HopDongChiTietID,
											...
											--else @ProductUnitName 
                                                ...
                                                0 AS GiaTriThayDoi ,
                                                ISNULL(dbo.fn_TC_GetThanhTienChuanThucChay_Mobile_KoChietKhau(0,--@SoLuong 
                                                              @ProductUnitName,-- 
                                                              0,--@DonGia,
                                                              '',--@NgayKyHopDong,
                                                              @TongViewThucChay,
                                      ...
                                      FROM      (SELECT * FROM DBO.HopDongChiTiet C WHERE C.HopDongChiTietID = @HopDongChiTietID 
																					...
																					-- edit 12/12/2017 - ko tinh cho hinh thuc quang cao Admatic
																					AND C.DmLoaiREF <> 42 ) C
                                                INNER JOIN (SELECT * FROM DBO.HopDong D  WHERE 1=1 AND D.TrangThaiHopDong <> 3) D ON D.HopDongID = C.HopDongFK
				...
				IF ISNULL(@TongSoLuongLechTreoHa, 0) > 0
					BEGIN
					    ...
					    IF ISNULL(@SoLuongLechTreoHa, 0) > 0
							BEGIN
							    UPDATE dbo.ThucChayDaTinh SET SoLuongThucChayLechTreoHa = 0
