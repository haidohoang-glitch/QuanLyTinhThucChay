# Stored Procedure: `ThucChay_Update_AdmaticThuTuChayHopDongChiTiet`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2016-11-28 11:19:52.600000
- **Ngày sửa cuối**: 2018-11-29 14:30:11.930000
...
```sql
/*
[dbo].[ThucChay_Update_AdmaticThuTuChayHopDongChiTiet] '2016-12-09'
*/

CREATE  PROCEDURE [dbo].[ThucChay_Update_AdmaticThuTuChayHopDongChiTiet] 
...
BEGIN
	...
	BEGIN
		...
		--,ROW_NUMBER() OVER (PARTITION BY hd.HopDongID ORDER BY hd.HopDongID, hdct.ChietKhau ,dchdct.minThoiGianBatDau, dchdct.HopDongChiTietREF) as SoThuTuChay
