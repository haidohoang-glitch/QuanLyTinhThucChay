# Stored Procedure: `ThucChay_Mobile_DoiTruTinhLai_ThucChayDaTinh`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2025-03-14 16:59:14.867000
- **Ngày sửa cuối**: 2025-03-21 12:03:20.087000

## Parameters

| Parameter | Type | Output |
|-----------|------|--------|
| `@DmTinhLaiTongHop` | `DataType_Thucchay_Mobile_DmTinhLaiTongHop2` | No |

## Definition (Source Code)

```sql
CREATE PROCEDURE [dbo].[ThucChay_Mobile_DoiTruTinhLai_ThucChayDaTinh] 
    @DmTinhLaiTongHop DataType_Thucchay_Mobile_DmTinhLaiTongHop2 READONLY
AS
BEGIN
	...
	SELECT NEWID(), HopDongID = hd.HopDongID,
					...
					DotChayHopDong =  N'Tính lại Mobile',--ISNULL(dbo.GetDotChayBookingByHopDongChiTiet(tc.HopDongChiTietREF,'Y'),''),
					...
					DonViTinh = dbo.ThucChay_Mobile_GetDonViTinh(hdct.DonViTinh, tc.DonViTinhTreo) , 
					DonGia = hdct.DonGia ,
					...
					GiaTriThayDoi = tc.ThanhTienThucChay_GhiNhan   ,
					...
					GhiChu =  IIF(pbcu.id IS NOT NULL, N'PP cũ ', N'PP mới ') + N'Tính lại: SP tối ưu [dbo].[ThucChay_Mobile_DoiTruTinhLai_ThucChayDaTinh] do ' + tc.LyDo
			FROM @DmTinhLaiTongHop tc
			...
			LEFT JOIN ABM_data_thucchay.dbo.ThucChay_Mobile_DmPhanBoChungBanner_Truoc20241212 pbcu ON pbcu.ID = tc.HopDongChiTietREF
