# Stored Procedure: `ThucChay_AdmarketGetBaoCaoByHopDong`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2013-12-25 17:19:24.870000
- **Ngày sửa cuối**: 2014-11-19 12:16:56.907000
...
-- =============================================
CREATE PROCEDURE [dbo].[ThucChay_AdmarketGetBaoCaoByHopDong]
...
BEGIN
	...
	SET @SqlCommandString = '
		SELECT 
			 ...
			 dbo.FormatNumber(T.TongClick) TongClick,
			 dbo.FormatNumber(T.TongView) TongView,
			 dbo.FormatNumber(T.TongTienThucChay) TongTienThucChay,
			 T.num STT
		FROM 
		(' 
			+ @SqlCommandString + 
