# Stored Procedure: `ThucChayDaTinh_UpdateGiaTriThayDoiMuaNgoaiChiTiet_dev`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2020-05-18 17:15:04.870000
- **Ngày sửa cuối**: 2020-05-25 16:27:09.973000
...
-- =============================================
/*
	EXEC  [dbo].[ThucChayDaTinh_UpdateGiaTriThayDoiMuaNgoaiChiTiet_dev] '2020-05-23'
*/
CREATE PROCEDURE [dbo].[ThucChayDaTinh_UpdateGiaTriThayDoiMuaNgoaiChiTiet_dev]
	...
	BEGIN
		...
		BEGIN
			...
			BEGIN
				...
				= ISNULL(
				(SELECT  (CASE WHEN tc.ChietKhau <> 100  THEN SUM(tc.ThanhTienLaiThucChaySauCK + tc.GiaTriThayDoiLaiSauCK) 
