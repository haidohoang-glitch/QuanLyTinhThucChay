# Stored Procedure: `Insert_DoanhSoTienVeNhanHangCore_ByNgayThucHien`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-06-12 10:47:06.880000
- **Ngày sửa cuối**: 2015-06-12 10:47:06.880000
...
-- =============================================
--EXEC [dbo].[Insert_DoanhSoTienVeNhanHangCore_ByNgayThucHien] '2015-01-06'
CREATE PROCEDURE [dbo].[Insert_DoanhSoTienVeNhanHangCore_ByNgayThucHien]
...
BEGIN
	...
	WHILE @@FETCH_STATUS = 0
		BEGIN
					...
					SET @IsPhatSinhGiaTriTD = [dbo].[fn_IsPhatSinhGiaTriTD_DoanhSoTienVeNhanHangCore_New]
					(
						@NgayThucHien,
						@HopDongID,
						@HopDongChiTietID ,
			...
			BEGIN
				...
				EXEC [Insert_DoanhSoTienVeNhanHangCore_PhatSinhTrongKy] @NgayThucHien, @HopDongID,@HopDongChiTietID ,@DmMaHopDongREF_New,@ThongTinTienVeID
			END
	...
	BEGIN
		...
		WHILE @@FETCH_STATUS = 0
		BEGIN
			EXEC dbo.Insert_DoanhSoTienVeNhanHangCore_PhatSinhThayDoi @NgayThucHien,@HopDongID
		...
		WHILE @@FETCH_STATUS = 0
		BEGIN
			--DELETE FROM DoanhSoTienVeNhanHangCore WHERE HopDongID = @HopDongIDThayDoi AND HopDongChiTietREF = @HopDongChiTietIDThayDoi AND ThongTinTienVeREF = @ThongTinTienVeThayDoiID
            EXEC dbo.Insert_DoanhSoTienVeNhanHangCore_NoiBo_History_Update @NgayThucHien,@HopDongIDThayDoi,@HopDongChiTietIDThayDoi,@ThongTinTienVeThayDoiID
            EXEC dbo.Insert_DoanhSoTienVeNhanHangCore_ThucThuKhuyenMai_History_Update @NgayThucHien,@HopDongIDThayDoi,@HopDongChiTietIDThayDoi,@ThongTinTienVeThayDoiID
