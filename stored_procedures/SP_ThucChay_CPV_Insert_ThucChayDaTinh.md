# Stored Procedure: `ThucChay_CPV_Insert_ThucChayDaTinh`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2025-03-07 17:15:18.800000
- **Ngày sửa cuối**: 2025-03-08 08:46:54.537000

## Parameters

| Parameter | Type | Output |
|-----------|------|--------|
| `@Thucchay_CPV_DmTinhMoi` | `DataType_Thucchay_CPMthuan_DmTinhMoi` | No |

## Definition (Source Code)

```sql

CREATE PROCEDURE [dbo].[ThucChay_CPV_Insert_ThucChayDaTinh] 
	@Thucchay_CPV_DmTinhMoi DataType_Thucchay_CPMthuan_DmTinhMoi READONLY
AS
BEGIN
	...
	SELECT NEWID(), HopDongID = hd.HopDongID,
					...
					DotChayHopDong = N'Tính mới CPV',--ISNULL(dbo.GetDotChayBookingByHopDongChiTiet(tc.HopDongChiTietREF,'Y'),''),
					...
					GiaTriKMThayDoi = 0 ,
					GhiChu =  tc.GhiChu
			FROM @Thucchay_CPV_DmTinhMoi tc
