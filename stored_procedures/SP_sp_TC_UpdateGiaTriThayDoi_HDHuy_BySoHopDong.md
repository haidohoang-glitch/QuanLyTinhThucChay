# Stored Procedure: `sp_TC_UpdateGiaTriThayDoi_HDHuy_BySoHopDong`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2017-10-16 16:34:58.973000
- **Ngày sửa cuối**: 2017-10-16 16:34:58.973000
...
CREATE PROCEDURE [dbo].[sp_TC_UpdateGiaTriThayDoi_HDHuy_BySoHopDong] 
...
AS
	...
	-- Declare the return variable here
        ...
        DECLARE Record_Cursor_TCDT1 CURSOR
        FOR
            SELECT  *
            FROM    ( SELECT    tcdt.DmWebsiteREF ,
                                tcdt.TenWebsite ,
	...
	-- Perform the first fetch.
        FETCH NEXT FROM Record_Cursor_TCDT1 INTO @DmWebsiteREF, @TenWebsite, @HopDongChiTietID, @HopDongREF, @SoHopDong, @DmSanPhamREF, @TenSanPham,
            @GiaTriThayDoi, @SoLuongThucChayByWebiste
	    ...
	    --GHI LOG VIEC THAY DOI
				...
				--EXEC  ThucChay_InsertThucTreoThayDoiSP_CPM_HDHuy @HopDongChiTietID, @DmSanPhamREF,@TenSanPham, @NgayThucHien, @GiaTriThayDoi,@DmWebsiteREF, @TenWebsite, @SoLuongThucChayByWebiste
                        EXEC [dbo].sp_TC_InsertThucChayDaTinh_DoiTruGiam_CPM_HDHuy @HopDongChiTietID, @DmSanPhamREF, @TenSanPham, @NgayThucHien, @GiaTriThayDoi,
                            @DmWebsiteREF, @TenWebsite, @SoLuongThucChayByWebiste
                ...
                ELSE
					...
					--EXEC  ThucChay_InsertThucTreoThayDoiPPSP_CPM_KiemToan @HopDongChiTietID, @DmSanPhamREF,@TenSanPham, @NgayThucHien, @GiaTriThayDoi,@DmWebsiteREF, @TenWebsite, @SoLuongThucChayByWebiste	
                        EXEC sp_TC_InsertThucTreoThayDoiPPSP_CPM_HDHuy @HopDongREF, @DmSanPhamREF, @TenSanPham, @NgayThucHien, @GiaTriThayDoi, @DmWebsiteREF,
                            @TenWebsite, @SoLuongThucChayByWebiste	
                    END
