# Stored Procedure: `Insert_rptThucChay_NhanHang_TheoSanPham_Thang`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-03-31 11:21:06.930000
- **Ngày sửa cuối**: 2015-03-31 11:21:06.930000
...
-- =============================================
CREATE PROCEDURE [dbo].[Insert_rptThucChay_NhanHang_TheoSanPham_Thang]
	...
	INSERT INTO @TeampData
			...
			GROUP BY 
			   rtchdn.TenNhanVien,
			    ...
			    rtchdn.DmSanPhamREF
	-----------------------------------UPDATE DL-----------------------------
	UPDATE  rptThucChay_NhanHang_TheoSanPham_Thang
		SET rptThucChay_NhanHang_TheoSanPham_Thang.NgayThucHien = @NgayThucHien,
		    rptThucChay_NhanHang_TheoSanPham_Thang.ThucChayPhatSinhTrongKy += td.ThucChayPhatSinhTrongKy,
		    rptThucChay_NhanHang_TheoSanPham_Thang.ThucChayPhatSinhCuoiKy += td.ThucChayPhatSinhTrongKy,
		    rptThucChay_NhanHang_TheoSanPham_Thang.KhuyenMaiPhatSinhTrongKy += td.KhuyenMaiPhatSinhTrongKy,
		    rptThucChay_NhanHang_TheoSanPham_Thang.KhuyenMaiPhatSinhCuoiKy += td.KhuyenMaiPhatSinhTrongKy,
		    rptThucChay_NhanHang_TheoSanPham_Thang.NoiBoPhatSinhTrongKy += td.NoiBoPhatSinhTrongKy,
		    rptThucChay_NhanHang_TheoSanPham_Thang.NoiBoPhatSinhCuoiKy += td.NoiBoPhatSinhTrongKy,
		...
		FROM rptThucChay_NhanHang_TheoSanPham_Thang rtchdt
		...
		AND td.Nam = rtchdt.Nam
		-------------------------------------------------INSERT DL
	    INSERT INTO rptThucChay_NhanHang_TheoSanPham_Thang
				SELECT 
				@NgayThucHien,
				td.Thang,
				td.Nam,
	            ...
	            td.TenSanPham,
	            td.DmSanPhamREF,
				[dbo].[fn_GetDauKy_Of_Ngay_NhanHangTheoSanPham]
				(
				td.DmNhanVienREF,
				td.PhongBanREF,
				td.BoPhanREF,
