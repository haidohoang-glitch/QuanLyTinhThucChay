# Stored Procedure: `Insert_rptThucChay_BaoCaoTongHopTheoHopDong_Nam`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-03-27 17:43:49.673000
- **Ngày sửa cuối**: 2015-03-27 17:43:49.673000
...
-- =============================================
--EXEC [dbo].[Insert_rptThucChay_BaoCaoTongHopTheoHopDong_Nam_NEW] '2013-01-02'
CREATE PROCEDURE [dbo].[Insert_rptThucChay_BaoCaoTongHopTheoHopDong_Nam]
...
BEGIN
    ...
    -- Tổng hợp dữ liệu theo ngày
	   INSERT INTO @TeampData
		...
		UPDATE  rptThucChay_BaoCaoTongHopTheoHopDong_Nam 
		SET rptThucChay_BaoCaoTongHopTheoHopDong_Nam.NgayThucHien = @NgayThucHien,
		    rptThucChay_BaoCaoTongHopTheoHopDong_Nam.ThucChayPhatSinhTrongKy += td.ThucChayPhatSinhTrongKy,
		    rptThucChay_BaoCaoTongHopTheoHopDong_Nam.ThucChayPhatSinhCuoiKy += td.ThucChayPhatSinhTrongKy,
		    rptThucChay_BaoCaoTongHopTheoHopDong_Nam.KhuyenMaiPhatSinhTrongKy += td.KhuyenMaiPhatSinhTrongKy,
		    rptThucChay_BaoCaoTongHopTheoHopDong_Nam.KhuyenMaiPhatSinhCuoiKy += td.KhuyenMaiPhatSinhTrongKy,
		    rptThucChay_BaoCaoTongHopTheoHopDong_Nam.NoiBoPhatSinhTrongKy += td.NoiBoPhatSinhTrongKy,
		    rptThucChay_BaoCaoTongHopTheoHopDong_Nam.NoiBoPhatSinhCuoiKy += td.NoiBoPhatSinhTrongKy,
		...
		FROM rptThucChay_BaoCaoTongHopTheoHopDong_Nam rtchdt
		...
		SET TrangThai = 1
		FROM @TeampData td
		INNER JOIN rptThucChay_BaoCaoTongHopTheoHopDong_Nam rtchdt
		ON td.HopDongID = rtchdt.HopDongID
		AND td.DmNhanVienREF = rtchdt.DmNhanVienREF
		AND td.PhongBanREF = rtchdt.PhongBanREF
		AND td.BoPhanREF = rtchdt.BoPhanREF
		...
		AND td.DmViTriBannerREF = rtchdt.DmViTriBannerREF
     ------------------------------------Insert--------------------------------------------
     INSERT INTO rptThucChay_BaoCaoTongHopTheoHopDong_Nam
     SELECT 
				@NgayThucHien,
				td.Nam,
				td.HopDongID,
