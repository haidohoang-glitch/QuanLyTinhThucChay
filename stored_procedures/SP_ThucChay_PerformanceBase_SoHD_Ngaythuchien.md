# Stored Procedure: `ThucChay_PerformanceBase_SoHD_Ngaythuchien`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2025-04-09 10:21:08.183000
- **Ngày sửa cuối**: 2025-04-09 11:12:09.290000
...
```sql
CREATE PROCEDURE [dbo].[ThucChay_PerformanceBase_SoHD_Ngaythuchien]
...
BEGIN
 ...
 SELECT --tcdc.NgayThucHien,
           ...
           tcdc.TenViTri,
           tcdc.ThanhTien,
           SUM(tctk.ThucchaySanPham)ThucchaySanPham,
           SUM(tcdc.ThanhTienThucChay)ThanhTienThucChay,
           SUM(tcdc.TienKPI)TienKPI,
           SUM(tcdc.TienTDGP)TienTDGP,
           SUM(tcdc.TienDCThucChay)TienDCThucChay,
           SUM(tcdc.TienHDNB)TienHDNB
    FROM
    (
        SELECT contract_number,
               ...
               DmViTriREF,
               NgayThucHien,
			   ISNULL(SUM(CONVERT(FLOAT, domain_tt_money)), 0) AS ThucchaySanPham
        ...
        (
            ...
            (
                ...
                WHERE 1=1
				AND tcad.SoHopDong=@Sohopdong
				AND tcad.NgayThucHien
                      BETWEEN @Startdate AND @Todate
                ...
                (
                    ...
                    AND EXISTS
                        ...
                        WHERE tcpbtd.DeletedStatus = 0
							  ...
							  AND tcpbtd.SoHopDong=@Sohopdong
...
WHERE tcdc.NgayThucHien BETWEEN @Startdate AND @Todate
GROUP BY  tcdc.SohopDong,
           tcdc.HopDongChiTietREF,
           tcdc.TK_AdMarket,
           tcdc.DmSanPhamREF,
           tcdc.DmViTriREF,
