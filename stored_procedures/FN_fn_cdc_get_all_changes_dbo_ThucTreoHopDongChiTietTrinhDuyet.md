# Function: `fn_cdc_get_all_changes_dbo_ThucTreoHopDongChiTietTrinhDuyet`

- **Loại**: SQL_INLINE_TABLE_VALUED_FUNCTION
- **Ngày tạo**: 2021-08-31 08:38:41.770000
- **Ngày sửa cuối**: 2021-08-31 08:38:41.770000
...
```sql
	...
	create function [cdc].[fn_cdc_get_all_changes_dbo_ThucTreoHopDongChiTietTrinhDuyet]
	(	@from_lsn binary(10),
		@to_lsn binary(10),
	...
	where ( [sys].[fn_cdc_check_parameters]( N'dbo_ThucTreoHopDongChiTietTrinhDuyet', @from_lsn, @to_lsn, lower(rtrim(ltrim(@row_filter_option))), 0) = 0)
	...
	from [cdc].[dbo_ThucTreoHopDongChiTietTrinhDuyet_CT] t with (nolock)    
	where (lower(rtrim(ltrim(@row_filter_option))) = 'all')
	    and ( [sys].[fn_cdc_check_parameters]( N'dbo_ThucTreoHopDongChiTietTrinhDuyet', @from_lsn, @to_lsn, lower(rtrim(ltrim(@row_filter_option))), 0) = 1)
