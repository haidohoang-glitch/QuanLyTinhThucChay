# Function: `fn_GetDauKy_Of_Quy_BaoCaoTongHopTheoHopDong`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-27 17:43:33.453000
- **Ngày sửa cuối**: 2015-03-27 17:43:33.453000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Quy_BaoCaoTongHopTheoHopDong] 
(
...
BEGIN
	...
	IF @isSoluong = 0
		...
		(
			...
			FROM rptThucChay_BaoCaoTongHopTheoHopDong_Quy dstchdc
			WHERE 1 = 1
