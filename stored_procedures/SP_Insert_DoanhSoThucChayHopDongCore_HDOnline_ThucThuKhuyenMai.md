# Stored Procedure: `Insert_DoanhSoThucChayHopDongCore_HDOnline_ThucThuKhuyenMai`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-03-27 17:43:51.803000
- **Ngày sửa cuối**: 2015-03-27 17:43:51.803000
...
CREATE PROCEDURE [dbo].[Insert_DoanhSoThucChayHopDongCore_HDOnline_ThucThuKhuyenMai] 
...
BEGIN
	...
	SELECT * FROM 
	(
	SELECT tcdt.NgayThucHien, isnull(tcdt.DmMaHopDongREF,0) AS DmMaHopDongREF, isnull(tcdt.TenMaHopDong,'') AS TenMaHopDong, 0 AS HopDongID, 'MuaOnline' AS SoHopDong
