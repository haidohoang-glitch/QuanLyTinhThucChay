# Function: `ThucChay_GenSQLCommandSelfServingForQuery`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2014-07-22 17:13:49.247000
- **Ngày sửa cuối**: 2014-10-14 10:39:32.890000
...
-- =============================================
CREATE FUNCTION [dbo].[ThucChay_GenSQLCommandSelfServingForQuery] 
(
	@StartDate datetime,
	@EndDate datetime,
...
BEGIN
	...
	SET @Sql = '
		SELECT * FROM dbo.GetDataThucChaySelfServingByParams('+ @DauNhay  + CONVERT(VARCHAR(50),@StartDate) + @DauNhay + ',' + @DauNhay  + CONVERT(VARCHAR(50),@EndDate) + @DauNhay + ')'
