# Function: `fn_GetDauKy_Of_Ngay_KhachHang`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-27 17:43:35.480000
- **Ngày sửa cuối**: 2015-03-27 17:43:35.480000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Ngay_KhachHang] 
(
...
BEGIN
	...
	BEGIN
		...
		(
			...
			FROM rptThucChay_KhachHang_Ngay dstchdc
			WHERE 1 = 1
