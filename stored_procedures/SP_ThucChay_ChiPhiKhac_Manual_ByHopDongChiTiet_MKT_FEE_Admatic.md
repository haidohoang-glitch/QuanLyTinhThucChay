# Stored Procedure: `ThucChay_ChiPhiKhac_Manual_ByHopDongChiTiet_MKT_FEE_Admatic`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2025-12-31 14:56:02.417000
- **Ngày sửa cuối**: 2025-12-31 14:57:34.400000
...
/*
EXEC [ThucChay_ChiPhiKhac_Manual_ByHopDongChiTiet]    
			@NgayGhiNhan ='2025-08-28',   
            @HopDongChiTietID = 759848
*/


CREATE PROCEDURE [dbo].[ThucChay_ChiPhiKhac_Manual_ByHopDongChiTiet_MKT_FEE_Admatic]
    @NgayGhiNhan DATE,
...
AS
	...
	@NgayDanhSoGioiHan_Admatic_MKT DATETIME = '2025-10-10'
		...
		SELECT DISTINCT
				...
				0 LoaiThayDoi,
				LyDo = N'Tinh lại Manual MKT FEE Admatic'
		...
		BEGIN
			...
			SELECT  NEWID(),
					...
					IIF(dm.LoaiXuLy = 2, N'Tính lại: ', N'Tính mới: ') + N'SP tối ưu [dbo].[ThucChay_ChiPhiKhac_Manual_ByHopDongChiTiet_MKT_FEE_Admatic] do ' + dm.LyDo
