# Function: `fn_GetDauKy_Of_Quy_SanPhamTheoWebsiteViTriBanner`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-27 17:43:28.653000
- **Ngày sửa cuối**: 2015-03-27 17:43:28.653000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Quy_SanPhamTheoWebsiteViTriBanner] 
(
...
BEGIN
	...
	BEGIN
		...
		(
			...
			FROM rptThucChay_SanPham_TheoWebsite_ViTriBanner_Quy dstchdc
			WHERE 1 = 1
