# Stored Procedure: `ThucChay_BaoCaoSumByFilterConditionV2`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2013-06-14 13:08:24.787000
- **Ngày sửa cuối**: 2014-11-19 12:16:57.710000
...
```sql
CREATE PROCEDURE [dbo].[ThucChay_BaoCaoSumByFilterConditionV2]
...
BEGIN
	...
	set @TableName =  dbo.ThucChay_GetBaoCaoByFilterConditionV2(
									@GroupFieldName,
									@StartDate ,
									@EndDate ,
									@DmSanPhamREFList ,
	...
	if(@PageCount>=@PageIndex)
		set @SQL = 	'SELECT * FROM 
		(SELECT *, ROW_NUMBER() OVER(ORDER BY ' + @GroupFieldName + ') AS rownum from ('+@TableName +') T  ) as VitualTable '+
