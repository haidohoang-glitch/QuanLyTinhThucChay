# Stored Procedure: `ThucChay_UpdateGiaTriThayDoi_HDHuy_BySoHopDong`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-03-18 12:32:24.400000
- **Ngày sửa cuối**: 2015-03-18 12:33:40.903000
...
-- =============================================
--EXEC [ThucChay_UpdateGiaTriThayDoi_HDHuy_BySoHopDong] '2015-08-15'

CREATE PROCEDURE [dbo].[ThucChay_UpdateGiaTriThayDoi_HDHuy_BySoHopDong] 
...
BEGIN
	...
	AND SoHopDong = @SoHopDong AND HopDongID = @HopDongREF
	...
	DECLARE Record_Cursor_TCDT1 CURSOR  FOR
		...
		AND tcdt.HopDongID = @HopDongREF AND tcdt.SoHopDong = @SoHopDong
