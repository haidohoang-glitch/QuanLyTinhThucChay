# Stored Procedure: `Gen_InsertOrUpdate_ThucChayHopDongChiTiet_New_dev`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2018-09-04 10:53:35.943000
- **Ngày sửa cuối**: 2018-09-04 11:12:08.923000
...
```sql
/*
EXEC [dbo].[Gen_InsertOrUpdate_ThucChayHopDongChiTiet_New_dev] 
*/
CREATE PROCEDURE [dbo].[Gen_InsertOrUpdate_ThucChayHopDongChiTiet_New_dev] 	
...
SET @NgayThucHien = DATEADD(HOUR,-220,@NgayThucHien)
...
FROM OPENQUERY(MySQL,''CALL Abm_get_hdcn_thucchay (''''' + CONVERT(NVARCHAR(50), @NgayThucHien, 120)
    + ''''');'') tchdct
	where tchdct.HopDongChiTietREF = 533494
	'
...
WHERE HopDongChiTietREF = 533494
...
--    SET    [STATUS] = 1
--    FROM  #ThucChayHopDongChiTiet t INNER JOIN ThucChayHopDongChiTiet dc
