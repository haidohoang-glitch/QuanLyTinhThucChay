# Function: `fn_GetDauKy_Of_Ngay_NhanHang`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-31 11:21:02.620000
- **Ngày sửa cuối**: 2015-03-31 11:21:02.620000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Ngay_NhanHang] 
(
...
BEGIN
	...
	BEGIN
		...
		(
			...
			FROM rptThucChay_NhanHang_Ngay dstchdc
			WHERE 1 = 1
