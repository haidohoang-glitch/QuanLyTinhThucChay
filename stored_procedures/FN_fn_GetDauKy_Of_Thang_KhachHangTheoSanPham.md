# Function: `fn_GetDauKy_Of_Thang_KhachHangTheoSanPham`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-27 17:43:24.050000
- **Ngày sửa cuối**: 2015-03-27 17:43:24.050000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Thang_KhachHangTheoSanPham] 
(
...
BEGIN
	...
	IF @isSoluong = 0
		...
		(
			...
			FROM rptThucChay_KhachHang_TheoSanPham_Thang dstchdc
			WHERE 1 = 1
