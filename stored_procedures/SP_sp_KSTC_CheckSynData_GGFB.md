# Stored Procedure: `sp_KSTC_CheckSynData_GGFB`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2021-12-30 16:15:52.563000
- **Ngày sửa cuối**: 2021-12-30 16:15:52.563000
...
-- =============================================
create PROCEDURE [dbo].[sp_KSTC_CheckSynData_GGFB]
...
BEGIN
	...
	SELECT N'GGFB_Operating_Result'as CheckSynData,  A.*,        B.* FROM (
...
SELECT N'GGFB_Operating_Result_Map_Order' as CheckSynData, A.*,B.* FROM (
        SELECT *        
...
SELECT N'GGFB_Operating_Order' as CheckSynData, A.*,B.* FROM (
...
SELECT N'GGFB_Operating_Result_Quantity' as CheckSynData, A.*,B.* FROM (
