# Function: `fn_GetDauKy_Of_Nam_HopDongTheoSanPham`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-27 17:43:40.400000
- **Ngày sửa cuối**: 2015-03-27 17:43:40.400000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Nam_HopDongTheoSanPham] 
(
...
BEGIN
	...
	IF @isSoluong = 0
		...
		(
			...
			FROM rptThucChay_HopDong_TheoSanPham_Nam dstchdc
			WHERE 1 = 1
