# Stored Procedure: `ThucChay_AdmaticDonViBai_bk_20250528`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2025-05-28 15:08:55.147000
- **Ngày sửa cuối**: 2025-05-28 15:08:55.147000
...
create PROCEDURE [dbo].[ThucChay_AdmaticDonViBai_bk_20250528]
    @NgayGhiNhan DATE,
...
AS
    BEGIN
		...
		WHERE   NgayThucHien = @NgayGhiNhan
				...
				AND ((DmSanPhamREF  in (305,5312) ) OR	(DmSanPhamREF  = 598 AND DmVitriREF = 9198))
		...
		*/
		BEGIN
			...
			BEGIN
				...
				INNER JOIN ABM_data_thucchay.dbo.HopDongChiTiet hdct ON tchdct.HopDongChiTietREF = hdct.HopDongChiTietID
				INNER JOIN ABM_data_thucchay.dbo.HopDong hd ON hd.HopDongID = hdct.HopDongFK
				WHERE  ((hdct.DmSanPhamREF in (305,5312)) OR (hdct.DmSanPhamREF = 598 AND hdct.DmViTriREF = 9198))
					   AND NOT ( hdct.DmLoaiREF = 13 OR hdct.DmLoaiBannerREF = 18 )
					   AND hdct.DmLoaiREF = 42
					   AND hdct.DonViTinhREF IN (7,84)
		...
		BEGIN
			...
			WHERE		tcdt.NgayThucHien < dm.NgayThucHien 
						...
						AND ((tcdt.DmSanPhamREF  in (305,5312) ) OR	(tcdt.DmSanPhamREF  = 598 AND tcdt.DmVitriREF = 9198))
