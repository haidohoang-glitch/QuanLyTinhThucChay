# Function: `fn_GetDauKy_Of_Thang_BaoCaoTongHopTheoHopDong`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-27 17:43:28.023000
- **Ngày sửa cuối**: 2015-03-27 17:43:28.023000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Thang_BaoCaoTongHopTheoHopDong] 
(
...
BEGIN
	...
	IF @isSoluong = 0
		...
		(
			...
			FROM rptThucChay_BaoCaoTongHopTheoHopDong_Thang dstchdc
			WHERE 1 = 1
