# Stored Procedure: `sp_TC_HopDongChiTietHuy_PR`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2017-06-12 15:59:32.590000
- **Ngày sửa cuối**: 2017-12-08 09:56:19.750000
...
CREATE PROCEDURE [dbo].[sp_TC_HopDongChiTietHuy_PR]
        ...
        IF EXISTS ( SELECT  NEWID() ,
            ...
            BEGIN
                ...
                VALUES  ( @HopDongID , -- HopDongID - int
                          ...
                          N'Hợp đồng chi tiết hủy'  -- GhiChu - nvarchar(500)
		                )
