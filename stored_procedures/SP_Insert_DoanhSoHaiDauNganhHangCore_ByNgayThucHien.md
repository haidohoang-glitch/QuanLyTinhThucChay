# Stored Procedure: `Insert_DoanhSoHaiDauNganhHangCore_ByNgayThucHien`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-04-22 16:42:58.357000
- **Ngày sửa cuối**: 2015-04-22 16:42:58.357000
...
-- =============================================
--EXEC [dbo].[Insert_DoanhSoHaiDauNganhHangCore_ByNgayThucHien] '2014-01-13'
CREATE PROCEDURE [dbo].[Insert_DoanhSoHaiDauNganhHangCore_ByNgayThucHien]
...
BEGIN
	...
	WHILE @@FETCH_STATUS = 0
		BEGIN
					...
					SET @IsPhatSinhGiaTriTD = [dbo].[fn_IsPhatSinhGiaTriTD_DoanhSoHaiDauNganhHangCore]
					(
						@HopDongID,
						@HopDongChiTietID ,
						@SoHopDong_New ,
			...
			IF(@IsPhatSinhGiaTriTD = 0)
				BEGIN	
					EXEC [Insert_DoanhSoHaiDauNganhHangCore_PhatSinhTrongKy] @NgayThucHien, @HopDongID,@HopDongChiTietID ,@DmMaHopDongREF_New 
					PRINT('Phat Sinh Trong Ky')
				END
			ELSE
				BEGIN
					EXEC [dbo].[Insert_DoanhSoHaiDauNganhHangCore_PhatSinhGiaTriThayDoi] @NgayThucHien, @HopDongID, @HopDongChiTietID, @DmMaHopDongREF_New
