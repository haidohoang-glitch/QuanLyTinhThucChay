# Stored Procedure: `InsertOrUpdateAdMarketThucChayDaTinh`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2013-07-17 09:21:03.903000
- **Ngày sửa cuối**: 2014-11-19 12:16:54.797000
...
```sql
CREATE PROCEDURE [dbo].[InsertOrUpdateAdMarketThucChayDaTinh] (
	...
	BEGIN
	    ...
	    VALUES
	      (
	        ...
	        0,	-- SoLuong - int
	        dbo.GetDonViTinhAdmarketByDmSanPhamREF(@DmSanPhamREF),	-- DonViTinh - nvarchar(50)
	        0.0,	-- DonGia - float
	        ...
	        dbo.GetSoLuongAdmarketByDmSanPhamREF(@DmSanPhamREF, @ttv, @ttc),	-- SoLuongThucChay - float
