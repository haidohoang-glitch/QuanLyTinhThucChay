# Stored Procedure: `sp_ThucChayDaTinh_ReInsertByHopDong_NhanHang`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2016-08-15 14:41:28.873000
- **Ngày sửa cuối**: 2024-11-20 16:06:41.250000
...
CREATE PROCEDURE [dbo].[sp_ThucChayDaTinh_ReInsertByHopDong_NhanHang]
...
BEGIN
	...
	DECLARE cursor_hdct CURSOR FOR  
		...
		select [HopDongREF], [HopDongChiTietREF], [ThucChayHopDongChiTietID], [DmNhanHangREF]  
	...
	BEGIN   
		...
		IF(NOT EXISTS(SELECT TOP 1 @PhanBoID FROM #ThucChayDatinh_HopDong_NhanHang 	
			...
			AND status_record = 1))
		BEGIN
			--THUC HIEN XL THAY DOI NHAN HANG
