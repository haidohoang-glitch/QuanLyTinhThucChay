# Stored Procedure: `Insert_rptThucChay_KhachHang_TheoNenTang_Thang`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-03-07 12:18:40.620000
- **Ngày sửa cuối**: 2015-03-07 12:18:40.620000
...
-- =============================================
CREATE PROCEDURE [dbo].[Insert_rptThucChay_KhachHang_TheoNenTang_Thang]
...
BEGIN
	...
	-- interfering with SELECT statements.
	 DECLARE @TeampData TABLE 
	  ...
	  rtchdn.DmLoaiNenTangREF
	  ------------------------------------UPDATE dl------------------------
	  UPDATE  rptThucChay_KhachHang_TheoNenTang_Thang 
		SET rptThucChay_KhachHang_TheoNenTang_Thang.NgayThucHien = @NgayThucHien,
		    rptThucChay_KhachHang_TheoNenTang_Thang.ThucChayPhatSinhTrongKy += td.ThucChayPhatSinhTrongKy,
		    rptThucChay_KhachHang_TheoNenTang_Thang.ThucChayPhatSinhCuoiKy += td.ThucChayPhatSinhTrongKy,
		    rptThucChay_KhachHang_TheoNenTang_Thang.KhuyenMaiPhatSinhTrongKy += td.KhuyenMaiPhatSinhTrongKy,
		    rptThucChay_KhachHang_TheoNenTang_Thang.KhuyenMaiPhatSinhCuoiKy += td.KhuyenMaiPhatSinhTrongKy,
		    rptThucChay_KhachHang_TheoNenTang_Thang.NoiBoPhatSinhTrongKy += td.NoiBoPhatSinhTrongKy,
		    rptThucChay_KhachHang_TheoNenTang_Thang.NoiBoPhatSinhCuoiKy += td.NoiBoPhatSinhTrongKy,
		...
		FROM rptThucChay_KhachHang_TheoNenTang_Thang rtchdt
		...
		AND td.Nam = rtchdt.Nam
		----------------------------------INSERT dl------------------------------------
		INSERT INTO rptThucChay_KhachHang_TheoNenTang_Thang
				SELECT 
				@NgayThucHien,
				td.Thang,
				td.Nam,
	            ...
	            td.DmLoaiNenTangREF,
	            '',
				[dbo].[fn_GetDauKy_Of_Thang_KhachHangTheoLoaiNenTang]
				(
				  td.DmKhachHangREF,	
				  td.DmHinhThucKhachHangREF	,
				  td.DmLoaiNenTangREF,
