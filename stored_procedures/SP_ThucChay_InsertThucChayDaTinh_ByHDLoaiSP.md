# Stored Procedure: `ThucChay_InsertThucChayDaTinh_ByHDLoaiSP`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2013-07-12 10:22:07.830000
- **Ngày sửa cuối**: 2017-10-06 11:31:35.890000
...
CREATE  PROCEDURE [dbo].[ThucChay_InsertThucChayDaTinh_ByHDLoaiSP] 
...
INSERT INTO dbo.ThucChayDaTinh 
	...
	(
		SELECT (case when HDCT.DmSanPhamREF=231 then 3
					 ...
					 when HDCT.DmSanPhamREF=732 then 17
					   when HDCT.DmSanPhamREF=735 then 18
					else 9
		...
		AND HDCT.DmSanPhamREF IN (231,238,339,240,370,735)
