# Stored Procedure: `sp_TC_InsertThucChayDaTinh_KoChietKhau_Mobile_TinhLaiCuoiThang`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2017-09-13 09:29:57.167000
- **Ngày sửa cuối**: 2017-09-25 12:00:49.397000
...
CREATE PROCEDURE [dbo].[sp_TC_InsertThucChayDaTinh_KoChietKhau_Mobile_TinhLaiCuoiThang]
...
AS
        ...
        INSERT  INTO dbo.ThucChayDaTinh_TinhLaiCuoiThang
                ...
                FROM    ( SELECT    NEWID() ThucChayDaTinhID ,
                                    ...
                                    ( CASE WHEN ( TD.DonViTinh = 'VIEW' )
                                           THEN dbo.fn_TC_GetSoLuongLechTreoHaThucChayMobile_KoChietKhau_TinhLaiCuoiThang(TD.HopDongChiTietREF,
                                                              TD.DonGiaTheoDonViTinh,
                                                              TD.NgayThucHien,
                                                              TD.TongViewThucChay,
                                                              TD.DmBannerREF,
	...
	--(SELECT TOP 1 DmWebsiteReportingdbID FROM DmWebsiteReportingdb WHERE DmWebsiteReportingdb.TenWebsite = @TenWebsite) DmWebsiteREF,
                                                ...
                                                0 TongSoBaiViet ,
                                                ISNULL(dbo.[fn_TC_GetSoLuongThucChayMobile_KoChietKhau_TinhLaiCuoiThang](@HopDongChiTietID,
											...
											--else @ProductUnitName 
                                                ...
                                                0 AS GiaTriThayDoi ,
                                                ISNULL(dbo.fn_TC_GetThanhTienChuanThucChay_Mobile_KoChietKhau_TinhLaiCuoiThang(0,--@SoLuong 
                                                              @ProductUnitName,-- 
                                                              0,--@DonGia,
                                                              '',--@NgayKyHopDong,
                                                              @TongViewThucChay,
				...
				IF ISNULL(@TongSoLuongLechTreoHa, 0) > 0
					BEGIN
					    ...
					    IF ISNULL(@SoLuongLechTreoHa, 0) > 0
							BEGIN
							    UPDATE dbo.ThucChayDaTinh_TinhLaiCuoiThang SET SoLuongThucChayLechTreoHa = 0
