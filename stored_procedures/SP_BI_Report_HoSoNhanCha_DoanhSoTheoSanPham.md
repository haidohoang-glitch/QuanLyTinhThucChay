# Stored Procedure: `BI_Report_HoSoNhanCha_DoanhSoTheoSanPham`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-06-25 16:17:15.033000
- **Ngày sửa cuối**: 2015-06-25 16:17:15.033000
...
-- =============================================
CREATE PROCEDURE [dbo].[BI_Report_HoSoNhanCha_DoanhSoTheoSanPham] 
	@DmNhanHangChaID INT,
	@FromDate DATETIME,
	@ToDate DATETIME
AS
BEGIN
	...
	exec [dbo].BI_HoSoNhanCha_DoanhSoTheoSanPham @DmNhanHangChaID, @FromDate, @ToDate;
END
