# Stored Procedure: `Gen_InsertOrUpdate_HopDongChiTiet_MuaNgoai_New_BySoNgay_v1`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2019-09-23 15:00:05.150000
- **Ngày sửa cuối**: 2020-01-09 11:08:00.237000
...
```sql
/*
EXEC [dbo].[Gen_InsertOrUpdate_HopDongChiTiet_MuaNgoai_New_BySoNgay_v1] 50
*/
CREATE PROCEDURE [dbo].[Gen_InsertOrUpdate_HopDongChiTiet_MuaNgoai_New_BySoNgay_v1]
	@SoNgayLui INT
As 	
BEGIN
	...
	, 0 Statuss
	 FROM (
		SELECT dt.Id, dt.LastModificationTime FROM [192.168.23.217].PMS.dbo.B_DuToan dt 
	...
	set @NgayThucHien_ThucChayMN = DATEADD(day,-@SoNgayLui,@NgayThucHien_ThucChayMN)
