# Stored Procedure: `sp_TC_InsertThucChayDaTinh_PR_NgayThucHien`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2019-05-29 16:05:57.620000
- **Ngày sửa cuối**: 2019-05-29 16:06:04.627000
...
*/
CREATE PROCEDURE [dbo].[sp_TC_InsertThucChayDaTinh_PR_NgayThucHien]
    @StartDate DATETIME ,
    @EndDate DATETIME ,
    ...
    --            AND NOT ( DmHinhThucQuangCao = 13 OR DmLoaiBannerREF = 18 )
        ...
        WHILE ( @NgayThucHien <= @EndDate )
            BEGIN
                ...
                FOR
                    SELECT DISTINCT HopDongREF, DmSanPhamREF FROM @ThucTreoPRCanTinhNgay
