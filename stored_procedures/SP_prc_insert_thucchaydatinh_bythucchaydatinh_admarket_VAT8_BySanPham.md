# Stored Procedure: `prc_insert_thucchaydatinh_bythucchaydatinh_admarket_VAT8_BySanPham`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2022-05-13 15:27:13.020000
- **Ngày sửa cuối**: 2022-05-13 16:06:13.057000
...
CREATE PROCEDURE [dbo].[prc_insert_thucchaydatinh_bythucchaydatinh_admarket_VAT8_BySanPham] 
...
BEGIN
	...
	and DmHinhThucQuangCao <> 42 and  NgayThucHien = @ngaythuchien
	...
	(
		...
		and a.domain_name = @DmSanPhamREF
		group by 
		a.domain_name,
		a.DmSanPhamREF,
		a.TenSanPham
