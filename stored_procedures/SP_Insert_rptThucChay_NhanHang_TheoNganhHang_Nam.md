# Stored Procedure: `Insert_rptThucChay_NhanHang_TheoNganhHang_Nam`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-03-31 11:21:06.627000
- **Ngày sửa cuối**: 2015-03-31 11:21:06.627000
...
-- =============================================
CREATE PROCEDURE [dbo].[Insert_rptThucChay_NhanHang_TheoNganhHang_Nam]
...
BEGIN
	...
	DECLARE @TeampData TABLE 
	   (
			...
			DmNhanHangREF INT,
			DsTenNgangHang NVARCHAR(200),
			DmListNganhHang NVARCHAR(200),
	...
	INSERT INTO @TeampData
			...
			GROUP BY 
			   rtchdn.TenNhanVien,
				...
				rtchdn.DmListNganhHangREF
	-----------------------------------UPDATE DL-----------------------------
	UPDATE  rptThucChay_NhanHang_TheoNganhHang_Nam
		SET rptThucChay_NhanHang_TheoNganhHang_Nam.NgayThucHien = @NgayThucHien,
		    rptThucChay_NhanHang_TheoNganhHang_Nam.ThucChayPhatSinhTrongKy += td.ThucChayPhatSinhTrongKy,
		    rptThucChay_NhanHang_TheoNganhHang_Nam.ThucChayPhatSinhCuoiKy += td.ThucChayPhatSinhTrongKy,
		    rptThucChay_NhanHang_TheoNganhHang_Nam.KhuyenMaiPhatSinhTrongKy += td.KhuyenMaiPhatSinhTrongKy,
		    rptThucChay_NhanHang_TheoNganhHang_Nam.KhuyenMaiPhatSinhCuoiKy += td.KhuyenMaiPhatSinhTrongKy,
		    rptThucChay_NhanHang_TheoNganhHang_Nam.NoiBoPhatSinhTrongKy += td.NoiBoPhatSinhTrongKy,
		    rptThucChay_NhanHang_TheoNganhHang_Nam.NoiBoPhatSinhCuoiKy += td.NoiBoPhatSinhTrongKy,
		...
		FROM rptThucChay_NhanHang_TheoNganhHang_Nam rtchdt
		...
		AND td.DmListNganhHang = rtchdt.DmListNganhHangREF
		...
		AND td.Nam = rtchdt.Nam
		-------------------------------------------------INSERT DL
	    INSERT INTO rptThucChay_NhanHang_TheoNganhHang_Nam
				SELECT 
				@NgayThucHien,
				td.Nam,
				 td.TenNhanHang, 
