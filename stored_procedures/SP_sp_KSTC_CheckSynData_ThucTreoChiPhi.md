# Stored Procedure: `sp_KSTC_CheckSynData_ThucTreoChiPhi`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2020-04-09 15:25:20.727000
- **Ngày sửa cuối**: 2021-06-03 13:57:08.373000
...
CREATE PROCEDURE [dbo].[sp_KSTC_CheckSynData_ThucTreoChiPhi] 
	-- Add the parameters for the stored procedure here

AS
BEGIN
-------------------------------------------1. kiem tra syn thuc treo chi phi bản ghi được duyệt----------------------------
SELECT N'Content, Khác' [LoaiChiPhi], A.*,B.*,(A.TotalMoney- B.ThanhTien)LechTien,
...
FROM [asd14].ThucTreo.dbo.ThucTreo_ChiPhi tt
...
SELECT N'Content, Khác' [LoaiChiPhi],A.*,B.* FROM (
...
FROM [asd14].ThucTreo.dbo.ThucTreo_ChiPhi a LEFT JOIN [ASD14].CONTRACT.dbo.contracts b ON a.Contract_Id = b.Id
WHERE 1=1
