# Function: `fn_GetDauKy_Of_Quy_HopDongTheoWebsite`

- **Loại**: SQL_SCALAR_FUNCTION
- **Ngày tạo**: 2015-03-27 17:43:30.447000
- **Ngày sửa cuối**: 2015-03-27 17:43:30.447000
...
CREATE FUNCTION [dbo].[fn_GetDauKy_Of_Quy_HopDongTheoWebsite] 
(
...
BEGIN
	...
	IF @isSoluong = 0
		...
		(
			...
			FROM rptThucChay_HopDong_TheoWebsite_Quy dstchdc
			WHERE 1 = 1
