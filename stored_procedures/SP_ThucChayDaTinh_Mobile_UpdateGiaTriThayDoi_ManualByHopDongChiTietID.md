# Stored Procedure: `ThucChayDaTinh_Mobile_UpdateGiaTriThayDoi_ManualByHopDongChiTietID`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2014-10-30 14:45:31.617000
- **Ngày sửa cuối**: 2017-06-26 11:36:28.800000
...
-- =============================================
-- 
-- EXEC [dbo].[ThucChayDaTinh_Mobile_UpdateGiaTriThayDoi_ManualByHopDongChiTietID] '2017-03-23', 'QC0110117',108489,342

CREATE PROCEDURE [dbo].[ThucChayDaTinh_Mobile_UpdateGiaTriThayDoi_ManualByHopDongChiTietID] 
...
BEGIN
	...
	SELECT @DanhSachNhanHangReF  = COALESCE(@DanhSachNhanHangReF + N', ', N'') + A.DmNhanHangREF  FROM
	(
