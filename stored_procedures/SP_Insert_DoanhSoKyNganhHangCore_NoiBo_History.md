# Stored Procedure: `Insert_DoanhSoKyNganhHangCore_NoiBo_History`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2015-04-22 16:42:53.057000
- **Ngày sửa cuối**: 2015-04-22 16:42:53.057000
...
-- =============================================
CREATE PROCEDURE [dbo].[Insert_DoanhSoKyNganhHangCore_NoiBo_History]
				    ...
				    IF(@CountNhan <> @SoLuongNganh) 
						BEGIN
							...
							ELSE
								BEGIN
									SET @ChiSoSLNhanM =  0
				    				SET @ChiSoTTNhanM = CAST(@ThanhTien AS BIGINT )/@SoLuongNganh
								END
						END
				    ...
				    BEGIN
				    	IF(@SoLuong <> 0)
				    	    begin
				    			...
				    			SET @ChiSoTTNhanM =  CAST(@ThanhTien AS BIGINT) - (@SoLuongNganh-1) * CAST(@SoLuong/@SoLuongNganh AS int) * CAST(@ThanhTien AS BIGINT)/@SoLuong
				    	    END
				    	ELSE
				    		BEGIN
				    			SET @ChiSoSLNhanM =  0
				    			SET @ChiSoTTNhanM =  CAST(@ThanhTien AS BIGINT) - (@SoLuongNganh-1)  * CAST(@ThanhTien AS BIGINT)/@SoLuongNganh
				    		END
