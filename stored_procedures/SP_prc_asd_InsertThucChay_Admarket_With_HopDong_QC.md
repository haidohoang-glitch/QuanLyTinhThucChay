# Stored Procedure: `prc_asd_InsertThucChay_Admarket_With_HopDong_QC`

- **Loại**: SQL_STORED_PROCEDURE
- **Ngày tạo**: 2021-06-15 11:36:08.333000
- **Ngày sửa cuối**: 2024-12-14 10:18:03.270000
...
CREATE PROCEDURE [dbo].[prc_asd_InsertThucChay_Admarket_With_HopDong_QC]
...
BEGIN
	...
	DECLARE @ThanhTienThucChayDaTinh FLOAT = 0, 
		...
		IF(EXISTS(SELECT TOP (1) hdct.HopDongChiTietID FROM dbo.HopDongChiTiet hdct 
			...
			OR (@TienThucChay_GhiNhan <0) --20240626 HAIDH COMMENT NEU TIEN THUC CHAY <0 THI VAN THUC HIEN GHI NHAN TIEP
			)
		BEGIN
