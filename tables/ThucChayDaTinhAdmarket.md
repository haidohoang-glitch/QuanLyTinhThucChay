...
|--------|------|-------------|
| `ThucChayDaTinhID` | `NVARCHAR(50)` PK |  |
| `HopDongID` | `INT` NN |  |
...
| `DmNhomWebsiteREF` | `NVARCHAR(200)` nullable |  |
...
| `SoLuongThayDoi` | `INT` NN DEFAULT 0 |  |
| `SoLuongKMThayDoi` | `INT` NN DEFAULT 0 |  |
| `GiaTriKMThayDoi` | `FLOAT` NN DEFAULT 0 |  |
...
| Index | Columns | Loại |
|-------|---------|------|
| `IX_ThucChayDaTinhAdmarket` | `HopDongID, SoHopDong, HopDongChiTietREF, DangSuDung, TrangThaiHopDong, DmSanPhamREF, NgayThucHien` | BTREE |
| `nonix_dmsp_nth` | `DmSanPhamREF, NgayThucHien` | BTREE |
| `nonix_hdctref_nth` | `HopDongChiTietREF, NgayThucHien` | BTREE |
| `nonix_nth` | `NgayThucHien` | BTREE |
| `PK_ThucChayDaTinhAdmarket` | `ThucChayDaTinhID` | PRIMARY KEY |
