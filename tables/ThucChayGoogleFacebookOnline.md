# Table: `ThucChayGoogleFacebookOnline`
...
| `SoNgayChay` | `INT` DEFAULT 0 nullable |  |
| `Click` | `INT` DEFAULT 0 nullable |  |
| `ThanhTien` | `FLOAT` DEFAULT 0 nullable |  |
| `Type` | `NVARCHAR(50)` nullable |  |
| `ThucChayGoogleFacebookID` | `NVARCHAR(50)` PK |  |
...
| Index | Columns | Loại |
|-------|---------|------|
| `PK_ThucChayGoogleFacebookOnline` | `ThucChayGoogleFacebookID` | PRIMARY KEY |
