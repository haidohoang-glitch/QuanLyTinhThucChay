# Table: `ThucChaySelfServingUsers_NhanHang`
...
|--------|------|-------------|
| `ThucChaySelfServingUsers_NhanHangID` | `UUID` PK |  |
...
| `LastModifedAt` | `DATETIME` nullable |  |
...
| Index | Columns | Loại |
|-------|---------|------|
| `PK_ThucChaySelfServingUsers_NhanHang` | `ThucChaySelfServingUsers_NhanHangID` | PRIMARY KEY |
