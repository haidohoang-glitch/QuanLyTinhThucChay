# Table: `QuyenChiTietNhomQuyenDoiTuongQuyen`
...
|--------|------|-------------|
| `QuyenChiTietNhomQuyenDoiTuongQuyenID` | `BIGINT` PK IDENTITY |  |
...
| Index | Columns | Loại |
|-------|---------|------|
| `PK_QuyenChiTietNhomQuyenDoiTuongQuyen` | `QuyenChiTietNhomQuyenDoiTuongQuyenID` | PRIMARY KEY |
