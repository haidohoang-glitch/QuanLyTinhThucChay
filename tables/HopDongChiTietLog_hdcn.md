...
|--------|------|-------------|
| `HopDongChiTietLogID` | `INT` NN |  |
| `HopDongChiTietREF` | `INT` NN |  |
| `HopDongFK` | `INT` NN |  |
| `DanhSachNhanHangREF` | `NVARCHAR(200)` nullable |  |
| `NhanHang` | `NVARCHAR(200)` nullable |  |
| `DmNhomNganhREF` | `NVARCHAR(200)` nullable |  |
| `TenNhomNganh` | `NVARCHAR(200)` nullable |  |
| `DmLoaiREF` | `BIGINT` nullable |  |
| `TenLoai` | `NVARCHAR(200)` nullable |  |
| `DmNhomWebsiteREF` | `NVARCHAR(200)` nullable |  |
| `TenNhomWebsite` | `NVARCHAR(200)` nullable |  |
...
| `TenLoaiBanner` | `NVARCHAR(200)` nullable |  |
