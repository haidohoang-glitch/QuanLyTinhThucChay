# Table: `ThucChay_ThanhTien_Admatic`
...
|--------|------|-------------|
| `ThucChay_ThanhTien_AdmaticID` | `BIGINT` PK IDENTITY |  |
...
| `ThanhTienThucChaySauCK_ChuaVAT` | `FLOAT` nullable |  |
...
| Index | Columns | Loại |
|-------|---------|------|
| `PK_ThucChay_ThanhTien_Admatic` | `ThucChay_ThanhTien_AdmaticID` | PRIMARY KEY |
