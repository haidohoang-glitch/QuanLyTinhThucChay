# Table: `Data_Log_QLTC_OnImage_Ads`
...
|--------|------|-------------|
| `ThucChay_Native_AdsID` | `INT` nullable |  |
...
| `CreatedByManipulation` | `INT` nullable |  |
| `Id_Delete` | `INT` nullable |  |
| `CreatedAtManipulation` | `DATETIME` nullable |  |
| `ID` | `INT` PK IDENTITY |  |
...
| Index | Columns | Loại |
|-------|---------|------|
| `PK_Data_Log_QLTC_OnImage_Ads` | `ID` | PRIMARY KEY |
